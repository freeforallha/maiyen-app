const Map<String, String> msStrings = {
  ...
  "Toàn bộ thiết bị MaiYen": "Semua peranti MaiYen",
  ...
  "MaiYen tự bật Bảo vệ vì bạn đã rời khỏi nhà.":
      "MaiYen menghidupkan Mod Perlindungan secara automatik kerana anda telah meninggalkan rumah.",
  ...
  "Sau vài lần sử dụng, MaiYen sẽ đánh giá thói quen kiểm tra ứng dụng tốt hơn.":
      "Selepas beberapa penggunaan, MaiYen akan menilai tabiat menyemak apl dengan lebih baik.",
  ...
  "Điện thoại ít có khả năng trì hoãn cảnh báo MaiYen.":
      "Telefon kurang berkemungkinan melengahkan amaran MaiYen.",
  ...
  "Điện thoại có thể nhận thông báo MaiYen.":
      "Telefon boleh menerima pemberitahuan MaiYen.",
  ...
  "MaiYen cần quyền vị trí \"Luôn cho phép\" để nhận biết khi bạn rời hoặc trở về nhà, kể cả khi ứng dụng đang chạy nền.":
      "MaiYen memerlukan kebenaran lokasi \"Sentiasa Benarkan\" untuk mengesan apabila anda meninggalkan atau pulang ke rumah, termasuk ketika aplikasi berjalan di latar belakang.",
  ...
  "Một người dùng MaiYen": "Satu-satunya pengguna MaiYen",
  ...
  "MaiYen Security Alert": "Makluman Keselamatan MaiYen",
  ...
  "MaiYen đang cập nhật vị trí": "MaiYen mengemas kini lokasi",
  ...
  "Không thể xác nhận với MaiYen. Hãy kiểm tra kết nối và thử lại.":
      "Tidak dapat mengesahkan dengan MaiYen. Sila semak sambungan anda dan cuba lagi.",
  ...
  "🚨 MaiYen phát hiện cảnh báo": "🚨 MaiYen mengesan amaran",
  ...
  "MaiYen đang xoá thiết bị \"\$deviceName\" khỏi nhà \"\$homeName\".":
      "MaiYen sedang memadam peranti \"\$deviceName\" daripada rumah \"\$homeName\".",
  ...
  "Nếu chưa có ai xác nhận, MaiYen sẽ chuyển sang gọi điện khẩn cấp.":
      "Jika tiada siapa yang mengesahkan, MaiYen akan bertukar kepada panggilan kecemasan.",
  ...
  "Hãy thêm thiết bị MaiYen đầu tiên để bắt đầu theo dõi nhà.":
      "Tambahkan peranti MaiYen pertama untuk memulakan pemantauan di rumah.",
  ...
  "Báo động MaiYen": "penggera MaiYen",
  ...
  "Thời gian tạm dừng báo động đã kết thúc.":
      "Tempoh jeda penggera telah tamat.",
  ...
  "Đã chuyển về Bình thường nhưng chưa gửi được thông báo":
      "Bertukar ke mod Normal, tetapi pemberitahuan tidak dapat dihantar",
  "Chung cho nhà": "Untuk seluruh rumah",
  "Áp dụng cho toàn bộ thành viên và có thể bật còi vật lý.":
      "Digunakan untuk semua ahli dan boleh mengaktifkan siren fizikal.",
  "Cá nhân": "Peribadi",
  "Lịch cá nhân hoạt động độc lập và không bật còi vật lý.":
      "Jadual peribadi berfungsi secara bebas dan tidak pernah mengaktifkan siren fizikal.",
  "Cài đặt này chỉ áp dụng cho tài khoản của bạn.":
      "Tetapan ini hanya digunakan untuk akaun anda.",
  "Chỉ chủ nhà và quản trị viên có thể thay đổi phần chung cho nhà.":
      "Hanya pemilik dan pentadbir boleh mengubah tetapan bersama rumah.",
  "Tham gia hệ thống báo động": "Sertai sistem penggera",
  "Cảm biến khẩn cấp luôn tham gia hệ thống báo động.":
      "Sensor kecemasan sentiasa menyertai sistem penggera.",
  "Tắt để thiết bị không tạo bất kỳ báo động nào.":
      "Matikan supaya peranti tidak menghasilkan sebarang penggera.",
  ...
  "Hiển thị cảnh báo toàn màn hình trên điện thoại của bạn.":
      "Paparkan amaran skrin penuh pada telefon anda.",
  ...
  "Lịch chung và lịch cá nhân hoạt động song song, không còn phải chọn một trong hai.":
      "Jadual bersama dan peribadi berjalan serentak; tidak perlu memilih salah satu.",
  ...
  "Lịch này chỉ áp dụng cho bạn và không bật còi vật lý.":
      "Jadual ini hanya digunakan untuk anda dan tidak mengaktifkan siren fizikal.",
  "Lịch này áp dụng cho toàn bộ thành viên trong nhà.":
      "Jadual ini digunakan untuk semua ahli rumah.",
  ...
  "Nhận cảnh báo theo lịch chung của nhà":
      "Terima amaran daripada jadual bersama rumah",
  "Tắt để không nhận thông báo hoặc cảnh báo toàn màn hình từ lịch chung. Còi vật lý của nhà vẫn hoạt động.":
      "Matikan untuk berhenti menerima pemberitahuan atau amaran skrin penuh daripada jadual bersama. Siren rumah masih berfungsi.",
};

const Map<String, String> mtDynamicStrings = {
  "Bảo vệ - Tự động": "Protezzjoni - Awtomatika",
  "Bảo vệ - Thủ công": "Protezzjoni - Manwali",
  "Tự động": "Awtomatika",
  "Thủ công": "Manwali",
  "\$displayMemberName đã gia nhập nhà \"\$homeName\".":
      "\$displayMemberName issieħeb fid-dar \"\$homeName\".",
  "NGUY HIỂM": "PERIKLU",
  "Nguy hiểm & Khẩn cấp": "Periklu u Emerġenza",
  "TẮT CÒI": "ITFI S-SIRENA",
  "Tắt còi báo động?": "Titfi s-sirena tal-allarm?",
  "Còi vật lý sẽ dừng, nhưng cảnh báo vẫn tiếp tục cho đến khi sự cố được xử lý.\n\nBạn chắc chắn muốn tắt còi?":
      "Is-sirena fiżika tieqaf, iżda t-twissija tkompli sakemm l-inċident jiġi solvut.\n\nŻgur li trid titfi s-sirena?",
  "Đã gửi lệnh tắt còi. Cảnh báo vẫn đang được theo dõi.":
      "Intbagħat il-kmand biex tintefa s-sirena. It-twissija għadha qed tiġi mmonitorjata.",
  "Không tìm thấy cảnh báo đang hoạt động hoặc chưa thể gửi lệnh tắt còi.":
      "Ma nstabet l-ebda twissija attiva jew il-kmand biex tintefa s-sirena ma setax jintbagħat.",
  "TẮT CÒI TRONG NHÀ": "ITFI S-SIRENA FID-DAR",
  "Đã tắt còi trong nhà. Cảnh báo vẫn tiếp tục cho đến khi được xử lý.":
      "Is-sirena fid-dar intefgħet. It-twissija tkompli sakemm tiġi solvuta.",
  "\$name đang chuẩn bị gửi tin...": "\$name qed jikteb...",
  "\$name1 và \$name2 đang chuẩn bị gửi tin...":
      "\$name1 u \$name2 qed jiktbu...",
  ...
  "FCM token đã sẵn sàng, nhưng tính năng tự động khi rời nhà còn thiếu điều kiện.":
      "It-token FCM huwa lest, iżda l-karatteristika awtomatika meta titlaq mid-dar għadha nieqsa minn kundizzjoni.",
  "Đã kích hoạt SOS": "SOS attivat",
  "Phát hiện chập điện": "Instab ċirkwit qasir",
  "Phát hiện quá dòng": "Instab kurrent żejjed",
  "Phát hiện quá áp": "Instab vultaġġ żejjed",
  "Thiết bị điện quá nhiệt": "It-tagħmir elettriku saħan iżżejjed",
  "Tài khoản đang được sử dụng": "Il-kont qed jintuża",
  "Hiện tại tài khoản này đang đăng nhập trên một thiết bị khác. Nếu tiếp tục, tài khoản trên thiết bị đó sẽ tự đăng xuất.":
      "Dan il-kont bħalissa huwa illoggjat fuq apparat ieħor. Jekk tkompli, il-kont fuq dak l-apparat jiġi illoggjat awtomatikament.",
  "Tiếp tục đăng nhập": "Kompli idħol",
  "Tài khoản đã được đăng nhập trên một thiết bị khác.":
      "Il-kont iddaħħal fuq apparat ieħor.",
  "KHẨN CẤP": "EMERĠENZA",
  "CẦN CHÚ Ý": "JEĦTIEĠ ATTENZJONI",
  "THÔNG TIN": "INFORMAZZJONI",
  "BÁO ĐỘNG": "ALLARM",
  "Cảm biến đã trở lại trạng thái an toàn.":
      "Is-sensur reġa' lura għal stat sigur.",
  "Người dùng đã tắt cảnh báo.": "Utent waqqaf it-twissija.",
  "Khung giờ bảo vệ đã kết thúc.": "Il-perjodu ta' protezzjoni ntemm.",
  "Cảnh báo tức thời đã tự kết thúc.":
      "It-twissija immedjata ntemmet awtomatikament.",
  "Điều kiện cảnh báo không còn hoạt động.":
      "Il-kundizzjoni tat-twissija m'għadhiex attiva.",
  "Cảnh báo đã kết thúc: \$reason": "It-twissija ntemmet: \$reason",
};

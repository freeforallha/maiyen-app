const Map<String, String> filStrings = {
  ...
  "Nhắc kiểm tra nhà theo thời gian": "Magtakda ng mga paalala para suriin ang bahay",
  ...
  "Đặt nhắc nhở / báo động nhà đã chọn": "Itakda ang paalala / alarma para sa mga napiling bahay",
  ...
  "Toàn bộ thông báo nhà sẽ bị xoá.": "Buburahin ang lahat ng notipikasyon ng bahay.",
  ...
  "Mỗi thành viên sẽ cần cấp quyền vị trí Luôn cho phép để trạng thái rời/đến nhà hoạt động khi ứng dụng chạy nền.": "Kailangang itakda ng bawat miyembro ang pahintulot sa lokasyon sa Palaging Payagan upang gumana ang status ng pag-alis/pagdating sa bahay habang tumatakbo ang app sa background.",
  ...
  "Không tìm thấy nhà của thông báo này": "Hindi natagpuan ang bahay para sa notipikasyon na ito",
  ...
  "Hành động này sẽ thay đổi thời gian báo động của một số thiết bị ": "Babaguhin ng aksyong ito ang oras ng alarma para sa ilang aparato ngayong araw...",
  "Hành động này sẽ tắt toàn bộ báo động của nhà ": "I-o-off ng aksyong ito ang lahat ng alarma para sa ",
  "Tắt toàn bộ báo động?": "I-off ang lahat ng alarma?",
  "Không xoá được lịch tạm tắt báo động": "Hindi matanggal ang iskedyul ng pag-pause ng alarma",
  ...
  "Chỉ Chủ nhà hoặc Quản trị viên mới có quyền thay đổi lặp báo động": "May-ari o Admin lang ang maaaring magbago ng setting ng pag-uulit ng alarma",
  "Không lưu được thời gian lặp báo động": "Hindi mai-save ang oras ng pag-uulit ng alarma",
  "Chỉ Chủ nhà hoặc Quản trị viên mới có quyền thay đổi Chế độ Bảo vệ": "May-ari o Admin lang ang maaaring magbago ng Mode ng Proteksyon",
  "Không thể thay đổi chế độ nhà": "Hindi mabago ang mode ng bahay",
  "Đã bật Bảo vệ nhưng chưa gửi được thông báo": "Naka-on ang Mode ng Proteksyon, pero hindi naipadala ang notipikasyon",
  "Đã bật Chế độ Bảo vệ thủ công": "Naka-enable ang manu-manong Mode ng Proteksyon",
  "Đã chuyển nhà về Bình thường": "Naibalik sa Normal ang bahay",
  "60 phút": "60 minuto",
  "30 phút": "30 minuto",
  "15 phút": "15 minuto",
  "Bạn đang xem lịch của chủ nhà. Chọn Riêng tôi để tự đặt lịch báo động.": "Tinitingnan mo ang iskedyul ng may-ari. Piliin ang Para sa akin lang para magtakda ng sarili mong iskedyul ng alarma.",
  ...
  "Bạn không có quyền sửa lịch báo động của nhà": "Wala kang pahintulot na baguhin ang iskedyul ng alarma ng bahay na ito",
  "Không thể áp dụng báo động cho toàn bộ thiết bị": "Hindi mailapat ang alarma sa lahat ng aparato",
  "Nhà chưa có thiết bị an ninh để áp dụng": "Walang aparatong panseguridad sa bahay na ito na maaaring lagyan ng alarma",
  ...
  "Nhắc nhở sẽ nhắc bạn kiểm tra trạng thái an toàn của ngôi nhà vào giờ đã chọn.": "Paalalahanan ka ng paalala na tingnan ang status ng seguridad ng iyong bahay sa napiling oras.",
  "Thêm khung giờ báo động": "Magdagdag ng saklaw ng oras ng alarma",
  "Đang sử dụng nhắc nhở riêng của bạn": "Ginagamit ang sarili mong mga setting ng paalala",
  "Đang sử dụng nhắc nhở của chủ nhà": "Ginagamit ang mga setting ng paalala ng may-ari",
  ...
  "Lặp báo động khi sự cố vẫn còn": "Ulitin ang alarma habang nagpapatuloy ang problema",
  ...
  "Bạn đã mở ứng dụng gần đây để kiểm tra trạng thái.": "Binuksan mo kamakailan ang app para tingnan ang status.",
  "Bạn nên mở ứng dụng định kỳ để kiểm tra quyền, lịch và cảnh báo chưa đọc.": "Buksan nang regular ang app para tingnan ang mga pahintulot, iskedyul, at hindi pa nababasang alerto.",
  "Sau vài lần sử dụng, SafeHome sẽ đánh giá thói quen kiểm tra ứng dụng tốt hơn.": "Pagkatapos ng ilang paggamit, mas mahusay nang masusuri ng SafeHome ang nakasanayan mong pagtingin sa app.",
  "Tần suất vào ứng dụng ổn": "Maayos ang dalas ng pagtingin sa app",
  "Đã lâu chưa vào ứng dụng kiểm tra": "Matagal mo nang hindi binubuksan ang app para tingnan ang status",
  "Đang ghi nhận tần suất vào ứng dụng": "Itinatala ang dalas ng pagbukas sa app",
  ...
  "Nên đặt lịch báo động cho thời gian ngủ hoặc vắng nhà.": "Magtakda ng iskedyul ng alarma para sa oras ng pagtulog o kapag wala ka sa bahay.",
  "Nhà đã có lịch báo động hoặc lịch cảnh báo theo thiết bị.": "May iskedyul ng alarma o alerto kada aparato ang bahay na ito.",
  "Chưa cài lịch báo động": "Hindi pa nakatakda ang iskedyul ng alarma",
  "Đã cài lịch báo động": "Nakatakda na ang iskedyul ng alarma",
  "Nên có ít nhất một nhắc nhở để không quên kiểm tra nhà.": "Magtakda ng kahit isang paalala para hindi mo makalimutang tingnan ang iyong bahay.",
  "Ứng dụng sẽ nhắc bạn kiểm tra nhà theo lịch đã đặt.": "Paalalahanan ka ng app na tingnan ang bahay ayon sa itinakdang iskedyul.",
  "Chưa cài đặt nhắc nhở": "Hindi pa naka-setup ang paalala",
  "Đã cài đặt nhắc nhở": "Naka-setup na ang paalala",
  "Hãy mở lại ứng dụng hoặc đăng nhập lại nếu thiết bị không nhận cảnh báo.": "Buksan muli ang app o mag-sign in ulit kung hindi nakakatanggap ng mga alerto ang aparatong ito.",
  ...
  "iOS quản lý chạy nền chặt hơn Android; hãy giữ thông báo và vị trí luôn luôn nếu dùng Auto rời khỏi nhà.": "Mas mahigpit ang iOS sa paggamit sa background kaysa Android; panatilihing naka-on ang mga notipikasyon at Palaging Payagan ang lokasyon kung gumagamit ng Awtomatikong Proteksyon kapag wala sa bahay.",
  ...
  "Tối ưu pin không chặn ứng dụng": "Hindi hinaharangan ng pag-optimize ng baterya ang app",
  ...
  "iOS không mở toàn màn hình như Android; ứng dụng dùng thông báo và âm thanh hệ thống.": "Hindi nagbubukas ng full-screen ang iOS tulad ng Android; gumagamit ang app ng mga notipikasyon at tunog ng system.",
  ...
  "Cảnh báo có thể không hiển thị nếu thông báo bị tắt.": "Maaaring hindi lumabas ang mga alerto kung naka-disable ang mga notipikasyon.",
  "Điện thoại có thể nhận thông báo SafeHome.": "Makakatanggap ang teleponong ito ng mga notipikasyon ng SafeHome.",
  ...
  "Kiểm tra điện thoại và cách bạn đang dùng ứng dụng.": "Sinusuri ang iyong telepono at kung paano mo ginagamit ang app.",
  ...
  "Hành động này sẽ thay đổi thời gian báo động của một số thiết bị trong hôm nay...": "Babaguhin ng aksyong ito ang oras ng alarma para sa ilang aparato ngayong araw...",
  "Hành động này sẽ tắt toàn bộ báo động của nhà dưới mọi hình thức. Bạn sẽ không còn nhận được cảnh báo khi có nguy hiểm trên điện thoại nữa.": "I-o-off ng aksyong ito ang lahat ng alarma para sa bahay na ito. Hindi ka na makakatanggap ng mga alerto sa panganib sa teleponong ito.",
  "Báo động đang sử dụng chế độ Theo nhà.\n\nBạn sẽ nhận cảnh báo theo lịch báo động chung do Chủ nhà hoặc Quản trị viên thiết lập.": "Ginagamit ng alarma ang mga setting ng bahay.\n\nMakakatanggap ka ng mga alerto ayon sa ibinahaging iskedyul na itinakda ng may-ari o administrator.",
  "Báo động đang sử dụng chế độ Riêng tôi.\n\nBạn sẽ nhận cảnh báo theo lịch báo động riêng đã thiết lập cho tài khoản này.": "Ginagamit ng alarma ang mga setting na Para sa akin lang.\n\nMakakatanggap ka ng mga alerto ayon sa personal na iskedyul ng alarma para sa account na ito.",
  ...
  "Chế độ Bảo vệ thủ công đã bật": "Naka-enable ang manu-manong Mode ng Proteksyon",
  "Báo động không lặp lại.": "Hindi uulit ang alarma.",
  "Báo động lặp sau \$securityModeRepeatMinutes phút nếu sự cố vẫn còn.": "Uulit ang alarma pagkalipas ng \$securityModeRepeatMinutes minuto kung magpapatuloy ang problema.",
  "\$actorName đã bật Chế độ Bảo vệ thủ công cho \"\$homeName\". Chế độ này chỉ tắt khi một thành viên có quyền chủ động chuyển về Bình thường. \$repeatMessage": "Manu-manong in-on ni \$actorName ang Mode ng Proteksyon para sa \"\$homeName\". Mananatiling naka-on ang mode na ito hanggang ibalik ito sa Normal ng miyembrong may pahintulot. \$repeatMessage",
  "Bạn đã bật báo động cho nhà \"\$homeName\".": "In-enable mo ang alarma para sa bahay na \"\$homeName\".",
  "Bạn đã tắt toàn bộ báo động của nhà \"\$homeName\".": "In-off mo ang lahat ng alarma ng bahay na \"\$homeName\".",
  ...
  "Chế độ Bảo vệ sẽ chỉ báo động một lần": "Isang beses lang mag-aalerto ang Mode ng Proteksyon",
  "Chế độ Bảo vệ sẽ lặp báo động sau \$minutes phút": "Uulit ang alerto ng Mode ng Proteksyon pagkalipas ng \$minutes minuto",
  ...
  "Khoảng thời gian phải nằm trong khung báo động (\$start → \$end)": "Dapat nasa loob ng iskedyul ng alarma ang panahon ng pag-pause (\$start → \$end)",
  ...
  "Sẽ báo lại theo lịch báo động đã cài nếu vấn đề chưa được xử lý.": "Mag-aalerto muli ayon sa iskedyul ng alarma kung hindi pa nalulutas ang problema.",
  ...
  "Đã cài nhắc nhở cho \$updatedHomes nhà.": "Naitakda ang paalala para sa \$updatedHomes bahay.",
  ...
  "Đã áp dụng báo động cho \$count thiết bị an ninh": "Inilapat ang alarma sa \$count aparatong panseguridad",
  ...
  "Có thành viên chưa xác định vị trí, hãy nhắc họ mở ứng dụng hoặc kiểm tra quyền vị trí.": "Hindi matukoy ang lokasyon ng ilang miyembro. Hilingin sa kanila na buksan ang app o suriin ang pahintulot sa lokasyon.",
  ...
  "Bạn chưa đặt nhắc nhở, nên tạo lịch nhắc kiểm tra nhà định kỳ.": "Hindi pa nakatakda ang paalala. Gumawa ng iskedyul upang regular na suriin ang iyong bahay.",
  "Bạn chưa đặt lịch báo động, nên bật bảo vệ theo khung giờ thường vắng nhà.": "Hindi pa nakatakda ang iskedyul ng alarma. I-enable ang proteksyon sa mga oras na karaniwan kang wala.",
  ...
  "Khoảng tạm tắt không trùng với lịch báo động nào đang bật": "Hindi nag-o-overlap ang saklaw ng pag-pause sa anumang aktibong iskedyul ng alarma",
  ...
  "Tắt để cảm biến không tạo báo động.": "I-off para hindi gumawa ng alarma ang sensor na ito.",
  ...
  "Sử dụng báo động theo lịch đã thiết lập": "Gamitin ang naka-set na iskedyul ng alarma",
  "Chỉ gửi thông báo, không kích hoạt báo động": "Magpadala lamang ng mga notipikasyon, huwag paganahin ang alarma",
  "Toàn bộ báo động của nhà đang tắt; hệ thống chỉ gửi thông báo.": "Naka-off ang lahat ng alarma sa bahay; mga notipikasyon lamang ang ipapadala ng system.",
  "Chỉ Chủ nhà có thể bật chế độ này.": "Ang may-ari lamang ang maaaring mag-enable ng mode na ito.",
  ...
  "Chỉ Chủ nhà mới có quyền bật chế độ Không bảo vệ": "Ang may-ari lamang ang maaaring mag-enable ng mode na Walang proteksiyon",
  "Đã chuyển nhà sang Không bảo vệ": "Lumipat ang bahay sa mode na Walang proteksiyon",
  "Đã chuyển sang Không bảo vệ nhưng chưa gửi được thông báo": "Lumipat sa mode na Walang proteksiyon, ngunit hindi naipadala ang notipikasyon",
  ...
  "Nhà đã chuyển sang Không bảo vệ": "Lumipat ang bahay sa mode na Walang proteksiyon",
  "Thông báo cảm biến": "Mga notipikasyon ng sensor",
  "Thông báo thông thường khi cảm biến phát hiện sự kiện.": "Mga karaniwang notipikasyon kapag may natukoy na kaganapan ang sensor.",

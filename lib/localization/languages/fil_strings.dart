const Map<String, String> filStrings = {
  ...
  "Đã tắt báo động": "Naka-off ang alarma",
  ...
  "Tamper bình thường": "Walang nakitang pakikialam",
  ...
  "Báo động đã tắt": "Naka-off ang alarma",
  ...
  "Cảnh báo an ninh đã kết thúc": "Natapos na ang alerto sa seguridad",
  "Sự cố nguy hiểm đã kết thúc": "Natapos na ang mapanganib na insidente",
  "Cảnh báo đã được kết thúc.": "Natapos na ang alerto.",
  "Vẫn còn cảnh báo khác đang hoạt động.": "May iba pang alertong aktibo pa.",
  "Báo động đã hoạt động trở lại": "Aktibo na ulit ang alarm",
  "Thời gian tạm dừng báo động đã kết thúc.": "Tapos na ang paghinto ng alarm.",
  "MQTT đã kết nối trở lại": "Nakakonekta na ulit ang MQTT",
  ...
  "Không thể xoá thiết bị": "Hindi ma-delete ang device",
  "Hãy thử lại thao tác xoá thiết bị.": "Subukang i-delete muli ang device.",
  "Chế độ Bảo vệ đã được tắt.": "Pinatay na ang Protection mode.",

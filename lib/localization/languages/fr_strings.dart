const Map<String, String> frStrings = {
  ...
  "Đã tắt báo động": "Alarme désactivée",
  ...
  "⏸️ Tạm tắt báo động hôm nay":
      "⏸️ Suspendre temporairement l’alarme pour aujourd’hui",
  ...
  "Tamper bình thường": "Aucune tentative de sabotage détectée",
  ...
  "Báo động đã tắt": "Alarme désactivée",
  "Tạm tắt báo động hôm nay":
      "Suspendre temporairement l’alarme pour aujourd’hui",
  ...
  "Sau vài lần sử dụng, SafeHome sẽ đánh giá thói quen kiểm tra ứng dụng tốt hơn.":
      "Après quelques utilisations, SafeHome pourra mieux évaluer vos habitudes de consultation de l’application.",
  ...
  "Toàn bộ thành viên đã rời khỏi nhà.":
      "Tous les membres ont quitté la maison.",
  ...
  "Đã chuyển về Bình thường nhưng chưa gửi được thông báo":
      "Passage au mode Normal effectué, mais la notification n’a pas pu être envoyée",
  "Chung cho nhà": "Pour toute la maison",
  "Áp dụng cho toàn bộ thành viên và có thể bật còi vật lý.":
      "S’applique à tous les membres et peut activer la sirène physique.",
  "Cá nhân": "Personnel",
  "Lịch cá nhân hoạt động độc lập và không bật còi vật lý.":
      "Le planning personnel fonctionne indépendamment et n’active jamais la sirène physique.",
  "Cài đặt này chỉ áp dụng cho tài khoản của bạn.":
      "Ce réglage s’applique uniquement à votre compte.",
  "Chỉ chủ nhà và quản trị viên có thể thay đổi phần chung cho nhà.":
      "Seuls le propriétaire et les administrateurs peuvent modifier les réglages communs.",
  "Tham gia hệ thống báo động": "Participer au système d’alarme",
  "Cảm biến khẩn cấp luôn tham gia hệ thống báo động.":
      "Les capteurs d’urgence participent toujours au système d’alarme.",
  "Tắt để thiết bị không tạo bất kỳ báo động nào.":
      "Désactivez pour empêcher cet appareil de déclencher une alarme.",
  ...
  "Hiển thị cảnh báo toàn màn hình trên điện thoại của bạn.":
      "Afficher une alerte plein écran sur votre téléphone.",
  ...
  "Lịch chung và lịch cá nhân hoạt động song song, không còn phải chọn một trong hai.":
      "Les plannings commun et personnel fonctionnent en parallèle, sans avoir à en choisir un.",
  ...
  "Lịch này chỉ áp dụng cho bạn và không bật còi vật lý.":
      "Ce planning s’applique uniquement à vous et n’active pas la sirène physique.",
  "Lịch này áp dụng cho toàn bộ thành viên trong nhà.":
      "Ce planning s’applique à tous les membres de la maison.",
  "Đã áp dụng lịch báo động": "Planning d’alarme appliqué",
  "Không thể lưu lịch báo động":
      "Impossible d’enregistrer le planning d’alarme",
  "Nhà chưa có thiết bị an ninh":
      "Cette maison ne contient aucun appareil de sécurité",
  "Nhận cảnh báo theo lịch chung của nhà":
      "Recevoir les alertes du planning commun de la maison",
  "Tắt để không nhận thông báo hoặc cảnh báo toàn màn hình từ lịch chung. Còi vật lý của nhà vẫn hoạt động.":
      "Désactivez cette option pour ne plus recevoir les notifications ni les alertes plein écran du planning commun. La sirène de la maison restera active.",
};

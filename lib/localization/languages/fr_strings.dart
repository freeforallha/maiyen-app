const Map<String, String> frStrings = {
  ...
  "Đã gửi yêu cầu xoá thiết bị": "Demande de suppression de l'appareil envoyée",
  ...
  "Gửi": "Envoyer",
  "Đã gửi email khôi phục": "Email de réinitialisation du mot de passe envoyé",
  ...
  "Không lấy được vị trí hiện tại": "Impossible d'obtenir la position actuelle",
  ...
  "Thêm, đổi tên và sắp xếp phòng": "Ajouter, renommer et organiser les pièces",
  ...
  "Giám sát an ninh • \$repeatText": "Surveillance de sécurité • \$repeatText",
  ...
  "Môi trường hiện tại: \$environment": "Environnement actuel : \$environment",
  ...
  "Cảnh báo an ninh đã kết thúc": "Alerte de sécurité terminée",
  "Sự cố nguy hiểm đã kết thúc": "Situation dangereuse terminée",
  "Cảnh báo đã được kết thúc.": "L’alerte est terminée.",
  "Vẫn còn cảnh báo khác đang hoạt động.": "Une autre alerte est toujours active.",
  "Báo động đã hoạt động trở lại": "L’alarme est de nouveau active",
  "Thời gian tạm dừng báo động đã kết thúc.": "La période de suspension de l’alarme est terminée.",
  "MQTT đã kết nối trở lại": "MQTT reconnecté",
  "Còi báo động đã được tắt": "La sirène physique a été arrêtée",
  "Sự cố vẫn đang được theo dõi.": "L’incident reste sous surveillance.",
  "Bảo vệ tự động đã bật": "Protection automatique activée",
  "Toàn bộ thành viên đã rời khỏi nhà.": "Tous les membres ont quitté la maison.",
  "Bảo vệ tự động đã tắt": "Protection automatique désactivée",
  "Có thành viên đã trở về nhà.": "Un membre est rentré à la maison.",
  "Thiết bị đã được xoá": "Appareil supprimé",
  "Không thể xoá thiết bị": "Impossible de supprimer l’appareil",
  "Hãy thử lại thao tác xoá thiết bị.": "Réessayez de supprimer l’appareil.",
  "Chế độ Bảo vệ đã được tắt.": "Le mode Protection a été désactivé.",
  "Nhà đang ở chế độ Bình thường.": "La maison est en mode Normal.",
  "Pin thiết bị đã ổn định": "La batterie de l’appareil est stable",
  "Hub đã kết nối trở lại": "Hub reconnecté",
  "Đã chuyển về Bình thường nhưng chưa gửi được thông báo": "Passage au mode Normal effectué, mais la notification n’a pas pu être envoyée",
  "Chung cho nhà": "Pour toute la maison",
  "Áp dụng cho toàn bộ thành viên và có thể bật còi vật lý.": "S’applique à tous les membres et peut activer la sirène physique.",
  "Cá nhân": "Personnel",
  "Lịch cá nhân hoạt động độc lập và không bật còi vật lý.": "Le planning personnel fonctionne indépendamment et n’active jamais la sirène physique.",
  "Cài đặt này chỉ áp dụng cho tài khoản của bạn.": "Ce réglage s’applique uniquement à votre compte.",
  "Chỉ chủ nhà và quản trị viên có thể thay đổi phần chung cho nhà.": "Seuls le propriétaire et les administrateurs peuvent modifier les réglages communs.",
  "Tham gia hệ thống báo động": "Participer au système d’alarme",
  "Cảm biến khẩn cấp luôn tham gia hệ thống báo động.": "Les capteurs d’urgence participent toujours au système d’alarme.",
  "Tắt để thiết bị không tạo bất kỳ báo động nào.": "Désactivez pour empêcher cet appareil de déclencher une alarme.",
  "Lịch báo động chung": "Planning d’alarme commun",
  "Lịch báo động cá nhân": "Planning d’alarme personnel",
  "Hiển thị cảnh báo toàn màn hình trên điện thoại của bạn.": "Afficher une alerte plein écran sur votre téléphone.",
  "Lặp lại cảnh báo": "Répéter l’alerte",
  "Báo động chung": "Alarme commune",
  "Báo động cá nhân": "Alarme personnelle",
  "Đã cài đặt": "Configuré",
  "Chưa cài đặt": "Non configuré",
  "Lịch chung và lịch cá nhân hoạt động song song, không còn phải chọn một trong hai.": "Les plannings commun et personnel fonctionnent en parallèle, sans avoir à en choisir un.",
  "Cài nhanh chung": "Réglage commun rapide",
  "Cài nhanh cá nhân": "Réglage personnel rapide",
  "Thiết lập nhanh lịch cá nhân": "Réglage rapide du planning personnel",
  "Thiết lập nhanh lịch chung": "Réglage rapide du planning commun",
  "Lịch này chỉ áp dụng cho bạn và không bật còi vật lý.": "Ce planning s’applique uniquement à vous et n’active pas la sirène physique.",
  "Lịch này áp dụng cho toàn bộ thành viên trong nhà.": "Ce planning s’applique à tous les membres de la maison.",
  "Đã áp dụng lịch báo động": "Planning d’alarme appliqué",
  "Không thể lưu lịch báo động": "Impossible d’enregistrer le planning d’alarme",
  "Nhà chưa có thiết bị an ninh": "Cette maison ne contient aucun appareil de sécurité",
  "Nhận cảnh báo theo lịch chung của nhà": "Recevoir les alertes du planning commun de la maison",
  "Tắt để không nhận thông báo hoặc cảnh báo toàn màn hình từ lịch chung. Còi vật lý của nhà vẫn hoạt động.": "Désactivez cette option pour ne plus recevoir les notifications ni les alertes plein écran du planning commun. La sirène de la maison restera active.",
};

const Map<String, String> tetStrings = {
  "Không tìm thấy người dùng": "La hetan utilizadór",
  "Không đọc được số điện thoại": "Labele lee númeru telefone",
  "Tin nhắn quá dài": "Mensajen ne'e naruk liu",
  "Không gửi được tin nhắn": "Labele haruka mensajen",
  ...
  "Chưa cập nhật": "Seidauk atualiza",
  "Chủ nhà": "Na'in ba uma",
  "Nhà được chia sẻ": "Uma ne'e fahe",
  "Địa chỉ": "Enderesu",
  "An ninh ra/vào": "Seguransa tama/sai",
  ...
  "CO₂": "CO₂",
  "Chất lượng không khí": "Kualidade ar",
  "Ổ điện thông minh": "Tomada elétrika intelijente",
  "Còi báo động": "Sirena",
  "Van thông minh": "Válvula intelijente",
  "Camera": "Kámara",
  "Chuông cửa": "Sinál odamatan nian",
  "Bàn phím an ninh": "Teklaun seguransa nian",
  "Bộ mở rộng sóng": "Estensor ba alkanse",
  "Hub trung tâm": "Sentru sentrál",
  "Đo điện năng": "Sukat eletrisidade",
  "Nguồn dự phòng UPS": "Fornesimentu enerjia redundante UPS",
  "Thiết bị đang Offline": "Dispozitivu ne'e lakon ligasaun",
  ...
  "Không có chuyển động": "Laiha movimentu",
  "Phát hiện hiện diện": "Deteksaun prezensa",
  "Không phát hiện hiện diện": "La detekta prezensa",
  "Phát hiện rung/chấn động": "Deteksaun vibrasaun/xoke",
  "Không có rung bất thường": "Laiha vibrasaun ne'ebé la normál",
  "Phát hiện kính vỡ": "Detekta vidru rahun",
  "Không có cảnh báo kính vỡ": "Laiha avizu ba vidru ne'ebé rahun",
  "Nhiệt độ nguy hiểm": "Temperatura ne'ebé perigozu",
  "Phát hiện khí CO": "Detekta gás CO",
  ...
  "Đang theo dõi": "Tuir mai",
  "Chưa nhận diện": "Seidauk identifika",
  "Chưa có cập nhật": "Seidauk iha atualizasaun",
  "Chưa có thiết bị, hãy nhấn nút + để thêm để bắt đầu duy trì an ninh":
      "Seidauk iha dispozitivu, hanehan butaun + hodi aumenta hodi hahú mantein seguransa",
  "CHƯA AN TOÀN": "LA SEGURU",
  "ĐÃ AN TOÀN": "IDA-NE'E SEGURU",
  "Nhà đang có dấu hiệu cần kiểm tra, bạn nên xem lại các trạng thái bên dưới.":
      "Uma ne'e hatudu sinál sira katak presiza inspesaun, ita-boot tenke haree estatutu sira iha kraik.",
  "Nhà đang hoạt động ổn định, bạn có thể yên tâm.":
      "Uma ne'e funsiona ho estavel, ita-boot bele hakmatek.",
  ...
  "Hẹn giờ báo động": "Tempu alarme nian",
  "Chưa thiết lập": "Seidauk konfigura",
  "Chưa thiết lập thời gian": "Seidauk determina ona oras",
  "Tổng hợp trạng thái nhà": "Sumáriu kona-ba estatutu uma nian",
  "Cần xử lý ngay": "Presiza atu trata kedas",
  "Đánh giá tự động": "Avaliasaun automátika",
  "Tự động đánh giá": "Avalia automatikamente",
  "Tổng quan hôm nay": "Vizaun Jerál ohin",
  "Chưa có dữ liệu tổng quan": "Seidauk iha dadus jerál",
  "Chưa có dữ liệu trạng thái": "Laiha dadus estatutu nian",
  "Chưa đủ dữ liệu để đánh giá": "La iha dadus sufisiente atu avalia",
  "Chưa có dữ liệu để đánh giá": "Seidauk iha dadus atu avalia",
  "Bấm vào để xem chi tiết": "Klik atu haree detalle sira",
  "Nhấn để xem chi tiết...": "Klik atu haree detalle sira...",
  "Tạm dừng": "Pauza",
  "Tắt": "Mate",
  "Chi tiết": "Detallu sira",
  "Tổng hợp trạng thái": "Sumáriu kona-ba estatutu",
  "Không an toàn": "La seguru",
  "Cần chú ý": "Presiza atensaun",
  "An toàn": "Seguru",
  "Không có": "Lae",
  "Đổi tên nhóm": "Troka naran ba grupu",
  "Huỷ": "Kansela",
  "Lưu": "Rai",
  "Thêm": "Hatama",
  "Xoá": "Apaga",
  "Đổi tên": "Troka naran",
  "Nhà của tôi": "Ha'u nia uma",
  "Bỏ chọn toàn bộ nhóm": "Hasai hili grupu tomak",
  "Chọn toàn bộ nhóm": "Hili grupu tomak",
  "Bỏ chọn": "La hili",
  "Quay lại": "Fila fali mai",
  "Tìm kiếm": "Buka",
  "Đóng tìm kiếm": "Taka peskiza",
  "Giờ": "Agora",
  "Phút": "Minutu sira",
  "Đặt nhắc nhở cho nhà": "Konfigura lembransa sira ba uma",
  "Đặt báo động cho nhà": "Konfigura alarme uma nian",
  "Xác nhận thay đổi": "Konfirma mudansa sira",
  "Tiếp tục": "Kontinua",
  "Giờ nhắc nhở": "Tempu lembransa",
  "Giờ bắt đầu báo động": "Agora alarme hahú",
  "Giờ kết thúc báo động": "Alarme nia oras remata",
  "Không có nhà nào đủ điều kiện để cài":
      "Laiha uma sira ne'ebé elizivel ba instalasaun",
  ...
  "Đặt vị trí nhà và bật bảo vệ tự động":
      "Konfigura fatin uma nian no ativa protesaun automátika",
  "Chuyển quyền chủ nhà hoặc xoá nhà":
      "Transfere direitu rai-na'in nian ka hamoos uma",
  "Đặt nhắc nhở / báo động nhà đã chọn":
      "Konfigura lembransa/alarme uma nian ne'ebé hili ona",
  "Chia sẻ nhà đã chọn": "Fahe uma ne'ebé hili ona",
  "Mở danh sách chia sẻ nhà": "Loke lista fahe uma nian",
  "Xoá các nhà đã chọn?": "Apaga uma sira ne'ebé maka hili ona?",
  "Các nhà đã chọn sẽ bị xoá vĩnh viễn.":
      "Uma sira ne'ebé maka hili ona sei elimina permanentemente.",
  "Hoặc quét QR để xin gia nhập các nhà đã chọn":
      "Ka scan QR hodi aplika atu tama iha uma sira ne'ebé maka hili ona",
  "Email người nhận": "Email destinatáriu",
  "Chia sẻ": "Fahe",
  "Email chưa đăng ký": "Email la rejista",
  "Chia sẻ hoàn tất": "Fahe hotu ona",
  "Mở List chia sẻ nhà": "Loke Lista fahe uma nian",
  "Không có nhà nào bạn có quyền quản lý":
      "Laiha uma ida ne'ebé ita-boot iha kontrolu ba",
  ...
  "Chưa có thông báo nào": "Seidauk iha anúnsiu sira",
  "Chưa có thông báo": "Seidauk iha anúnsiu",
  "Vuốt lên để tải thêm": "Liga ba leten atu download tan",
  "Không có thiết bị": "Laiha ekipamentu",
  "Chỉ chủ nhà mới được xoá nhà": "Uma-na'in de'it maka bele hamoos uma ne'e",
  "Chỉ chủ nhà mới được chuyển quyền":
      "Uma-na'in de'it maka bele transfere direitu sira",
  "Lưu ý khi bật báo động": "Kuidadu bainhira loke alarme",
  "Báo động đã được bật": "Alarme ativa ona",
  "Đã hiểu": "Komprende ona",
  "Lưu ý tạm tắt báo động": "Nota: Hamate alarme temporariamente",
  "Đã bật báo động": "Alarme ativadu",
  "Đã tắt báo động": "Alarme dezativadu ona",
  ...
  "Rời khỏi Home này?": "Husik uma ida-ne'e?",
  "Nhà này và toàn bộ thiết bị bên trong sẽ bị xoá vĩnh viễn.":
      "Uma ida-ne'e no dispozitivu hotu-hotu iha laran sei elimina permanentemente.",
  "Đã xoá nhà": "Uma ne'ebé eliminadu",
  "QR của nhà này": "QR husi uma ne'e",
  ...
  "Nhập mã mời": "Hatama kódigu konvite nian",
  "Gửi yêu cầu gia nhập": "Hatama pedidu ida atu tama",
  "QR này không phải mã thiết bị": "QR ida-ne'e la'ós kódigu dispozitivu nian",
  "Xin gia nhập nhà": "Favor ida mai hamutuk iha uma",
  "Quét mã QR chia sẻ nhà": "Scan kódigu QR hodi fahe uma",
  "Mời thành viên bằng mã QR": "Konvida membru sira ho kódigu QR",
  ...
  "Đã gửi yêu cầu chuyển quyền chủ nhà":
      "Pedidu atu transfere direitu uma-na'in nian haruka ona",
  "Bạn không có quyền xoá thiết bị":
      "Ita-boot laiha lisensa atu hamoos dispozitivu",
  "Xóa Device?": "Apaga dispozitivu?",
  "Đã gửi yêu cầu xoá thiết bị":
      "Pedidu ba eliminasaun dispozitivu nian haruka ona",
  "Đang xoá thiết bị": "Hamoos dispozitivu",
  "Đăng xuất?": "Sai?",
  "Thêm nhà": "Hatama uma",
  "Thêm nhà mới": "Hatama uma foun",
  "Tạo nhà mới": "Kria uma foun",
  "Tạo một ngôi nhà mới của bạn": "Kria Ita-boot nia uma foun",
  "Quét mã QR được chủ nhà chia sẻ":
      "Eskanea kódigu QR ne'ebé fahe hosi uma-na'in",
  "Tên nhà": "Uma nia naran",
  "Số điện thoại": "Númeru telefone",
  "Nam": "Nam",
  "Nữ": "Feto",
  "Ngày": "Data",
  "Tháng": "Fulan",
  "Năm": "Tinan",
  "Thông tin cá nhân": "Informasaun pesoál",
  "Thiết lập tài khoản": "Harii konta ida",
  "Vui lòng nhập đủ thông tin": "Hatama informasaun kompletu",
  "Không thể lưu thông tin": "Labele rai informasaun",
  "Đã lưu thông tin": "Informasaun ne'ebé rai ona",
  "Lỗi lưu profile": "Erru iha salvasaun perfil",
  "Thêm số điện thoại để dùng cho các trường hợp khẩn cấp":
      "Hatama númeru telefone ida ba emerjénsia sira",
  "Hoàn tất": "Kompleta ona",
  "Đã tạo nhà mới": "Uma foun kria ona",
  ...
  "Chọn giờ kết thúc tạm tắt": "Hili tempu finál ba taka temporáriu",
  "Đến": "Mai",
  "Đến giờ": "Tempu to'o ona",
  "Xoá lịch tạm tắt": "Apaga oráriu taka temporáriu nian",
  "Xóa lịch tạm tắt": "Apaga oráriu taka temporáriu",
  "Giới tính": "Jéneru",
  "SĐT": "Númeru telefone",
  "Ngày sinh": "Data moris",
  "Yêu cầu & lời mời": "Pedidu sira & konvite sira",
  "Xem lời mời chia sẻ và xin gia nhập":
      "Haree konvite atu fahe no aplika atu tama",
  "Cài đặt bảo mật": "Konfigurasaun seguransa nian",
  "Quyền báo động toàn màn hình": "Lisensa ba alarme ekran tomak",
  "Báo động toàn màn hình": "Alarme ho ekran tomak",
  "Đã được cấp quyền": "Lisensa fó ona",
  "Chưa được cấp quyền": "Seidauk hetan autorizasaun",
  "Mở cài đặt hệ thống": "Loke konfigurasaun sistema nian",
  "Đăng xuất": "Hasai",
  "Thoát tài khoản khỏi thiết bị này":
      "Sai husi ita-boot nia konta husi dispozitivu ida-ne'e",
  "Không có yêu cầu hoặc lời mời nào": "Laiha pedidu ka konvite sira",
  "Xoá tài khoản": "Apaga konta",
  "Hành động này sẽ xoá toàn bộ dữ liệu:":
      "Asaun ida-ne'e sei hamoos dadus hotu-hotu:",
  ...
  "Tình trạng": "Estatutu",
  "Tháo/Lắp": "Hasai/Instalasaun",
  "Pin": "Bateria",
  "Tín hiệu": "Sinál",
  "Chưa liên kết": "Seidauk iha ligasaun",
  "Liên lạc cuối": "Kontaktu ikus",
  "Event cuối": "Eventu ikus",
  "Sự kiện cuối": "Eventu ikus",
  ...
  "Độ ẩm": "Umidade",
  "Công suất": "Kapasidade",
  "Điện áp": "Tensaun",
  "Dòng điện": "Korrente elétriku",
  "Điện năng": "Eletrisidade",
  "Cường độ rung": "Intensidade vibrasaun",
  "Góc nghiêng": "Ângulu inklinasaun",
  "Độ mở van": "Grau abertura válvula nian",
  "Nguồn dự phòng": "Enerjia backup",
  "Ngập/rò nước": "Inundasaun/bee-fuga",
  "Phát hiện khói": "Deteksaun suar",
  "Quản lý phòng": "Jestaun kuartu nian",
  "Bạn không có quyền quản lý phòng": "Ita-boot laiha lisensa atu jere kuartu",
  "Đổi tên phòng": "Troka naran ba kuartu",
  "Tên phòng": "Kuartu nia naran",
  "Xoá phòng": "Hamoos kuartu",
  "Thiết bị trong phòng này sẽ được chuyển về Chưa phân phòng.":
      "Ekipamentu sira iha sala ida-ne'e sei muda ba sala ne'ebé la atribui.",
  "Thêm phòng": "Kuartu barak liután",
  "Ví dụ: Phòng khách": "Ezemplu: Sala vizita",
  "Phòng khách": "Sala vizita",
  "Tên phòng đã tồn tại": "Naran kuartu nian eziste ona",
  "Chưa phân phòng": "Kuartu sira seidauk atribui",
  "Phòng mặc định": "Sala padraun",
  "Phát hiện bất thường": "Deteksaun ne'ebé la normál",
  "Phát hiện cạy phá": "Deteksaun ba manipulasaun",
  "Tamper detected": "Deteksaun ba manipulasaun",
  "Tamper cleared": "Alerta kona-ba manipulasaun remata ona",
  "Door opened": "Odamatan nakloke",
  "Door closed": "Odamatan taka",
  "Motion detected": "Deteksaun movimentu",
  "Battery low": "Bateria menus",
  "Device offline": "Dispozitivu lakon ligasaun",
  "Device online": "Dispozitivu ligadu ona",
  "Cửa mở": "Odamatan nakloke",
  "Cửa đóng": "Odamatan taka",
  ...
  "Đang lưu...": "Poupa hela...",
  "Đổi tên hiển thị": "Troka naran hatudu nian",
  "Cập nhật thông tin nhà": "Atualiza informasaun kona-ba uma",
  "Nhập địa chỉ của nhà": "Hatama uma nia enderesu",
  "Lưu thay đổi": "Rai mudansa sira",
  "Tên này chỉ hiển thị riêng trên tài khoản của bạn.":
      "Naran ida-ne'e bele haree de'it iha ita-boot nia konta.",
  "Tên và địa chỉ sẽ được cập nhật cho toàn bộ thành viên trong nhà.":
      "Naran no enderesu sei atualiza ba membru família hotu-hotu.",
  "Một thành viên": "Membru ida",
  "Đã cập nhật thông tin nhà": "Informasaun kona-ba uma atualiza ona",
  "Thay tên": "Troka naran",
  ...
  "Cảnh báo khói": "Alerta kona-ba suar",
  "Cập nhật thiết bị": "Atualiza ita-boot nia dispozitivu",
  "Cửa đang mở": "Odamatan nakloke",
  "Cửa đã đóng": "Odamatan taka metin",
  ...
  "Tính năng đang được phát triển":
      "Karakterístika iha dezenvolvimentu nia laran",
  "Thông báo": "Avizu",
  "Chat trong nhà": "Konversa iha uma laran",
  "Tìm kiếm tin nhắn": "Buka mensajen sira",
  "Xem thành viên": "Haree membru sira",
  "Tìm nội dung hoặc tên người gửi": "Buka konteúdu ka naran haruka-na'in nian",
  "Xoá từ khoá": "Hamoos liafuan xave sira",
  "Không có kết quả": "Laiha rezultadu",
  "Tìm ngôn ngữ": "Buka lian sira",
  "Kết quả trước": "Rezultadu anteriór sira",
  "Kết quả tiếp theo": "Rezultadu tuir mai",
  "Chưa có tin nhắn": "Seidauk iha mensajen",
  "Không tìm thấy thành viên phù hợp": "La hetan membru sira ne'ebé hanesan",
  "Nhắc đến trong tin nhắn": "Mensiona iha mensajen",
  "Huỷ trả lời": "Kansela resposta",
  "Nhắn gì đó...": "Haruka mensajen ruma...",
  "Gọi điện": "Bolu",
  "Báo động thiết bị": "Alarme ba dispozitivu",
  "Chế độ áp dụng": "Modu aplikavel",
  "Theo nhà": "Tuir uma",
  ...
  "Thiết lập nhanh toàn bộ thiết bị":
      "Konfigurasaun lalais ba dispozitivu tomak",
  "Áp dụng cho toàn bộ thiết bị": "Aplika ba dispozitivu hotu-hotu",
  "Bắt đầu": "Hahú",
  "Kết thúc": "Remata",
  ...
  "Hôm nay đã ghi nhận cảnh báo khói": "Ohin rejista ona alerta ba suar",
  "Khói đã an toàn": "Suar ne'e seguru",
  "Không tìm thấy nhà của thông báo này": "La hetan uma ba mensajen ida-ne'e",
  "Không tìm thấy thiết bị trong nhà này":
      "Laiha dispozitivu ruma ne'ebé hetan iha uma ida-ne'e",
  "Một chủ nhà": "Uma-na'in ida",
  "Ngôi nhà đang hoạt động ổn định": "Uma ne'e funsiona ho estavel",
  "Nhiệt độ cao": "Temperatura aas",
  "OK": "OK",
  ...
  "Không": "Lae",
  "Đã chia sẻ nhà thành công.": "Uma fahe ho susesu.",
  "Tìm nhà...": "Buka uma...",
  "Đã rời khỏi nhà": "Husik hela uma",
  "Bạn sẽ rời khỏi các nhà được chia sẻ.":
      "Ita sei sai husi uma sira ne'ebé fahe.",
  ...
  "Thao tác này sẽ thay đổi lịch báo động của toàn bộ thiết bị an ninh trong các nhà đã chọn.\n\n":
      "Ida-ne'e sei muda oráriu alarme nian ba dispozitivu seguransa hotu-hotu iha uma sira ne'ebé maka hili ona.\n\n",
  "Thao tác này sẽ thêm nhắc nhở cho các nhà đã chọn.\n\n":
      "Ida-ne'e sei aumenta lembransa sira ba uma sira ne'ebé maka hili ona.\n\n",
  "Xác nhận thay đổi báo động": "Konfirma mudansa alarme nian",
  "Xác nhận thay đổi nhắc nhở": "Konfirma lembransa ba mudansa",
  "Lặp lại khi sự cố vẫn còn": "Halo filafali se problema ne'e persiste",
  "Thời gian lặp lại báo động": "Tempu repete alarme nian",
  "VD: Mr Chung": "Ezemplu: Sr. Chung",
  "🏡 Chưa có nhà nào": "🏡 Sedauk iha uma",
  "Vẫn chuyển về Bình thường": "Nafatin muda fali ba Normál",
  "Tự động Bảo vệ khi rời nhà vẫn đang bật. Nếu mọi thành viên vẫn ở ngoài, hệ thống có thể tự bật lại Bảo vệ sau vài phút.":
      "Protesaun Automátika Sai Uma nian sei lakan hela. Se membru hotu-hotu hela iha liur, sistema bele automatikamente ativa fali Seguransa hafoin minutu balun.",
  ...
  "Hành động này sẽ tắt toàn bộ báo động của nhà ":
      "Asaun ida-ne'e sei hamate alarme uma nian hotu",
  "Tắt toàn bộ báo động?": "Hamate alarme hotu-hotu?",
  "Không xoá được lịch tạm tắt báo động":
      "Labele hamoos oráriu alarme temporáriu nian",
  "Không lưu được tạm tắt báo động":
      "Labele salva, hamate alarme temporariamente",
  "Không gửi được yêu cầu xoá": "Labele haruka pedidu ba apagamentu",
  ...
  "Bạn đang xem lịch của chủ nhà. Chọn Riêng tôi để tự đặt lịch báo động.":
      "Ita-boot haree hela uma-na'in nia kalendáriu. Hili Ha'u nia rasik atu tau ita-boot nia oráriu alarme rasik.",
  "Chọn giờ kết thúc báo động": "Hili oras atu remata alarme",
  "Chọn giờ bắt đầu báo động": "Hili oras atu hahú alarme",
  "Bạn không có quyền sửa lịch báo động của nhà":
      "Ita-boot laiha direitu atu muda ita-boot nia uma nia oráriu alarme nian",
  "Không thể áp dụng báo động cho toàn bộ thiết bị":
      "Alarme sira labele aplika ba dispozitivu tomak",
  "Nhà chưa có thiết bị an ninh để áp dụng":
      "Uma refere la iha ekipamentu seguransa atu aplika",
  "Bạn không có quyền sửa lịch Theo nhà. Hãy chọn Riêng tôi.":
      "Ita-boot laiha direitu atu edita oráriu Kámara nian. Favor hili ha'u de'it.",
  "Không thể lưu chế độ báo động": "Labele salva modo alarme nian",
  "Thêm nhắc nhở": "Hatama lembransa",
  ...
  "Xoá nhắc nhở": "Apaga lembransa",
  "Mỗi 1 giờ": "Kada oras 1",
  "Mỗi 30 phút": "Kada minutu 30",
  "Mỗi 15 phút": "Kada minutu 15",
  "Không báo lại": "Labele relata fali",
  "Báo lại khi vẫn chưa an toàn":
      "Relata fali bainhira ida-ne'e seidauk seguru",
  "Báo lại mỗi 1 giờ": "Relata kada oras 1",
  "Báo lại mỗi 30 phút": "Dukur kada minutu 30",
  "Báo lại mỗi 15 phút": "Dukur kada minutu 15",
  "Quản lý nhà": "Jestaun uma nian",
  "Xoá thành viên": "Hamoos membru sira",
  "Đã xoá thành viên": "Membru eliminadu",
  "Đồng ý": "Konkorda",
  "Bạn chắc chắn muốn rời khỏi nhà này?":
      "Ita-boot iha serteza katak ita-boot hakarak sai hosi uma ida-ne'e?",
  "Xoá thành viên?": "Apaga membru sira?",
  "Rời khỏi nhà?": "Husik uma?",
  "Chỉ chủ nhà mới được thay đổi vai trò":
      "Só uma-na'in maka bele muda papél sira",
  "Bạn không có quyền xoá thành viên này":
      "Ita-boot laiha direitu atu hamoos membru ida-ne'e",
  "Bạn": "Ita-boot",
  "Không có email": "Laiha email sira",
  "Chưa có số điện thoại": "Seidauk iha númeru telefone",
  "Không mở được ứng dụng gọi điện": "Labele loke aplikasaun xamada nian",
  "Thành viên chưa cập nhật số điện thoại":
      "Membru ne'e seidauk atualiza sira nia númeru telefone",
  "Bảo vệ thủ công đang bật - chỉ tắt khi chuyển về Bình thường":
      "Protesaun manuál lakan - mate de'it bainhira muda fali ba Normál",
  "Thời gian lặp": "Repete tempu",
  "Chọn 0 để chỉ báo một lần. Cài đặt này dùng cho cả Bảo vệ thủ công và Tự động Bảo vệ khi rời nhà.":
      "Hili 0 atu indika dala ida. Konfigurasaun ida-ne'e ba Protesaun Manuál no Protesaun Automátika bainhira sai hosi uma.",
  "Lặp báo động khi sự cố vẫn còn": "Repete alarme bainhira problema persiste",
  "Đang được sử dụng": "Iha utilizasaun",
  "Chuyển về sử dụng thông thường": "Muda fali ba uzu normál",
  "Chế độ nhà": "Modu uma nian",
  "Thiết bị SOS chưa ghi nhận cảnh báo.":
      "Dispozitivu SOS seidauk rejista alarme ruma.",
  ...
  "Auto rời khỏi nhà đã sẵn sàng":
      "Protesaun Automátika Sai-Uma nian prontu ona",
  "Auto rời khỏi nhà chưa bật":
      "Protesaun Automátika Sai husi Uma seidauk ativa",
  "Nên thêm báo khói, SOS hoặc thiết bị khẩn cấp phù hợp với nhà.":
      "Rekomenda atu aumenta alarme suar nian, SOS ka ekipamentu emerjénsia nian ne'ebé apropriadu ba uma.",
  "Chưa có thiết bị khẩn cấp": "Seidauk iha ekipamentu emerjénsia nian",
  "Đã có thiết bị khẩn cấp": "Ekipamentu emerjénsia nian disponivel",
  "Nên đặt lịch báo động cho thời gian ngủ hoặc vắng nhà.":
      "Ita-boot tenke tau oráriu alarme nian ba bainhira ita-boot toba ka dook hosi uma.",
  "Nhà đã có lịch báo động hoặc lịch cảnh báo theo thiết bị.":
      "Uma iha ona oráriu alarme ka oráriu alerta nian tuir dispozitivu.",
  "Chưa cài lịch báo động": "Oráriu alarme nian seidauk tau",
  "Đã cài lịch báo động": "Oráriu alarme nian estabelese ona",
  "Nên có ít nhất một nhắc nhở để không quên kiểm tra nhà.":
      "Tenke iha pelumenus lembransa ida atu nune'e ita-boot labele haluha atu haree uma.",
  "Ứng dụng sẽ nhắc bạn kiểm tra nhà theo lịch đã đặt.":
      "Aplikasaun sei fó hanoin ba ita-boot atu verifika ita-boot nia uma tuir oráriu ne'ebé maka estabelese ona.",
  "Chưa cài đặt nhắc nhở": "Lembransa sira seidauk konfigura",
  "Đã cài đặt nhắc nhở": "Lembransa sira monta ona",
  "Hãy mở lại ứng dụng hoặc đăng nhập lại nếu thiết bị không nhận cảnh báo.":
      "Loke fali aplikasaun ka tama fali se ita-boot nia dispozitivu la simu avizu.",
  "Thiết bị chưa đăng ký nhận cảnh báo":
      "Dispozitivu ne'e la rejista atu simu alerta sira",
  ...
  "Auto rời khỏi nhà cần quyền vị trí luôn luôn để chạy ổn định.":
      "Protesaun automátika bainhira sai hosi uma presiza lisensa ba lokalizasaun Sempre ativadu ba operasaun ne'ebé estável.",
  "Cần cấp quyền vị trí để Auto rời khỏi nhà hoạt động.":
      "Presiza lisensa ba lokalizasaun atu Protesaun Sai husi Uma automátika bele funsiona.",
  "Dịch vụ vị trí đang tắt nên Auto rời khỏi nhà không ổn định.":
      "Servisu sira lokalizasaun nian mate ona nune'e Protesaun Sai husi Uma automátiku la estavel.",
  "Chỉ cần quyền này khi dùng Auto rời khỏi nhà.":
      "Lisensa ida-ne'e presiza de'it bainhira uza funsaun automátika Protesaun Sai husi Uma.",
  "Chưa cấp vị trí luôn luôn": "Pozisaun ne'e seidauk hetan",
  "Đã cấp vị trí luôn luôn": "Pozisaun ne'e sempre hetan",
  "iOS không mở toàn màn hình như Android; ứng dụng dùng thông báo và âm thanh hệ thống.":
      "iOS la loke ekran tomak hanesan Android; Aplikasaun ne'e uza notifikasaun sira no lian sira sistema nian.",
  "Android dùng cảnh báo toàn màn hình; nếu máy chặn, hãy cấp quyền trong cài đặt.":
      "Android uza alerta sira iha ekran tomak; Se ita-boot nia dispozitivu blokeia ida-ne'e, favór ida fó lisensa iha konfigurasaun sira.",
  "Cảnh báo trên iOS": "Alerta iha iOS",
  ...
  "Hệ thống: Có thể bỏ lỡ cảnh báo": "Sistema: Alerta bele lakon",
  "Cách bạn đang dùng ứng dụng": "Oinsá ita-boot uza aplikasaun",
  ...
  "Bạn không có quyền thay đổi vị trí nhà":
      "Ita-boot laiha direitu atu muda ita-boot nia uma nia fatin",
  "Hãy bật GPS để đặt vị trí nhà":
      "Loke GPS hodi tau ita-boot nia uma nia lokalizasaun",
  "Bạn chưa cấp quyền vị trí": "Ita-boot seidauk fó lisensa ba lokalizasaun",
  "Hãy cấp quyền vị trí trong Cài đặt ứng dụng":
      "Favor fó lisensa ba lokalizasaun iha Konfigurasaun Aplikasaun nian",
  ...
  "Thao tác này sẽ thay đổi lịch báo động của toàn bộ thiết bị an ninh trong các nhà đã chọn.\n\nNhững thành viên đang sử dụng báo động 'Theo nhà' sẽ bị ảnh hưởng.\nBáo động cá nhân ở chế độ 'Riêng tôi' sẽ không bị thay đổi.":
      "Ida-ne'e sei muda oráriu alarme nian ba dispozitivu seguransa hotu-hotu iha uma sira ne'ebé maka hili ona.\n\nMembru sira ne'ebé uza alarme 'Tuir Uma' sei hetan afetadu.\nAlarme pesoál sira iha modo 'Ha'u nian rasik' sei la muda.",
  "Thao tác này sẽ thêm nhắc nhở cho các nhà đã chọn.\n\nNhững thành viên đang sử dụng nhắc nhở 'Theo nhà' sẽ bị ảnh hưởng.\nNhắc nhở cá nhân ở chế độ 'Riêng tôi' sẽ không bị thay đổi.":
      "Ida-ne'e sei aumenta lembransa sira ba uma sira ne'ebé maka hili ona.\n\nMembru sira ne'ebé uza lembransa sira 'Tuir uma' sei hetan afetadu.\nLembransa pesoál sira iha modo 'Ha'u nian rasik' sei la muda.",
  "Khi bật, các thiết bị an ninh sẽ được giám sát ngay.\n\nTự động Bảo vệ khi rời nhà sẽ tạm dừng. Chế độ này không tự tắt khi có người về nhà và chỉ được tắt khi một thành viên có quyền chủ động chuyển về Bình thường.":
      "Bainhira loke, dispozitivu seguransa sira sei monitoriza kedas.\n\nProtesaun Automátika bainhira sai husi uma sei para. Modu ida-ne'e la mate automatikamente bainhira ema ida fila ba uma no mate de'it bainhira membru ida iha inisiativa atu muda fali ba Normál.",
  "Hành động này sẽ thay đổi thời gian báo động của một số thiết bị trong hôm nay...":
      "Asaun ida-ne'e sei muda oras alarme nian ba dispozitivu balu ohin...",
  ...
  "Không thể chấp nhận lời mời. Vui lòng thử lại.":
      "Konvite labele simu. Favor ida koko fali.",
  "Không thể chấp nhận lời xin vào nhà. Vui lòng thử lại.":
      "Labele simu pedidu atu tama ba uma. Favor ida koko fali.",
  "Từ chối": "Rekuza",
  ...
  "Bạn không có quyền thực hiện thao tác này。":
      "Ita-boot laiha lisensa atu hala'o operasaun ida-ne'e.",
  "Cài đặt": "Instala",
  "Cập nhật": "Atualizasaun",
  "Chọn ngôn ngữ": "Hili lian",
  ...
  "Hub chưa gửi trạng thái": "Hub seidauk haruka estatutu",
  "Hub mất kết nối": "Hub lakon ligasaun",
  "Hub tín hiệu bình thường": "Sinál hub nian normál",
  "Khóa đang mở khi nhà ở chế độ Bảo vệ":
      "Xave nakloke bainhira uma iha modo Protesaun",
  "Khóa đang mở trong giờ báo động": "Xave loke durante oras alarme nian",
  "Không có thông báo": "Laiha notifikasaun",
  "Khu vực nguy hiểm": "Área perigozu",
  "Kiểm tra thiết bị trong nhà này": "Haree aparellu doméstiku ida-ne'e",
  "Mất điện lưới": "Enerjia prinsipál mate",
  "Mời người khác tham gia nhà này":
      "Konvida ema seluk atu hamutuk ho uma ida-ne'e",
  "Môi trường hiện tại": "Ambiente atuál",
  "MQTT mất kết nối": "MQTT lakon ligasaun",
  "Ngôn ngữ": "Lian",
  "Nhà đã chia sẻ": "Uma ne'e fahe ona",
  "Nhà đang hoạt động bình thường": "Uma ne'e funsiona ho normál",
  "Nhập email": "Hatama email",
  "Phòng": "Kuartu",
  ...
  "Tài khoản cá nhân": "Konta pesoál",
  "Tạo tài khoản": "Kria konta ida",
  "Thành viên": "Membru",
  "Thành viên trong nhà": "Membru uma fukun nian",
  "Thành viên đang ở trong nhà": "Membru sira iha uma laran",
  "Thành viên đang ở ngoài": "Membru sira sai",
  "Thành viên chưa xác định vị trí": "Membru seidauk lokaliza",
  "Thay đổi ngôn ngữ hiển thị": "Muda linguajen hatudu nian",
  "Thêm, đổi tên và sắp xếp phòng":
      "Hatama, muda naran, no organiza kuartu sira",
  "Thiết bị đang được giám sát": "Dispozitivu ne'e hetan monitorizasaun",
  "Tiếng Anh": "Inglés",
  "Tiếng Hàn": "Koreanu",
  "Tiếng Nhật": "Japonés",
  "Tiếng Trung": "Xinés",
  "Tiếng Việt": "Vietname",
  "Toàn bộ thiết bị": "Ekipamentu kompletu",
  "Vai trò": "Papél",
  "Về nhà": "Fila ba uma",
  "Xem và quản lý quyền thành viên": "Haree no jere direitu sira membru nian",
  "Xóa": "Apaga",
  "Xóa nhà": "Apaga uma",
  "Xoá toàn bộ dữ liệu và thiết bị": "Hamoos dadus no dispozitivu hotu",
  "TẮT CẢNH BÁO": "MATE AVISO",
  "Đã tạo nhà": "Uma kria ona",
  "Chế độ Bảo vệ thủ công đã bật": "Modu Protesaun Manuál ativa ona",
  "Báo động không lặp lại.": "Alarme sira la repete.",
  "Báo động lặp sau \$securityModeRepeatMinutes phút nếu sự cố vẫn còn.":
      "Alarme repete hafoin minutu \$securityModeRepeatMinutes se problema persiste.",
  "\$actorName đã bật Chế độ Bảo vệ thủ công cho \"\$homeName\". Chế độ này chỉ tắt khi một thành viên có quyền chủ động chuyển về Bình thường. \$repeatMessage":
      "\$actorName iha Modu Protesaun Manuál ne'ebé ativadu ba \"\$homeName\". Modu ida-ne'e só mate bainhira membru ida iha inisiativa atu muda fali ba Normál. \$repeatMessage",
  "Bạn đã bật báo động cho nhà \"\$homeName\".":
      "Ita-boot loke ona alarme uma nian \"\$homeName\".",
  "Bạn đã tắt toàn bộ báo động của nhà \"\$homeName\".":
      "Ita-boot hamate ona alarme uma nian hotu \"\$homeName\".",
  "Thành viên mới": "Membru foun",
  "Thành viên rời nhà": "Membru sai husi uma",
  "\$displayMemberName đã rời khỏi nhà \"\$homeName\".":
      "\$displayMemberName sai ona husi uma \"\$homeName\".",
  "\$actorName đã đổi vai trò của \$memberName từ \$oldRoleName thành \$newRoleName trong nhà \"\$homeName\".":
      "\$actorName muda papél \$memberName husi \$oldRoleName ba \$newRoleName iha uma \"\$homeName\".",
  ...
  "Dùng vị trí để tự động bật Chế độ Bảo vệ khi mọi người rời nhà.":
      "Uza lokalizasaun atu ativa automatikamente Modu Protejidu bainhira ema sai hosi uma.",
  "CẢNH BÁO SOS": "AVISO SOS",
  "CẢNH BÁO KHÓI / CHÁY": "AVISO BA SUAR/AHI",
  "CẢNH BÁO NGẬP NƯỚC": "AVISO INUNDASAUN",
  ...
  "Bạn có tin nhắn mới": "Ita-boot iha mensajen foun ida",
  "Chế độ Bảo vệ sẽ chỉ báo động một lần":
      "Modu protesaun sei alarma dala ida de'it",
  "Chế độ Bảo vệ sẽ lặp báo động sau \$minutes phút":
      "Modu protesaun sei repete alarme hafoin minutu \$minutes",
  ...
  "\$actorName đã cập nhật tên nhà thành \"\$newName\" và thay đổi địa chỉ.":
      "\$actorName atualiza naran uma nian ba \"\$newName\" no muda enderesu.",
  "\$actorName đã đổi tên nhà thành \"\$newName\".":
      "\$actorName muda ona nia naran ba \"\$newName\".",
  "\$actorName đã cập nhật địa chỉ của nhà \"\$newName\".":
      "\$actorName atualiza sira nia enderesu \"\$newName\".",
  "\$actorName đã đổi tên thiết bị \"\$oldDeviceName\" thành \"\$newName\" trong nhà \"\$homeName\".":
      "\$actorName muda naran ba dispozitivu \"\$oldDeviceName\" ba \"\$newName\" iha uma \"\$homeName\".",
  "Đang ghép nối: \$seconds giây": "Par: \$seconds segundu sira",
  "Chế độ thêm thiết bị đã được mở trong nhà \"\$homeName\" trong \$seconds giây.":
      "Modu adisaun dispozitivu nian loke iha uma \"\$homeName\" ba segundu \$seconds.",
  "Khoảng thời gian phải nằm trong khung báo động (\$start → \$end)":
      "Períodu tempu tenke iha kuadru alarme nian (\$start → \$end)",
  "\$passCount/\$total bài test đạt\n\n":
      "\$passCount/\$total liu ona teste\n\n",
  "\$name chưa cập nhật số điện thoại trong hồ sơ.":
      "\$name seidauk atualiza nia númeru telefone iha nia perfil.",
  "Tin nhắn mới trong \$homeName": "Mensajen foun iha \$homeName",
  "\$current/\$total kết quả": "Rezultadu sira \$current/\$total",
  "Đang trả lời \$name": "Hatán ba \$name",
  "\"\$name\" phát hiện khói trong \"\$homeName\".":
      "\"\$name\" detekta suar iha \"\$homeName\".",
  "\"\$name\" đã trở lại trạng thái bình thường.":
      "\"\$name\" fila fali ona ba estadu normál.",
  "\"\$name\" vừa kích hoạt SOS trong \"\$homeName\".":
      "\"\$name\" foin ativa SOS iha \"\$homeName\".",
  "\"\$name\" đã hết trạng thái SOS.": "\"\$name\" laiha ona estatutu SOS.",
  "\"\$name\" báo bị tháo/cạy trong \"\$homeName\".":
      "\"\$name\" relata katak hasai/hasai iha \"\$homeName\".",
  "\"\$name\" đã hết cảnh báo tháo/cạy.":
      "\"\$name\" hasai tiha ona avizu remosaun/pry.",
  "\"\$name\" đã đóng trong \"\$homeName\".":
      "\"\$name\" taka iha \"\$homeName\".",
  "\"\$name\" đang mở trong \"\$homeName\".":
      "\"\$name\" loke iha \"\$homeName\".",
  "\"\$name\" trong \"\$homeName\" đang yếu pin.":
      "\"\$name\" iha \"\$homeName\" iha bateria menus.",
  "\"\$name\" trong \"\$homeName\" đã mất kết nối.":
      "\"\$name\" iha \"\$homeName\" lakon ligasaun.",
  "\"\$name\" trong \"\$homeName\" đã kết nối trở lại.":
      "\"\$name\" iha \"\$homeName\" liga fali.",
  "\"\$name\" ghi nhận nhiệt độ cao trong \"\$homeName\".":
      "\"\$name\" rejista temperatura aas iha \"\$homeName\".",
  "\"\$name\" ghi nhận độ ẩm cao trong \"\$homeName\".":
      "\"\$name\" rejista umidade aas iha \"\$homeName\".",
  "Có nút SOS vừa được kích hoạt": "Iha node SOS ne'ebé foin maka ativa",
  "Có dấu hiệu khói hoặc cháy": "Iha sinál suar ka ahi",
  "Có dấu hiệu ngập nước": "Iha sinál inundasaun nian",
  "Có dấu hiệu rò khí": "Iha sinál sira fuga anin nian",
  ...
  "Sẽ báo lại theo lịch báo động đã cài nếu vấn đề chưa được xử lý.":
      "Sei relata fali tuir oráriu alarme nian ne'ebé maka estabelese ona se problema ne'e seidauk rezolve.",
  "\"\$deviceName\" đã đóng trong \"\$resolvedHomeName\".":
      "\"\$deviceName\" taka iha \"\$resolvedHomeName\".",
  "\"\$deviceName\" đang mở trong \"\$resolvedHomeName\".":
      "\"\$deviceName\" loke iha \"\$resolvedHomeName\".",
  "\$count nhà đã chọn": "\$count hili uma",
  "🚨 \$count nhà không an toàn\$suffix": "🚨 \$count uma la seguru\$suffix",
  "⚠️ \$count nhà cần chú ý\$suffix": "⚠️ \$count presiza atensaun \$suffix",
  "✅ \$count nhà an toàn": "✅ \$count uma seguru",
  "\$count nhà đang được theo dõi": "Uma \$count hetan monitorizasaun",
  "\$minutes phút": "Minutu \$minutes",
  "Đã cài nhắc nhở cho \$updatedHomes nhà.":
      "Instala ona lembransa ba uma \$updatedHomes.",
  "Đã cài báo động cho \$updatedDevices thiết bị trong \$updatedHomes nhà.\n":
      "Konjuntu alarme nian ba dispozitivu \$updatedDevices iha uma \$updatedHomes.\n",
  "Đã chia sẻ các nhà bạn có quyền.\n\n\$skipped nhà bị bỏ qua vì bạn không có quyền chia sẻ.":
      "Fahe uma sira ne'ebé ita-boot iha direitu ba.\n\n\$skipped uma hetan ignora tanba ita-boot laiha lisensa atu fahe.",
  "Đã áp dụng báo động cho \$count thiết bị an ninh":
      "Alarme aplika ba dispozitivu seguransa \$count",
  "Áp dụng cùng một lịch cho \$count thiết bị an ninh":
      "Aplika oráriu hanesan ba dispozitivu seguransa \$count",
  "\$count phút trước": "\$count minutu sira liubá",
  "\$count giờ trước": "\$count oras hirak liubá",
  "\${count}h trước": "\${count}h uluk",
  "\${hours}h\$minutes' trước": "\${hours}h\$minutes' dahuluk",
  "\$count ngày trước": "\$count iha tempu uluk",
  "\$count tháng trước": "\$count iha fulan kotuk",
  "Bạn chắc chắn muốn xoá \$name khỏi nhà này?":
      "Ita-boot iha serteza katak ita-boot hakarak hasai \$name husi uma ida-ne'e?",
  "\$targetEmail\nXin gia nhập \"\$homeName\"":
      "\$targetEmail\nFavor ida hamutuk ho \"\$homeName\"",
  "Xin gia nhập \"\$homeName\"": "Favor ida hamutuk ho \"\$homeName\"",
  "Bạn được mời nhận quyền nhà \"\$homeName\"":
      "Ita-boot sira hetan konvite atu simu direitu ba \"\$homeName\".",
  ...
  "Không có thành viên nào ở nhà nhưng cửa hoặc khóa đang mở, hãy kiểm tra ngay.":
      "Laiha ema ida iha uma maibé odamatan ka xave nakloke, verifika kedas.",
  "Kiểm tra cửa hoặc khóa đang mở trước khi giữ nhà ở chế độ Bảo vệ.":
      "Verifika odamatan ka xave nakloke antes tau uma iha modo Protesaun.",
  "Có thể vẫn có người ở nhà; nếu đúng, nên chuyển về Bình thường.":
      "Karik iha nafatin ema iha uma; Se ida-ne'e loos, ida-ne'e tenke muda fali ba Normál.",
  "Có thành viên chưa xác định vị trí, hãy nhắc họ mở ứng dụng hoặc kiểm tra quyền vị trí.":
      "Se membru ida iha fatin ne'ebé deskoñesidu, fó hanoin ba sira atu loke aplikasaun ka verifika sira nia lisensa fatin nian.",
  "Có thiết bị mất kết nối, hãy kiểm tra pin, nguồn hoặc vị trí đặt thiết bị.":
      "Se dispozitivu ida lakon ligasaun, verifika bateria, enerjia, ka dispozitivu nia fatin.",
  "Có thiết bị pin yếu, nên thay pin sớm để tránh mất cảnh báo.":
      "Se ita-boot iha dispozitivu ida ho bateria ne'ebé menus, ita-boot tenke troka bateria sedu atu evita lakon avizu.",
  "Bạn chưa đặt nhắc nhở, nên tạo lịch nhắc kiểm tra nhà định kỳ.":
      "Ita-boot seidauk tau lembransa ida, nune'e ita-boot tenke kria oráriu ida atu fó hanoin ba ita-boot atu verifika ita-boot nia uma beibeik.",
  "Bạn chưa đặt lịch báo động, nên bật bảo vệ theo khung giờ thường vắng nhà.":
      "Ita-boot seidauk tau oráriu alarme nian, nune'e loke seguransa durante oras sira ne'ebé ita-boot baibain la iha uma.",
  "Không có việc cần xử lý ngay, bạn chỉ cần tiếp tục theo dõi trạng thái nhà.":
      "Laiha buat ida ne'ebé maka presiza atu halo kedas, ita-boot presiza de'it atu kontinua monitoriza estatutu uma nian.",
  "Lặp sau \$minutes phút": "Halo filafali hafoin minutu \$minutes",
  "Đang dùng • \$repeatText": "Iha utilizasaun • \$repeatText",
  "Giám sát an ninh • \$repeatText":
      "Monitorizasaun seguransa nian • \$repeatText",
  "Gia đình: \$mode": "Família: \$mode",
  "Gợi ý xử lý": "Manejamentu ne'ebé sujere",
  "Phát hiện \$count vấn đề cần xử lý":
      "Detekta ona problema \$count ne'ebé presiza atu rezolve",
  "Hôm nay các cửa đã được sử dụng \$count lần":
      "Ohin loron odamatan sira uza ona dala \$count",
  "Đã ghi nhận \$count hoạt động gần đây":
      "\$count rejista atividade foin lalais ne'e",
  "Hệ thống: Cần kiểm tra \$issueCount mục":
      "Sistema: Presiza atu verifika sasán \$issueCount",
  "FCM token đã sẵn sàng trên điện thoại này.":
      "Token FCM disponivel iha telefone ida-ne'e.",
  "FCM token đã sẵn sàng, nhưng Auto rời khỏi nhà còn thiếu điều kiện.":
      "Token FCM prontu ona, maibé karakterístika Protesaun Sai-Uma automátika laiha.",
  ...
  "\$count thiết bị đang được theo dõi":
      "Dispozitivu \$count hetan monitorizasaun",
  "Cập nhật \$timeText": "Atualiza \$timeText",
  "Dữ liệu gần nhất cập nhật \$count phút trước":
      "Dadus ikus liu atualiza \$count minutu hirak liubá",
  "Dữ liệu gần nhất cập nhật \$count giờ trước":
      "Dadus ikus liu atualiza \$count oras hirak liubá",
  "Thành viên trong nhà: \$count": "Membru uma nian: \$count",
  "Thành viên bên ngoài: \$count": "Membru esternu: \$count",
  ...
  "Tự đóng sau \$time": "Taka rasik hafoin \$time",
  "Ngày trong tuần": "Loron semana nian",
  "Hoặc": "Ou",
  "Giờ bắt đầu và kết thúc không được trùng nhau":
      "Oras hahú no remata labele taka malu",
  "Giờ kết thúc phải sau thời điểm hiện tại":
      "Tempu ikus tenke liutiha tempu atuál",
  "Khoảng tạm tắt không hợp lệ": "Pauza ne'ebé la válidu",
  "Khoảng tạm tắt không trùng với lịch báo động nào đang bật":
      "Períodu off la koinside ho kualkér oráriu alarme nian ne'ebé maka iha",
  ...
  "Cho phép kích hoạt còi trong nhà.":
      "Permite atu ativa sirene iha uma laran.",
  "Đánh thức màn hình": "Hadeer ekran",
  "Hiển thị cảnh báo toàn màn hình trên điện thoại.":
      "Hatudu alerta ekran tomak iha telefone.",
  ...
  "Không thể lưu cấu hình báo động": "Labele salva konfigurasaun alarme nian",
  "Chỉ chủ nhà và quản trị viên có thể thay đổi cài đặt này.":
      "Só uma-na'in sira no administradór sira maka bele muda konfigurasaun ida-ne'e.",
  "Thông tin chi tiết": "Informasaun detallu",
  "Thông báo báo động": "Notifikasaun ba alarme",
  "Cài đặt nhắc nhở": "Konfigurasaun lembransa nian",
  "Nhắc nhở theo lịch": "Lembransa sira ne'ebé ajenda ona",
  "Danh sách thông báo": "Notifikasaun sira",
  "Cài đặt thông báo": "Konfigurasaun notifikasaun nian",
  "Sử dụng báo động theo lịch đã thiết lập":
      "Uza alarme sira tuir oráriu sira ne'ebé estabelese ona",
  "Chỉ gửi thông báo, không kích hoạt báo động":
      "Haruka de'it notifikasaun sira, la hamosu alarme sira",
  "Toàn bộ báo động của nhà đang tắt; hệ thống chỉ gửi thông báo.":
      "Alarme uma nian hotu-hotu mate; Sistema haruka de'it notifikasaun sira.",
  "Chỉ Chủ nhà có thể bật chế độ này.":
      "Uma-na'in de'it maka bele ativa modu ida-ne'e.",
  "Bật Không bảo vệ?": "Ativa modu Dezarmadu?",
  "Cảm biến vừa phát hiện một sự kiện.": "Sensor foin detekta eventu ida.",
  "Chỉ Chủ nhà mới có quyền bật chế độ Không bảo vệ":
      "Uma-na'in de'it maka bele ativa modu Dezarmadu",
  "Đã chuyển nhà sang Không bảo vệ": "Uma muda ona ba Dezarmadu",
  "Đã chuyển sang Không bảo vệ nhưng chưa gửi được thông báo":
      "Muda ba Dezarmadu maibé notifikasaun sira seidauk haruka",
  "Giám sát toàn diện": "Monitorizasaun komprensivu",
  "Không bảo vệ": "Dezarmadu",
  "Không bảo vệ đang bật": "Modu Dezarmadu ativu",
  "Nhà đã chuyển sang Không bảo vệ": "Uma muda ona ba Dezarmadu",
  "Thông báo cảm biến": "Notifikasaun sensor",
  "Thông báo thông thường khi cảm biến phát hiện sự kiện.":
      "Notifikasaun normál bainhira sensor ida detekta eventu ida.",
  "Tôi hiểu, tiếp tục": "Ha'u komprende, kontinua",
  "Cảnh báo an ninh đã kết thúc": "Alerta seguransa nian remata ona",
  "Sự cố nguy hiểm đã kết thúc": "Insidente perigozu ne'e remata ona",
  "Cảnh báo đã được kết thúc.": "Alerta ne'e hakotu ona.",
  "Vẫn còn cảnh báo khác đang hoạt động.":
      "Iha nafatin avizu ativu sira seluk.",
  "Báo động đã hoạt động trở lại": "Alarme lakan fali ona",
  "Thời gian tạm dừng báo động đã kết thúc.": "Pauza alarme nian remata ona.",
  "MQTT đã kết nối trở lại": "MQTT liga fali",
  "Còi báo động đã được tắt": "Sirene mate tiha ona",
  "Sự cố vẫn đang được theo dõi.": "Akontesimentu ne'e sei akompaña hela.",
  "Bảo vệ tự động đã bật": "Protesaun automátika ativa ona",
  "Toàn bộ thành viên đã rời khỏi nhà.": "Membru hotu-hotu sai ona husi uma.",
  "Bảo vệ tự động đã tắt": "Protesaun automátika dezativadu",
  "Có thành viên đã trở về nhà.": "Membru balun fila ona ba uma.",
  "Thiết bị đã được xoá": "Dispozitivu ne'e apaga tiha ona",
  "Không thể xoá thiết bị": "Dispozitivu ne'e labele hamoos",
  "Hãy thử lại thao tác xoá thiết bị.": "Koko hamoos fali dispozitivu.",
  "Chế độ Bảo vệ đã được tắt.": "Modu protesaun desativa ona.",
  "Nhà đang ở chế độ Bình thường.": "Uma iha modo Normál.",
  "Pin thiết bị đã ổn định": "Bateria dispozitivu nian estavel",
  "Hub đã kết nối trở lại": "Hub liga fali",
  "Đã chuyển về Bình thường nhưng chưa gửi được thông báo":
      "Muda fali ba Normál maibé notifikasaun sira seidauk haruka",
  "Chung cho nhà": "Komún ba uma",
  "Áp dụng cho toàn bộ thành viên và có thể bật còi vật lý.":
      "Aplika ba membru hotu-hotu no bele ativa sirene fízika.",
  "Cá nhân": "Pesoál",
  "Lịch cá nhân hoạt động độc lập và không bật còi vật lý.":
      "Oráriu pesoál funsiona independente no la ativa sirene fízika.",
  "Cài đặt này chỉ áp dụng cho tài khoản của bạn.":
      "Konfigurasaun ida-ne'e aplika de'it ba ita-boot nia konta.",
  "Chỉ chủ nhà và quản trị viên có thể thay đổi phần chung cho nhà.":
      "Uma-na'in no administradór sira de'it maka bele muda sasán komún sira ba uma.",
  "Tham gia hệ thống báo động": "Tama ba sistema alarme nian",
  "Cảm biến khẩn cấp luôn tham gia hệ thống báo động.":
      "Sensor emerjénsia sira sempre partisipa iha sistema alarme nian.",
  "Tắt để thiết bị không tạo bất kỳ báo động nào.":
      "Mate atu nune'e dispozitivu labele hamosu alarme ruma.",
  "Lịch báo động chung": "Oráriu alarme jerál",
  "Lịch báo động cá nhân": "Oráriu alarme pesoál",
  "Hiển thị cảnh báo toàn màn hình trên điện thoại của bạn.":
      "Hatudu alerta sira iha ekran tomak iha ita-boot nia telefone.",
  "Lặp lại cảnh báo": "Repete avizu",
  "Báo động chung": "Alarme jerál",
  "Báo động cá nhân": "Alarme pesoál",
  "Đã cài đặt": "Konfigura ona",
  "Chưa cài đặt": "Seidauk konfigura",
  "Lịch chung và lịch cá nhân hoạt động song song, không còn phải chọn một trong hai.":
      "Kalendáriu ne'ebé fahe no kalendáriu pesoál funsiona hamutuk, la presiza ona atu hili entre rua ne'e.",
  "Cài nhanh chung": "Konfigurasaun lalais komún",
  "Cài nhanh cá nhân": "Konfigurasaun lalais pesoál",
  "Thiết lập nhanh lịch cá nhân": "Konfigura lalais kalendáriu pesoál",
  "Thiết lập nhanh lịch chung": "Konfigura lalais kalendáriu fahe ida",
  "Lịch này chỉ áp dụng cho bạn và không bật còi vật lý.":
      "Oráriu ida-ne'e aplika de'it ba ita-boot no la ativa sirene fízika.",
  "Lịch này áp dụng cho toàn bộ thành viên trong nhà.":
      "Oráriu ida-ne'e aplika ba membru família hotu-hotu.",
  "Đã áp dụng lịch báo động": "Oráriu alarme nian aplika ona",
  "Không thể lưu lịch báo động": "Labele rai oráriu alarme nian",
  "Nhà chưa có thiết bị an ninh": "Uma ne'e laiha ekipamentu seguransa nian",

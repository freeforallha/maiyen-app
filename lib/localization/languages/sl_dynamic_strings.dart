const Map<String, String> slDynamicStrings = {
  "Bảo vệ - Tự động": "Zaščita – samodejno",
  "Bảo vệ - Thủ công": "Zaščita – ročno",
  "Tự động": "Samodejno",
  "Thủ công": "Ročno",
  "\$displayMemberName đã gia nhập nhà \"\$homeName\".":
      "\$displayMemberName se je pridružil domu »\$homeName«.",
  "NGUY HIỂM": "NEVARNOST",
  "Nguy hiểm & Khẩn cấp": "Nevarnost in nujni primeri",
  "TẮT CÒI": "IZKLOPI SIRENO",
  "Tắt còi báo động?": "Izklopiti alarmno sireno?",
  "Còi vật lý sẽ dừng, nhưng cảnh báo vẫn tiếp tục cho đến khi sự cố được xử lý.\n\nBạn chắc chắn muốn tắt còi?":
      "Fizična sirena se bo ustavila, opozorilo pa bo ostalo aktivno, dokler težava ne bo odpravljena.\n\nAli ste prepričani, da želite izklopiti sireno?",
  "Đã gửi lệnh tắt còi. Cảnh báo vẫn đang được theo dõi.":
      "Ukaz za izklop sirene je bil poslan. Opozorilo se še naprej spremlja.",
  "Không tìm thấy cảnh báo đang hoạt động hoặc chưa thể gửi lệnh tắt còi.":
      "Aktivnega opozorila ni bilo mogoče najti ali pa ukaza za izklop sirene še ni bilo mogoče poslati.",
  "TẮT CÒI TRONG NHÀ": "IZKLOPI SIRENO V DOMU",
  "Đã tắt còi trong nhà. Cảnh báo vẫn tiếp tục cho đến khi được xử lý.":
      "Sirena v domu je izklopljena. Opozorilo ostane aktivno, dokler težava ni odpravljena.",
  "\$name đang chuẩn bị gửi tin...": "\$name piše ...",
  "\$name1 và \$name2 đang chuẩn bị gửi tin...":
      "\$name1 in \$name2 pišeta ...",
  ...
  "FCM token đã sẵn sàng, nhưng tính năng tự động khi rời nhà còn thiếu điều kiện.":
      "Žeton FCM je pripravljen, vendar za samodejno zaščito ob odhodu manjka še en pogoj.",
  "Đã kích hoạt SOS": "SOS je aktiviran",
  "Phát hiện chập điện": "Zaznan je kratek stik",
  "Phát hiện quá dòng": "Zaznan je previsok tok",
  "Phát hiện quá áp": "Zaznana je prenapetost",
  "Thiết bị điện quá nhiệt": "Električna naprava se pregreva",
  "Tài khoản đang được sử dụng": "Račun je v uporabi",
  "Hiện tại tài khoản này đang đăng nhập trên một thiết bị khác. Nếu tiếp tục, tài khoản trên thiết bị đó sẽ tự đăng xuất.":
      "Ta račun je trenutno prijavljen v drugi napravi. Če nadaljujete, bo račun v tej napravi samodejno odjavljen.",
  "Tiếp tục đăng nhập": "Nadaljuj prijavo",
  "Tài khoản đã được đăng nhập trên một thiết bị khác.":
      "Račun je prijavljen v drugi napravi.",
  "KHẨN CẤP": "NUJNO",
  "CẦN CHÚ Ý": "POTREBNA POZORNOST",
  "THÔNG TIN": "INFORMACIJE",
  "BÁO ĐỘNG": "ALARM",
  "Cảm biến đã trở lại trạng thái an toàn.":
      "Senzor se je vrnil v varno stanje.",
  "Người dùng đã tắt cảnh báo.": "Uporabnik je izklopil opozorilo.",
  "Khung giờ bảo vệ đã kết thúc.": "Čas zaščite se je končal.",
  "Cảnh báo tức thời đã tự kết thúc.":
      "Takojšnje opozorilo se je samodejno končalo.",
  "Điều kiện cảnh báo không còn hoạt động.":
      "Pogoj za opozorilo ni več aktiven.",
  "Cảnh báo đã kết thúc: \$reason": "Opozorilo se je končalo: \$reason",
};

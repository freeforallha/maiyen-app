const Map<String, String> tetDynamicStrings = {
  "Bảo vệ - Tự động": "Protesaun - Automátiku",
  "Bảo vệ - Thủ công": "Protesaun - Manual",
  "Tự động": "Automátiku",
  "Thủ công": "Manual",
  "\$displayMemberName đã gia nhập nhà \"\$homeName\".":
      "\$displayMemberName tama iha uma \"\$homeName\".",
  "NGUY HIỂM": "PERIGU",
  "Nguy hiểm & Khẩn cấp": "Perigu no emerjénsia",
  "TẮT CÒI": "MATE SIRENE",
  "Tắt còi báo động?": "Mate sirene alarme nian?",
  "Còi vật lý sẽ dừng, nhưng cảnh báo vẫn tiếp tục cho đến khi sự cố được xử lý.\n\nBạn chắc chắn muốn tắt còi?":
      "Sirene fízika sei para, maibé alerta sei kontinua to'o insidente ne'e rezolve ona.\n\nIta-boot hakarak mate sirene ka lae?",
  "Đã gửi lệnh tắt còi. Cảnh báo vẫn đang được theo dõi.":
      "Komandu atu mate sirene haruka ona. Alerta sei monitoriza hela.",
  "Không tìm thấy cảnh báo đang hoạt động hoặc chưa thể gửi lệnh tắt còi.":
      "La hetan alerta ativu ka seidauk bele haruka komandu atu mate sirene.",
  "TẮT CÒI TRONG NHÀ": "MATE SIRENE UMA NIAN",
  "Đã tắt còi trong nhà. Cảnh báo vẫn tiếp tục cho đến khi được xử lý.":
      "Sirene uma nian mate ona. Alerta sei kontinua to'o rezolve ona.",
  "\$name đang chuẩn bị gửi tin...": "\$name hela hakerek mensajen...",
  "\$name1 và \$name2 đang chuẩn bị gửi tin...":
      "\$name1 no \$name2 hela hakerek mensajen...",
  ...
  "Hiện tại tài khoản này đang đăng nhập trên một thiết bị khác. Nếu tiếp tục, tài khoản trên thiết bị đó sẽ tự đăng xuất.":
      "Konta ida-ne'e agora tama iha dispozitivu seluk. Se kontinua, konta iha dispozitivu ne'ebá sei sai rasik.",
  "Tiếp tục đăng nhập": "Kontinua tama",
  "Tài khoản đã được đăng nhập trên một thiết bị khác.":
      "Konta ida-ne'e tama ona iha dispozitivu seluk.",
  "KHẨN CẤP": "EMERJÉNSIA",
  "CẦN CHÚ Ý": "PRESIZA ATENSAUN",
  "THÔNG TIN": "INFORMASAUN",
  "BÁO ĐỘNG": "ALARME",

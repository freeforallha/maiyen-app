const Map<String, String> viStrings = {
  ...
  "Vẫn còn cảnh báo khác đang hoạt động.": "Vẫn còn cảnh báo khác đang hoạt động.",
  "Báo động đã hoạt động trở lại": "Báo động đã hoạt động trở lại",
  "Thời gian tạm dừng báo động đã kết thúc.": "Thời gian tạm dừng báo động đã kết thúc.",
  ...
  "Đã chuyển về Bình thường nhưng chưa gửi được thông báo": "Đã chuyển về Bình thường nhưng chưa gửi được thông báo",
  "Chung cho nhà": "Chung cho nhà",
  "Áp dụng cho toàn bộ thành viên và có thể bật còi vật lý.": "Áp dụng cho toàn bộ thành viên và có thể bật còi vật lý.",
  "Cá nhân": "Cá nhân",
  "Lịch cá nhân hoạt động độc lập và không bật còi vật lý.": "Lịch cá nhân hoạt động độc lập và không bật còi vật lý.",
  "Cài đặt này chỉ áp dụng cho tài khoản của bạn.": "Cài đặt này chỉ áp dụng cho tài khoản của bạn.",
  "Chỉ chủ nhà và quản trị viên có thể thay đổi phần chung cho nhà.": "Chỉ chủ nhà và quản trị viên có thể thay đổi phần chung cho nhà.",
  "Tham gia hệ thống báo động": "Tham gia hệ thống báo động",
  "Cảm biến khẩn cấp luôn tham gia hệ thống báo động.": "Cảm biến khẩn cấp luôn tham gia hệ thống báo động.",
  "Tắt để thiết bị không tạo bất kỳ báo động nào.": "Tắt để thiết bị không tạo bất kỳ báo động nào.",
  "Lịch báo động chung": "Lịch báo động chung",
  "Lịch báo động cá nhân": "Lịch báo động cá nhân",
  "Hiển thị cảnh báo toàn màn hình trên điện thoại của bạn.": "Hiển thị cảnh báo toàn màn hình trên điện thoại của bạn.",
  ...
  "Lịch chung và lịch cá nhân hoạt động song song, không còn phải chọn một trong hai.": "Lịch chung và lịch cá nhân hoạt động song song, không còn phải chọn một trong hai.",
  ...
  "Lịch này chỉ áp dụng cho bạn và không bật còi vật lý.": "Lịch này chỉ áp dụng cho bạn và không bật còi vật lý.",
  "Lịch này áp dụng cho toàn bộ thành viên trong nhà.": "Lịch này áp dụng cho toàn bộ thành viên trong nhà.",
  ...
  "Nhận cảnh báo theo lịch chung của nhà": "Nhận cảnh báo theo lịch chung của nhà",
  "Tắt để không nhận thông báo hoặc cảnh báo toàn màn hình từ lịch chung. Còi vật lý của nhà vẫn hoạt động.": "Tắt để không nhận thông báo hoặc cảnh báo toàn màn hình từ lịch chung. Còi vật lý của nhà vẫn hoạt động.",
};

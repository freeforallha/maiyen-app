const Map<String, String> zhStrings = {
  ...
  "Đặt báo động cho nhà": "设置家庭警报",
  "Xác nhận thay đổi": "确认更改",
  "Tiếp tục": "继续",
  "Giờ nhắc nhở": "提醒 时间",
  "Giờ bắt đầu báo động": "警报开始时间",
  "Giờ kết thúc báo động": "警报结束时间",
  ...
  "Lưu ý khi bật báo động": "开启警报提示",
  "Báo động đã được bật": "警报已开启",
  "Đã hiểu": "知道了",
  "Đã bật báo động": "警报已开启",
  "Đã tắt báo động": "警报已关闭",
  "Tắt báo động": "停止警报",
  "Cả ngày": "全天",
  ...
  "Ra ngoài": "外出",
  "Khác": "其他",
  "Lưu ý tạm tắt báo động": "警报暂停说明",
  "Tạm tắt báo động hôm nay": "今天暂停警报",
  ...
  "Mỗi thành viên sẽ cần cấp quyền vị trí Luôn cho phép để trạng thái rời/đến nhà hoạt động khi ứng dụng chạy nền.": "每位成员都需要授予“始终允许”位置权限，离家/到家状态才能在后台工作。",
  "Lưu cài đặt": "保存设置",
  ...
  "Thiết lập nhanh báo động": "快速设置警报",
  ...
  "Hành động này sẽ tắt toàn bộ báo động của nhà ": "此操作将关闭此家庭的所有警报。你将不再在此手机上收到危险警报。",
  "Tắt toàn bộ báo động?": "关闭全部警报？",
  "Không xoá được lịch tạm tắt báo động": "无法删除警报暂停计划",
  "Không lưu được tạm tắt báo động": "无法保存警报暂停",
  ...
  "Chỉ Chủ nhà hoặc Quản trị viên mới có quyền thay đổi Chế độ Bảo vệ": "只有屋主或管理员可以更改布防模式",
  ...
  "30 phút": "30 分钟",
  "15 phút": "15 分钟",
  "Bạn đang xem lịch của chủ nhà. Chọn Riêng tôi để tự đặt lịch báo động.": "你正在查看屋主的计划。选择仅自己即可设置个人警报计划。",
  "Chọn giờ kết thúc báo động": "选择警报结束时间",
  "Chọn giờ bắt đầu báo động": "选择警报开始时间",
  "Bạn không có quyền sửa lịch báo động của nhà": "你没有权限编辑此家庭的警报计划",
  "Không thể áp dụng báo động cho toàn bộ thiết bị": "无法将警报应用到所有设备",
  ...
  "Không thể lưu chế độ báo động": "无法保存警报模式",
  "Thêm nhắc nhở": "添加 提醒",
  "Nhắc nhở sẽ nhắc bạn kiểm tra trạng thái an toàn của ngôi nhà vào giờ đã chọn.": "提醒 会在所选时间提醒你检查家庭安全状态。",
  "Thêm khung giờ báo động": "添加警报时间段",
  ...
  "Sửa giờ kết thúc báo động": "编辑警报结束时间",
  "Sửa giờ bắt đầu báo động": "编辑警报开始时间",
  "Xoá nhắc nhở": "删除 提醒",
  "Mỗi 1 giờ": "每 1 小时",
  "Mỗi 30 phút": "每 30 分钟",
  "Mỗi 15 phút": "每 15 分钟",
  ...
  "Hôm nay đã ghi nhận cảnh báo SOS": "今天已记录 SOS警报",
  ...
  "Lặp báo động khi sự cố vẫn còn": "问题仍存在时重复警报",
  ...
  "Bạn nên mở ứng dụng định kỳ để kiểm tra quyền, lịch và cảnh báo chưa đọc.": "建议定期打开应用检查权限、时间表和未读警报。",
  "Sau vài lần sử dụng, SafeHome sẽ đánh giá thói quen kiểm tra ứng dụng tốt hơn.": "使用几次后，SafeHome 可以更好地评估你的应用检查习惯。",
  ...
  "Nên đặt lịch báo động cho thời gian ngủ hoặc vắng nhà.": "建议为睡眠时间或外出时设置警报时间表。",
  "Nhà đã có lịch báo động hoặc lịch cảnh báo theo thiết bị.": "此家庭已有警报时间表或设备级警报时间表。",
  "Chưa cài lịch báo động": "尚未设置警报时间表",
  "Đã cài lịch báo động": "已设置警报时间表",
  "Nên có ít nhất một nhắc nhở để không quên kiểm tra nhà.": "建议至少设置一个 提醒，避免忘记检查家庭。",
  "Ứng dụng sẽ nhắc bạn kiểm tra nhà theo lịch đã đặt.": "应用会按计划提醒你检查家庭。",
  "Chưa cài đặt nhắc nhở": "尚未设置 提醒",
  "Đã cài đặt nhắc nhở": "已设置 提醒",
  "Hãy mở lại ứng dụng hoặc đăng nhập lại nếu thiết bị không nhận cảnh báo.": "如果此设备收不到警报，请重新打开应用或重新登录。",
  ...
  "Điện thoại ít có khả năng trì hoãn cảnh báo SafeHome.": "手机较少可能延迟 SafeHome警报。",
  ...
  "iOS không mở toàn màn hình như Android; ứng dụng dùng thông báo và âm thanh hệ thống.": "iOS 不像 Android 那样全屏打开；应用使用系统通知和声音。",
  ...
  "Không thể thay đổi trạng thái báo động": "无法更改警报状态",
  "Đã tắt toàn bộ báo động của nhà": "已关闭家庭的所有警报",
  ...
  "Thao tác này sẽ thay đổi lịch báo động của toàn bộ thiết bị an ninh trong các nhà đã chọn.\n\nNhững thành viên đang sử dụng báo động 'Theo nhà' sẽ bị ảnh hưởng.\nBáo động cá nhân ở chế độ 'Riêng tôi' sẽ không bị thay đổi.": "此操作会更改所选家庭中所有安全设备的家庭警报计划。\n\n正在使用按家庭警报设置的成员会受到影响。\n处于仅自己模式的个人警报不会改变。",
  "Thao tác này sẽ thêm nhắc nhở cho các nhà đã chọn.\n\nNhững thành viên đang sử dụng nhắc nhở 'Theo nhà' sẽ bị ảnh hưởng.\nNhắc nhở cá nhân ở chế độ 'Riêng tôi' sẽ không bị thay đổi.": "此操作会为所选家庭添加家庭 提醒。\n\n正在使用按家庭 提醒 设置的成员会受到影响。\n处于仅自己模式的个人 提醒 不会改变。",
  ...
  "Hành động này sẽ tắt toàn bộ báo động của nhà dưới mọi hình thức. Bạn sẽ không còn nhận được cảnh báo khi có nguy hiểm trên điện thoại nữa.": "此操作将关闭此家庭的所有警报。你将不再在此手机上收到危险警报。",
  "Báo động đang sử dụng chế độ Theo nhà.\n\nBạn sẽ nhận cảnh báo theo lịch báo động chung do Chủ nhà hoặc Quản trị viên thiết lập.": "警报正在使用家庭设置。\n\n你将根据屋主或管理员设置的共享警报日程接收警报。",
  "Báo động đang sử dụng chế độ Riêng tôi.\n\nBạn sẽ nhận cảnh báo theo lịch báo động riêng đã thiết lập cho tài khoản này.": "警报正在使用个人设置。\n\n你将根据此账户设置的个人警报日程接收警报。",
  ...
  "⏸️ Tạm tắt báo động hôm nay": "⏸️ 今天暂停警报",
  "Báo động": "警报",
  "Bạn không có quyền thực hiện thao tác này。": "你没有权限执行此操作。",
  "Cài đặt": "设置",
  "Cập nhật": "更新",
  ...
  "\$actorName đã bật Chế độ Bảo vệ thủ công cho \"\$homeName\". Chế độ này chỉ tắt khi một thành viên có quyền chủ động chuyển về Bình thường. \$repeatMessage": "\$actorName 已为 \"\$homeName\" 开启手动布防模式。只有有权限的成员切回普通模式时，此模式才会关闭。\$repeatMessage",
  "Bạn đã bật báo động cho nhà \"\$homeName\".": "你已为 \"\$homeName\" 开启警报。",
  "Bạn đã tắt toàn bộ báo động của nhà \"\$homeName\".": "你已关闭 \"\$homeName\" 的所有警报。",
  "Thành viên mới": "新成员",
  ...
  "Chế độ Bảo vệ sẽ lặp báo động sau \$minutes phút": "布防模式将在 \$minutes 分钟后重复报警",
  ...
  "Khoảng thời gian phải nằm trong khung báo động (\$start → \$end)": "暂停时间必须在警报日程范围内（\$start → \$end）",
  ...
  "Sẽ báo lại theo lịch báo động đã cài nếu vấn đề chưa được xử lý.": "如果问题尚未处理，将按警报日程再次提醒。",
  ...
  "Có thành viên chưa xác định vị trí, hãy nhắc họ mở ứng dụng hoặc kiểm tra quyền vị trí.": "有成员位置未知。请提醒他们打开 app 或检查位置权限。",
  ...
  "Bạn chưa đặt nhắc nhở, nên tạo lịch nhắc kiểm tra nhà định kỳ.": "尚未设置 提醒。请创建定期检查家庭的日程。",
  "Bạn chưa đặt lịch báo động, nên bật bảo vệ theo khung giờ thường vắng nhà.": "尚未设置警报日程。请在通常无人时段启用保护。",
  ...
  "Khoảng tạm tắt không hợp lệ": "警报暂停时间范围无效",
  "Khoảng tạm tắt không trùng với lịch báo động nào đang bật": "暂停时间范围与任何已启用的警报计划均不重叠",
  "Cài đặt báo động": "警报设置",
  "Điều khiển cách cảm biến này kích hoạt cảnh báo.": "控制此传感器触发警报的方式。",
  "Tham gia báo động": "参与报警",
  "Tắt để cảm biến không tạo báo động.": "关闭后，此传感器将不会触发警报。",
  ...
  "Toàn bộ báo động của nhà đang tắt; hệ thống chỉ gửi thông báo.": "家中的所有警报均已关闭；系统只会发送通知。",
  ...
  "Đã chuyển sang Không bảo vệ nhưng chưa gửi được thông báo": "已切换到「无保护」模式，但通知发送失败",
  ...
  "Cảnh báo an ninh đã kết thúc": "安全警报已结束",
  "Sự cố nguy hiểm đã kết thúc": "紧急危险已结束",
  "Cảnh báo đã được kết thúc.": "警报已结束。",
  "Vẫn còn cảnh báo khác đang hoạt động.": "仍有其他警报处于活动状态。",
  "Báo động đã hoạt động trở lại": "警报已恢复运行",
  "Thời gian tạm dừng báo động đã kết thúc.": "警报暂停时间已结束。",
  "MQTT đã kết nối trở lại": "MQTT 已重新连接",
  "Còi báo động đã được tắt": "实体警报器已关闭",
  "Sự cố vẫn đang được theo dõi.": "事件仍在监控中。",
  "Bảo vệ tự động đã bật": "自动防护已开启",
  "Toàn bộ thành viên đã rời khỏi nhà.": "所有成员都已离家。",
  "Bảo vệ tự động đã tắt": "自动防护已关闭",
  "Có thành viên đã trở về nhà.": "有成员已回家。",
  "Thiết bị đã được xoá": "设备已删除",
  "Không thể xoá thiết bị": "无法删除设备",
  "Hãy thử lại thao tác xoá thiết bị.": "请重试删除设备。",
  "Chế độ Bảo vệ đã được tắt.": "防护模式已关闭。",
  "Nhà đang ở chế độ Bình thường.": "房屋处于正常模式。",
  "Pin thiết bị đã ổn định": "设备电池状态已稳定",
  ...
  "Lịch báo động chung": "全屋警报计划",
  "Lịch báo động cá nhân": "个人警报计划",
  "Hiển thị cảnh báo toàn màn hình trên điện thoại của bạn.": "在您的手机上显示全屏警报。",
  "Lặp lại cảnh báo": "重复警报",
  "Báo động chung": "全屋警报",

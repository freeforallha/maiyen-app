const Map<String, String> ruStrings = {
  ...
  "Đặt nhắc nhở / báo động nhà đã chọn": "Настроить напоминание / тревога для выбранных домов",
  ...
  "Đưa mã QR chia sẻ nhà vào khung hình": "Поместите QR-код общего дома в рамку",
  ...
  "Ra ngoài": "Выхожу",
  "Khác": "Другое",
  "⏸️ Tạm tắt báo động hôm nay": "⏸️ Приостановить тревогу на сегодня",
  ...
  "Mỗi thành viên sẽ cần cấp quyền vị trí Luôn cho phép để trạng thái rời/đến nhà hoạt động khi ứng dụng chạy nền.": "Каждый участник должен разрешить постоянный доступ к местоположению, чтобы статус ухода/возвращения домой работал в фоне.",
  ...
  "Tamper bình thường": "Вскрытие не обнаружено",
  ...
  "Báo động đã tắt": "Тревога отключена",
  "Tạm tắt báo động hôm nay": "Приостановить тревогу на сегодня",
  ...
  "Hành động này sẽ thay đổi thời gian báo động của một số thiết bị ": "Это действие изменит время тревога для некоторых устройств сегодня...",
  ...
  "Không xoá được lịch tạm tắt báo động": "Не удалось удалить график паузы тревога",
  ...
  "Chỉ Chủ nhà hoặc Quản trị viên mới có quyền thay đổi lặp báo động": "Только владелец или администратор может изменить повтор тревога",
  "Không lưu được thời gian lặp báo động": "Не удалось сохранить время повторения тревога",
  "Chỉ Chủ nhà hoặc Quản trị viên mới có quyền thay đổi Chế độ Bảo vệ": "Только владелец или администратор может изменить режим охраны",
  ...
  "30 phút": "30 минут",
  "15 phút": "15 минут",
  "Bạn đang xem lịch của chủ nhà. Chọn Riêng tôi để tự đặt lịch báo động.": "Вы просматриваете график владельца. Выберите «Только я», чтобы задать собственный график тревога.",
  "Chọn giờ kết thúc báo động": "Выберите время окончания тревога",
  "Chọn giờ bắt đầu báo động": "Выберите время начала тревога",
  "Bạn không có quyền sửa lịch báo động của nhà": "У вас нет разрешения редактировать график тревога этого дома",
  "Không thể áp dụng báo động cho toàn bộ thiết bị": "Не удалось применить тревога ко всем устройствам",
  ...
  "Nhắc nhở sẽ nhắc bạn kiểm tra trạng thái an toàn của ngôi nhà vào giờ đã chọn.": "напоминание напомнит вам проверить состояние безопасности дома в выбранное время.",
  "Thêm khung giờ báo động": "Добавить временное окно тревога",
  "Đang sử dụng nhắc nhở riêng của bạn": "Используются ваши личные настройки напоминание",
  "Đang sử dụng nhắc nhở của chủ nhà": "Используются настройки напоминание владельца",
  ...
  "Lặp báo động khi sự cố vẫn còn": "Повторять тревога, пока проблема сохраняется",
  ...
  "Bạn đã mở ứng dụng gần đây để kiểm tra trạng thái.": "Вы недавно открывали приложение для проверки статуса.",
  "Bạn nên mở ứng dụng định kỳ để kiểm tra quyền, lịch và cảnh báo chưa đọc.": "Регулярно открывайте приложение, чтобы проверять разрешения, графики и непрочитанные тревоги.",
  "Sau vài lần sử dụng, SafeHome sẽ đánh giá thói quen kiểm tra ứng dụng tốt hơn.": "После нескольких сеансов SafeHome сможет лучше оценить вашу привычку проверять приложение.",
  "Tần suất vào ứng dụng ổn": "Частота входа в приложение нормальная",
  "Đã lâu chưa vào ứng dụng kiểm tra": "Проверка приложения давно не выполнялась",
  "Đang ghi nhận tần suất vào ứng dụng": "Частота входа в приложение записывается",
  ...
  "Nên đặt lịch báo động cho thời gian ngủ hoặc vắng nhà.": "Задайте график тревога на время сна или отсутствия дома.",
  "Nhà đã có lịch báo động hoặc lịch cảnh báo theo thiết bị.": "В этом доме есть график тревога или график тревог для отдельных устройств.",
  "Chưa cài lịch báo động": "График тревога не задан",
  "Đã cài lịch báo động": "График тревога задан",
  "Nên có ít nhất một nhắc nhở để không quên kiểm tra nhà.": "Задайте хотя бы один напоминание, чтобы не забывать проверять дом.",
  "Ứng dụng sẽ nhắc bạn kiểm tra nhà theo lịch đã đặt.": "Приложение напомнит проверить дом по заданному графику.",
  "Chưa cài đặt nhắc nhở": "напоминание не настроен",
  "Đã cài đặt nhắc nhở": "напоминание настроен",
  "Hãy mở lại ứng dụng hoặc đăng nhập lại nếu thiết bị không nhận cảnh báo.": "Откройте приложение снова или войдите повторно, если это устройство не получает тревоги.",
  ...
  "Tối ưu pin không chặn ứng dụng": "Оптимизация батареи не блокирует приложение",
  ...
  "iOS không mở toàn màn hình như Android; ứng dụng dùng thông báo và âm thanh hệ thống.": "iOS не открывает полноэкранную тревогу как Android; приложение использует системные уведомления и звук.",
  ...
  "Kiểm tra điện thoại và cách bạn đang dùng ứng dụng.": "Проверяет телефон и использование приложения.",
  ...
  "Không thể thay đổi trạng thái báo động": "Не удалось изменить статус тревога",
  ...
  "Hành động này sẽ thay đổi thời gian báo động của một số thiết bị trong hôm nay...": "Это действие изменит время тревога для некоторых устройств сегодня...",
  "Hành động này sẽ tắt toàn bộ báo động của nhà dưới mọi hình thức. Bạn sẽ không còn nhận được cảnh báo khi có nguy hiểm trên điện thoại nữa.": "Это действие отключит все тревога для этого дома. Вы больше не будете получать тревоги об опасности на телефон.",
  "Báo động đang sử dụng chế độ Theo nhà.\n\nBạn sẽ nhận cảnh báo theo lịch báo động chung do Chủ nhà hoặc Quản trị viên thiết lập.": "тревога использует настройки дома.\n\nВы будете получать тревоги по общему графику тревога, заданному владельцем или администратором.",
  "Báo động đang sử dụng chế độ Riêng tôi.\n\nBạn sẽ nhận cảnh báo theo lịch báo động riêng đã thiết lập cho tài khoản này.": "тревога использует личные настройки.\n\nВы будете получать тревоги по личному графику тревога для этой учетной записи.",
  ...
  "\$actorName đã bật Chế độ Bảo vệ thủ công cho \"\$homeName\". Chế độ này chỉ tắt khi một thành viên có quyền chủ động chuyển về Bình thường. \$repeatMessage": "\$actorName включил ручной режим охраны для «\$homeName». Этот режим отключается только когда участник с правами переключит дом обратно в обычный режим. \$repeatMessage",
  "Bạn đã bật báo động cho nhà \"\$homeName\".": "Вы включили тревога для «\$homeName».",
  "Bạn đã tắt toàn bộ báo động của nhà \"\$homeName\".": "Вы отключили все тревога для «\$homeName».",
  ...
  "Chế độ Bảo vệ sẽ chỉ báo động một lần": "Режим охраны подаст тревогу только один раз",
  "Chế độ Bảo vệ sẽ lặp báo động sau \$minutes phút": "Режим охраны повторит тревогу через \$minutes минут",
  ...
  "Khoảng thời gian phải nằm trong khung báo động (\$start → \$end)": "Период паузы должен быть в расписании тревога (\$start → \$end)",
  ...
  "Sẽ báo lại theo lịch báo động đã cài nếu vấn đề chưa được xử lý.": "Повторная тревога сработает по настроенному расписанию тревога, если проблема не решена.",
  ...
  "Đã cài nhắc nhở cho \$updatedHomes nhà.": "напоминание установлен для \$updatedHomes домов.",
  ...
  "Đã áp dụng báo động cho \$count thiết bị an ninh": "тревога применён к \$count устройствам безопасности",
  ...
  "Có thành viên chưa xác định vị trí, hãy nhắc họ mở ứng dụng hoặc kiểm tra quyền vị trí.": "У некоторых участников неизвестно местоположение. Попросите их открыть приложение или проверить разрешение на местоположение.",
  ...
  "Bạn chưa đặt nhắc nhở, nên tạo lịch nhắc kiểm tra nhà định kỳ.": "напоминание не настроен. Создайте расписание для регулярной проверки дома.",
  "Bạn chưa đặt lịch báo động, nên bật bảo vệ theo khung giờ thường vắng nhà.": "Расписание тревога не настроено. Включите охрану на время, когда вас обычно нет дома.",
  ...
  "Khoảng tạm tắt không trùng với lịch báo động nào đang bật": "Интервал приостановки не совпадает ни с одним активным расписанием тревога",
  ...
  "Tắt để cảm biến không tạo báo động.": "Отключите, чтобы датчик не создавал тревога.",
  ...
  "Sử dụng báo động theo lịch đã thiết lập": "Использовать настроенное расписание тревоги",
  "Chỉ gửi thông báo, không kích hoạt báo động": "Только отправлять уведомления, не запускать тревогу",
  "Toàn bộ báo động của nhà đang tắt; hệ thống chỉ gửi thông báo.": "Все тревоги дома отключены; система будет только отправлять уведомления.",
  "Chỉ Chủ nhà có thể bật chế độ này.": "Только владелец может включить этот режим.",
  "Bật Không bảo vệ?": "Включить режим «Без защиты»?",
  "Cảm biến vừa phát hiện một sự kiện.": "Датчик только что обнаружил событие.",
  "Chỉ Chủ nhà mới có quyền bật chế độ Không bảo vệ": "Только владелец может включить режим «Без защиты»",
  "Đã chuyển nhà sang Không bảo vệ": "Дом переведён в режим «Без защиты»",
  "Đã chuyển sang Không bảo vệ nhưng chưa gửi được thông báo": "Режим «Без защиты» включён, но уведомление отправить не удалось",
  ...
  "Thông báo thông thường khi cảm biến phát hiện sự kiện.": "Обычные уведомления при обнаружении события датчиком.",
  ...
  "Còi báo động đã được tắt": "Физическая сирена выключена",
  "Sự cố vẫn đang được theo dõi.": "Ситуация всё ещё отслеживается.",
  "Bảo vệ tự động đã bật": "Автоматическая защита включена",
  "Toàn bộ thành viên đã rời khỏi nhà.": "Все участники покинули дом.",
  "Bảo vệ tự động đã tắt": "Автоматическая защита выключена",
  "Có thành viên đã trở về nhà.": "Участник вернулся домой.",
  "Thiết bị đã được xoá": "Устройство удалено",
  "Không thể xoá thiết bị": "Не удалось удалить устройство",
  "Hãy thử lại thao tác xoá thiết bị.": "Повторите удаление устройства.",
  "Chế độ Bảo vệ đã được tắt.": "Режим защиты выключен.",

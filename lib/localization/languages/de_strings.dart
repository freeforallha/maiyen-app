const Map<String, String> deStrings = {
  ...
  "Đã tắt báo động": "Alarm deaktiviert",
  ...
  "Vẫn còn cảnh báo khác đang hoạt động.": "Eine weitere Warnung ist noch aktiv.",
  ...
  "Toàn bộ thành viên đã rời khỏi nhà.": "Alle Mitglieder haben das Haus verlassen.",
  ...
  "Hãy thử lại thao tác xoá thiết bị.": "Bitte versuchen Sie erneut, das Gerät zu entfernen.",
  ...
  "Đã chuyển về Bình thường nhưng chưa gửi được thông báo": "Auf Normal umgestellt, aber die Benachrichtigung konnte nicht gesendet werden",
  "Chung cho nhà": "Für das ganze Zuhause",
  "Áp dụng cho toàn bộ thành viên và có thể bật còi vật lý.": "Gilt für alle Mitglieder und kann die physische Sirene aktivieren.",
  "Cá nhân": "Persönlich",
  "Lịch cá nhân hoạt động độc lập và không bật còi vật lý.": "Der persönliche Zeitplan arbeitet unabhängig und aktiviert niemals die physische Sirene.",
  "Cài đặt này chỉ áp dụng cho tài khoản của bạn.": "Diese Einstellung gilt nur für dein Konto.",
  "Chỉ chủ nhà và quản trị viên có thể thay đổi phần chung cho nhà.": "Nur Eigentümer und Administratoren können gemeinsame Einstellungen ändern.",
  "Tham gia hệ thống báo động": "Am Alarmsystem teilnehmen",
  "Cảm biến khẩn cấp luôn tham gia hệ thống báo động.": "Notfallsensoren nehmen immer am Alarmsystem teil.",
  "Tắt để thiết bị không tạo bất kỳ báo động nào.": "Ausschalten, damit das Gerät keinen Alarm auslöst.",
  "Lịch báo động chung": "Gemeinsamer Alarmzeitplan",
  "Lịch báo động cá nhân": "Persönlicher Alarmzeitplan",
  "Hiển thị cảnh báo toàn màn hình trên điện thoại của bạn.": "Vollbildalarm auf deinem Telefon anzeigen.",
  ...
  "Lịch chung và lịch cá nhân hoạt động song song, không còn phải chọn một trong hai.": "Gemeinsamer und persönlicher Zeitplan laufen parallel; eine Auswahl ist nicht mehr nötig.",
  ...
  "Lịch này chỉ áp dụng cho bạn và không bật còi vật lý.": "Dieser Zeitplan gilt nur für dich und aktiviert keine physische Sirene.",
  "Lịch này áp dụng cho toàn bộ thành viên trong nhà.": "Dieser Zeitplan gilt für alle Mitglieder des Zuhauses.",
  "Đã áp dụng lịch báo động": "Alarmzeitplan angewendet",
  "Không thể lưu lịch báo động": "Alarmzeitplan konnte nicht gespeichert werden",
  "Nhà chưa có thiết bị an ninh": "Dieses Zuhause hat keine Sicherheitsgeräte",
  "Nhận cảnh báo theo lịch chung của nhà": "Warnungen aus dem gemeinsamen Hauszeitplan erhalten",
  "Tắt để không nhận thông báo hoặc cảnh báo toàn màn hình từ lịch chung. Còi vật lý của nhà vẫn hoạt động.": "Deaktivieren, um keine Benachrichtigungen oder Vollbildwarnungen aus dem gemeinsamen Zeitplan zu erhalten. Die Haussirene bleibt aktiv.",
};

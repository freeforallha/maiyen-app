const Map<String, String> deStrings = {
  ...
  "Môi trường": "Umgebung",
  "Toàn bộ thiết bị MaiYen": "Alle MaiYen-Geräte",
  ...
  "Giờ": "Stunde",
  "Phút": "Minuten",
  "Đặt nhắc nhở cho nhà": "Zuhause-Erinnerung einrichten",
  "Đặt báo động cho nhà": "Zuhause-Alarm einrichten",
  "Xác nhận thay đổi": "Änderung bestätigen",
  "Tiếp tục": "Weiter",
  "Giờ nhắc nhở": "Erinnerung-Zeit",
  "Giờ bắt đầu báo động": "Alarm-Startzeit",
  "Giờ kết thúc báo động": "Alarm-Endzeit",
  ...
  "Đặt nhắc nhở / báo động nhà đã chọn":
      "Erinnerung / Alarm für ausgewählte Zuhause festlegen",
  ...
  "Lưu ý khi bật báo động": "Hinweis beim Aktivieren von Alarm",
  "Báo động đã được bật": "Alarm aktiviert",
  "Đã hiểu": "Verstanden",
  "Lưu ý tạm tắt báo động": "Hinweis zur Alarm-Pause",
  "Đã bật báo động": "Alarm aktiviert",
  "Đã tắt báo động": "Alarm ausgeschaltet",
  ...
  "Ra ngoài": "Ausgehen",
  "Khác": "Andere",
  "⏸️ Tạm tắt báo động hôm nay": "⏸️ Alarm heute pausieren",
  ...
  "Gọi điện": "Anrufen",
  "Báo động thiết bị": "Geräte-Alarm",
  ...
  "Thiết lập nhanh báo động": "Schnelle Alarm-Einrichtung",
  ...
  "Tamper bình thường": "Keine Manipulation erkannt",
  ...
  "Tạm tắt báo động hôm nay": "Alarm heute pausieren",
  ...
  "Thao tác này sẽ thêm nhắc nhở cho các nhà đã chọn.\n\n":
      "Dadurch wird den ausgewählten Zuhause ein Zuhause-Erinnerung hinzugefügt.\n\n",
  "Xác nhận thay đổi báo động": "Alarm-Änderungen bestätigen",
  "Xác nhận thay đổi nhắc nhở": "Erinnerung-Änderungen bestätigen",
  "Lặp lại khi sự cố vẫn còn": "Wiederholen, solange das Problem besteht",
  "Thời gian lặp lại báo động": "Alarm-Wiederholungszeit",
  ...
  "Tắt toàn bộ báo động?": "Alle Alarm ausschalten?",
  ...
  "Đã bật Chế độ Bảo vệ thủ công": "Manueller Schutzmodus aktiviert",
  ...
  "Chọn giờ kết thúc báo động": "Alarm-Endzeit wählen",
  "Chọn giờ bắt đầu báo động": "Alarm-Startzeit wählen",
  ...
  "Không thể lưu chế độ báo động":
      "Alarm-Modus konnte nicht gespeichert werden",
  "Thêm nhắc nhở": "Erinnerung hinzufügen",
  "Nhắc nhở sẽ nhắc bạn kiểm tra trạng thái an toàn của ngôi nhà vào giờ đã chọn.":
      "Erinnerung erinnert dich zur gewählten Zeit daran, den Sicherheitsstatus deines Zuhauses zu prüfen.",
  "Thêm khung giờ báo động": "Alarm-Zeitfenster hinzufügen",
  "Đang sử dụng nhắc nhở riêng của bạn":
      "Deine eigenen Erinnerung-Einstellungen werden verwendet",
  "Đang sử dụng nhắc nhở của chủ nhà":
      "Erinnerung-Einstellungen des Besitzers werden verwendet",
  "Sửa giờ nhắc nhở": "Erinnerung-Zeit bearbeiten",
  "Sửa giờ kết thúc báo động": "Alarm-Endzeit bearbeiten",
  "Sửa giờ bắt đầu báo động": "Alarm-Startzeit bearbeiten",
  "Xoá nhắc nhở": "Erinnerung löschen",
  ...
  "MaiYen tự bật Bảo vệ vì bạn đã rời khỏi nhà.":
      "MaiYen hat den Schutzmodus automatisch aktiviert, weil du gegangen bist.",
  ...
  "Sau vài lần sử dụng, MaiYen sẽ đánh giá thói quen kiểm tra ứng dụng tốt hơn.":
      "Nach einigen Sitzungen kann MaiYen deine Gewohnheit zur App-Prüfung besser bewerten.",
  "Tần suất vào ứng dụng ổn": "App-Prüfhäufigkeit sieht gut aus",
  "Đã lâu chưa vào ứng dụng kiểm tra": "Letzte App-Prüfung ist lange her",
  "Đang ghi nhận tần suất vào ứng dụng": "App-Prüfhäufigkeit wird erfasst",
  ...
  "Chưa cài lịch báo động": "Alarm-Zeitplan nicht eingerichtet",
  "Đã cài lịch báo động": "Alarm-Zeitplan eingerichtet",
  "Nên có ít nhất một nhắc nhở để không quên kiểm tra nhà.":
      "Lege mindestens einen Erinnerung fest, damit du die Prüfung deines Zuhauses nicht vergisst.",
  ...
  "Chưa cài đặt nhắc nhở": "Erinnerung nicht eingerichtet",
  "Đã cài đặt nhắc nhở": "Erinnerung eingerichtet",
  ...
  "Điện thoại ít có khả năng trì hoãn cảnh báo MaiYen.":
      "Dieses Telefon wird MaiYen-Warnungen wahrscheinlich nicht verzögern.",
  "Chưa tắt tối ưu pin": "Akkuoptimierung ist noch aktiv",
  "Tối ưu pin không chặn ứng dụng": "Akkuoptimierung blockiert die App nicht",
  ...
  "Điện thoại có thể nhận thông báo MaiYen.":
      "Das Telefon kann MaiYen-Benachrichtigungen empfangen.",
  ...
  "Cách bạn đang dùng ứng dụng": "Deine App-Nutzung",
  ...
  "MaiYen cần quyền vị trí \"Luôn cho phép\" để nhận biết khi bạn rời hoặc trở về nhà, kể cả khi ứng dụng đang chạy nền.":
      "MaiYen benötigt die Standortberechtigung \"Immer erlauben\", um zu erkennen, wenn du dein Zuhause verlässt oder zurückkehrst, auch wenn die App im Hintergrund läuft.",
  ...
  "Thao tác này sẽ thêm nhắc nhở cho các nhà đã chọn.\n\nNhững thành viên đang sử dụng nhắc nhở 'Theo nhà' sẽ bị ảnh hưởng.\nNhắc nhở cá nhân ở chế độ 'Riêng tôi' sẽ không bị thay đổi.":
      "Dadurch wird den ausgewählten Zuhause ein Zuhause-Erinnerung hinzugefügt.\n\nMitglieder, die Erinnerung-Einstellungen \"Nach Zuhause\" verwenden, sind betroffen.\nPersönliche Erinnerung-Einstellungen im Modus \"Nur ich\" werden nicht geändert.",
  ...
  "Một người dùng MaiYen": "MaiYen-Nutzer",
  ...
  "ĐÓNG NHẮC NHỞ": "Erinnerung SCHLIESSEN",
  "MaiYen Security Alert": "MaiYen-Sicherheitswarnung",
  ...
  "Đang mở trong giờ báo động": "Offen während der Alarm-Zeit",
  ...
  "Khóa đang mở trong giờ báo động": "Entriegelt während der Alarm-Zeit",
  ...
  "Chế độ Bảo vệ thủ công đã bật": "Manueller Schutzmodus aktiviert",
  ...
  "MaiYen đang cập nhật vị trí": "MaiYen aktualisiert den Standort",
  ...
  "Không thể xác nhận với MaiYen. Hãy kiểm tra kết nối và thử lại.":
      "Bestätigung bei MaiYen nicht möglich. Prüfe deine Verbindung und versuche es erneut.",
  ...
  "🚨 MaiYen phát hiện cảnh báo": "🚨 MaiYen hat einen Alarm erkannt",
  "Mở MaiYen để kiểm tra ngay.": "Öffne MaiYen, um sofort zu prüfen.",
  ...
  "MaiYen đang xoá thiết bị \"\$deviceName\" khỏi nhà \"\$homeName\".":
      "MaiYen entfernt \"\$deviceName\" aus \"\$homeName\".",
  ...
  "Nếu chưa có ai xác nhận, MaiYen sẽ chuyển sang gọi điện khẩn cấp.":
      "Wenn niemand bestätigt, wechselt MaiYen zu einem Notruf.",
  ...
  "Hãy thêm thiết bị MaiYen đầu tiên để bắt đầu theo dõi nhà.":
      "Füge dein erstes MaiYen-Gerät hinzu, um dieses Zuhause zu überwachen.",
  ...
  "Bạn chưa đặt nhắc nhở, nên tạo lịch nhắc kiểm tra nhà định kỳ.":
      "Erinnerung ist nicht eingerichtet. Erstelle einen Zeitplan, um dein Zuhause regelmäßig zu prüfen.",
  ...
  "Cảm biến khẩn cấp luôn kích hoạt ngay lập tức.":
      "Notfallsensoren lösen immer sofort aus.",
  "Ngay lập tức": "Sofort",
  "giây": "Sekunden",
  "Đã lưu cấu hình báo động": "Alarmeinstellungen gespeichert",
  "Không thể lưu cấu hình báo động":
      "Alarmeinstellungen konnten nicht gespeichert werden",
  "Chỉ chủ nhà và quản trị viên có thể thay đổi cài đặt này.":
      "Nur der Hauseigentümer und Administratoren können diese Einstellung ändern.",
  "Thông tin chi tiết": "Gerätedetails",
  "Thông báo báo động": "Alarmbenachrichtigung",
  "Cài đặt nhắc nhở": "Erinnerungseinstellungen",
  "Nhắc nhở theo lịch": "Geplante Erinnerung",
  "Danh sách thông báo": "Benachrichtigungen",
  "Cài đặt thông báo": "Benachrichtigungseinstellungen",
  "Sử dụng báo động theo lịch đã thiết lập":
      "Eingerichteten Alarmzeitplan verwenden",
  "Chỉ gửi thông báo, không kích hoạt báo động":
      "Nur Benachrichtigungen senden, keinen Alarm auslösen",
  "Toàn bộ báo động của nhà đang tắt; hệ thống chỉ gửi thông báo.":
      "Alle Alarme des Zuhauses sind ausgeschaltet; das System sendet nur Benachrichtigungen.",
  "Chỉ Chủ nhà có thể bật chế độ này.":
      "Nur der Besitzer kann diesen Modus aktivieren.",
  "Bật Không bảo vệ?": "Ungeschützten Modus aktivieren?",
  "Cảm biến vừa phát hiện một sự kiện.":
      "Ein Sensor hat gerade ein Ereignis erkannt.",
  "Chỉ Chủ nhà mới có quyền bật chế độ Không bảo vệ":
      "Nur der Besitzer kann den ungeschützten Modus aktivieren",
  "Đã chuyển nhà sang Không bảo vệ":
      "Zuhause wurde in den ungeschützten Modus versetzt",
  "Đã chuyển sang Không bảo vệ nhưng chưa gửi được thông báo":
      "In den ungeschützten Modus gewechselt, aber die Benachrichtigung konnte nicht gesendet werden",
  "Giám sát toàn diện": "Vollständige Überwachung",
  "Không bảo vệ": "Ungeschützt",
  "Không bảo vệ đang bật": "Ungeschützter Modus ist aktiv",
  "Nhà đã chuyển sang Không bảo vệ":
      "Zuhause wurde in den ungeschützten Modus versetzt",
  "Thông báo cảm biến": "Sensorbenachrichtigungen",
  "Thông báo thông thường khi cảm biến phát hiện sự kiện.":
      "Normale Benachrichtigungen, wenn ein Sensor ein Ereignis erkennt.",
  "Tôi hiểu, tiếp tục": "Verstanden, fortfahren",
  "Cảnh báo an ninh đã kết thúc": "Sicherheitswarnung beendet",
  "Sự cố nguy hiểm đã kết thúc": "Notfall beendet",
  "Cảnh báo đã được kết thúc.": "Die Warnung wurde beendet.",
  "Vẫn còn cảnh báo khác đang hoạt động.":
      "Eine weitere Warnung ist noch aktiv.",
  "Báo động đã hoạt động trở lại": "Alarm ist wieder aktiv",
  "Thời gian tạm dừng báo động đã kết thúc.": "Die Alarmpause ist beendet.",
  "MQTT đã kết nối trở lại": "MQTT wieder verbunden",
  "Còi báo động đã được tắt": "Physische Sirene wurde ausgeschaltet",
  "Sự cố vẫn đang được theo dõi.": "Der Vorfall wird weiterhin überwacht.",
  "Bảo vệ tự động đã bật": "Automatischer Schutz aktiviert",
  "Toàn bộ thành viên đã rời khỏi nhà.":
      "Alle Mitglieder haben das Haus verlassen.",
  "Bảo vệ tự động đã tắt": "Automatischer Schutz deaktiviert",
  "Có thành viên đã trở về nhà.": "Ein Mitglied ist nach Hause zurückgekehrt.",
  "Thiết bị đã được xoá": "Gerät wurde entfernt",
  "Không thể xoá thiết bị": "Gerät konnte nicht entfernt werden",
  "Hãy thử lại thao tác xoá thiết bị.":
      "Bitte versuchen Sie erneut, das Gerät zu entfernen.",
  "Chế độ Bảo vệ đã được tắt.": "Der Schutzmodus wurde ausgeschaltet.",
  "Nhà đang ở chế độ Bình thường.": "Das Haus befindet sich im Normalmodus.",
  "Pin thiết bị đã ổn định": "Gerätebatterie ist wieder stabil",
  "Hub đã kết nối trở lại": "Hub wieder verbunden",
  "Đã chuyển về Bình thường nhưng chưa gửi được thông báo":
      "Auf Normal umgestellt, aber die Benachrichtigung konnte nicht gesendet werden",
  "Chung cho nhà": "Für das ganze Zuhause",
  "Áp dụng cho toàn bộ thành viên và có thể bật còi vật lý.":
      "Gilt für alle Mitglieder und kann die physische Sirene aktivieren.",
  "Cá nhân": "Persönlich",
  "Lịch cá nhân hoạt động độc lập và không bật còi vật lý.":
      "Der persönliche Zeitplan arbeitet unabhängig und aktiviert niemals die physische Sirene.",
  "Cài đặt này chỉ áp dụng cho tài khoản của bạn.":
      "Diese Einstellung gilt nur für dein Konto.",
  "Chỉ chủ nhà và quản trị viên có thể thay đổi phần chung cho nhà.":
      "Nur Eigentümer und Administratoren können gemeinsame Einstellungen ändern.",
  "Tham gia hệ thống báo động": "Am Alarmsystem teilnehmen",
  "Cảm biến khẩn cấp luôn tham gia hệ thống báo động.":
      "Notfallsensoren nehmen immer am Alarmsystem teil.",
  "Tắt để thiết bị không tạo bất kỳ báo động nào.":
      "Ausschalten, damit das Gerät keinen Alarm auslöst.",
  "Lịch báo động chung": "Gemeinsamer Alarmzeitplan",
  "Lịch báo động cá nhân": "Persönlicher Alarmzeitplan",
  "Hiển thị cảnh báo toàn màn hình trên điện thoại của bạn.":
      "Vollbildalarm auf deinem Telefon anzeigen.",
  "Lặp lại cảnh báo": "Alarm wiederholen",
  "Báo động chung": "Gemeinsamer Alarm",
  "Báo động cá nhân": "Persönlicher Alarm",
  "Đã cài đặt": "Eingerichtet",
  "Chưa cài đặt": "Nicht eingerichtet",
  "Lịch chung và lịch cá nhân hoạt động song song, không còn phải chọn một trong hai.":
      "Gemeinsamer und persönlicher Zeitplan laufen parallel; eine Auswahl ist nicht mehr nötig.",
  "Cài nhanh chung": "Gemeinsam schnell einrichten",
  "Cài nhanh cá nhân": "Persönlich schnell einrichten",
  "Thiết lập nhanh lịch cá nhân": "Persönlichen Zeitplan schnell einrichten",
  "Thiết lập nhanh lịch chung": "Gemeinsamen Zeitplan schnell einrichten",
  "Lịch này chỉ áp dụng cho bạn và không bật còi vật lý.":
      "Dieser Zeitplan gilt nur für dich und aktiviert keine physische Sirene.",
  "Lịch này áp dụng cho toàn bộ thành viên trong nhà.":
      "Dieser Zeitplan gilt für alle Mitglieder des Zuhauses.",
  "Đã áp dụng lịch báo động": "Alarmzeitplan angewendet",
  "Không thể lưu lịch báo động":
      "Alarmzeitplan konnte nicht gespeichert werden",
  "Nhà chưa có thiết bị an ninh": "Dieses Zuhause hat keine Sicherheitsgeräte",
  "Nhận cảnh báo theo lịch chung của nhà":
      "Warnungen aus dem gemeinsamen Hauszeitplan erhalten",
  "Tắt để không nhận thông báo hoặc cảnh báo toàn màn hình từ lịch chung. Còi vật lý của nhà vẫn hoạt động.":
      "Deaktivieren, um keine Benachrichtigungen oder Vollbildwarnungen aus dem gemeinsamen Zeitplan zu erhalten. Die Haussirene bleibt aktiv.",
};

const Map<String, String> deStrings = {
  ...
  "Đặt nhắc nhở / báo động nhà đã chọn": "Erinnerung / Alarm für ausgewählte Zuhause festlegen",
  ...
  "Đưa mã QR chia sẻ nhà vào khung hình": "Platziere den geteilten Zuhause-QR-Code im Rahmen",
  "Mã QR này do chủ nhà chia sẻ": "Dieser QR-Code wurde vom Hauseigentümer geteilt",
  ...
  "Mỗi thành viên sẽ cần cấp quyền vị trí Luôn cho phép để trạng thái rời/đến nhà hoạt động khi ứng dụng chạy nền.": "Jedes Mitglied muss die Standortberechtigung \"Immer erlauben\" erteilen, damit der Abwesend/Zuhause-Status im Hintergrund funktioniert.",
  ...
  "Không xoá được lịch tạm tắt báo động": "Alarm-Pausenzeitplan konnte nicht gelöscht werden",
  "Không lưu được tạm tắt báo động": "Alarm-Pause konnte nicht gespeichert werden",
  ...
  "Chỉ Chủ nhà hoặc Quản trị viên mới có quyền thay đổi Chế độ Bảo vệ": "Nur der Besitzer oder ein Administrator kann den Schutzmodus ändern",
  ...
  "30 phút": "30 Minuten",
  "15 phút": "15 Minuten",
  "Bạn đang xem lịch của chủ nhà. Chọn Riêng tôi để tự đặt lịch báo động.": "Du siehst den Zeitplan des Besitzers. Wähle \"Nur ich\", um deinen eigenen Alarm-Zeitplan festzulegen.",
  "Chọn giờ kết thúc báo động": "Alarm-Endzeit wählen",
  "Chọn giờ bắt đầu báo động": "Alarm-Startzeit wählen",
  "Bạn không có quyền sửa lịch báo động của nhà": "Du hast keine Berechtigung, den Alarm-Zeitplan dieses Zuhauses zu bearbeiten",
  "Không thể áp dụng báo động cho toàn bộ thiết bị": "Alarm konnte nicht auf alle Geräte angewendet werden",
  ...
  "Không thể lưu chế độ báo động": "Alarm-Modus konnte nicht gespeichert werden",
  "Thêm nhắc nhở": "Erinnerung hinzufügen",
  "Nhắc nhở sẽ nhắc bạn kiểm tra trạng thái an toàn của ngôi nhà vào giờ đã chọn.": "Erinnerung erinnert dich zur gewählten Zeit daran, den Sicherheitsstatus deines Zuhauses zu prüfen.",
  "Thêm khung giờ báo động": "Alarm-Zeitfenster hinzufügen",
  "Đang sử dụng nhắc nhở riêng của bạn": "Deine eigenen Erinnerung-Einstellungen werden verwendet",
  "Đang sử dụng nhắc nhở của chủ nhà": "Erinnerung-Einstellungen des Besitzers werden verwendet",
  ...
  "Bạn đã mở ứng dụng gần đây để kiểm tra trạng thái.": "Du hast die App kürzlich geöffnet, um den Status zu prüfen.",
  "Bạn nên mở ứng dụng định kỳ để kiểm tra quyền, lịch và cảnh báo chưa đọc.": "Öffne die App regelmäßig, um Berechtigungen, Zeitpläne und ungelesene Warnungen zu prüfen.",
  "Sau vài lần sử dụng, SafeHome sẽ đánh giá thói quen kiểm tra ứng dụng tốt hơn.": "Nach einigen Sitzungen kann SafeHome deine Gewohnheit zur App-Prüfung besser bewerten.",
  ...
  "Nên đặt lịch báo động cho thời gian ngủ hoặc vắng nhà.": "Lege Alarm für Schlafenszeiten oder Abwesenheit fest.",
  "Nhà đã có lịch báo động hoặc lịch cảnh báo theo thiết bị.": "Dieses Zuhause hat einen Alarm-Zeitplan oder einen gerätespezifischen Warnzeitplan.",
  "Chưa cài lịch báo động": "Alarm-Zeitplan nicht eingerichtet",
  "Đã cài lịch báo động": "Alarm-Zeitplan eingerichtet",
  "Nên có ít nhất một nhắc nhở để không quên kiểm tra nhà.": "Lege mindestens einen Erinnerung fest, damit du die Prüfung deines Zuhauses nicht vergisst.",
  "Ứng dụng sẽ nhắc bạn kiểm tra nhà theo lịch đã đặt.": "Die App erinnert dich nach dem festgelegten Zeitplan daran, dein Zuhause zu prüfen.",
  "Chưa cài đặt nhắc nhở": "Erinnerung nicht eingerichtet",
  "Đã cài đặt nhắc nhở": "Erinnerung eingerichtet",
  "Hãy mở lại ứng dụng hoặc đăng nhập lại nếu thiết bị không nhận cảnh báo.": "Öffne die App erneut oder melde dich erneut an, wenn dieses Gerät keine Warnungen empfängt.",
  ...
  "iOS không mở toàn màn hình như Android; ứng dụng dùng thông báo và âm thanh hệ thống.": "iOS öffnet keine Vollbildwarnung wie Android. Die App verwendet Systembenachrichtigungen und Ton.",
  ...
  "Kiểm tra điện thoại và cách bạn đang dùng ứng dụng.": "Prüfe dein Telefon und deine App-Nutzung.",
  ...
  "Không thể thay đổi trạng thái báo động": "Alarm-Status konnte nicht geändert werden",
  "Đã tắt toàn bộ báo động của nhà": "Alle Alarme dieses Zuhauses wurden ausgeschaltet",
  ...
  "\$actorName đã bật Chế độ Bảo vệ thủ công cho \"\$homeName\". Chế độ này chỉ tắt khi một thành viên có quyền chủ động chuyển về Bình thường. \$repeatMessage": "\$actorName hat den manuellen Schutzmodus für \"\$homeName\" aktiviert. Dieser Modus wird nur deaktiviert, wenn ein berechtigtes Mitglied in den Normalmodus zurückwechselt. \$repeatMessage",
  "Bạn đã bật báo động cho nhà \"\$homeName\".": "Du hast Alarm für \"\$homeName\" aktiviert.",
  "Bạn đã tắt toàn bộ báo động của nhà \"\$homeName\".": "Du hast alle Alarme für \"\$homeName\" deaktiviert.",
  ...
  "Chế độ Bảo vệ sẽ chỉ báo động một lần": "Der Schutzmodus alarmiert nur einmal",
  "Chế độ Bảo vệ sẽ lặp báo động sau \$minutes phút": "Der Schutzmodus wiederholt den Alarm nach \$minutes Minuten",
  ...
  "Khoảng thời gian phải nằm trong khung báo động (\$start → \$end)": "Der Pausenzeitraum muss im Alarm-Zeitplan liegen (\$start → \$end)",
  ...
  "Sẽ báo lại theo lịch báo động đã cài nếu vấn đề chưa được xử lý.": "Alarmiert erneut nach dem eingerichteten Alarm-Zeitplan, wenn das Problem nicht behoben wurde.",
  ...
  "Đã cài nhắc nhở cho \$updatedHomes nhà.": "Erinnerung wurde für \$updatedHomes Zuhause eingerichtet.",
  ...
  "Đã áp dụng báo động cho \$count thiết bị an ninh": "Alarm auf \$count Sicherheitsgeräte angewendet",
  ...
  "Có thành viên chưa xác định vị trí, hãy nhắc họ mở ứng dụng hoặc kiểm tra quyền vị trí.": "Bei einigen Mitgliedern ist der Standort unbekannt. Bitte sie, die App zu öffnen oder die Standortberechtigung zu prüfen.",
  ...
  "Bạn chưa đặt nhắc nhở, nên tạo lịch nhắc kiểm tra nhà định kỳ.": "Erinnerung ist nicht eingerichtet. Erstelle einen Zeitplan, um dein Zuhause regelmäßig zu prüfen.",
  "Bạn chưa đặt lịch báo động, nên bật bảo vệ theo khung giờ thường vắng nhà.": "Der Alarm-Zeitplan ist nicht eingerichtet. Aktiviere den Schutz für Zeiten, in denen du normalerweise abwesend bist.",
  ...
  "Khoảng tạm tắt không trùng với lịch báo động nào đang bật": "Der Pausenzeitraum überschneidet sich mit keinem aktiven Alarm-Zeitplan",
  ...
  "Tắt để cảm biến không tạo báo động.": "Deaktivieren, damit dieser Sensor keinen Alarm auslöst.",
  ...
  "Sử dụng báo động theo lịch đã thiết lập": "Eingerichteten Alarmzeitplan verwenden",
  "Chỉ gửi thông báo, không kích hoạt báo động": "Nur Benachrichtigungen senden, keinen Alarm auslösen",
  "Toàn bộ báo động của nhà đang tắt; hệ thống chỉ gửi thông báo.": "Alle Alarme des Zuhauses sind ausgeschaltet; das System sendet nur Benachrichtigungen.",
  "Chỉ Chủ nhà có thể bật chế độ này.": "Nur der Besitzer kann diesen Modus aktivieren.",
  "Bật Không bảo vệ?": "Ungeschützten Modus aktivieren?",
  "Cảm biến vừa phát hiện một sự kiện.": "Ein Sensor hat gerade ein Ereignis erkannt.",
  "Chỉ Chủ nhà mới có quyền bật chế độ Không bảo vệ": "Nur der Besitzer kann den ungeschützten Modus aktivieren",
  "Đã chuyển nhà sang Không bảo vệ": "Zuhause wurde in den ungeschützten Modus versetzt",
  "Đã chuyển sang Không bảo vệ nhưng chưa gửi được thông báo": "In den ungeschützten Modus gewechselt, aber die Benachrichtigung konnte nicht gesendet werden",
  "Giám sát toàn diện": "Vollständige Überwachung",
  "Không bảo vệ": "Ungeschützt",
  "Không bảo vệ đang bật": "Ungeschützter Modus ist aktiv",
  "Nhà đã chuyển sang Không bảo vệ": "Zuhause wurde in den ungeschützten Modus versetzt",
  "Thông báo cảm biến": "Sensorbenachrichtigungen",
  "Thông báo thông thường khi cảm biến phát hiện sự kiện.": "Normale Benachrichtigungen, wenn ein Sensor ein Ereignis erkennt.",

const Map<String, String> bsStrings = {
  ...
  "Tự động Bảo vệ khi rời nhà vẫn đang bật. Nếu mọi thành viên vẫn ở ngoài, hệ thống có thể tự bật lại Bảo vệ sau vài phút.": "Automatska zaštita pri odlasku i dalje je uključena. Ako su svi članovi još uvijek izvan doma, sistem može ponovno uključiti Zaštitu nakon nekoliko minuta.",
  ...
  "Không thể xác nhận tài khoản hiện tại": "Nije moguće potvrditi trenutni račun",
  ...
  "Chỉ Chủ nhà hoặc Quản trị viên mới có quyền thay đổi Chế độ Bảo vệ": "Samo Vlasnik ili Administrator može promijeniti režim zaštite",
  "Không thể thay đổi chế độ nhà": "Nije moguće promijeniti način doma",
  "Đã bật Bảo vệ nhưng chưa gửi được thông báo": "Režim zaštite je uključen, ali obavijest nije moguće poslati",
  ...
  "Bạn không có quyền sửa lịch Theo nhà. Hãy chọn Riêng tôi.": "Nemate dozvolu za uređivanje postavki Doma. Odaberite Samo za mene.",
  ...
  "Bạn nên mở ứng dụng định kỳ để kiểm tra quyền, lịch và cảnh báo chưa đọc.": "Redovito otvarajte aplikaciju kako biste provjerili dozvole, rasporede i nepročitana upozorenja.",
  ...
  "Cần kiểm tra quyền vị trí luôn luôn và điều kiện chạy nền.": "Provjerite dozvola lokacije „Uvijek” i uvjete rada u pozadini.",
  ...
  "Hãy kiểm tra quyền chạy nền và tự khởi động để cảnh báo không bị trễ.": "Provjerite dozvola rada u pozadini i automatsko pokretanje kako upozorenja ne bi kasnila.",
  ...
  "Auto rời khỏi nhà cần quyền vị trí luôn luôn để chạy ổn định.": "Automatski odlazak treba dozvolu za lokaciju „Uvijek” za pouzdan rad.",
  ...
  "iOS không mở toàn màn hình như Android; ứng dụng dùng thông báo và âm thanh hệ thống.": "iOS ne otvara upozorenja preko cijelog ekrana kao Android; aplikacija koristi sistemske obavijesti i zvuk.",
  "Android dùng cảnh báo toàn màn hình; nếu máy chặn, hãy cấp quyền trong cài đặt.": "Android koristi upozorenja preko cijelog ekrana; ako ih telefon blokira, dopustite ih u postavkama.",
  ...
  "Để sau": "Kasnije",
  "SafeHome cần quyền vị trí \"Luôn cho phép\" để nhận biết khi bạn rời hoặc trở về nhà, kể cả khi ứng dụng đang chạy nền.": "SafeHome treba dozvolu za lokaciju „Uvijek dopusti” kako bi prepoznao kada odlazite ili se vraćate kući, čak i dok aplikacija radi u pozadini.",
  ...
  "Hãy chọn quyền vị trí Luôn cho phép trong Cài đặt ứng dụng": "Odaberite dozvola lokacije „Uvijek dopusti” u postavkama aplikacije",
  ...
  "\$actorName đã bật Chế độ Bảo vệ thủ công cho \"\$homeName\". Chế độ này chỉ tắt khi một thành viên có quyền chủ động chuyển về Bình thường. \$repeatMessage": "\$actorName je uključio ručni režim zaštite za „\$homeName”. Ovaj se način može isključiti samo kada ga ovlašteni član ručno vrati na Normalno. \$repeatMessage",
  ...
  "Kiểm tra cửa hoặc khóa đang mở trước khi giữ nhà ở chế độ Bảo vệ.": "Provjerite otvorena vrata ili bravu prije nego što dom ostavite u režimu zaštite.",
  ...
  "Hệ thống: Cần kiểm tra \$issueCount mục": "Sistem: \$issueCount stavki treba provjeru",
  ...
  "Hiển thị cảnh báo toàn màn hình trên điện thoại.": "Prikazuje upozorenje preko cijelog ekrana telefona.",
  ...
  "Toàn bộ báo động của nhà đang tắt; hệ thống chỉ gửi thông báo.": "Svi Alarmi doma su isključeni; sistem će slati samo obavijesti.",
  ...
  "Hiển thị cảnh báo toàn màn hình trên điện thoại của bạn.": "Prikazuje upozorenje preko cijelog ekrana vašeg telefona.",
  ...
  "Tắt để không nhận thông báo hoặc cảnh báo toàn màn hình từ lịch chung. Còi vật lý của nhà vẫn hoạt động.": "Isključite kako više ne biste primali obavijesti ili upozorenja preko cijelog ekrana iz zajedničkog rasporeda. Sirena doma i dalje će raditi.",
};

const Map<String, String> trDynamicStrings = {
  "Bảo vệ - Tự động": "Koruma - Otomatik",
  "Bảo vệ - Thủ công": "Koruma - Manuel",
  "Tự động": "Otomatik",
  "Thủ công": "Manuel",
  "\$displayMemberName đã gia nhập nhà \"\$homeName\".":
      "\$displayMemberName, \"\$homeName\" evine katıldı.",
  "NGUY HIỂM": "TEHLİKE",
  "Nguy hiểm & Khẩn cấp": "Tehlike ve Acil Durum",
  "TẮT CÒI": "SİRENİ DURDUR",
  "Tắt còi báo động?": "Alarm sireni durdurulsun mu?",
  "Còi vật lý sẽ dừng, nhưng cảnh báo vẫn tiếp tục cho đến khi sự cố được xử lý.\n\nBạn chắc chắn muốn tắt còi?":
      "Fiziksel siren duracak, ancak olay ele alınana kadar uyarı etkin kalacak.\n\nSireni durdurmak istediğinizden emin misiniz?",
  "Đã gửi lệnh tắt còi. Cảnh báo vẫn đang được theo dõi.":
      "Sireni durdurma komutu gönderildi. Uyarı hâlâ izleniyor.",
  "Không tìm thấy cảnh báo đang hoạt động hoặc chưa thể gửi lệnh tắt còi.":
      "Etkin uyarı bulunamadı veya sireni durdurma komutu gönderilemedi.",
  "TẮT CÒI TRONG NHÀ": "EV SİRENİNİ SESSİZE AL",
  "Đã tắt còi trong nhà. Cảnh báo vẫn tiếp tục cho đến khi được xử lý.":
      "Ev sireni sessize alındı. Uyarı ele alınana kadar etkin kalır.",
  "\$name đang chuẩn bị gửi tin...": "\$name yazıyor...",
  "\$name1 và \$name2 đang chuẩn bị gửi tin...":
      "\$name1 ve \$name2 yazıyor...",
  ...
  "Phát hiện chập điện": "Kısa devre algılandı",
  "Phát hiện quá dòng": "Aşırı akım algılandı",
  "Phát hiện quá áp": "Aşırı gerilim algılandı",
  "Thiết bị điện quá nhiệt": "Elektrikli cihaz aşırı ısınıyor",
  "Tài khoản đang được sử dụng": "Hesap kullanımda",
  "Hiện tại tài khoản này đang đăng nhập trên một thiết bị khác. Nếu tiếp tục, tài khoản trên thiết bị đó sẽ tự đăng xuất.":
      "Bu hesap şu anda başka bir cihazda açık. Devam ederseniz o cihazdaki hesaptan otomatik olarak çıkış yapılır.",
  "Tiếp tục đăng nhập": "Oturum açmaya devam et",
  "Tài khoản đã được đăng nhập trên một thiết bị khác.":
      "Bu hesap başka bir cihazda açıldı.",
  "KHẨN CẤP": "ACİL DURUM",
  "CẦN CHÚ Ý": "UYARI",
  "THÔNG TIN": "BİLGİ",
  "BÁO ĐỘNG": "ALARM",
  "Cảm biến đã trở lại trạng thái an toàn.": "Sensör güvenli duruma döndü.",
  "Người dùng đã tắt cảnh báo.": "Uyarı bir kullanıcı tarafından durduruldu.",
  "Khung giờ bảo vệ đã kết thúc.": "Koruma programı sona erdi.",
  "Cảnh báo tức thời đã tự kết thúc.":
      "Geçici uyarı otomatik olarak sona erdi.",
  "Điều kiện cảnh báo không còn hoạt động.": "Uyarı koşulu artık etkin değil.",
  "Cảnh báo đã kết thúc: \$reason": "Uyarı sona erdi: \$reason",
};

const Map<String, String> fiDynamicStrings = {
  "Bảo vệ - Tự động": "Suojaus – Automaattinen",
  "Bảo vệ - Thủ công": "Suojaus – Manuaalinen",
  "Tự động": "Automaattinen",
  "Thủ công": "Manuaalinen",
  "\$displayMemberName đã gia nhập nhà \"\$homeName\".":
      "\$displayMemberName liittyi kotiin \"\$homeName\".",
  "NGUY HIỂM": "VAARA",
  "Nguy hiểm & Khẩn cấp": "Vaara ja hätätilanne",
  "TẮT CÒI": "PYSÄYTÄ SIREENI",
  "Tắt còi báo động?": "Pysäytetäänkö hälytyssireeni?",
  "Còi vật lý sẽ dừng, nhưng cảnh báo vẫn tiếp tục cho đến khi sự cố được xử lý.\n\nBạn chắc chắn muốn tắt còi?":
      "Fyysinen sireeni pysähtyy, mutta hälytys jatkuu, kunnes tapahtuma on käsitelty.\n\nHaluatko varmasti pysäyttää sireenin?",
  "Đã gửi lệnh tắt còi. Cảnh báo vẫn đang được theo dõi.":
      "Sireenin pysäytyskomento lähetettiin. Hälytystä valvotaan edelleen.",
  "Không tìm thấy cảnh báo đang hoạt động hoặc chưa thể gửi lệnh tắt còi.":
      "Aktiivista hälytystä ei löytynyt tai sireenin pysäytyskomentoa ei voitu lähettää.",
  "TẮT CÒI TRONG NHÀ": "PYSÄYTÄ KODIN SIREENI",
  "Đã tắt còi trong nhà. Cảnh báo vẫn tiếp tục cho đến khi được xử lý.":
      "Kodin sireeni on pysäytetty. Hälytys jatkuu, kunnes se on käsitelty.",
  "\$name đang chuẩn bị gửi tin...": "\$name kirjoittaa...",
  "\$name1 và \$name2 đang chuẩn bị gửi tin...":
      "\$name1 ja \$name2 kirjoittavat...",
  ...
  "Đã kích hoạt SOS": "SOS aktivoitu",
  "Phát hiện chập điện": "Oikosulku havaittu",
  "Phát hiện quá dòng": "Ylivirta havaittu",
  "Phát hiện quá áp": "Ylijännite havaittu",
  "Thiết bị điện quá nhiệt": "Sähkölaite ylikuumenee",
  "Tài khoản đang được sử dụng": "Tili on käytössä",
  "Hiện tại tài khoản này đang đăng nhập trên một thiết bị khác. Nếu tiếp tục, tài khoản trên thiết bị đó sẽ tự đăng xuất.":
      "Tämä tili on tällä hetkellä kirjautuneena toisella laitteella. Jos jatkat, tili kirjataan automaattisesti ulos toiselta laitteelta.",
  "Tiếp tục đăng nhập": "Jatka kirjautumista",
  "Tài khoản đã được đăng nhập trên một thiết bị khác.":
      "Tilille kirjauduttiin toisella laitteella.",
  "KHẨN CẤP": "HÄTÄTILANNE",
  "CẦN CHÚ Ý": "VAATII HUOMIOTA",
  "THÔNG TIN": "TIEDOT",
  "BÁO ĐỘNG": "HÄLYTYS",
  "Cảm biến đã trở lại trạng thái an toàn.":
      "Anturi on palannut turvalliseen tilaan.",
  "Người dùng đã tắt cảnh báo.": "Käyttäjä pysäytti hälytyksen.",
  "Khung giờ bảo vệ đã kết thúc.": "Suojausaika on päättynyt.",
  "Cảnh báo tức thời đã tự kết thúc.":
      "Välitön hälytys päättyi automaattisesti.",
  "Điều kiện cảnh báo không còn hoạt động.":
      "Hälytysehto ei ole enää aktiivinen.",
  "Cảnh báo đã kết thúc: \$reason": "Hälytys päättyi: \$reason",
};

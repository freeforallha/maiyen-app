const Map<String, String> ptDynamicStrings = {
  "Bảo vệ - Tự động": "Proteção - Automática",
  "Bảo vệ - Thủ công": "Proteção - Manual",
  "Tự động": "Automático",
  "Thủ công": "Manual",
  "\$displayMemberName đã gia nhập nhà \"\$homeName\".":
      "\$displayMemberName entrou na casa \"\$homeName\".",
  "NGUY HIỂM": "PERIGO",
  "Nguy hiểm & Khẩn cấp": "Perigo e emergência",
  "TẮT CÒI": "DESLIGAR SIRENE",
  "Tắt còi báo động?": "Desligar a sirene do alarme?",
  "Còi vật lý sẽ dừng, nhưng cảnh báo vẫn tiếp tục cho đến khi sự cố được xử lý.\n\nBạn chắc chắn muốn tắt còi?":
      "A sirene física será desligada, mas o alerta continuará até que o incidente seja resolvido.\n\nTem certeza de que deseja desligar a sirene?",
  "Đã gửi lệnh tắt còi. Cảnh báo vẫn đang được theo dõi.":
      "O comando para desligar a sirene foi enviado. O alerta continua sendo monitorado.",
  "Không tìm thấy cảnh báo đang hoạt động hoặc chưa thể gửi lệnh tắt còi.":
      "Nenhum alerta ativo foi encontrado ou não foi possível enviar o comando para desligar a sirene.",
  "TẮT CÒI TRONG NHÀ": "DESLIGAR SIRENE DA CASA",
  "Đã tắt còi trong nhà. Cảnh báo vẫn tiếp tục cho đến khi được xử lý.":
      "A sirene da casa foi desligada. O alerta continuará até que seja resolvido.",
  "\$name đang chuẩn bị gửi tin...": "\$name está digitando...",
  "\$name1 và \$name2 đang chuẩn bị gửi tin...":
      "\$name1 e \$name2 estão digitando...",
  ...
  "FCM token đã sẵn sàng, nhưng tính năng tự động khi rời nhà còn thiếu điều kiện.":
      "O token FCM está pronto, mas a proteção automática ao sair de casa ainda precisa de uma condição.",
  "Đã kích hoạt SOS": "SOS ativado",
  "Phát hiện chập điện": "Curto-circuito detectado",
  "Phát hiện quá dòng": "Sobrecorrente detectada",
  "Phát hiện quá áp": "Sobretensão detectada",
  "Thiết bị điện quá nhiệt": "Dispositivo elétrico superaquecido",
  ...
  "KHẨN CẤP": "EMERGÊNCIA",
  "CẦN CHÚ Ý": "ATENÇÃO NECESSÁRIA",
  "THÔNG TIN": "INFORMAÇÃO",
  "BÁO ĐỘNG": "ALARME",
  "Cảm biến đã trở lại trạng thái an toàn.":
      "O sensor voltou a um estado seguro.",

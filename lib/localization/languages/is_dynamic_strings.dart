const Map<String, String> isDynamicStrings = {
  "Bảo vệ - Tự động": "Vernd – Sjálfvirk",
  "Bảo vệ - Thủ công": "Vernd – Handvirk",
  "Tự động": "Sjálfvirkt",
  "Thủ công": "Handvirkt",
  "\$displayMemberName đã gia nhập nhà \"\$homeName\".":
      "\$displayMemberName tengdist \"\$homeName\".",
  "NGUY HIỂM": "HÆTTA",
  "Nguy hiểm & Khẩn cấp": "Hætta og neyðartilvik",
  "TẮT CÒI": "STÖÐVA SÍRENU",
  "Tắt còi báo động?": "Stöðva viðvörunarsírenuna?",
  "Còi vật lý sẽ dừng, nhưng cảnh báo vẫn tiếp tục cho đến khi sự cố được xử lý.\n\nBạn chắc chắn muốn tắt còi?":
      "Líkamlega sírenan stöðvast en viðvörunin heldur áfram þar til atvikið hefur verið leyst.\n\nErtu viss um að þú viljir stöðva sírenuna?",
  "Đã gửi lệnh tắt còi. Cảnh báo vẫn đang được theo dõi.":
      "Skipunin um að stöðva sírenuna var send. Enn er fylgst með viðvöruninni.",
  "Không tìm thấy cảnh báo đang hoạt động hoặc chưa thể gửi lệnh tắt còi.":
      "Engin virk viðvörun fannst eða ekki tókst að senda skipunina um að stöðva sírenuna.",
  "TẮT CÒI TRONG NHÀ": "STÖÐVA SÍRENU HEIMILISINS",
  "Đã tắt còi trong nhà. Cảnh báo vẫn tiếp tục cho đến khi được xử lý.":
      "Sírena heimilisins hefur verið stöðvuð. Viðvörunin heldur áfram þar til úr henni hefur verið leyst.",
  "\$name đang chuẩn bị gửi tin...": "\$name skrifar...",
  "\$name1 và \$name2 đang chuẩn bị gửi tin...": "\$name1 og \$name2 skrifa...",
  ...
  "Đã kích hoạt SOS": "SOS virkjað",
  "Phát hiện chập điện": "Skammhlaup greint",
  "Phát hiện quá dòng": "Yfirstraumur greindur",
  "Phát hiện quá áp": "Yfirspenna greind",
  "Thiết bị điện quá nhiệt": "Raftæki ofhitnar",
  "Tài khoản đang được sử dụng": "Reikningurinn er í notkun",
  "Hiện tại tài khoản này đang đăng nhập trên một thiết bị khác. Nếu tiếp tục, tài khoản trên thiết bị đó sẽ tự đăng xuất.":
      "Þessi reikningur er nú skráður inn á öðru tæki. Ef þú heldur áfram verður reikningurinn sjálfkrafa skráður út á hinu tækinu.",
  "Tiếp tục đăng nhập": "Halda áfram innskráningu",
  "Tài khoản đã được đăng nhập trên một thiết bị khác.":
      "Reikningurinn var skráður inn á öðru tæki.",
  "KHẨN CẤP": "NEYÐARTILVIK",
  "CẦN CHÚ Ý": "KREFST ATHYGLI",
  "THÔNG TIN": "UPPLÝSINGAR",
  "BÁO ĐỘNG": "VIÐVÖRUN",
  "Cảm biến đã trở lại trạng thái an toàn.":
      "Skynjarinn er aftur kominn í öruggt ástand.",
  "Người dùng đã tắt cảnh báo.": "Notandi stöðvaði viðvörunina.",
  "Khung giờ bảo vệ đã kết thúc.": "Verndartímabilinu er lokið.",
  "Cảnh báo tức thời đã tự kết thúc.":
      "Augnabliksviðvöruninni lauk sjálfkrafa.",
  "Điều kiện cảnh báo không còn hoạt động.":
      "Viðvörunarskilyrðið er ekki lengur virkt.",
  "Cảnh báo đã kết thúc: \$reason": "Viðvöruninni er lokið: \$reason",
};

const Map<String, String> esStrings = {
  ...
  "Môi trường": "Entorno",
  "Toàn bộ thiết bị MaiYen": "Todos los dispositivos MaiYen",
  ...
  "Quét QR để xin gia nhập nhà": "Escanear QR para solicitar acceso a la casa",
  ...
  "Tamper bình thường": "No se detectó manipulación",
  ...
  "Lặp báo động khi sự cố vẫn còn": "Repetir la alarma si el problema continúa",
  ...
  "MaiYen tự bật Bảo vệ vì bạn đã rời khỏi nhà.":
      "MaiYen activó automáticamente el modo protección porque saliste de casa.",
  ...
  "Sau vài lần sử dụng, MaiYen sẽ đánh giá thói quen kiểm tra ứng dụng tốt hơn.":
      "Después de algunos usos, MaiYen evaluará mejor tus hábitos de revisión de la app.",
  ...
  "Điện thoại ít có khả năng trì hoãn cảnh báo MaiYen.":
      "Es menos probable que el teléfono retrase las alertas de MaiYen.",
  ...
  "Điện thoại có thể nhận thông báo MaiYen.":
      "El teléfono puede recibir notificaciones de MaiYen.",
  ...
  "MaiYen cần quyền vị trí \"Luôn cho phép\" để nhận biết khi bạn rời hoặc trở về nhà, kể cả khi ứng dụng đang chạy nền.":
      "MaiYen necesita el permiso de ubicación «Siempre permitido» para detectar cuándo sales o vuelves a casa, incluso cuando la app se ejecuta en segundo plano.",
  ...
  "Một người dùng MaiYen": "Un usuario de MaiYen",
  ...
  "MaiYen Security Alert": "Alerta de seguridad MaiYen",
  ...
  "Thêm, đổi tên và sắp xếp phòng": "Añadir, renombrar y ordenar habitaciones",
  ...
  "MaiYen đang cập nhật vị trí": "MaiYen está actualizando la ubicación",
  ...
  "Không thể xác nhận với MaiYen. Hãy kiểm tra kết nối và thử lại.":
      "No se pudo confirmar con MaiYen. Revisa la conexión e inténtalo de nuevo.",
  ...
  "🚨 MaiYen phát hiện cảnh báo": "🚨 MaiYen detectó una alerta",
  "Mở MaiYen để kiểm tra ngay.": "Abre MaiYen para revisar ahora.",
  ...
  "MaiYen đang xoá thiết bị \"\$deviceName\" khỏi nhà \"\$homeName\".":
      "MaiYen está eliminando el dispositivo «\$deviceName» de «\$homeName».",
  ...
  "Nếu chưa có ai xác nhận, MaiYen sẽ chuyển sang gọi điện khẩn cấp.":
      "Si nadie confirma, MaiYen pasará a una llamada de emergencia.",
  ...
  "🚨 \$count nhà không an toàn\$suffix": "🚨 \$count casas no seguras\$suffix",
  ...
  "\${hours}h\$minutes' trước": "hace \${hours} h \$minutes min",
  ...
  "Hãy thêm thiết bị MaiYen đầu tiên để bắt đầu theo dõi nhà.":
      "Añade tu primer dispositivo MaiYen para empezar a supervisar esta casa.",
  ...
  "Giám sát an ninh • \$repeatText": "Supervisión de seguridad • \$repeatText",
  "Gia đình: \$mode": "Casa: \$mode",
  "Gợi ý xử lý": "Acciones sugeridas",
  "Phát hiện \$count vấn đề cần xử lý": "\$count problemas requieren atención",
  ...
  "Cảnh báo an ninh đã kết thúc": "Alerta de seguridad finalizada",
  "Sự cố nguy hiểm đã kết thúc": "Situación de peligro finalizada",
  "Cảnh báo đã được kết thúc.": "La alerta ha finalizado.",
  "Vẫn còn cảnh báo khác đang hoạt động.": "Otra alerta sigue activa.",
  "Báo động đã hoạt động trở lại": "La alarma vuelve a estar activa",
  "Thời gian tạm dừng báo động đã kết thúc.":
      "El período de pausa de la alarma ha finalizado.",
  "MQTT đã kết nối trở lại": "MQTT se ha reconectado",
  "Còi báo động đã được tắt": "La sirena física se ha apagado",
  "Sự cố vẫn đang được theo dõi.": "El incidente sigue bajo supervisión.",
  "Bảo vệ tự động đã bật": "Protección automática activada",
  "Toàn bộ thành viên đã rời khỏi nhà.":
      "Todos los miembros han salido de casa.",
  "Bảo vệ tự động đã tắt": "Protección automática desactivada",
  "Có thành viên đã trở về nhà.": "Un miembro ha regresado a casa.",
  "Thiết bị đã được xoá": "Dispositivo eliminado",
  "Không thể xoá thiết bị": "No se pudo eliminar el dispositivo",
  "Hãy thử lại thao tác xoá thiết bị.":
      "Vuelve a intentar eliminar el dispositivo.",
  "Chế độ Bảo vệ đã được tắt.": "El modo Protección se ha desactivado.",
  "Nhà đang ở chế độ Bình thường.": "La casa está en modo Normal.",
  "Pin thiết bị đã ổn định": "La batería del dispositivo está estable",
  "Hub đã kết nối trở lại": "Hub reconectado",
  "Đã chuyển về Bình thường nhưng chưa gửi được thông báo":
      "Se cambió al modo Normal, pero no se pudo enviar la notificación",
  "Chung cho nhà": "Para toda la casa",
  "Áp dụng cho toàn bộ thành viên và có thể bật còi vật lý.":
      "Se aplica a todos los miembros y puede activar la sirena física.",
  "Cá nhân": "Personal",
  "Lịch cá nhân hoạt động độc lập và không bật còi vật lý.":
      "El horario personal funciona de forma independiente y nunca activa la sirena física.",
  "Cài đặt này chỉ áp dụng cho tài khoản của bạn.":
      "Este ajuste solo se aplica a tu cuenta.",
  "Chỉ chủ nhà và quản trị viên có thể thay đổi phần chung cho nhà.":
      "Solo el propietario y los administradores pueden cambiar los ajustes comunes.",
  "Tham gia hệ thống báo động": "Participar en el sistema de alarma",
  "Cảm biến khẩn cấp luôn tham gia hệ thống báo động.":
      "Los sensores de emergencia siempre participan en el sistema de alarma.",
  "Tắt để thiết bị không tạo bất kỳ báo động nào.":
      "Desactívalo para impedir que el dispositivo genere alarmas.",
  "Lịch báo động chung": "Horario de alarma común",
  "Lịch báo động cá nhân": "Horario de alarma personal",
  "Hiển thị cảnh báo toàn màn hình trên điện thoại của bạn.":
      "Mostrar una alerta a pantalla completa en tu teléfono.",
  "Lặp lại cảnh báo": "Repetir alerta",
  "Báo động chung": "Alarma común",
  "Báo động cá nhân": "Alarma personal",
  "Đã cài đặt": "Configurado",
  "Chưa cài đặt": "Sin configurar",
  "Lịch chung và lịch cá nhân hoạt động song song, không còn phải chọn một trong hai.":
      "Los horarios común y personal funcionan en paralelo; ya no es necesario elegir uno.",
  "Cài nhanh chung": "Configuración común rápida",
  "Cài nhanh cá nhân": "Configuración personal rápida",
  "Thiết lập nhanh lịch cá nhân": "Configuración rápida del horario personal",
  "Thiết lập nhanh lịch chung": "Configuración rápida del horario común",
  "Lịch này chỉ áp dụng cho bạn và không bật còi vật lý.":
      "Este horario solo se aplica a ti y no activa la sirena física.",
  "Lịch này áp dụng cho toàn bộ thành viên trong nhà.":
      "Este horario se aplica a todos los miembros de la casa.",
  "Đã áp dụng lịch báo động": "Horario de alarma aplicado",
  "Không thể lưu lịch báo động": "No se pudo guardar el horario de alarma",
  "Nhà chưa có thiết bị an ninh":
      "Esta casa no tiene dispositivos de seguridad",
  "Nhận cảnh báo theo lịch chung của nhà":
      "Recibir alertas del horario común de la casa",
  "Tắt để không nhận thông báo hoặc cảnh báo toàn màn hình từ lịch chung. Còi vật lý của nhà vẫn hoạt động.":
      "Desactívalo para no recibir notificaciones ni alertas a pantalla completa del horario común. La sirena de la casa seguirá funcionando.",
};

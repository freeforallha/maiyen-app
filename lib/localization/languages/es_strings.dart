const Map<String, String> esStrings = {
  ...
  "Thời gian tạm dừng báo động đã kết thúc.": "El período de pausa de la alarma ha finalizado.",
  ...
  "Toàn bộ thành viên đã rời khỏi nhà.": "Todos los miembros han salido de casa.",
  ...
  "Hãy thử lại thao tác xoá thiết bị.": "Vuelve a intentar eliminar el dispositivo.",
  ...
  "Đã chuyển về Bình thường nhưng chưa gửi được thông báo": "Se cambió al modo Normal, pero no se pudo enviar la notificación",
  "Chung cho nhà": "Para toda la casa",
  "Áp dụng cho toàn bộ thành viên và có thể bật còi vật lý.": "Se aplica a todos los miembros y puede activar la sirena física.",
  "Cá nhân": "Personal",
  "Lịch cá nhân hoạt động độc lập và không bật còi vật lý.": "El horario personal funciona de forma independiente y nunca activa la sirena física.",
  "Cài đặt này chỉ áp dụng cho tài khoản của bạn.": "Este ajuste solo se aplica a tu cuenta.",
  "Chỉ chủ nhà và quản trị viên có thể thay đổi phần chung cho nhà.": "Solo el propietario y los administradores pueden cambiar los ajustes comunes.",
  "Tham gia hệ thống báo động": "Participar en el sistema de alarma",
  "Cảm biến khẩn cấp luôn tham gia hệ thống báo động.": "Los sensores de emergencia siempre participan en el sistema de alarma.",
  "Tắt để thiết bị không tạo bất kỳ báo động nào.": "Desactívalo para impedir que el dispositivo genere alarmas.",
  "Lịch báo động chung": "Horario de alarma común",
  "Lịch báo động cá nhân": "Horario de alarma personal",
  "Hiển thị cảnh báo toàn màn hình trên điện thoại của bạn.": "Mostrar una alerta a pantalla completa en tu teléfono.",
  ...
  "Lịch chung và lịch cá nhân hoạt động song song, không còn phải chọn một trong hai.": "Los horarios común y personal funcionan en paralelo; ya no es necesario elegir uno.",
  ...
  "Lịch này chỉ áp dụng cho bạn và không bật còi vật lý.": "Este horario solo se aplica a ti y no activa la sirena física.",
  "Lịch này áp dụng cho toàn bộ thành viên trong nhà.": "Este horario se aplica a todos los miembros de la casa.",
  "Đã áp dụng lịch báo động": "Horario de alarma aplicado",
  "Không thể lưu lịch báo động": "No se pudo guardar el horario de alarma",
  "Nhà chưa có thiết bị an ninh": "Esta casa no tiene dispositivos de seguridad",
  "Nhận cảnh báo theo lịch chung của nhà": "Recibir alertas del horario común de la casa",
  "Tắt để không nhận thông báo hoặc cảnh báo toàn màn hình từ lịch chung. Còi vật lý của nhà vẫn hoạt động.": "Desactívalo para no recibir notificaciones ni alertas a pantalla completa del horario común. La sirena de la casa seguirá funcionando.",
};

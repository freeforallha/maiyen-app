const Map<String, String> thStrings = {
  ...
  "Toàn bộ thiết bị MaiYen": "อุปกรณ์ MaiYen ทั้งหมด",
  "Cửa ra/vào": "ประตู",
  "Cửa": "ประตู",
  "Cửa sổ": "หน้าต่าง",
  "Cổng": "ประตูรั้ว",
  ...
  "Đặt nhắc nhở / báo động nhà đã chọn":
      "ตั้งค่า การเตือนความจำ /สัญญาณเตือนบ้านที่เลือก",
  ...
  "Hành động này sẽ thay đổi thời gian báo động của một số thiết bị ":
      "การดำเนินการนี้จะเปลี่ยนเวลาสัญญาณเตือนของอุปกรณ์บางเครื่อง",
  "Hành động này sẽ tắt toàn bộ báo động của nhà ":
      "การดำเนินการนี้จะปิดสัญญาณเตือนทั้งหมดของบ้าน",
  "Tắt toàn bộ báo động?": "ปิดสัญญาณเตือนทั้งหมดหรือไม่",
  "Không xoá được lịch tạm tắt báo động":
      "ไม่สามารถลบช่วงหยุดสัญญาณเตือนชั่วคราวได้",
  "Không lưu được tạm tắt báo động":
      "ไม่สามารถบันทึกช่วงหยุดสัญญาณเตือนชั่วคราวได้",
  ...
  "Chỉ Chủ nhà hoặc Quản trị viên mới có quyền thay đổi lặp báo động":
      "เฉพาะเจ้าของบ้านหรือผู้ดูแลระบบเท่านั้นที่เปลี่ยนการทำซ้ำของสัญญาณเตือนได้",
  "Không lưu được thời gian lặp báo động":
      "ไม่สามารถบันทึกช่วงเวลาทำซ้ำของสัญญาณเตือนได้",
  ...
  "Bạn đang xem lịch của chủ nhà. Chọn Riêng tôi để tự đặt lịch báo động.":
      "คุณกำลังดูกำหนดเวลาของเจ้าของบ้าน เลือก \"เฉพาะฉัน\" เพื่อตั้งกำหนดเวลาสัญญาณเตือนของคุณเอง",
  ...
  "Bạn không có quyền sửa lịch báo động của nhà":
      "คุณไม่มีสิทธิ์แก้ไขกำหนดเวลาสัญญาณเตือนของบ้าน",
  "Không thể áp dụng báo động cho toàn bộ thiết bị":
      "ไม่สามารถใช้สัญญาณเตือนกับอุปกรณ์ทั้งหมดได้",
  ...
  "Nhắc nhở sẽ nhắc bạn kiểm tra trạng thái an toàn của ngôi nhà vào giờ đã chọn.":
      "การเตือนความจำ จะเตือนให้คุณตรวจสอบสถานะความปลอดภัยภายในบ้านตามเวลาที่เลือก",
  "Thêm khung giờ báo động": "เพิ่มช่วงเวลาสัญญาณเตือน",
  "Đang sử dụng nhắc nhở riêng của bạn":
      "กำลังใช้ การเตือนความจำ ส่วนตัวของคุณ",
  ...
  "MaiYen tự bật Bảo vệ vì bạn đã rời khỏi nhà.":
      "MaiYen เปิดโหมดป้องกันอัตโนมัติเนื่องจากคุณออกจากบ้าน",
  ...
  "Sau vài lần sử dụng, MaiYen sẽ đánh giá thói quen kiểm tra ứng dụng tốt hơn.":
      "หลังใช้งานไปสักระยะ MaiYen จะประเมินพฤติกรรมการตรวจสอบแอปได้แม่นยำขึ้น",
  ...
  "Nên đặt lịch báo động cho thời gian ngủ hoặc vắng nhà.":
      "ควรกำหนดเวลาสัญญาณเตือนในช่วงนอนหลับหรือไม่มีคนอยู่บ้าน",
  "Nhà đã có lịch báo động hoặc lịch cảnh báo theo thiết bị.":
      "บ้านมีกำหนดเวลาสัญญาณเตือนหรือกำหนดการแจ้งเตือนตามอุปกรณ์แล้ว",
  ...
  "Nên có ít nhất một nhắc nhở để không quên kiểm tra nhà.":
      "ควรมี การเตือนความจำ อย่างน้อยหนึ่งรายการเพื่อไม่ให้ลืมตรวจสอบบ้าน",
  ...
  "Điện thoại ít có khả năng trì hoãn cảnh báo MaiYen.":
      "โทรศัพท์มีโอกาสทำให้การแจ้งเตือน MaiYen ล่าช้าน้อยลง",
  ...
  "Điện thoại có thể nhận thông báo MaiYen.":
      "โทรศัพท์รับการแจ้งเตือน MaiYen ได้",
  ...
  "Không thể thay đổi trạng thái báo động":
      "ไม่สามารถเปลี่ยนสถานะสัญญาณเตือนได้",
  ...
  "MaiYen cần quyền vị trí \"Luôn cho phép\" để nhận biết khi bạn rời hoặc trở về nhà, kể cả khi ứng dụng đang chạy nền.":
      "MaiYen ต้องใช้สิทธิ์ตำแหน่ง \"อนุญาตเสมอ\" เพื่อระบุว่าคุณออกจากหรือกลับถึงบ้าน แม้แอปทำงานเบื้องหลัง",
  ...
  "Hành động này sẽ thay đổi thời gian báo động của một số thiết bị trong hôm nay...":
      "การดำเนินการนี้จะเปลี่ยนเวลาสัญญาณเตือนของอุปกรณ์บางเครื่องในวันนี้...",
  "Hành động này sẽ tắt toàn bộ báo động của nhà dưới mọi hình thức. Bạn sẽ không còn nhận được cảnh báo khi có nguy hiểm trên điện thoại nữa.":
      "การดำเนินการนี้จะปิดสัญญาณเตือนทุกประเภทของบ้าน คุณจะไม่ได้รับการแจ้งเตือนบนโทรศัพท์เมื่อเกิดอันตรายอีกต่อไป",
  ...
  "Một người dùng MaiYen": "ผู้ใช้ MaiYen",
  ...
  "MaiYen Security Alert": "การแจ้งเตือนความปลอดภัย MaiYen",
  ...
  "Báo động lặp sau \$securityModeRepeatMinutes phút nếu sự cố vẫn còn.":
      "สัญญาณเตือนจะทำซ้ำหลัง \$securityModeRepeatMinutes นาที หากยังมีปัญหาอยู่",
  ...
  "Bạn đã bật báo động cho nhà \"\$homeName\".":
      "คุณเปิดสัญญาณเตือนสำหรับบ้าน \"\$homeName\" แล้ว",
  "Bạn đã tắt toàn bộ báo động của nhà \"\$homeName\".":
      "คุณได้ปิดสัญญาณเตือนทั้งหมดของบ้าน \"\$homeName\" แล้ว",
  ...
  "MaiYen đang cập nhật vị trí": "MaiYen กำลังอัปเดตตำแหน่ง",
  ...
  "Không thể xác nhận với MaiYen. Hãy kiểm tra kết nối và thử lại.":
      "ไม่สามารถยืนยันกับ MaiYen ได้ โปรดตรวจสอบการเชื่อมต่อแล้วลองอีกครั้ง",
  ...
  "🚨 MaiYen phát hiện cảnh báo": "🚨 MaiYen ตรวจพบการแจ้งเตือน",
  "Mở MaiYen để kiểm tra ngay.": "เปิด MaiYen เพื่อตรวจสอบทันที",
  ...
  "MaiYen đang xoá thiết bị \"\$deviceName\" khỏi nhà \"\$homeName\".":
      "MaiYen กำลังลบอุปกรณ์ \"\$deviceName\" ออกจากบ้าน \"\$homeName\"",
  ...
  "Khoảng thời gian phải nằm trong khung báo động (\$start → \$end)":
      "ช่วงเวลาหยุดชั่วคราวต้องอยู่ภายในกำหนดเวลาสัญญาณเตือน(\$start → \$end)",
  ...
  "Nếu chưa có ai xác nhận, MaiYen sẽ chuyển sang gọi điện khẩn cấp.":
      "หากไม่มีใครยืนยัน MaiYen จะเปลี่ยนไปใช้การโทรฉุกเฉิน",
  ...
  "Sẽ báo lại theo lịch báo động đã cài nếu vấn đề chưa được xử lý.":
      "จะแจ้งเตือนซ้ำตามกำหนดเวลาสัญญาณเตือนที่ตั้งไว้ หากยังไม่ได้แก้ไขปัญหา",
  ...
  "Đã cài nhắc nhở cho \$updatedHomes nhà.":
      "ตั้ง การเตือนความจำ ให้บ้าน \$updatedHomes หลังแล้ว",
  ...
  "Đã áp dụng báo động cho \$count thiết bị an ninh":
      "ใช้สัญญาณเตือนกับอุปกรณ์รักษาความปลอดภัย \$count เครื่องแล้ว",
  ...
  "Hãy thêm thiết bị MaiYen đầu tiên để bắt đầu theo dõi nhà.":
      "โปรดเพิ่มอุปกรณ์ MaiYen เครื่องแรกเพื่อเริ่มตรวจสอบบ้าน",
  ...
  "Bạn chưa đặt nhắc nhở, nên tạo lịch nhắc kiểm tra nhà định kỳ.":
      "คุณยังไม่ได้ตั้ง การเตือนความจำ ควรสร้างกำหนดการ การเตือนความจำ เพื่อตรวจสอบบ้านเป็นระยะ",
  "Bạn chưa đặt lịch báo động, nên bật bảo vệ theo khung giờ thường vắng nhà.":
      "คุณยังไม่ได้ตั้งกำหนดเวลาสัญญาณเตือนควรเปิดโหมดป้องกันตามช่วงเวลาที่มักไม่มีคนอยู่บ้าน",
  ...
  "Báo động MaiYen": "สัญญาณเตือนของ MaiYen",
  ...
  "Khoảng tạm tắt không trùng với lịch báo động nào đang bật":
      "ช่วงหยุดสัญญาณเตือนชั่วคราวไม่ทับซ้อนกับกำหนดเวลาสัญญาณเตือนที่เปิดใช้งานอยู่",
  "Cài đặt báo động": "การตั้งค่าสัญญาณเตือนภัย",
  "Điều khiển cách cảm biến này kích hoạt cảnh báo.":
      "กำหนดวิธีที่เซ็นเซอร์นี้เรียกใช้การแจ้งเตือน",
  "Tham gia báo động": "เข้าร่วมระบบเตือนภัย",
  "Tắt để cảm biến không tạo báo động.":
      "ปิดเพื่อไม่ให้เซ็นเซอร์นี้สร้างสัญญาณเตือน",
  ...
  "Hiển thị cảnh báo toàn màn hình trên điện thoại.":
      "แสดงการแจ้งเตือนแบบเต็มหน้าจอบนโทรศัพท์",
  ...
  "Cảm biến khẩn cấp luôn kích hoạt ngay lập tức.":
      "เซ็นเซอร์ฉุกเฉินจะทำงานทันทีเสมอ",
  "Ngay lập tức": "ทันที",
  "giây": "วินาที",
  ...
  "Chỉ chủ nhà và quản trị viên có thể thay đổi cài đặt này.":
      "เฉพาะเจ้าของบ้านและผู้ดูแลระบบเท่านั้นที่เปลี่ยนการตั้งค่านี้ได้",
  ...
  "Sử dụng báo động theo lịch đã thiết lập":
      "ใช้กำหนดเวลาสัญญาณเตือนภัยที่ตั้งไว้",
  "Chỉ gửi thông báo, không kích hoạt báo động":
      "ส่งเฉพาะการแจ้งเตือน ไม่เปิดสัญญาณเตือนภัย",
  "Toàn bộ báo động của nhà đang tắt; hệ thống chỉ gửi thông báo.":
      "สัญญาณเตือนภัยทั้งหมดของบ้านถูกปิด ระบบจะส่งเฉพาะการแจ้งเตือน",
  "Chỉ Chủ nhà có thể bật chế độ này.":
      "เฉพาะเจ้าของบ้านเท่านั้นที่เปิดโหมดนี้ได้",
  ...
  "Chỉ Chủ nhà mới có quyền bật chế độ Không bảo vệ":
      "เฉพาะเจ้าของบ้านเท่านั้นที่เปิดโหมดไม่ป้องกันได้",
  ...
  "Đã chuyển sang Không bảo vệ nhưng chưa gửi được thông báo":
      "เปลี่ยนเป็นโหมดไม่ป้องกันแล้ว แต่ส่งการแจ้งเตือนไม่สำเร็จ",
  ...
  "Thông báo thông thường khi cảm biến phát hiện sự kiện.":
      "การแจ้งเตือนทั่วไปเมื่อเซ็นเซอร์ตรวจพบเหตุการณ์",
  ...
  "Hiển thị cảnh báo toàn màn hình trên điện thoại của bạn.":
      "แสดงการแจ้งเตือนเต็มหน้าจอบนโทรศัพท์ของคุณ",
  ...
  "Lịch chung và lịch cá nhân hoạt động song song, không còn phải chọn một trong hai.":
      "ตารางร่วมและตารางส่วนตัวทำงานพร้อมกัน ไม่ต้องเลือกอย่างใดอย่างหนึ่ง",
  ...
  "Lịch này chỉ áp dụng cho bạn và không bật còi vật lý.":
      "ตารางนี้ใช้กับคุณเท่านั้นและไม่เปิดไซเรนจริง",
  "Lịch này áp dụng cho toàn bộ thành viên trong nhà.":
      "ตารางนี้ใช้กับสมาชิกทุกคนในบ้าน",
  ...
  "Tắt để không nhận thông báo hoặc cảnh báo toàn màn hình từ lịch chung. Còi vật lý của nhà vẫn hoạt động.":
      "ปิดเพื่อไม่รับการแจ้งเตือนหรือการเตือนแบบเต็มหน้าจอจากตารางร่วม ไซเรนของบ้านยังคงทำงานตามปกติ",
};

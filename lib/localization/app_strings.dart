...
class AppStrings {
  ...
  String manualSecurityModeEnabledMessage({
    ...
    final repeatMessage = securityModeRepeatMinutes == 0
      ...
      fil: "Uulit ang Alarm pagkalipas ng $securityModeRepeatMinutes minuto kung magpapatuloy ang problema.",
    ...
    return choose(
      ...
      fil: "Manu-manong in-on ni $actorName ang Mode ng Proteksyon para sa \"$homeName\". Mananatiling naka-on ang mode na ito hanggang ibalik ito sa Normal ng miyembrong may pahintulot. $repeatMessage",
  ...
  String memberRoleChangedMessage({
    ...
    return choose(
      ...
      fil: "Pinalitan ni $actorName ang tungkulin ni $memberName mula $oldRoleName patungong $newRoleName sa bahay na \"$homeName\".",
  ...
  String androidAlarmFullscreenChannelDescription() => choose(
    ...
    fil: "Buksan ang full-screen alert; tutunog ang sirena mula sa pahina ng Alarm",
  ...
  String androidEmergencyPriorityChannelDescription() => choose(
    ...
    fil: "Mataas na priyoridad na alertong pang-emergency bago buksan ang full-screen",
  ...
  String androidReminderPriorityChannelDescription() => choose(
    ...
    fil: "Mataas na priyoridad na Reminder ng SafeHome na hindi nagbubukas ng full-screen",
  ...
  String homeSecurityRepeatToast(int minutes) {
    return minutes == 0
      ...
      fil: "Uulit ang alerto ng Mode ng Proteksyon pagkalipas ng $minutes minuto",
  ...
  String ownershipTransferRequestSentMessage({
    ...
    fil: "Nagpadala ka kay $email ng kahilingan na ilipat ang pagmamay-ari ng bahay na \"$homeName\".",
  ...
  String ownershipTransferRequestMessage({
    ...
    fil: "Gustong ilipat ni $actorName sa iyo ang pagmamay-ari ng bahay na \"$homeName\".",
  ...
  String deviceDeleteInProgressMessage({
    ...
    fil: "Tinatanggal ng SafeHome ang \"$deviceName\" mula sa bahay na \"$homeName\".",
  ...
  String homeInfoUpdatedMessage({
    ...
    if (nameChanged && addressChanged) {
      return choose(
        ...
        fil: "Pinalitan ni $actorName ng \"$newName\" ang pangalan ng bahay at binago rin ang address nito.",
  ...
  String deviceRenamedMessage({
    ...
    fil: "Pinalitan ni $actorName ng \"$newName\" ang pangalan ng aparatong \"$oldDeviceName\" sa bahay na \"$homeName\".",
  ...
  String pairingEnabledMessage({
    ...
    fil: "Naka-enable ang pagpapares ng aparato sa bahay na \"$homeName\" sa loob ng $seconds segundo.",
  ...
  String alarmPauseWithinScheduleMessage({
    ...
    fil: "Dapat nasa loob ng iskedyul ng Alarm ang panahon ng pag-pause ($start → $end)",
  ...
  String deviceHighTemperatureMessage({
    ...
    fil: "Nagtala ang \"$name\" ng mataas na temperatura sa bahay na \"$homeName\".",
  ...
  String deviceHighHumidityMessage({
    ...
    fil: "Nagtala ang \"$name\" ng mataas na halumigmig sa bahay na \"$homeName\".",
    ...
    if (doorClosed != null) {
      ...
      if (deviceName.isNotEmpty && resolvedHomeName.isNotEmpty) {
        return doorClosed
          ...
          fil: "Nagsara ang \"$deviceName\" sa bahay na \"$resolvedHomeName\".",
          ...
          fil: "Bukas ang \"$deviceName\" sa bahay na \"$resolvedHomeName\".",
  ...
  static const Map<String, String> _vietnameseDisplayOverrides = {
    ...
    "Auto rời khỏi nhà chưa ổn":
        "Tự động Bảo vệ khi rời nhà chưa ổn định",
    "Auto rời khỏi nhà đã sẵn sàng":
        "Tự động Bảo vệ khi rời nhà đã sẵn sàng",
  ...
  static const Map<String, String> _french = {
    ...
    "Đã tắt toàn bộ Alarm của nhà": "Tous les Alarm de la maison ont été désactivés",
    "QR này không phải mã xin gia nhập Home":
    "Ce QR n'est pas un code de demande d'accès à une maison",
  ...
  static const Map<String, String> _indonesian = {
    ...
    "Hành động này sẽ tắt toàn bộ báo động của nhà ": "Tindakan ini akan menonaktifkan semua Alarm di rumah ",
    "Tắt toàn bộ Alarm?": "Nonaktifkan semua Alarm?",
    "Không xoá được lịch tạm tắt Alarm": "Tidak dapat menghapus jadwal jeda Alarm",
    ...
    "Hành động này sẽ tắt toàn bộ báo động của nhà dưới mọi hình thức. Bạn sẽ không còn nhận được cảnh báo khi có nguy hiểm trên điện thoại nữa.": "Tindakan ini akan menonaktifkan semua Alarm di rumah. Anda tidak akan lagi menerima peringatan bahaya di ponsel.",
    ...
    "Bạn đã tắt toàn bộ Alarm của nhà \"\$homeName\".": "Semua Alarm di rumah \"\$homeName\" telah dinonaktifkan.",
  ...
  static const Map<String, String> _filipino = {
    ...
    "Bạn không có quyền sửa lịch chung của nhà": "Wala kang pahintulot na baguhin ang ibinahaging iskedyul ng bahay",
    ...
    "Chưa có thiết bị, hãy nhấn nút + để thêm để bắt đầu duy trì an ninh": "Wala pang aparato. I-tap ang + para magdagdag at simulang protektahan ang iyong bahay.",
    "CHƯA AN TOÀN": "HINDI LIGTAS",
    "ĐÃ AN TOÀN": "LIGTAS",
    "Nhà đang có dấu hiệu cần kiểm tra, bạn nên xem lại các trạng thái bên dưới.": "Kailangang suriin ang iyong bahay. Tingnan ang mga status sa ibaba.",
    "Nhà đang hoạt động ổn định, bạn có thể yên tâm.": "Normal ang pagpapatakbo ng iyong bahay.",
    "Không có dấu hiệu khói hoặc SOS bất thường.": "Walang natukoy na usok o anumang SOS alert.",
    "Chưa có nhiều hoạt động mới để phân tích sâu hơn.": "Hindi pa sapat ang datos ng kamakailang aktibidad para sa mas malalim na pagsusuri.",
    "Hub kết nối bình thường": "Nakakonekta ang Hub",
    "Cài đặt cảnh báo cho nhà hiện tại": "Mga setting ng alerto para sa bahay na ito",
    ...
    "Nhắc kiểm tra nhà theo thời gian": "Magtakda ng mga Reminder para suriin ang bahay",
    ...
    "Đặt vị trí nhà và bật bảo vệ tự động": "Itakda ang lokasyon ng bahay at i-enable ang awtomatikong proteksyon",
    "Chuyển quyền chủ nhà hoặc xoá nhà": "Ilipat ang pagmamay-ari o tanggalin ang bahay",
    "Đặt Reminder / Alarm nhà đã chọn": "Itakda ang Reminder / Alarm para sa mga napiling bahay",
    ...
    "Các nhà đã chọn sẽ bị xoá vĩnh viễn.": "Permanenteng tatanggalin ang mga napiling bahay.",
    "Hoặc quét QR để xin gia nhập các nhà đã chọn": "O mag-scan ng QR para humiling ng access sa mga napiling bahay",
    ...
    "Không có nhà nào bạn có quyền quản lý": "Wala kang pamamahala sa alinman sa mga napiling bahay",
    ...
    "Toàn bộ thông báo nhà sẽ bị xoá.": "Buburahin ang lahat ng notification ng bahay.",
    ...
    "Chỉ chủ nhà mới được xoá nhà": "May-ari lang ang maaaring magtanggal ng bahay na ito",
    "Chỉ chủ nhà mới được chuyển quyền": "May-ari lang ang maaaring maglipat ng pagmamay-ari",
    ...
    "Cả ngày": "Buong araw",
    "Bạn không có quyền thực hiện thao tác này.": "Wala kang pahintulot na gawin ito.",
    "Không thể hoàn tất thao tác. Vui lòng thử lại.": "Hindi makumpleto ang aksyon. Pakisubukang muli.",
    "QR gia nhập nhiều nhà không hợp lệ": "Di-wastong QR code para sa pagsali sa maraming bahay",
    ...
    "QR này không phải mã xin gia nhập nhà": "Ang QR code na ito ay hindi code para sumali sa bahay",
    "Bạn không có quyền thêm thiết bị": "Wala kang pahintulot na magdagdag ng mga aparato",
    "Đã mở chế độ thêm thiết bị": "Naka-enable ang pagpapares ng aparato",
    "Rời khỏi Home này?": "Umalis sa bahay na ito?",
    "Nhà này và toàn bộ thiết bị bên trong sẽ bị xoá vĩnh viễn.": "Permanenteng tatanggalin ang bahay na ito at lahat ng aparatong naroon.",
    "Đã xoá nhà": "Natanggal na ang bahay",
    "QR của nhà này": "QR code ng bahay na ito",
    "Người khác quét mã này để gửi yêu cầu gia nhập nhà.": "Maaaring i-scan ng iba ang code na ito para humiling ng access sa bahay.",
    ...
    "Đưa mã QR chia sẻ nhà vào khung hình": "Ilagay sa loob ng frame ang QR code para sa pagbabahagi ng bahay",
    "Mã QR này do chủ nhà chia sẻ": "Ibinahagi ng may-ari ng bahay ang QR code na ito",
    "Nhập mã mời": "Ilagay ang code ng imbitasyon",
    "Gửi yêu cầu gia nhập": "Ipadala ang kahilingan na sumali",
    "QR này không phải mã thiết bị": "Ang QR code na ito ay hindi code ng aparato",
    ...
    "Không thể share cho chính bạn": "Hindi mo maaaring ibahagi ang bahay sa sarili mo",
    ...
    "Không thể chuyển quyền cho chính bạn": "Hindi mo maaaring ilipat ang pagmamay-ari sa iyong sarili",
    ...
    "Đã gửi yêu cầu chuyển quyền chủ nhà": "Naipadala na ang kahilingan sa paglilipat ng pagmamay-ari",
    "Bạn không có quyền xoá thiết bị": "Wala kang pahintulot na magtanggal ng mga aparato",
    "Xóa Device?": "Tanggalin ang aparatong ito?",
    "Đã gửi yêu cầu xoá thiết bị": "Naipadala na ang kahilingan sa pagtanggal ng aparato",
    ...
    "Quét mã QR được chủ nhà chia sẻ": "I-scan ang QR code na ibinahagi ng may-ari ng bahay",
    ...
    "Vui lòng nhập đủ thông tin": "Pakilagay ang lahat ng kinakailangang impormasyon",
    ...
    "Thêm số điện thoại để dùng cho các trường hợp khẩn cấp": "Magdagdag ng numero ng telepono para sa mga emergency",
    "Hoàn tất": "Tapos na",
    ...
    "Xem lời mời chia sẻ và xin gia nhập": "Tingnan ang mga imbitasyon sa pagbabahagi at kahilingang sumali",
    ...
    "Bạn không có quyền quản lý phòng": "Wala kang pahintulot na pamahalaan ang mga kuwarto",
    "Đổi tên phòng": "Palitan ang pangalan ng kuwarto",
    "Tên phòng": "Pangalan ng kuwarto",
    "Xoá phòng": "Tanggalin ang kuwarto",
    "Thiết bị trong phòng này sẽ được chuyển về Chưa phân phòng.": "Ililipat sa seksyong Hindi nakatalaga ang mga aparato sa kuwartong ito.",
    ...
    "Hãy đặt vị trí nhà trước khi bật tự động Bảo vệ": "Itakda muna ang lokasyon ng bahay bago i-on ang Awtomatikong Proteksyon",
    "Bán kính bảo vệ mặc định: 150 m": "Default na radius ng proteksyon: 150 m",
    "Mỗi thành viên sẽ cần cấp quyền vị trí Luôn cho phép để trạng thái rời/đến nhà hoạt động khi app chạy nền.": "Kailangang itakda ng bawat miyembro ang pahintulot sa lokasyon sa Palaging Payagan upang gumana ang status ng pag-alis/pagdating sa bahay habang tumatakbo ang app sa background.",
    ...
    "Tên này chỉ hiển thị riêng trên tài khoản của bạn.": "Sa account mo lang ipinapakita ang pangalang ito.",
    "Tên và địa chỉ sẽ được cập nhật cho toàn bộ thành viên trong nhà.": "Maa-update ang pangalan at address para sa lahat ng miyembro ng bahay.",
    ...
    "Hãy thực hiện kiểm tra bằng tài khoản Owner": "Gawin ang pagsusuring ito gamit ang account ng may-ari",
    "Không đọc được dữ liệu nhà": "Hindi mabasa ang datos ng bahay",
    "Nhà cần có ít nhất một thiết bị để test": "Kailangang may kahit isang aparato ang bahay para sa pagsusuri",
    "Đóng": "Isara",
    ...
    "Bạn không có quyền sắp xếp phòng": "Wala kang pahintulot na baguhin ang ayos ng mga kuwarto",
    ...
    "Gửi": "Ipadala",
    "Đã gửi email khôi phục": "Naipadala na ang email para sa pag-reset ng password",
    ...
    "Tìm nội dung hoặc tên người gửi": "Maghanap ng nilalaman o pangalan ng nagpadala",
    ...
    "Dùng lịch chung do Chủ nhà hoặc Quản trị viên thiết lập": "Gamitin ang ibinahaging iskedyul na itinakda ng may-ari o admin",
    "Dùng lịch riêng chỉ áp dụng cho tài khoản của bạn": "Gumamit ng personal na iskedyul na para lang sa iyong account",
    ...
    "Hôm nay đã ghi nhận cảnh báo SOS": "May naitalang alerto ng SOS ngayong araw",
    "Hôm nay đã ghi nhận cảnh báo khói": "May naitalang alerto sa usok ngayong araw",
    "Khói đã an toàn": "Wala nang usok",
    "Không tìm thấy nhà của thông báo này": "Hindi natagpuan ang bahay para sa notification na ito",
    "Không tìm thấy thiết bị trong nhà này": "Hindi natagpuan ang aparato sa bahay na ito",
    ...
    "Tự động Bảo vệ khi rời nhà vẫn đang bật. Nếu mọi thành viên vẫn ở ngoài, hệ thống có thể tự bật lại Bảo vệ sau vài phút.": "Naka-on pa rin ang Awtomatikong Proteksyon kapag wala sa bahay. Kung nasa labas pa rin ang lahat ng miyembro, maaaring awtomatikong i-on muli ng system ang Mode ng Proteksyon pagkalipas ng ilang minuto.",
    ...
    "Hành động này sẽ thay đổi thời gian báo động của một số thiết bị ": "Babaguhin ng aksyong ito ang oras ng Alarm para sa ilang aparato ngayong araw...",
    "Hành động này sẽ tắt toàn bộ báo động của nhà ": "I-o-off ng aksyong ito ang lahat ng Alarm para sa ",
    "Tắt toàn bộ Alarm?": "I-off ang lahat ng Alarm?",
    "Không xoá được lịch tạm tắt Alarm": "Hindi matanggal ang iskedyul ng pag-pause ng Alarm",
    ...
    "Không thể xác nhận tài khoản hiện tại": "Hindi ma-verify ang kasalukuyang account",
    "Mật khẩu không đúng": "Maling password",
    "Không thể xác nhận mật khẩu": "Hindi ma-verify ang password",
    "Chỉ Chủ nhà hoặc Quản trị viên mới có quyền thay đổi lặp báo động": "May-ari o Admin lang ang maaaring magbago ng setting ng pag-uulit ng Alarm",
    "Không lưu được thời gian lặp báo động": "Hindi mai-save ang oras ng pag-uulit ng Alarm",
    "Chỉ Chủ nhà hoặc Quản trị viên mới có quyền thay đổi Mode Bảo vệ": "May-ari o Admin lang ang maaaring magbago ng Mode ng Proteksyon",
    "Không thể thay đổi chế độ nhà": "Hindi mabago ang mode ng bahay",
    "Đã bật Bảo vệ nhưng chưa gửi được thông báo": "Naka-on ang Mode ng Proteksyon, pero hindi naipadala ang notification",
    "Đã bật Mode Bảo vệ thủ công": "Naka-enable ang manu-manong Mode ng Proteksyon",
    "Đã chuyển nhà về Bình thường": "Naibalik sa Normal ang bahay",
    "60 phút": "60 minuto",
    "30 phút": "30 minuto",
    "15 phút": "15 minuto",
    "Bạn đang xem lịch của chủ nhà. Chọn Riêng tôi để tự đặt lịch Alarm.": "Tinitingnan mo ang iskedyul ng may-ari. Piliin ang Para sa akin lang para magtakda ng sarili mong iskedyul ng Alarm.",
    ...
    "Bạn không có quyền sửa lịch Alarm của nhà": "Wala kang pahintulot na baguhin ang iskedyul ng Alarm ng bahay na ito",
    "Không thể áp dụng Alarm cho toàn bộ thiết bị": "Hindi mailapat ang Alarm sa lahat ng aparato",
    "Nhà chưa có thiết bị an ninh để áp dụng": "Walang aparatong panseguridad sa bahay na ito na maaaring lagyan ng Alarm",
    "Bạn không có quyền sửa lịch Theo nhà. Hãy chọn Riêng tôi.": "Wala kang pahintulot na baguhin ang iskedyul ng bahay. Piliin ang Para sa akin lang.",
    "Không thể lưu chế độ Alarm": "Hindi mai-save ang mode ng Alarm",
    "Thêm Reminder": "Magdagdag ng Reminder",
    "Reminder sẽ nhắc bạn kiểm tra trạng thái an toàn của ngôi nhà vào giờ đã chọn.": "Paalalahanan ka ng Reminder na tingnan ang status ng seguridad ng iyong bahay sa napiling oras.",
    "Thêm khung giờ Alarm": "Magdagdag ng saklaw ng oras ng Alarm",
    "Đang sử dụng Reminder riêng của bạn": "Ginagamit ang sarili mong mga setting ng Reminder",
    "Đang sử dụng Reminder của chủ nhà": "Ginagamit ang mga setting ng Reminder ng may-ari",
    ...
    "Đồng ý": "OK",
    "Bạn chắc chắn muốn rời khỏi nhà này?": "Sigurado ka bang gusto mong umalis sa bahay na ito?",
    "Xoá thành viên?": "Alisin ang miyembro?",
    "Rời khỏi nhà?": "Umalis sa bahay na ito?",
    "Chỉ chủ nhà mới được thay đổi vai trò": "May-ari lang ang maaaring magbago ng mga tungkulin",
    "Bạn không có quyền xoá thành viên này": "Wala kang pahintulot na alisin ang miyembrong ito",
    "Bạn": "Ikaw",
    ...
    "Thành viên chưa cập nhật số điện thoại": "Hindi pa nagdagdag ng numero ng telepono ang miyembrong ito",
    "Bảo vệ thủ công đang bật - chỉ tắt khi chuyển về Bình thường": "Naka-on ang manu-manong Mode ng Proteksyon—lumipat sa Normal para i-off ito",
    "Thời gian lặp": "Agwat ng pag-uulit",
    "Chọn 0 để chỉ báo một lần. Cài đặt này dùng cho cả Bảo vệ thủ công và Tự động Bảo vệ khi rời nhà.": "Piliin ang 0 para isang beses lang mag-alerto. Nalalapat ang setting na ito sa manu-manong Mode ng Proteksyon at Awtomatikong Proteksyon kapag wala sa bahay.",
    "Lặp báo động khi sự cố vẫn còn": "Ulitin ang Alarm habang nagpapatuloy ang problema",
    ...
    "Thiết bị SOS chưa ghi nhận cảnh báo.": "Wala pang naitalang alerto mula sa aparatong SOS.",
    "Cảm biến khói chưa ghi nhận bất thường.": "Wala pang natukoy na problema ang sensor ng usok.",
    "Bạn hoặc thành viên đã chủ động bật Bảo vệ.": "Manu-manong in-on mo o ng isang miyembro ang Mode ng Proteksyon.",
    "SafeHome tự bật Bảo vệ vì bạn đã rời khỏi nhà.": "Awtomatikong in-on ng SafeHome ang Mode ng Proteksyon dahil umalis ka sa bahay.",
    "Nhà đang ở chế độ dùng bình thường.": "Kasalukuyang nasa Normal mode ang bahay na ito.",
    ...
    "Bạn đã mở app gần đây để kiểm tra trạng thái.": "Binuksan mo kamakailan ang app para tingnan ang status.",
    "Bạn nên mở app định kỳ để kiểm tra quyền, lịch và cảnh báo chưa đọc.": "Buksan nang regular ang app para tingnan ang mga pahintulot, iskedyul, at hindi pa nababasang alerto.",
    "Sau vài lần sử dụng, SafeHome sẽ đánh giá thói quen kiểm tra app tốt hơn.": "Pagkatapos ng ilang paggamit, mas mahusay nang masusuri ng SafeHome ang nakasanayan mong pagtingin sa app.",
    "Tần suất vào app ổn": "Maayos ang dalas ng pagtingin sa app",
    "Đã lâu chưa vào app kiểm tra": "Matagal mo nang hindi binubuksan ang app para tingnan ang status",
    "Đang ghi nhận tần suất vào app": "Itinatala ang dalas ng pagbukas sa app",
    "Cần kiểm tra quyền vị trí luôn luôn và điều kiện chạy nền.": "Suriin ang pahintulot sa lokasyon na Palaging Payagan at ang mga kondisyon sa background.",
    "Thiết bị đủ điều kiện để Auto rời khỏi nhà hoạt động.": "Natutugunan ng aparatong ito ang mga kinakailangan para sa Awtomatikong Proteksyon kapag wala sa bahay.",
    "Bạn có thể bật khi muốn tự động chuyển Bảo vệ lúc rời nhà.": "I-enable ito kung gusto mong awtomatikong i-on ang Mode ng Proteksyon kapag umalis ka.",
    "Auto rời khỏi nhà chưa ổn": "Hindi pa handa ang Awtomatikong Proteksyon kapag wala sa bahay",
    "Auto rời khỏi nhà đã sẵn sàng": "Handa na ang Awtomatikong Proteksyon kapag wala sa bahay",
    "Auto rời khỏi nhà chưa bật": "Hindi naka-enable ang Awtomatikong Proteksyon kapag wala sa bahay",
    "Nên thêm báo khói, SOS hoặc thiết bị khẩn cấp phù hợp với nhà.": "Magdagdag ng sensor ng usok, SOS, o aparatong pang-emergency na angkop sa iyong bahay.",
    "Chưa có thiết bị khẩn cấp": "Wala pang aparatong pang-emergency",
    "Đã có thiết bị khẩn cấp": "May mga aparatong pang-emergency na",
    "Nên đặt lịch Alarm cho thời gian ngủ hoặc vắng nhà.": "Magtakda ng iskedyul ng Alarm para sa oras ng pagtulog o kapag wala ka sa bahay.",
    "Nhà đã có lịch Alarm hoặc lịch cảnh báo theo thiết bị.": "May iskedyul ng Alarm o alerto kada aparato ang bahay na ito.",
    "Chưa set lịch Alarm": "Hindi pa nakatakda ang iskedyul ng Alarm",
    "Đã set lịch Alarm": "Nakatakda na ang iskedyul ng Alarm",
    "Nên có ít nhất một Reminder để không quên kiểm tra nhà.": "Magtakda ng kahit isang Reminder para hindi mo makalimutang tingnan ang iyong bahay.",
    "App sẽ nhắc bạn kiểm tra nhà theo lịch đã đặt.": "Paalalahanan ka ng app na tingnan ang bahay ayon sa itinakdang iskedyul.",
    "Chưa setup Reminder": "Hindi pa naka-setup ang Reminder",
    "Đã setup Reminder": "Naka-setup na ang Reminder",
    "Hãy mở lại app hoặc đăng nhập lại nếu thiết bị không nhận cảnh báo.": "Buksan muli ang app o mag-sign in ulit kung hindi nakakatanggap ng mga alerto ang aparatong ito.",
    "Thiết bị chưa đăng ký nhận cảnh báo": "Hindi nakarehistro ang aparatong ito para sa mga alerto",
    "Thiết bị nhận cảnh báo bình thường": "Nakakatanggap nang maayos ng mga alerto ang aparatong ito",
    "iOS quản lý chạy nền chặt hơn Android; hãy giữ thông báo và vị trí luôn luôn nếu dùng Auto rời khỏi nhà.": "Mas mahigpit ang iOS sa paggamit sa background kaysa Android; panatilihing naka-on ang mga notification at Palaging Payagan ang lokasyon kung gumagamit ng Awtomatikong Proteksyon kapag wala sa bahay.",
    "Cơ chế iOS": "Pagpapatakbo ng iOS",
    "Hãy kiểm tra quyền chạy nền và tự khởi động để cảnh báo không bị trễ.": "Suriin ang pahintulot sa background at awtomatikong pagsisimula para hindi maantala ang mga alerto.",
    "Thiết bị đã xác nhận các điều kiện chạy nền quan trọng.": "Nakumpirma ng aparato ang mahahalagang kondisyon sa background.",
    "Cần kiểm tra chạy nền / tự khởi động": "Suriin ang paggamit sa background / awtomatikong pagsisimula",
    "Chạy nền ổn định": "Maayos ang pagpapatakbo sa background",
    "Một số máy Android có thể trì hoãn cảnh báo nếu tối ưu pin còn bật.": "Maaaring maantala ng ilang Android phone ang mga alerto habang naka-on ang pag-optimize ng baterya.",
    "Điện thoại ít có khả năng trì hoãn cảnh báo SafeHome.": "Mas maliit ang posibilidad na maantala ng telepono ang mga alerto ng SafeHome.",
    "Chưa tắt tối ưu pin": "Naka-enable pa rin ang pag-optimize ng baterya",
    "Tối ưu pin không chặn app": "Hindi hinaharangan ng pag-optimize ng baterya ang app",
    "Auto rời khỏi nhà cần quyền vị trí luôn luôn để chạy ổn định.": "Kailangan ng pahintulot sa lokasyon na Palaging Payagan upang gumana nang maaasahan ang Awtomatikong Proteksyon kapag wala sa bahay.",
    "Cần cấp quyền vị trí để Auto rời khỏi nhà hoạt động.": "Kailangan ang pahintulot sa lokasyon para sa Awtomatikong Proteksyon kapag wala sa bahay.",
    "Dịch vụ vị trí đang tắt nên Auto rời khỏi nhà không ổn định.": "Naka-off ang serbisyo ng lokasyon, kaya maaaring hindi gumana nang maaasahan ang Awtomatikong Proteksyon kapag wala sa bahay.",
    "Chỉ cần quyền này khi dùng Auto rời khỏi nhà.": "Kailangan lang ito kapag ginagamit ang Awtomatikong Proteksyon kapag wala sa bahay.",
    "Chưa cấp vị trí luôn luôn": "Hindi pinapayagan ang lokasyon sa lahat ng oras",
    "Đã cấp vị trí luôn luôn": "Pinapayagan ang lokasyon sa lahat ng oras",
    "iOS không mở toàn màn hình như Android; app dùng notification và âm thanh hệ thống.": "Hindi nagbubukas ng full-screen ang iOS tulad ng Android; gumagamit ang app ng mga notification at tunog ng system.",
    "Android dùng cảnh báo toàn màn hình; nếu máy chặn, hãy cấp quyền trong cài đặt.": "Gumagamit ang Android ng mga full-screen na alerto; payagan ito sa mga setting kung hinaharangan ng telepono.",
    "Cảnh báo trên iOS": "Mga alerto sa iOS",
    "Cảnh báo toàn màn hình": "Mga full-screen na alerto",
    "Cảnh báo có thể không hiển thị nếu thông báo bị tắt.": "Maaaring hindi lumabas ang mga alerto kung naka-disable ang mga notification.",
    "Điện thoại có thể nhận thông báo SafeHome.": "Makakatanggap ang teleponong ito ng mga notification ng SafeHome.",
    ...
    "Hệ thống: Có thể bỏ lỡ cảnh báo": "System: Maaaring hindi matanggap ang ilang alerto",
    "Cách bạn đang dùng app": "Paano mo ginagamit ang app",
    "Thiết bị của bạn": "Ang iyong aparato",
    "Kiểm tra điện thoại và cách bạn đang dùng app.": "Sinusuri ang iyong telepono at kung paano mo ginagamit ang app.",
    "Hệ thống SafeHome": "System ng SafeHome",
    "Hệ thống: Đang kiểm tra...": "System: Sinusuri...",
    "Tên": "Pangalan",
    "Bạn không có quyền thay đổi vị trí nhà": "Wala kang pahintulot na baguhin ang lokasyon ng bahay",
    "Hãy bật GPS để đặt vị trí nhà": "I-on ang GPS para itakda ang lokasyon ng bahay",
    "Bạn chưa cấp quyền vị trí": "Hindi pa naibibigay ang pahintulot sa lokasyon",
    "Hãy cấp quyền vị trí trong Cài đặt ứng dụng": "Ibigay ang pahintulot sa lokasyon sa mga setting ng app",
    "Đã bật tự động Bảo vệ khi mọi người rời nhà": "Naka-enable ang Awtomatikong Proteksyon kapag umalis ang lahat sa bahay",
    "Đã tắt tự động Bảo vệ khi mọi người rời nhà": "Naka-disable ang Awtomatikong Proteksyon kapag umalis ang lahat sa bahay",
    ...
    "QR này không phải mã xin gia nhập Home": "Ang QR code na ito ay hindi code para sumali sa bahay",
    "Thêm Home": "Magdagdag ng bahay",
    "Mở cài đặt": "Buksan ang mga setting",
    "Để sau": "Mamaya",
    "SafeHome cần quyền vị trí \"Luôn cho phép\" để nhận biết khi bạn rời hoặc trở về nhà, kể cả khi ứng dụng đang chạy nền.": "Kailangan ng SafeHome ang pahintulot sa lokasyon na \"Palaging Payagan\" upang matukoy kung umalis ka o bumalik sa bahay, kahit tumatakbo ang app sa background.",
    "SafeHome hiện chỉ được truy cập vị trí khi bạn đang sử dụng ứng dụng.\n\nHãy chọn quyền Vị trí và chuyển sang \"Luôn cho phép\" để tính năng tự động Bảo vệ khi rời nhà hoạt động khi ứng dụng đang chạy nền.": "Kasalukuyang maa-access lang ng SafeHome ang lokasyon habang ginagamit mo ang app.\n\nBuksan ang setting ng pahintulot sa Lokasyon at piliin ang \"Palaging Payagan\" upang patuloy na gumana sa background ang awtomatikong proteksyon kapag wala sa bahay.",
    "Cho phép vị trí luôn luôn": "Palaging payagan ang access sa lokasyon",
    "Các nhà của bạn sẽ bị xoá.\nCác nhà được chia sẻ sẽ được rời khỏi.": "Tatanggalin ang mga bahay mo.\nAalis ka sa mga ibinahaging bahay.",
    "Thao tác này sẽ thay đổi lịch Home Alarm của toàn bộ thiết bị an ninh trong các nhà đã chọn.\n\nNhững thành viên đang sử dụng Alarm 'Theo nhà' sẽ bị ảnh hưởng.\nAlarm cá nhân ở chế độ 'Riêng tôi' sẽ không bị thay đổi.": "Babaguhin nito ang mga iskedyul ng Alarm ng bahay para sa lahat ng aparatong panseguridad sa mga napiling bahay.\n\nMaaapektuhan ang mga miyembrong gumagamit ng mga setting ng Alarm ng bahay.\nHindi mababago ang mga personal na setting ng Alarm.",
    "Thao tác này sẽ thêm Home Reminder cho các nhà đã chọn.\n\nNhững thành viên đang sử dụng Reminder 'Theo nhà' sẽ bị ảnh hưởng.\nReminder cá nhân ở chế độ 'Riêng tôi' sẽ không bị thay đổi.": "Magdaragdag ito ng Reminder ng bahay sa mga napiling bahay.\n\nMaaapektuhan ang mga miyembrong gumagamit ng mga setting ng Reminder ng bahay.\nHindi mababago ang mga personal na setting ng Reminder.",
    "Khi bật, các thiết bị an ninh sẽ được giám sát ngay.\n\nTự động Bảo vệ khi rời nhà sẽ tạm dừng. Chế độ này không tự tắt khi có người về nhà và chỉ được tắt khi một thành viên có quyền chủ động chuyển về Bình thường.": "Agad na susubaybayan ang mga aparatong panseguridad.\n\nIpo-pause ang Awtomatikong Proteksyon kapag wala sa bahay. Hindi awtomatikong nag-o-off ang mode na ito kapag may umuwi at maaari lang itong ibalik sa Normal ng miyembrong may pahintulot.",
    "Hành động này sẽ thay đổi thời gian báo động của một số thiết bị trong hôm nay...": "Babaguhin ng aksyong ito ang oras ng Alarm para sa ilang aparato ngayong araw...",
    "Hành động này sẽ tắt toàn bộ báo động của nhà dưới mọi hình thức. Bạn sẽ không còn nhận được cảnh báo khi có nguy hiểm trên điện thoại nữa.": "I-o-off ng aksyong ito ang lahat ng Alarm para sa bahay na ito. Hindi ka na makakatanggap ng mga alerto sa panganib sa teleponong ito.",
    "Alarm đang sử dụng chế độ Theo nhà.\n\nBạn sẽ nhận cảnh báo theo lịch Alarm chung do Chủ nhà hoặc Quản trị viên thiết lập.": "Ginagamit ng Alarm ang mga setting ng bahay.\n\nMakakatanggap ka ng mga alerto ayon sa ibinahaging iskedyul na itinakda ng may-ari o administrator.",
    "Alarm đang sử dụng chế độ Riêng tôi.\n\nBạn sẽ nhận cảnh báo theo lịch Alarm riêng đã thiết lập cho tài khoản này.": "Ginagamit ng Alarm ang mga setting na Para sa akin lang.\n\nMakakatanggap ka ng mga alerto ayon sa personal na iskedyul ng Alarm para sa account na ito.",
    ...
    "Chấp nhận": "Tanggapin",
    "Cho phép": "Payagan",
    "Không thể chấp nhận lời mời. Vui lòng thử lại.": "Hindi matanggap ang imbitasyon. Pakisubukang muli.",
    "Không thể chấp nhận lời xin vào nhà. Vui lòng thử lại.": "Hindi matanggap ang kahilingan na sumali. Pakisubukang muli.",
    "Từ chối": "Tanggihan",
    ...
    "Pair": "Ipares",
    "Mật khẩu tối thiểu 6 ký tự": "Dapat may hindi bababa sa 6 na character ang password",
    ...
    "Hãy chọn quyền vị trí Luôn cho phép trong Cài đặt ứng dụng": "Piliin ang pahintulot sa lokasyon na Palaging Payagan sa mga setting ng app",
    "Tài khoản Google cần tạo thêm mật khẩu để dùng các chức năng bảo mật.": "Kailangan ng karagdagang password ang iyong Google account para magamit ang mga feature ng seguridad.",
    "Alarm": "Alarm",
    "Bạn không có quyền thực hiện thao tác này。": "Wala kang pahintulot na gawin ang aksyong ito.",
    "Cài đặt": "Mga setting",
    "Cập nhật": "I-update",
    "Chọn ngôn ngữ": "Pumili ng wika",
    "Chưa có dữ liệu thiết bị để đánh giá": "Walang datos ng aparato para sa pagtatasa",
    "Chuyển quyền sở hữu cho thành viên khác": "Ilipat ang pagmamay-ari sa ibang miyembro",
    "Có": "Oo",
    ...
    "Đang mở khi nhà ở chế độ Bảo vệ": "Bukas habang nasa Mode ng Proteksyon ang bahay",
    "Đang mở trong giờ Alarm": "Bukas sa oras ng Alarm",
    "Đang tải...": "Naglo-load...",
    "Hồ sơ, yêu cầu và lời mời tham gia": "Profile, mga kahilingan, at imbitasyon",
    ...
    "Khóa đang mở khi nhà ở chế độ Bảo vệ": "Naka-unlock habang nasa Mode ng Proteksyon ang bahay",
    ...
    "Mời người khác tham gia nhà này": "Mag-imbita ng isang tao na sumali sa bahay na ito",
    ...
    "Thêm, đổi tên và sắp xếp phòng": "Magdagdag, magpalit ng pangalan, at mag-ayos ng mga kuwarto",
    ...
    "Vai trò": "Tungkulin",
    "Về nhà": "Nasa bahay",
    "Xem và quản lý quyền thành viên": "Tingnan at pamahalaan ang mga tungkulin ng miyembro",
    "Xóa": "Tanggalin",
    ...
    "Mode Bảo vệ thủ công đã bật": "Naka-enable ang manu-manong Mode ng Proteksyon",
    "Báo động không lặp lại.": "Hindi uulit ang Alarm.",
    "Báo động lặp sau \$securityModeRepeatMinutes phút nếu sự cố vẫn còn.": "Uulit ang Alarm pagkalipas ng \$securityModeRepeatMinutes minuto kung magpapatuloy ang problema.",
    "\$actorName đã bật Mode Bảo vệ thủ công cho \"\$homeName\". Chế độ này chỉ tắt khi một thành viên có quyền chủ động chuyển về Bình thường. \$repeatMessage": "Manu-manong in-on ni \$actorName ang Mode ng Proteksyon para sa \"\$homeName\". Mananatiling naka-on ang mode na ito hanggang ibalik ito sa Normal ng miyembrong may pahintulot. \$repeatMessage",
    "Bạn đã bật Alarm cho nhà \"\$homeName\".": "In-enable mo ang Alarm para sa bahay na \"\$homeName\".",
    "Bạn đã tắt toàn bộ Alarm của nhà \"\$homeName\".": "In-off mo ang lahat ng Alarm ng bahay na \"\$homeName\".",
    "Thành viên mới": "Bagong miyembro",
    "Thành viên rời nhà": "Umalis ang miyembro sa bahay",
    "\$displayMemberName đã rời khỏi nhà \"\$homeName\".": "Umalis si \$displayMemberName sa bahay na \"\$homeName\".",
    "\$actorName đã đổi vai trò của \$memberName từ \$oldRoleName thành \$newRoleName trong nhà \"\$homeName\".": "Pinalitan ni \$actorName ang tungkulin ni \$memberName mula \$oldRoleName patungong \$newRoleName sa bahay na \"\$homeName\".",
    ...
    "Đang theo dõi để tự động bật Chế độ Bảo vệ.": "Sinusubaybayan upang awtomatikong i-on ang Mode ng Proteksyon.",
    "Dùng vị trí để tự động bật Chế độ Bảo vệ khi mọi người rời nhà.": "Ginagamit ang lokasyon upang awtomatikong i-on ang Mode ng Proteksyon kapag umalis ang lahat sa bahay.",
    ...
    "Không thể xác nhận với SafeHome. Hãy kiểm tra kết nối và thử lại.": "Hindi makumpirma ng SafeHome. Suriin ang koneksyon at subukang muli.",
    "Chỉ tắt cảnh báo khi bạn đã kiểm tra tình trạng trong nhà.\n\nBạn chắc chắn muốn tắt cảnh báo?": "I-off lamang ang alerto pagkatapos suriin ang kalagayan ng bahay.\n\nSigurado ka bang gusto mong i-off ang alerto?",
    "🚨 SafeHome phát hiện cảnh báo": "🚨 May natukoy na alerto ang SafeHome",
    "Mở SafeHome để kiểm tra ngay.": "Buksan ang SafeHome upang suriin ito ngayon.",
    ...
    "Mode Bảo vệ sẽ chỉ báo động một lần": "Isang beses lang mag-aalerto ang Mode ng Proteksyon",
    "Mode Bảo vệ sẽ lặp báo động sau \$minutes phút": "Uulit ang alerto ng Mode ng Proteksyon pagkalipas ng \$minutes minuto",
    "Đã gửi yêu cầu gia nhập \$count nhà": "Naipadala ang mga kahilingang sumali sa \$count bahay",
    "\$requesterName đang xin gia nhập nhà \"\$homeName\".": "Humiling si \$requesterName na sumali sa bahay na \"\$homeName\".",
    "Bạn đã xoá nhà \"\$homeName\".": "Tinanggal mo ang bahay na \"\$homeName\".",
    "Bạn đã gửi yêu cầu chuyển quyền chủ nhà \"\$homeName\" cho \$email.": "Nagpadala ka kay \$email ng kahilingan na ilipat ang pagmamay-ari ng bahay na \"\$homeName\".",
    "\$actorName muốn chuyển quyền chủ nhà \"\$homeName\" cho bạn.": "Gustong ilipat ni \$actorName sa iyo ang pagmamay-ari ng bahay na \"\$homeName\".",
    "\$actorName đã mời bạn tham gia nhà \"\$homeName\".": "Inimbitahan ka ni \$actorName na sumali sa bahay na \"\$homeName\".",
    "SafeHome đang xoá thiết bị \"\$deviceName\" khỏi nhà \"\$homeName\".": "Tinatanggal ng SafeHome ang \"\$deviceName\" mula sa bahay na \"\$homeName\".",
    "Thiết bị \"\$deviceName\" đã xuất hiện trong \"\$homeName\".": "Naidagdag ang aparatong \"\$deviceName\" sa bahay na \"\$homeName\".",
    "Bạn đã tạo nhà \"\$name\".": "Nagawa mo na ang bahay na \"\$name\".",
    "\$actorName đã cập nhật tên nhà thành \"\$newName\" và thay đổi địa chỉ.": "Pinalitan ni \$actorName ng \"\$newName\" ang pangalan ng bahay at binago rin ang address nito.",
    "\$actorName đã đổi tên nhà thành \"\$newName\".": "Pinalitan ni \$actorName ng \"\$newName\" ang pangalan ng bahay.",
    "\$actorName đã cập nhật địa chỉ của nhà \"\$newName\".": "In-update ni \$actorName ang address ng bahay na \"\$newName\".",
    "\$actorName đã đổi tên thiết bị \"\$oldDeviceName\" thành \"\$newName\" trong nhà \"\$homeName\".": "Pinalitan ni \$actorName ng \"\$newName\" ang pangalan ng aparatong \"\$oldDeviceName\" sa bahay na \"\$homeName\".",
    "Đang ghép nối: \$seconds giây": "Ipinapares: \$seconds segundo",
    "Chế độ thêm thiết bị đã được mở trong nhà \"\$homeName\" trong \$seconds giây.": "Naka-enable ang pagpapares ng aparato sa bahay na \"\$homeName\" sa loob ng \$seconds segundo.",
    "Khoảng thời gian phải nằm trong khung Alarm (\$start → \$end)": "Dapat nasa loob ng iskedyul ng Alarm ang panahon ng pag-pause (\$start → \$end)",
    "\$passCount/\$total bài test đạt\n\n": "\$passCount/\$total pagsusuri ang pumasa\n\n",
    "\$name chưa cập nhật số điện thoại trong hồ sơ.": "Hindi pa nagdagdag si \$name ng numero ng telepono sa profile.",
    ...
    "\"\$name\" phát hiện khói trong \"\$homeName\".": "Natukoy ng \"\$name\" ang usok sa bahay na \"\$homeName\".",
    "\"\$name\" đã trở lại trạng thái bình thường.": "Bumalik na sa normal ang \"\$name\".",
    "\"\$name\" vừa kích hoạt SOS trong \"\$homeName\".": "Na-trigger ng \"\$name\" ang SOS sa bahay na \"\$homeName\".",
    "\"\$name\" đã hết trạng thái SOS.": "Wala na sa SOS status ang \"\$name\".",
    "\"\$name\" báo bị tháo/cạy trong \"\$homeName\".": "Natukoy ng \"\$name\" ang pakikialam sa bahay na \"\$homeName\".",
    "\"\$name\" đã hết cảnh báo tháo/cạy.": "Natapos na ang alerto sa pakikialam para sa \"\$name\".",
    "\"\$name\" đã đóng trong \"\$homeName\".": "Nagsara ang \"\$name\" sa bahay na \"\$homeName\".",
    "\"\$name\" đang mở trong \"\$homeName\".": "Bukas ang \"\$name\" sa bahay na \"\$homeName\".",
    "\"\$name\" trong \"\$homeName\" đang yếu pin.": "Mahina ang baterya ng \"\$name\" sa bahay na \"\$homeName\".",
    "\"\$name\" trong \"\$homeName\" đã mất kết nối.": "Nag-offline ang \"\$name\" sa bahay na \"\$homeName\".",
    "\"\$name\" trong \"\$homeName\" đã kết nối trở lại.": "Online na muli ang \"\$name\" sa bahay na \"\$homeName\".",
    "\"\$name\" ghi nhận nhiệt độ cao trong \"\$homeName\".": "Nagtala ang \"\$name\" ng mataas na temperatura sa bahay na \"\$homeName\".",
    "\"\$name\" ghi nhận độ ẩm cao trong \"\$homeName\".": "Nagtala ang \"\$name\" ng mataas na halumigmig sa bahay na \"\$homeName\".",
    ...
    "Có cửa đang mở hoặc thiết bị bị tháo": "May bukas na pinto o may aparatong pinakialaman",
    "Có thiết bị đang cảnh báo": "May aparatong nag-aalerto",
    "Nếu chưa có ai xác nhận, SafeHome sẽ chuyển sang gọi điện khẩn cấp.": "Kung walang magkumpirma, magsasagawa ang SafeHome ng emergency call.",
    "Báo lại lúc \$time nếu vấn đề chưa được xử lý.": "Mag-aalerto muli sa \$time kung hindi pa nalulutas ang problema.",
    "Sẽ báo lại theo lịch Alarm đã cài nếu vấn đề chưa được xử lý.": "Mag-aalerto muli ayon sa iskedyul ng Alarm kung hindi pa nalulutas ang problema.",
    "\"\$deviceName\" đã đóng trong \"\$resolvedHomeName\".": "Nagsara ang \"\$deviceName\" sa bahay na \"\$resolvedHomeName\".",
    "\"\$deviceName\" đang mở trong \"\$resolvedHomeName\".": "Bukas ang \"\$deviceName\" sa bahay na \"\$resolvedHomeName\".",
    "\$count nhà đã chọn": "\$count bahay ang napili",
    "🚨 \$count nhà không an toàn\$suffix": "🚨 \$count bahay ang hindi ligtas\$suffix",
    "⚠️ \$count nhà cần chú ý\$suffix": "⚠️ \$count bahay ang kailangang bigyang-pansin\$suffix",
    ...
    "Đã cài Reminder cho \$updatedHomes nhà.": "Naitakda ang Reminder para sa \$updatedHomes bahay.",
    "Đã cài Alarm cho \$updatedDevices thiết bị trong \$updatedHomes nhà.\n": "Naitakda ang Alarm para sa \$updatedDevices aparato sa \$updatedHomes bahay.\n",
    "Đã chia sẻ các nhà bạn có quyền.\n\n\$skipped nhà bị bỏ qua vì bạn không có quyền chia sẻ.": "Naibahagi ang mga bahay na pinamamahalaan mo.\n\nNilaktawan ang \$skipped bahay dahil wala kang pahintulot na ibahagi ang mga ito.",
    "Đã áp dụng Alarm cho \$count thiết bị an ninh": "Inilapat ang Alarm sa \$count aparatong panseguridad",
    "Áp dụng cùng một lịch cho \$count thiết bị an ninh": "Ilapat ang parehong iskedyul sa \$count aparatong panseguridad",
    ...
    "\${hours}h\$minutes' trước": "\${hours} oras at \${minutes} minuto ang nakalipas",
    "\$count ngày trước": "\$count araw ang nakalipas",
    "\$count tháng trước": "\$count buwan ang nakalipas",
    "Bạn chắc chắn muốn xoá \$name khỏi nhà này?": "Sigurado ka bang gusto mong alisin si \$name sa bahay na ito?",
    "\$targetEmail\nXin gia nhập \"\$homeName\"": "\$targetEmail\nHumihiling na sumali sa \"\$homeName\"",
    "Xin gia nhập \"\$homeName\"": "Humihiling na sumali sa \"\$homeName\"",
    "Bạn được mời nhận quyền nhà \"\$homeName\"": "Inimbitahan kang tanggapin ang pagmamay-ari ng bahay na \"\$homeName\"",
    "\$ownerEmail\nMời bạn gia nhập \"\$homeName\"": "\$ownerEmail\nIniimbitahan kang sumali sa \"\$homeName\"",
    "Mời bạn gia nhập \"\$homeName\"": "Iniimbitahan kang sumali sa \"\$homeName\"",
    "Cần kiểm tra: \$joined": "Kailangang bigyang-pansin: \$joined",
    "Cập nhật \$value": "In-update ang \$value",
    "Hãy thêm thiết bị SafeHome đầu tiên để bắt đầu theo dõi nhà.": "Idagdag ang una mong aparatong SafeHome upang simulang subaybayan ang bahay na ito.",
    "Kiểm tra cảnh báo khẩn cấp trước, sau đó liên hệ thành viên trong nhà nếu cần.": "Suriin muna ang mga alertong pang-emergency, pagkatapos ay kontakin ang mga miyembro ng bahay kung kailangan.",
    "Không có thành viên nào ở nhà nhưng cửa hoặc khóa đang mở, hãy kiểm tra ngay.": "Walang miyembro sa bahay ngunit may bukas na pinto o lock. Suriin ito ngayon.",
    "Kiểm tra cửa hoặc khóa đang mở trước khi giữ nhà ở chế độ Bảo vệ.": "Suriin ang bukas na pinto o lock bago panatilihin ang bahay na ito sa Mode ng Proteksyon.",
    "Có thể vẫn có người ở nhà; nếu đúng, nên chuyển về Bình thường.": "Maaaring may tao pa sa bahay. Kung gayon, ibalik ang bahay sa Normal.",
    "Có thành viên chưa xác định vị trí, hãy nhắc họ mở app hoặc kiểm tra quyền vị trí.": "Hindi matukoy ang lokasyon ng ilang miyembro. Hilingin sa kanila na buksan ang app o suriin ang pahintulot sa lokasyon.",
    "Có thiết bị mất kết nối, hãy kiểm tra pin, nguồn hoặc vị trí đặt thiết bị.": "May aparatong nadiskonekta. Tingnan ang baterya, kuryente, o puwesto nito.",
    "Có thiết bị pin yếu, nên thay pin sớm để tránh mất cảnh báo.": "May aparatong mahina ang baterya. Palitan ito agad upang hindi mapalampas ang mga alerto.",
    "Bạn chưa đặt Reminder, nên tạo lịch nhắc kiểm tra nhà định kỳ.": "Hindi pa nakatakda ang Reminder. Gumawa ng iskedyul upang regular na suriin ang iyong bahay.",
    "Bạn chưa đặt lịch Alarm, nên bật bảo vệ theo khung giờ thường vắng nhà.": "Hindi pa nakatakda ang iskedyul ng Alarm. I-enable ang proteksyon sa mga oras na karaniwan kang wala.",
    "Không có việc cần xử lý ngay, bạn chỉ cần tiếp tục theo dõi trạng thái nhà.": "Walang kailangang aksyunan agad. Patuloy lang na subaybayan ang bahay na ito.",
    ...
    "Phát hiện \$count vấn đề cần xử lý": "May natukoy na \$count problemang kailangang aksyunan",
    "Hôm nay các cửa đã được sử dụng \$count lần": "Ginamit ang mga pinto nang \$count beses ngayong araw",
    "Đã ghi nhận \$count hoạt động gần đây": "Naitala ang \$count kamakailang aktibidad",
    "Hệ thống: Cần kiểm tra \$issueCount mục": "System: May \$issueCount item na kailangang suriin",
    "FCM token đã sẵn sàng trên điện thoại này.": "Handa na ang FCM token sa teleponong ito.",
    "FCM token đã sẵn sàng, nhưng Auto rời khỏi nhà còn thiếu điều kiện.": "Handa na ang FCM token, ngunit may kulang pang kinakailangan para sa Awtomatikong Proteksyon kapag wala sa bahay.",
    "Hiện có \$emergencyTotal thiết bị khẩn cấp. Khuyến nghị tối thiểu: báo khói và SOS.": "May \$emergencyTotal aparatong pang-emergency. Inirerekomendang minimum: sensor ng usok at SOS.",
    "Bạn chắc chắn muốn chuyển quyền chủ nhà cho:\n\$targetEmail?": "Ilipat ang pagmamay-ari ng bahay kay:\n\$targetEmail?",
    ...
    "Dữ liệu gần nhất cập nhật \$count phút trước": "Huling na-update ang datos \$count minuto ang nakalipas",
    "Dữ liệu gần nhất cập nhật \$count giờ trước": "Huling na-update ang datos \$count oras ang nakalipas",
    ...
    "Môi trường hiện tại: \$environment": "Kasalukuyang kapaligiran: \$environment",
    "\$name: Đang mở khi nhà ở chế độ Bảo vệ": "\$name: Bukas habang nasa Mode ng Proteksyon ang bahay",
    "An tâm hơn trong từng ngôi nhà": "Panatag sa bawat bahay",
    "Báo động SafeHome": "Alarm ng SafeHome",
    "Có cảnh báo an ninh cần kiểm tra ngay.": "May alerto sa seguridad na kailangang suriin agad.",
    ...
    "Hoặc": "O",
    "Giờ bắt đầu và kết thúc không được trùng nhau": "Hindi maaaring magkapareho ang oras ng pagsisimula at pagtatapos",
    "Giờ kết thúc phải sau thời điểm hiện tại": "Dapat mas huli sa kasalukuyang oras ang oras ng pagtatapos",
    "Khoảng tạm tắt không hợp lệ": "Di-wastong saklaw ng pag-pause ng Alarm",
    "Khoảng tạm tắt không trùng với lịch Alarm nào đang bật": "Hindi nag-o-overlap ang saklaw ng pag-pause sa anumang aktibong iskedyul ng Alarm",
  };
  ...
  static const Map<String, String> _khmer = {
    ...
    "Bạn không có quyền sửa lịch chung của nhà": "អ្នកមិនមានសិទ្ធិកែប្រែកាលវិភាគរួមរបស់ផ្ទះទេ",
    ...
    "Chưa có thiết bị, hãy nhấn nút + để thêm để bắt đầu duy trì an ninh": "មិនទាន់មានឧបករណ៍ទេ។ ចុច + ដើម្បីបន្ថែមឧបករណ៍ និងចាប់ផ្ដើមការពារផ្ទះរបស់អ្នក។",
    "CHƯA AN TOÀN": "មិនមានសុវត្ថិភាព",
    "ĐÃ AN TOÀN": "មានសុវត្ថិភាព",
    "Nhà đang có dấu hiệu cần kiểm tra, bạn nên xem lại các trạng thái bên dưới.": "ផ្ទះរបស់អ្នកត្រូវការការយកចិត្តទុកដាក់។ សូមពិនិត្យស្ថានភាពខាងក្រោម។",
    "Nhà đang hoạt động ổn định, bạn có thể yên tâm.": "ផ្ទះរបស់អ្នកកំពុងដំណើរការធម្មតា។",
    "Không có dấu hiệu khói hoặc SOS bất thường.": "មិនរកឃើញផ្សែងខុសប្រក្រតី ឬសកម្មភាព SOS ទេ។",
    "Chưa có nhiều hoạt động mới để phân tích sâu hơn.": "មិនទាន់មានសកម្មភាពថ្មីៗគ្រប់គ្រាន់សម្រាប់ការវិភាគលម្អិតទេ។",
    ...
    "Nhắc kiểm tra nhà theo thời gian": "កំណត់កាលវិភាគ Reminder ដើម្បីពិនិត្យផ្ទះ",
    ...
    "Không có nhà nào đủ điều kiện để cài": "រកមិនឃើញផ្ទះដែលមានលក្ខខណ្ឌគ្រប់គ្រាន់ទេ",
    ...
    "Đặt vị trí nhà và bật bảo vệ tự động": "កំណត់ទីតាំងផ្ទះ និងបើកការការពារដោយស្វ័យប្រវត្តិ",
    "Chuyển quyền chủ nhà hoặc xoá nhà": "ផ្ទេរសិទ្ធិម្ចាស់ផ្ទះ ឬលុបផ្ទះ",
    "Đặt Reminder / Alarm nhà đã chọn": "កំណត់ Reminder / Alarm សម្រាប់ផ្ទះដែលបានជ្រើសរើស",
    ...
    "Các nhà đã chọn sẽ bị xoá vĩnh viễn.": "ផ្ទះដែលបានជ្រើសរើសនឹងត្រូវលុបជាអចិន្ត្រៃយ៍។",
    "Hoặc quét QR để xin gia nhập các nhà đã chọn": "ឬស្កេនកូដ QR ដើម្បីស្នើសុំសិទ្ធិចូលប្រើផ្ទះដែលបានជ្រើសរើស",
    ...
    "Không có nhà nào bạn có quyền quản lý": "អ្នកមិនមានផ្ទះណាមួយដែលអ្នកមានសិទ្ធិគ្រប់គ្រងទេ",
    ...
    "Chỉ chủ nhà mới được chuyển quyền": "មានតែម្ចាស់ផ្ទះប៉ុណ្ណោះដែលអាចផ្ទេរសិទ្ធិម្ចាស់ផ្ទះបាន",
    ...
    "Tắt Alarm": "បិទ Alarm",
    "Cả ngày": "ពេញមួយថ្ងៃ",
    "Bạn không có quyền thực hiện thao tác này.": "អ្នកមិនមានសិទ្ធិធ្វើសកម្មភាពនេះទេ។",
    "Không thể hoàn tất thao tác. Vui lòng thử lại.": "មិនអាចបញ្ចប់សកម្មភាពបានទេ។ សូមព្យាយាមម្ដងទៀត។",
    "QR gia nhập nhiều nhà không hợp lệ": "កូដ QR សម្រាប់ស្នើចូលរួមផ្ទះច្រើនមិនត្រឹមត្រូវ",
    ...
    "QR này không phải mã xin gia nhập nhà": "កូដ QR នេះមិនមែនជាកូដសម្រាប់ចូលរួមផ្ទះទេ",
    ...
    "Nhà này và toàn bộ thiết bị bên trong sẽ bị xoá vĩnh viễn.": "ផ្ទះនេះ និងឧបករណ៍ទាំងអស់នឹងត្រូវលុបជាអចិន្ត្រៃយ៍។",
    "Đã xoá nhà": "បានលុបផ្ទះ",
    "QR của nhà này": "កូដ QR របស់ផ្ទះ",
    "Người khác quét mã này để gửi yêu cầu gia nhập nhà.": "អ្នកផ្សេងអាចស្កេនកូដនេះដើម្បីស្នើសុំសិទ្ធិចូលប្រើផ្ទះ។",
    ...
    "Mã QR này do chủ nhà chia sẻ":
        "កូដ QR នេះត្រូវបានចែករំលែកដោយម្ចាស់ផ្ទះ",
    ...
    "Không thể chuyển quyền cho chính bạn": "អ្នកមិនអាចផ្ទេរសិទ្ធិម្ចាស់ផ្ទះទៅខ្លួនឯងបានទេ",
    ...
    "Thêm số điện thoại để dùng cho các trường hợp khẩn cấp": "បន្ថែមលេខទូរសព្ទសម្រាប់ពេលមានអាសន្ន",
    "Hoàn tất": "រួចរាល់",
    ...
    "Xoá phòng": "លុបបន្ទប់",
    "Thiết bị trong phòng này sẽ được chuyển về Chưa phân phòng.": "ឧបករណ៍នៅក្នុងបន្ទប់នេះនឹងត្រូវផ្លាស់ទៅ «មិនទាន់កំណត់បន្ទប់»។",
    ...
    "Hãy đặt vị trí nhà trước khi bật tự động Bảo vệ": "កំណត់ទីតាំងផ្ទះមុនពេលបើកការការពារដោយស្វ័យប្រវត្តិ",
    "Bán kính bảo vệ mặc định: 150 m": "កាំការពារលំនាំដើម៖ 150 m",
    "Mỗi thành viên sẽ cần cấp quyền vị trí Luôn cho phép để trạng thái rời/đến nhà hoạt động khi app chạy nền.": "សមាជិកនីមួយៗត្រូវផ្ដល់សិទ្ធិទីតាំង «អនុញ្ញាតជានិច្ច» ដើម្បីឱ្យស្ថានភាពនៅក្រៅ/ក្នុងផ្ទះដំណើរការ ពេលកម្មវិធីដំណើរការនៅផ្ទៃខាងក្រោយ។",
    ...
    "Tên này chỉ hiển thị riêng trên tài khoản của bạn.": "ឈ្មោះនេះបង្ហាញតែនៅលើគណនីរបស់អ្នកប៉ុណ្ណោះ។",
    "Tên và địa chỉ sẽ được cập nhật cho toàn bộ thành viên trong nhà.": "ឈ្មោះ និងអាសយដ្ឋាននឹងត្រូវធ្វើបច្ចុប្បន្នភាពសម្រាប់សមាជិកផ្ទះទាំងអស់។",
    ...
    "Hãy thực hiện kiểm tra bằng tài khoản Owner": "ដំណើរការការសាកល្បងនេះដោយប្រើគណនីម្ចាស់ផ្ទះ",
    "Không đọc được dữ liệu nhà": "មិនអាចអានទិន្នន័យផ្ទះបានទេ",
    "Nhà cần có ít nhất một thiết bị để test": "ផ្ទះត្រូវមានឧបករណ៍យ៉ាងហោចណាស់មួយសម្រាប់ការសាកល្បង",
    "Đóng": "បិទ",
    "Đã thiết lập": "កំណត់",
    "Quét QR": "ស្កេន QR",
    "Quét QR để thêm thiết bị": "ស្កេន QR ដើម្បីបន្ថែមឧបករណ៍",
    "Nhập HUB ID thủ công": "បញ្ចូល ID របស់ Hub ដោយដៃ",
    "Bạn không có quyền sắp xếp phòng": "អ្នកមិនមានសិទ្ធិរៀបចំលំដាប់បន្ទប់ឡើងវិញទេ",
    ...
    "Dùng lịch chung do Chủ nhà hoặc Quản trị viên thiết lập": "ប្រើកាលវិភាគរួមដែលម្ចាស់ផ្ទះ ឬអ្នកគ្រប់គ្រងបានកំណត់",
    "Dùng lịch riêng chỉ áp dụng cho tài khoản của bạn": "ប្រើកាលវិភាគផ្ទាល់ខ្លួនដែលអនុវត្តតែលើគណនីរបស់អ្នក",
    ...
    "Hôm nay đã ghi nhận cảnh báo SOS": "មានការជូនដំណឹង SOS មួយត្រូវបានកត់ត្រានៅថ្ងៃនេះ",
    "Hôm nay đã ghi nhận cảnh báo khói": "មានការជូនដំណឹងអំពីផ្សែងមួយត្រូវបានកត់ត្រានៅថ្ងៃនេះ",
    ...
    "Tự động Bảo vệ khi rời nhà vẫn đang bật. Nếu mọi thành viên vẫn ở ngoài, hệ thống có thể tự bật lại Bảo vệ sau vài phút.": "ការការពារដោយស្វ័យប្រវត្តិនៅពេលចាកចេញពីផ្ទះនៅតែបានបើក។ ប្រសិនបើសមាជិកទាំងអស់នៅតែនៅក្រៅផ្ទះ ប្រព័ន្ធអាចបើកមុខងារការពារឡើងវិញបន្ទាប់ពីពីរបីនាទី។",
    "Chuyển về Bình thường?": "ប្ដូរទៅធម្មតាមែនទេ?",
    "Khi bật, các thiết bị an ninh sẽ được giám sát ngay.\n\n": "ឧបករណ៍សន្តិសុខនឹងត្រូវតាមដានភ្លាមៗ។\n\n",
    "Bật Bảo vệ thủ công?": "បើកមុខងារការពារដោយដៃមែនទេ?",
    "Hành động này sẽ thay đổi thời gian báo động của một số thiết bị ": "សកម្មភាពនេះនឹងផ្លាស់ប្ដូរពេលវេលា Alarm សម្រាប់ឧបករណ៍មួយចំនួននៅថ្ងៃនេះ...",
    "Hành động này sẽ tắt toàn bộ báo động của nhà ": "សកម្មភាពនេះនឹងបិទ Alarm ទាំងអស់សម្រាប់ ",
    ...
    "Không thể xác nhận tài khoản hiện tại": "មិនអាចផ្ទៀងផ្ទាត់គណនីបច្ចុប្បន្នបានទេ",
    "Mật khẩu không đúng": "ពាក្យសម្ងាត់មិនត្រឹមត្រូវ",
    "Không thể xác nhận mật khẩu": "មិនអាចផ្ទៀងផ្ទាត់ពាក្យសម្ងាត់បានទេ",
    "Chỉ Chủ nhà hoặc Quản trị viên mới có quyền thay đổi lặp báo động": "មានតែម្ចាស់ផ្ទះ ឬអ្នកគ្រប់គ្រងប៉ុណ្ណោះដែលអាចផ្លាស់ប្ដូរការកំណត់ការកើតឡើងវិញរបស់ Alarm",
    "Không lưu được thời gian lặp báo động": "មិនអាចរក្សាទុកពេលវេលាកើតឡើងវិញរបស់ Alarm បានទេ",
    "Chỉ Chủ nhà hoặc Quản trị viên mới có quyền thay đổi Mode Bảo vệ": "មានតែម្ចាស់ផ្ទះ ឬអ្នកគ្រប់គ្រងប៉ុណ្ណោះដែលអាចផ្លាស់ប្ដូរមុខងារការពារ",
    "Không thể thay đổi chế độ nhà": "មិនអាចផ្លាស់ប្ដូរមុខងារផ្ទះបានទេ",
    "Đã bật Bảo vệ nhưng chưa gửi được thông báo": "មុខងារការពារបានបើក ប៉ុន្តែមិនអាចផ្ញើការជូនដំណឹងបានទេ",
    "Đã bật Mode Bảo vệ thủ công": "បានបើកមុខងារការពារដោយដៃ",
    "Đã chuyển nhà về Bình thường": "ផ្ទះបានប្ដូរត្រឡប់ទៅធម្មតា",
    "60 phút": "60 នាទី",
    "30 phút": "30 នាទី",
    "15 phút": "15 នាទី",
    "Bạn đang xem lịch của chủ nhà. Chọn Riêng tôi để tự đặt lịch Alarm.": "អ្នកកំពុងមើលកាលវិភាគរបស់ម្ចាស់ផ្ទះ។ ជ្រើសរើស «សម្រាប់ខ្ញុំប៉ុណ្ណោះ» ដើម្បីកំណត់កាលវិភាគ Alarm ផ្ទាល់ខ្លួន។",
    "Chọn giờ kết thúc Alarm": "ជ្រើសរើសម៉ោងបញ្ចប់ Alarm",
    "Chọn giờ bắt đầu Alarm": "ជ្រើសរើសម៉ោងចាប់ផ្ដើម Alarm",
    "Bạn không có quyền sửa lịch Alarm của nhà": "អ្នកមិនមានសិទ្ធិកែសម្រួលកាលវិភាគ Alarm របស់ផ្ទះនេះទេ",
    "Không thể áp dụng Alarm cho toàn bộ thiết bị": "មិនអាចអនុវត្ត Alarm លើឧបករណ៍ទាំងអស់បានទេ",
    "Nhà chưa có thiết bị an ninh để áp dụng": "ផ្ទះនេះគ្មានឧបករណ៍សន្តិសុខសម្រាប់អនុវត្តទេ",
    "Bạn không có quyền sửa lịch Theo nhà. Hãy chọn Riêng tôi.": "អ្នកមិនមានសិទ្ធិកែសម្រួលការកំណត់ផ្ទះទេ។ ជ្រើសរើស «សម្រាប់ខ្ញុំប៉ុណ្ណោះ»។",
    "Không thể lưu chế độ Alarm": "មិនអាចរក្សាទុកមុខងារ Alarm បានទេ",
    "Thêm Reminder": "បន្ថែម Reminder",
    "Reminder sẽ nhắc bạn kiểm tra trạng thái an toàn của ngôi nhà vào giờ đã chọn.": "Reminder នឹងរំលឹកអ្នកឱ្យពិនិត្យស្ថានភាពសុវត្ថិភាពផ្ទះតាមម៉ោងដែលបានជ្រើសរើស។",
    "Thêm khung giờ Alarm": "បន្ថែមចន្លោះពេល Alarm",
    "Đang sử dụng Reminder riêng của bạn": "កំពុងប្រើការកំណត់ Reminder ផ្ទាល់ខ្លួនរបស់អ្នក",
    "Đang sử dụng Reminder của chủ nhà": "កំពុងប្រើការកំណត់ Reminder របស់ម្ចាស់ផ្ទះ",
    ...
    "Đồng ý": "យល់ព្រម",
    "Bạn chắc chắn muốn rời khỏi nhà này?": "តើអ្នកប្រាកដថាចង់ចាកចេញពីផ្ទះនេះមែនទេ?",
    "Xoá thành viên?": "ដកសមាជិកចេញមែនទេ?",
    "Rời khỏi nhà?": "ចាកចេញពីផ្ទះនេះមែនទេ?",
    "Chỉ chủ nhà mới được thay đổi vai trò": "មានតែម្ចាស់ផ្ទះប៉ុណ្ណោះដែលអាចផ្លាស់ប្ដូរតួនាទីបាន",
    ...
    "Thành viên chưa cập nhật số điện thoại": "សមាជិកនេះមិនទាន់បានបន្ថែមលេខទូរសព្ទទេ",
    "Bảo vệ thủ công đang bật - chỉ tắt khi chuyển về Bình thường": "មុខងារការពារដោយដៃបានបើក — ប្ដូរទៅធម្មតាដើម្បីបិទវា",
    "Thời gian lặp": "ចន្លោះពេលកើតឡើងវិញ",
    "Chọn 0 để chỉ báo một lần. Cài đặt này dùng cho cả Bảo vệ thủ công và Tự động Bảo vệ khi rời nhà.": "ជ្រើសរើស 0 ដើម្បីឱ្យជូនដំណឹងតែម្ដង។ ការកំណត់នេះអនុវត្តលើមុខងារការពារដោយដៃ និងការការពារដោយស្វ័យប្រវត្តិនៅពេលចាកចេញពីផ្ទះ។",
    ...
    "Thiết bị SOS chưa ghi nhận cảnh báo.": "ឧបករណ៍ SOS មិនទាន់បានកត់ត្រាការជូនដំណឹងទេ។",
    "Cảm biến khói chưa ghi nhận bất thường.": "ឧបករណ៍ចាប់ផ្សែងមិនបានរកឃើញបញ្ហាទេ។",
    "Bạn hoặc thành viên đã chủ động bật Bảo vệ.": "អ្នក ឬសមាជិកម្នាក់បានបើកមុខងារការពារដោយដៃ។",
    "SafeHome tự bật Bảo vệ vì bạn đã rời khỏi nhà.": "SafeHome បានបើកមុខងារការពារដោយស្វ័យប្រវត្តិ ព្រោះអ្នកបានចាកចេញពីផ្ទះ។",
    "Nhà đang ở chế độ dùng bình thường.": "បច្ចុប្បន្នផ្ទះនេះកំពុងប្រើប្រាស់ក្នុងមុខងារធម្មតា។",
    ...
    "Bạn đã mở app gần đây để kiểm tra trạng thái.": "ថ្មីៗនេះអ្នកបានបើកកម្មវិធីដើម្បីពិនិត្យស្ថានភាព។",
    "Bạn nên mở app định kỳ để kiểm tra quyền, lịch và cảnh báo chưa đọc.": "បើកកម្មវិធីជាប្រចាំ ដើម្បីពិនិត្យសិទ្ធិ កាលវិភាគ និងការជូនដំណឹងដែលមិនទាន់បានអាន។",
    "Sau vài lần sử dụng, SafeHome sẽ đánh giá thói quen kiểm tra app tốt hơn.": "បន្ទាប់ពីប្រើប្រាស់ពីរបីលើក SafeHome អាចវាយតម្លៃទម្លាប់ពិនិត្យកម្មវិធីរបស់អ្នកបានប្រសើរជាងមុន។",
    "Tần suất vào app ổn": "ភាពញឹកញាប់នៃការពិនិត្យកម្មវិធីល្អ",
    "Đã lâu chưa vào app kiểm tra": "មិនបានពិនិត្យកម្មវិធីអស់មួយរយៈហើយ",
    "Đang ghi nhận tần suất vào app": "កំពុងកត់ត្រាភាពញឹកញាប់នៃការពិនិត្យកម្មវិធី",
    "Cần kiểm tra quyền vị trí luôn luôn và điều kiện chạy nền.": "ពិនិត្យសិទ្ធិទីតាំង «អនុញ្ញាតជានិច្ច» និងលក្ខខណ្ឌដំណើរការផ្ទៃខាងក្រោយ។",
    "Thiết bị đủ điều kiện để Auto rời khỏi nhà hoạt động.": "ឧបករណ៍នេះបំពេញលក្ខខណ្ឌសម្រាប់ការការពារដោយស្វ័យប្រវត្តិនៅពេលចាកចេញ។",
    "Bạn có thể bật khi muốn tự động chuyển Bảo vệ lúc rời nhà.": "បើកវា ប្រសិនបើអ្នកចង់ឱ្យមុខងារការពារបើកដោយស្វ័យប្រវត្តិពេលអ្នកចាកចេញ។",
    "Auto rời khỏi nhà chưa ổn": "ការការពារដោយស្វ័យប្រវត្តិនៅពេលចាកចេញមិនទាន់រួចរាល់",
    "Auto rời khỏi nhà đã sẵn sàng": "ការការពារដោយស្វ័យប្រវត្តិនៅពេលចាកចេញរួចរាល់",
    "Auto rời khỏi nhà chưa bật": "ការការពារដោយស្វ័យប្រវត្តិនៅពេលចាកចេញមិនទាន់បានបើក",
    "Nên thêm báo khói, SOS hoặc thiết bị khẩn cấp phù hợp với nhà.": "បន្ថែមឧបករណ៍ចាប់ផ្សែង SOS ឬឧបករណ៍បន្ទាន់ដែលសមស្របសម្រាប់ផ្ទះរបស់អ្នក។",
    "Chưa có thiết bị khẩn cấp": "មិនទាន់មានឧបករណ៍បន្ទាន់",
    "Đã có thiết bị khẩn cấp": "បានបន្ថែមឧបករណ៍បន្ទាន់",
    "Nên đặt lịch Alarm cho thời gian ngủ hoặc vắng nhà.": "កំណត់កាលវិភាគ Alarm សម្រាប់ពេលគេង ឬពេលអ្នកចាកចេញពីផ្ទះ។",
    "Nhà đã có lịch Alarm hoặc lịch cảnh báo theo thiết bị.": "ផ្ទះនេះមានកាលវិភាគ Alarm ឬកាលវិភាគជូនដំណឹងតាមឧបករណ៍។",
    "Chưa set lịch Alarm": "មិនទាន់បានកំណត់កាលវិភាគ Alarm",
    "Đã set lịch Alarm": "បានកំណត់កាលវិភាគ Alarm",
    "Nên có ít nhất một Reminder để không quên kiểm tra nhà.": "កំណត់ Reminder យ៉ាងហោចណាស់មួយ ដើម្បីកុំឱ្យអ្នកភ្លេចពិនិត្យផ្ទះ។",
    "App sẽ nhắc bạn kiểm tra nhà theo lịch đã đặt.": "កម្មវិធីនឹងរំលឹកអ្នកឱ្យពិនិត្យផ្ទះតាមកាលវិភាគ។",
    "Chưa setup Reminder": "មិនទាន់បានដំឡើង Reminder",
    "Đã setup Reminder": "បានដំឡើង Reminder",
    "Hãy mở lại app hoặc đăng nhập lại nếu thiết bị không nhận cảnh báo.": "បើកកម្មវិធីឡើងវិញ ឬចូលគណនីម្ដងទៀត ប្រសិនបើឧបករណ៍នេះមិនទទួលការជូនដំណឹង។",
    "Thiết bị chưa đăng ký nhận cảnh báo": "ឧបករណ៍នេះមិនទាន់បានចុះឈ្មោះសម្រាប់ទទួលការជូនដំណឹង",
    "Thiết bị nhận cảnh báo bình thường": "ឧបករណ៍នេះអាចទទួលការជូនដំណឹង",
    "iOS quản lý chạy nền chặt hơn Android; hãy giữ thông báo và vị trí luôn luôn nếu dùng Auto rời khỏi nhà.": "iOS គ្រប់គ្រងការប្រើប្រាស់ផ្ទៃខាងក្រោយតឹងរ៉ឹងជាង Android។ សូមបើកការជូនដំណឹង និងទីតាំង «អនុញ្ញាតជានិច្ច» ប្រសិនបើប្រើការការពារដោយស្វ័យប្រវត្តិនៅពេលចាកចេញ។",
    "Cơ chế iOS": "ដំណើរការរបស់ iOS",
    "Hãy kiểm tra quyền chạy nền và tự khởi động để cảnh báo không bị trễ.": "ពិនិត្យសិទ្ធិផ្ទៃខាងក្រោយ និងការចាប់ផ្ដើមដោយស្វ័យប្រវត្តិ ដើម្បីកុំឱ្យការជូនដំណឹងយឺត។",
    "Thiết bị đã xác nhận các điều kiện chạy nền quan trọng.": "ឧបករណ៍បានបញ្ជាក់លក្ខខណ្ឌផ្ទៃខាងក្រោយសំខាន់ៗ។",
    "Cần kiểm tra chạy nền / tự khởi động": "ពិនិត្យការប្រើប្រាស់ផ្ទៃខាងក្រោយ / ការចាប់ផ្ដើមដោយស្វ័យប្រវត្តិ",
    "Chạy nền ổn định": "ការប្រើប្រាស់ផ្ទៃខាងក្រោយមានស្ថិរភាព",
    "Một số máy Android có thể trì hoãn cảnh báo nếu tối ưu pin còn bật.": "ទូរសព្ទ Android មួយចំនួនអាចពន្យារការជូនដំណឹង ខណៈពេលការបង្កើនប្រសិទ្ធភាពថ្មបានបើក។",
    "Điện thoại ít có khả năng trì hoãn cảnh báo SafeHome.": "ទូរសព្ទនេះទំនងជាមិនពន្យារការជូនដំណឹង SafeHome ទេ។",
    ...
    "Auto rời khỏi nhà cần quyền vị trí luôn luôn để chạy ổn định.": "ការការពារដោយស្វ័យប្រវត្តិនៅពេលចាកចេញត្រូវការទីតាំង «អនុញ្ញាតជានិច្ច» ដើម្បីដំណើរការបានទុកចិត្ត។",
    "Cần cấp quyền vị trí để Auto rời khỏi nhà hoạt động.": "ត្រូវការសិទ្ធិទីតាំងសម្រាប់ការការពារដោយស្វ័យប្រវត្តិនៅពេលចាកចេញ។",
    "Dịch vụ vị trí đang tắt nên Auto rời khỏi nhà không ổn định.": "សេវាទីតាំងបានបិទ ដូច្នេះការការពារដោយស្វ័យប្រវត្តិនៅពេលចាកចេញអាចដំណើរការមិនបានទុកចិត្ត។",
    "Chỉ cần quyền này khi dùng Auto rời khỏi nhà.": "ត្រូវការតែពេលប្រើការការពារដោយស្វ័យប្រវត្តិនៅពេលចាកចេញប៉ុណ្ណោះ។",
    "Chưa cấp vị trí luôn luôn": "មិនបានអនុញ្ញាតទីតាំង «អនុញ្ញាតជានិច្ច»",
    "Đã cấp vị trí luôn luôn": "បានអនុញ្ញាតទីតាំង «អនុញ្ញាតជានិច្ច»",
    "iOS không mở toàn màn hình như Android; app dùng notification và âm thanh hệ thống.": "iOS មិនបើកពេញអេក្រង់ដូច Android ទេ។ កម្មវិធីប្រើការជូនដំណឹងប្រព័ន្ធ និងសំឡេង។",
    "Android dùng cảnh báo toàn màn hình; nếu máy chặn, hãy cấp quyền trong cài đặt.": "Android ប្រើការជូនដំណឹងពេញអេក្រង់។ អនុញ្ញាតវាក្នុងការកំណត់ ប្រសិនបើទូរសព្ទរារាំងវា។",
    "Cảnh báo trên iOS": "ការជូនដំណឹងលើ iOS",
    "Cảnh báo toàn màn hình": "ការជូនដំណឹងពេញអេក្រង់",
    "Cảnh báo có thể không hiển thị nếu thông báo bị tắt.": "ការជូនដំណឹងអាចមិនបង្ហាញ ប្រសិនបើបានបិទការជូនដំណឹង។",
    "Điện thoại có thể nhận thông báo SafeHome.": "ទូរសព្ទនេះអាចទទួលការជូនដំណឹងពី SafeHome។",
    ...
    "Kiểm tra điện thoại và cách bạn đang dùng app.": "ពិនិត្យទូរសព្ទរបស់អ្នក និងរបៀបដែលអ្នកប្រើកម្មវិធី។",
    "Hệ thống SafeHome": "ប្រព័ន្ធ SafeHome",
    "Hệ thống: Đang kiểm tra...": "ប្រព័ន្ធ៖ កំពុងពិនិត្យ...",
    "Tên": "ឈ្មោះ",
    "Bạn không có quyền thay đổi vị trí nhà": "អ្នកមិនមានសិទ្ធិផ្លាស់ប្ដូរទីតាំងផ្ទះទេ",
    "Hãy bật GPS để đặt vị trí nhà": "បើក GPS ដើម្បីកំណត់ទីតាំងផ្ទះ",
    "Bạn chưa cấp quyền vị trí": "មិនទាន់បានផ្ដល់សិទ្ធិទីតាំង",
    "Hãy cấp quyền vị trí trong Cài đặt ứng dụng": "ផ្ដល់សិទ្ធិទីតាំងក្នុងការកំណត់កម្មវិធី",
    "Đã bật tự động Bảo vệ khi mọi người rời nhà": "ការការពារដោយស្វ័យប្រវត្តិនៅពេលសមាជិកទាំងអស់ចាកចេញពីផ្ទះបានបើក",
    "Đã tắt tự động Bảo vệ khi mọi người rời nhà": "ការការពារដោយស្វ័យប្រវត្តិនៅពេលសមាជិកទាំងអស់ចាកចេញពីផ្ទះបានបិទ",
    "Không thể thay đổi trạng thái Alarm": "មិនអាចផ្លាស់ប្ដូរស្ថានភាព Alarm បានទេ",
    "Đã tắt toàn bộ Alarm của nhà": "Alarm ទាំងអស់ក្នុងផ្ទះត្រូវបានបិទ",
    "QR này không phải mã xin gia nhập Home": "កូដ QR នេះមិនមែនជាកូដសម្រាប់ចូលរួមផ្ទះទេ",
    "Thêm Home": "បន្ថែមផ្ទះ",
    "Mở cài đặt": "បើកការកំណត់",
    "Để sau": "ពេលក្រោយ",
    "SafeHome cần quyền vị trí \"Luôn cho phép\" để nhận biết khi bạn rời hoặc trở về nhà, kể cả khi ứng dụng đang chạy nền.": "SafeHome ត្រូវការសិទ្ធិទីតាំងដែលអនុញ្ញាតជានិច្ច ដើម្បីដឹងពេលអ្នកចាកចេញ ឬត្រឡប់មកផ្ទះ ទោះបីកម្មវិធីកំពុងដំណើរការនៅផ្ទៃខាងក្រោយក៏ដោយ។",
    "SafeHome hiện chỉ được truy cập vị trí khi bạn đang sử dụng ứng dụng.\n\nHãy chọn quyền Vị trí và chuyển sang \"Luôn cho phép\" để tính năng tự động Bảo vệ khi rời nhà hoạt động khi ứng dụng đang chạy nền.": "បច្ចុប្បន្ន SafeHome អាចចូលប្រើទីតាំងបានតែពេលកំពុងប្រើកម្មវិធីប៉ុណ្ណោះ។\n\nបើកសិទ្ធិទីតាំង ហើយជ្រើសរើស \"អនុញ្ញាតគ្រប់ពេល\" ដើម្បីឱ្យការការពារដោយស្វ័យប្រវត្តិបន្តដំណើរការនៅផ្ទៃខាងក្រោយ។",
    "Cho phép vị trí luôn luôn": "អនុញ្ញាតទីតាំងជានិច្ច",
    "Các nhà của bạn sẽ bị xoá.\nCác nhà được chia sẻ sẽ được rời khỏi.": "ផ្ទះរបស់អ្នកនឹងត្រូវលុប។\nអ្នកនឹងចាកចេញពីផ្ទះដែលបានចែករំលែក។",
    "Thao tác này sẽ thay đổi lịch Home Alarm của toàn bộ thiết bị an ninh trong các nhà đã chọn.\n\nNhững thành viên đang sử dụng Alarm 'Theo nhà' sẽ bị ảnh hưởng.\nAlarm cá nhân ở chế độ 'Riêng tôi' sẽ không bị thay đổi.": "វានឹងផ្លាស់ប្ដូរកាលវិភាគ Alarm របស់ផ្ទះសម្រាប់ឧបករណ៍សន្តិសុខទាំងអស់នៅក្នុងផ្ទះដែលបានជ្រើសរើស។\n\nសមាជិកដែលប្រើការកំណត់ Alarm របស់ផ្ទះនឹងទទួលរងឥទ្ធិពល។\nការកំណត់ Alarm ផ្ទាល់ខ្លួននឹងមិនផ្លាស់ប្ដូរទេ។",
    "Thao tác này sẽ thêm Home Reminder cho các nhà đã chọn.\n\nNhững thành viên đang sử dụng Reminder 'Theo nhà' sẽ bị ảnh hưởng.\nReminder cá nhân ở chế độ 'Riêng tôi' sẽ không bị thay đổi.": "វានឹងបន្ថែម Reminder សម្រាប់ផ្ទះដែលបានជ្រើសរើស។\n\nសមាជិកដែលប្រើការកំណត់ Reminder របស់ផ្ទះនឹងទទួលរងឥទ្ធិពល។\nការកំណត់ Reminder ផ្ទាល់ខ្លួននឹងមិនផ្លាស់ប្ដូរទេ។",
    "Khi bật, các thiết bị an ninh sẽ được giám sát ngay.\n\nTự động Bảo vệ khi rời nhà sẽ tạm dừng. Chế độ này không tự tắt khi có người về nhà và chỉ được tắt khi một thành viên có quyền chủ động chuyển về Bình thường.": "ឧបករណ៍សន្តិសុខនឹងត្រូវតាមដានភ្លាមៗ។\n\nការការពារដោយស្វ័យប្រវត្តិនៅពេលចាកចេញនឹងផ្អាក។ មុខងារនេះមិនបិទដោយស្វ័យប្រវត្តិពេលមាននរណាម្នាក់ត្រឡប់មកផ្ទះទេ ហើយត្រូវប្ដូរត្រឡប់ទៅធម្មតាដោយសមាជិកដែលមានសិទ្ធិ។",
    "Hành động này sẽ thay đổi thời gian báo động của một số thiết bị trong hôm nay...": "សកម្មភាពនេះនឹងផ្លាស់ប្ដូរពេលវេលា Alarm សម្រាប់ឧបករណ៍មួយចំនួននៅថ្ងៃនេះ...",
    "Hành động này sẽ tắt toàn bộ báo động của nhà dưới mọi hình thức. Bạn sẽ không còn nhận được cảnh báo khi có nguy hiểm trên điện thoại nữa.": "សកម្មភាពនេះនឹងបិទ Alarm ទាំងអស់សម្រាប់ផ្ទះនេះ។ អ្នកនឹងលែងទទួលការជូនដំណឹងអំពីគ្រោះថ្នាក់លើទូរសព្ទនេះ។",
    "Alarm đang sử dụng chế độ Theo nhà.\n\nBạn sẽ nhận cảnh báo theo lịch Alarm chung do Chủ nhà hoặc Quản trị viên thiết lập.": "Alarm កំពុងប្រើការកំណត់របស់ផ្ទះ។\n\nអ្នកនឹងទទួលការជូនដំណឹងតាមកាលវិភាគរួមដែលម្ចាស់ផ្ទះ ឬអ្នកគ្រប់គ្រងបានកំណត់។",
    "Alarm đang sử dụng chế độ Riêng tôi.\n\nBạn sẽ nhận cảnh báo theo lịch Alarm riêng đã thiết lập cho tài khoản này.": "Alarm កំពុងប្រើការកំណត់របស់ខ្ញុំ។\n\nអ្នកនឹងទទួលការជូនដំណឹងតាមកាលវិភាគ Alarm ផ្ទាល់ខ្លួនសម្រាប់គណនីនេះ។",
    "Không thể đăng nhập bằng Google": "មិនអាចចូលដោយប្រើ Google បានទេ",
    "Không đặt được mật khẩu": "មិនអាចកំណត់ពាក្យសម្ងាត់បានទេ",
    "Chấp nhận": "យល់ព្រម",
    "Cho phép": "អនុញ្ញាត",
    "Không thể chấp nhận lời mời. Vui lòng thử lại.": "មិនអាចទទួលយកការអញ្ជើញបានទេ។ សូមព្យាយាមម្ដងទៀត។",
    "Không thể chấp nhận lời xin vào nhà. Vui lòng thử lại.": "មិនអាចទទួលយកសំណើចូលរួមបានទេ។ សូមព្យាយាមម្ដងទៀត។",
    "Từ chối": "បដិសេធ",
    ...
    "Hãy chọn quyền vị trí Luôn cho phép trong Cài đặt ứng dụng": "ជ្រើសរើសសិទ្ធិទីតាំង «អនុញ្ញាតជានិច្ច» ក្នុងការកំណត់កម្មវិធី",
    "Tài khoản Google cần tạo thêm mật khẩu để dùng các chức năng bảo mật.": "គណនី Google របស់អ្នកត្រូវការពាក្យសម្ងាត់បន្ថែម ដើម្បីប្រើមុខងារសន្តិសុខ។",
    "Alarm": "Alarm",
    "Bạn không có quyền thực hiện thao tác này。": "អ្នកមិនមានសិទ្ធិធ្វើសកម្មភាពនេះទេ។",
    "Cài đặt": "ការកំណត់",
    ...
    "Chuyển quyền sở hữu cho thành viên khác": "ផ្ទេរសិទ្ធិម្ចាស់ផ្ទះទៅសមាជិកផ្សេង",
    "Có": "បាទ/ចាស",
    ...
    "Khóa đang mở khi nhà ở chế độ Bảo vệ": "បានដោះសោខណៈពេលផ្ទះស្ថិតក្នុងមុខងារការពារ",
    ...
    "Báo động lặp sau \$securityModeRepeatMinutes phút nếu sự cố vẫn còn.": "Alarm នឹងកើតឡើងវិញបន្ទាប់ពី \$securityModeRepeatMinutes នាទី ប្រសិនបើបញ្ហានៅតែមាន។",
    "\$actorName đã bật Mode Bảo vệ thủ công cho \"\$homeName\". Chế độ này chỉ tắt khi một thành viên có quyền chủ động chuyển về Bình thường. \$repeatMessage": "\$actorName បានបើកមុខងារការពារដោយដៃសម្រាប់ \"\$homeName\"។ មុខងារនេះបិទបានតែនៅពេលសមាជិកដែលមានសិទ្ធិប្ដូរត្រឡប់ទៅធម្មតា។ \$repeatMessage",
    "Bạn đã bật Alarm cho nhà \"\$homeName\".": "អ្នកបានបើក Alarm សម្រាប់ \"\$homeName\"។",
    "Bạn đã tắt toàn bộ Alarm của nhà \"\$homeName\".": "អ្នកបានបិទ Alarm ទាំងអស់សម្រាប់ \"\$homeName\"។",
    "Thành viên mới": "សមាជិកថ្មី",
    "Thành viên rời nhà": "សមាជិកបានចាកចេញពីផ្ទះ",
    "\$displayMemberName đã rời khỏi nhà \"\$homeName\".": "\$displayMemberName បានចាកចេញពី \"\$homeName\"។",
    "\$actorName đã đổi vai trò của \$memberName từ \$oldRoleName thành \$newRoleName trong nhà \"\$homeName\".": "\$actorName បានផ្លាស់ប្ដូរតួនាទីរបស់ \$memberName ពី \$oldRoleName ទៅ \$newRoleName ក្នុង \"\$homeName\"។",
    ...
    "Đang theo dõi để tự động bật Chế độ Bảo vệ.": "កំពុងតាមដាន ដើម្បីបើកមុខងារការពារដោយស្វ័យប្រវត្តិ។",
    "Dùng vị trí để tự động bật Chế độ Bảo vệ khi mọi người rời nhà.": "ប្រើទីតាំង ដើម្បីបើកមុខងារការពារដោយស្វ័យប្រវត្តិ នៅពេលសមាជិកទាំងអស់ចាកចេញពីផ្ទះ។",
    ...
    "Không thể xác nhận với SafeHome. Hãy kiểm tra kết nối và thử lại.": "មិនអាចបញ្ជាក់ជាមួយ SafeHome បានទេ។ សូមពិនិត្យការតភ្ជាប់ ហើយព្យាយាមម្ដងទៀត។",
    "Chỉ tắt cảnh báo khi bạn đã kiểm tra tình trạng trong nhà.\n\nBạn chắc chắn muốn tắt cảnh báo?": "បញ្ឈប់ការជូនដំណឹងតែបន្ទាប់ពីបានពិនិត្យស្ថានភាពផ្ទះប៉ុណ្ណោះ។\n\nតើអ្នកប្រាកដថាចង់បញ្ឈប់ការជូនដំណឹងមែនទេ?",
    ...
    "Mode Bảo vệ sẽ lặp báo động sau \$minutes phút": "មុខងារការពារនឹងជូនដំណឹងម្ដងទៀតបន្ទាប់ពី \$minutes នាទី",
    "Đã gửi yêu cầu gia nhập \$count nhà": "បានផ្ញើសំណើចូលរួមផ្ទះចំនួន \$count",
    "\$requesterName đang xin gia nhập nhà \"\$homeName\".": "\$requesterName បានស្នើសុំចូលរួម \"\$homeName\"។",
    "Bạn đã xoá nhà \"\$homeName\".": "អ្នកបានលុប \"\$homeName\"។",
    "Bạn đã gửi yêu cầu chuyển quyền chủ nhà \"\$homeName\" cho \$email.": "អ្នកបានផ្ញើសំណើផ្ទេរសិទ្ធិម្ចាស់ផ្ទះរបស់ \"\$homeName\" ទៅ \$email។",
    "\$actorName muốn chuyển quyền chủ nhà \"\$homeName\" cho bạn.": "\$actorName ចង់ផ្ទេរសិទ្ធិម្ចាស់ផ្ទះរបស់ \"\$homeName\" មកឱ្យអ្នក។",
    "\$actorName đã mời bạn tham gia nhà \"\$homeName\".": "\$actorName បានអញ្ជើញអ្នកឱ្យចូលរួម \"\$homeName\"។",
    "SafeHome đang xoá thiết bị \"\$deviceName\" khỏi nhà \"\$homeName\".": "SafeHome កំពុងដក \"\$deviceName\" ចេញពី \"\$homeName\"។",
    "Thiết bị \"\$deviceName\" đã xuất hiện trong \"\$homeName\".": "បានបន្ថែមឧបករណ៍ \"\$deviceName\" ទៅ \"\$homeName\"។",
    "Bạn đã tạo nhà \"\$name\".": "អ្នកបានបង្កើតផ្ទះ \"\$name\"។",
    "\$actorName đã cập nhật tên nhà thành \"\$newName\" và thay đổi địa chỉ.": "\$actorName បានធ្វើបច្ចុប្បន្នភាពឈ្មោះផ្ទះទៅជា \"\$newName\" និងផ្លាស់ប្ដូរអាសយដ្ឋាន។",
    "\$actorName đã đổi tên nhà thành \"\$newName\".": "\$actorName បានប្ដូរឈ្មោះផ្ទះទៅជា \"\$newName\"។",
    "\$actorName đã cập nhật địa chỉ của nhà \"\$newName\".": "\$actorName បានធ្វើបច្ចុប្បន្នភាពអាសយដ្ឋានរបស់ \"\$newName\"។",
    "\$actorName đã đổi tên thiết bị \"\$oldDeviceName\" thành \"\$newName\" trong nhà \"\$homeName\".": "\$actorName បានប្ដូរឈ្មោះឧបករណ៍ \"\$oldDeviceName\" ទៅជា \"\$newName\" ក្នុង \"\$homeName\"។",
    "Đang ghép nối: \$seconds giây": "កំពុងផ្គូផ្គង៖ \$seconds វិនាទី",
    "Chế độ thêm thiết bị đã được mở trong nhà \"\$homeName\" trong \$seconds giây.": "បានបើកការផ្គូផ្គងឧបករណ៍ក្នុង \"\$homeName\" រយៈពេល \$seconds វិនាទី។",
    "Khoảng thời gian phải nằm trong khung Alarm (\$start → \$end)": "រយៈពេលផ្អាកត្រូវស្ថិតក្នុងកាលវិភាគ Alarm (\$start → \$end)",
    "\$passCount/\$total bài test đạt\n\n": "ការសាកល្បងបានជោគជ័យ \$passCount/\$total\n\n",
    "\$name chưa cập nhật số điện thoại trong hồ sơ.": "\$name មិនទាន់បានបន្ថែមលេខទូរសព្ទទៅក្នុងប្រវត្តិរូបទេ។",
    ...
    "\"\$name\" phát hiện khói trong \"\$homeName\".": "\"\$name\" បានរកឃើញផ្សែងនៅក្នុង \"\$homeName\"។",
    "\"\$name\" đã trở lại trạng thái bình thường.": "\"\$name\" បានត្រឡប់ទៅស្ថានភាពធម្មតា។",
    "\"\$name\" vừa kích hoạt SOS trong \"\$homeName\".": "\"\$name\" បានដំណើរការ SOS នៅក្នុង \"\$homeName\"។",
    "\"\$name\" đã hết trạng thái SOS.": "\"\$name\" លែងស្ថិតក្នុងស្ថានភាព SOS ទៀតហើយ។",
    "\"\$name\" báo bị tháo/cạy trong \"\$homeName\".": "ឧបករណ៍ \"\$name\" ត្រូវបានដោះ ឬលូកលាន់នៅក្នុង \"\$homeName\"។",
    "\"\$name\" đã hết cảnh báo tháo/cạy.": "ការជូនដំណឹងអំពីការដោះ ឬលូកលាន់ឧបករណ៍ \"\$name\" បានបញ្ចប់។",
    "\"\$name\" đã đóng trong \"\$homeName\".": "\"\$name\" បានបិទនៅក្នុង \"\$homeName\"។",
    "\"\$name\" đang mở trong \"\$homeName\".": "\"\$name\" បើកនៅក្នុង \"\$homeName\"។",
    "\"\$name\" trong \"\$homeName\" đang yếu pin.": "ថ្មរបស់ \"\$name\" នៅក្នុង \"\$homeName\" ខ្សោយ។",
    "\"\$name\" trong \"\$homeName\" đã mất kết nối.": "\"\$name\" នៅក្នុង \"\$homeName\" បានអហ្វឡាញ។",
    "\"\$name\" trong \"\$homeName\" đã kết nối trở lại.": "\"\$name\" នៅក្នុង \"\$homeName\" បានត្រឡប់អនឡាញវិញ។",
    "\"\$name\" ghi nhận nhiệt độ cao trong \"\$homeName\".": "\"\$name\" បានកត់ត្រាសីតុណ្ហភាពខ្ពស់នៅក្នុង \"\$homeName\"។",
    "\"\$name\" ghi nhận độ ẩm cao trong \"\$homeName\".": "\"\$name\" បានកត់ត្រាសំណើមខ្ពស់នៅក្នុង \"\$homeName\"។",
    ...
    "Có cửa đang mở hoặc thiết bị bị tháo": "ទ្វារមួយបើក ឬឧបករណ៍មួយត្រូវបានដោះ ឬលូកលាន់",
    "Có thiết bị đang cảnh báo": "ឧបករណ៍មួយកំពុងជូនដំណឹង",
    "Nếu chưa có ai xác nhận, SafeHome sẽ chuyển sang gọi điện khẩn cấp.": "ប្រសិនបើគ្មាននរណាម្នាក់បញ្ជាក់ SafeHome នឹងធ្វើការហៅទូរសព្ទបន្ទាន់។",
    "Báo lại lúc \$time nếu vấn đề chưa được xử lý.": "នឹងជូនដំណឹងម្ដងទៀតនៅម៉ោង \$time ប្រសិនបើបញ្ហាមិនទាន់បានដោះស្រាយ។",
    "Sẽ báo lại theo lịch Alarm đã cài nếu vấn đề chưa được xử lý.": "នឹងជូនដំណឹងម្ដងទៀតតាមកាលវិភាគ Alarm ប្រសិនបើបញ្ហាមិនទាន់បានដោះស្រាយ។",
    "\"\$deviceName\" đã đóng trong \"\$resolvedHomeName\".": "\"\$deviceName\" បានបិទនៅក្នុង \"\$resolvedHomeName\"។",
    "\"\$deviceName\" đang mở trong \"\$resolvedHomeName\".": "\"\$deviceName\" បើកនៅក្នុង \"\$resolvedHomeName\"។",
    "\$count nhà đã chọn": "បានជ្រើសរើសផ្ទះចំនួន \$count",
    "🚨 \$count nhà không an toàn\$suffix": "🚨 ផ្ទះមិនមានសុវត្ថិភាពចំនួន \$count\$suffix",
    "⚠️ \$count nhà cần chú ý\$suffix": "⚠️ ផ្ទះត្រូវការការយកចិត្តទុកដាក់ចំនួន \$count\$suffix",
    ...
    "Đã cài Reminder cho \$updatedHomes nhà.": "បានកំណត់ Reminder សម្រាប់ផ្ទះចំនួន \$updatedHomes។",
    "Đã cài Alarm cho \$updatedDevices thiết bị trong \$updatedHomes nhà.\n": "បានកំណត់ Alarm សម្រាប់ឧបករណ៍ \$updatedDevices នៅក្នុងផ្ទះចំនួន \$updatedHomes។\n",
    "Đã chia sẻ các nhà bạn có quyền.\n\n\$skipped nhà bị bỏ qua vì bạn không có quyền chia sẻ.": "បានចែករំលែកផ្ទះដែលអ្នកគ្រប់គ្រង។\n\nផ្ទះចំនួន \$skipped ត្រូវបានរំលង ព្រោះអ្នកមិនមានសិទ្ធិចែករំលែក។",
    "Đã áp dụng Alarm cho \$count thiết bị an ninh": "បានអនុវត្ត Alarm លើឧបករណ៍សន្តិសុខចំនួន \$count",
    "Áp dụng cùng một lịch cho \$count thiết bị an ninh": "អនុវត្តកាលវិភាគដូចគ្នាលើឧបករណ៍សន្តិសុខចំនួន \$count",
    ...
    "Bạn chắc chắn muốn xoá \$name khỏi nhà này?": "តើអ្នកប្រាកដថាចង់ដក \$name ចេញពីផ្ទះនេះមែនទេ?",
    "\$targetEmail\nXin gia nhập \"\$homeName\"": "\$targetEmail\nបានស្នើសុំចូលរួម \"\$homeName\"",
    "Xin gia nhập \"\$homeName\"": "បានស្នើសុំចូលរួម \"\$homeName\"",
    "Bạn được mời nhận quyền nhà \"\$homeName\"": "អ្នកត្រូវបានអញ្ជើញឱ្យទទួលសិទ្ធិម្ចាស់ផ្ទះរបស់ \"\$homeName\"",
    ...
    "Hãy thêm thiết bị SafeHome đầu tiên để bắt đầu theo dõi nhà.": "បន្ថែមឧបករណ៍ SafeHome ដំបូងរបស់អ្នក ដើម្បីចាប់ផ្ដើមតាមដានផ្ទះនេះ។",
    "Kiểm tra cảnh báo khẩn cấp trước, sau đó liên hệ thành viên trong nhà nếu cần.": "ពិនិត្យការជូនដំណឹងបន្ទាន់ជាមុនសិន បន្ទាប់មកទាក់ទងសមាជិកគ្រួសារ ប្រសិនបើចាំបាច់។",
    "Không có thành viên nào ở nhà nhưng cửa hoặc khóa đang mở, hãy kiểm tra ngay.": "គ្មានសមាជិកគ្រួសារនៅផ្ទះទេ ប៉ុន្តែទ្វារ ឬសោមួយបើក។ សូមពិនិត្យឥឡូវនេះ។",
    "Kiểm tra cửa hoặc khóa đang mở trước khi giữ nhà ở chế độ Bảo vệ.": "ពិនិត្យទ្វារ ឬសោដែលបើក មុនពេលរក្សាផ្ទះនេះក្នុងមុខងារការពារ។",
    "Có thể vẫn có người ở nhà; nếu đúng, nên chuyển về Bình thường.": "ប្រហែលជានៅមាននរណាម្នាក់នៅផ្ទះ។ ប្រសិនបើដូច្នោះ សូមប្ដូរត្រឡប់ទៅមុខងារធម្មតា។",
    "Có thành viên chưa xác định vị trí, hãy nhắc họ mở app hoặc kiểm tra quyền vị trí.": "ទីតាំងរបស់សមាជិកមួយចំនួនមិនទាន់ស្គាល់។ សុំឱ្យពួកគេបើកកម្មវិធី ឬពិនិត្យសិទ្ធិទីតាំង។",
    "Có thiết bị mất kết nối, hãy kiểm tra pin, nguồn hoặc vị trí đặt thiết bị.": "ឧបករណ៍មួយបានផ្ដាច់ការតភ្ជាប់។ ពិនិត្យថ្ម ប្រភពថាមពល ឬទីតាំងដាក់របស់វា។",
    "Có thiết bị pin yếu, nên thay pin sớm để tránh mất cảnh báo.": "ឧបករណ៍មួយមានថ្មខ្សោយ។ ប្ដូរថ្មឆាប់ៗ ដើម្បីកុំឱ្យខកខានការជូនដំណឹង។",
    "Bạn chưa đặt Reminder, nên tạo lịch nhắc kiểm tra nhà định kỳ.": "មិនទាន់បានកំណត់ Reminder។ បង្កើតកាលវិភាគ ដើម្បីពិនិត្យផ្ទះរបស់អ្នកជាប្រចាំ។",
    "Bạn chưa đặt lịch Alarm, nên bật bảo vệ theo khung giờ thường vắng nhà.": "មិនទាន់បានកំណត់កាលវិភាគ Alarm។ បើកការការពារសម្រាប់ពេលដែលអ្នកតែងតែនៅក្រៅផ្ទះ។",
    "Không có việc cần xử lý ngay, bạn chỉ cần tiếp tục theo dõi trạng thái nhà.": "មិនត្រូវធ្វើសកម្មភាពបន្ទាន់ទេ។ បន្តតាមដានផ្ទះនេះ។",
    ...
    "Phát hiện \$count vấn đề cần xử lý": "មានបញ្ហា \$count ដែលត្រូវការការយកចិត្តទុកដាក់",
    "Hôm nay các cửa đã được sử dụng \$count lần": "ទ្វារត្រូវបានប្រើ \$count ដងនៅថ្ងៃនេះ",
    "Đã ghi nhận \$count hoạt động gần đây": "បានកត់ត្រាសកម្មភាពថ្មីៗចំនួន \$count",
    "Hệ thống: Cần kiểm tra \$issueCount mục": "ប្រព័ន្ធ៖ មាន \$issueCount ចំណុចត្រូវពិនិត្យ",
    "FCM token đã sẵn sàng trên điện thoại này.": "FCM token រួចរាល់នៅលើទូរសព្ទនេះ។",
    "FCM token đã sẵn sàng, nhưng Auto rời khỏi nhà còn thiếu điều kiện.": "FCM token រួចរាល់ ប៉ុន្តែការការពារដោយស្វ័យប្រវត្តិនៅពេលចាកចេញនៅខ្វះលក្ខខណ្ឌមួយ។",
    "Hiện có \$emergencyTotal thiết bị khẩn cấp. Khuyến nghị tối thiểu: báo khói và SOS.": "រកឃើញឧបករណ៍បន្ទាន់ចំនួន \$emergencyTotal។ ចំនួនអប្បបរមាដែលបានណែនាំ៖ ឧបករណ៍ចាប់ផ្សែង និង SOS។",
    "Bạn chắc chắn muốn chuyển quyền chủ nhà cho:\n\$targetEmail?": "ផ្ទេរសិទ្ធិម្ចាស់ផ្ទះទៅ៖\n\$targetEmail?",
    ...
    "Dữ liệu gần nhất cập nhật \$count phút trước": "ទិន្នន័យចុងក្រោយបានធ្វើបច្ចុប្បន្នភាព \$count នាទីមុន",
    "Dữ liệu gần nhất cập nhật \$count giờ trước": "ទិន្នន័យចុងក្រោយបានធ្វើបច្ចុប្បន្នភាព \$count ម៉ោងមុន",
    ...
    "\$name: Đang mở khi nhà ở chế độ Bảo vệ": "\$name៖ បើកខណៈពេលផ្ទះស្ថិតក្នុងមុខងារការពារ",
    "An tâm hơn trong từng ngôi nhà": "ស្ងប់ចិត្តនៅគ្រប់ផ្ទះ",
    "Báo động SafeHome": "SafeHome Alarm",
    "Có cảnh báo an ninh cần kiểm tra ngay.": "ការជូនដំណឹងសន្តិសុខមួយត្រូវការការយកចិត្តទុកដាក់របស់អ្នក។",
    ...
    "Hoặc": "ឬ",
    "Giờ bắt đầu và kết thúc không được trùng nhau": "ម៉ោងចាប់ផ្ដើម និងម៉ោងបញ្ចប់មិនអាចដូចគ្នាបានទេ",
    "Giờ kết thúc phải sau thời điểm hiện tại": "ម៉ោងបញ្ចប់ត្រូវតែក្រោយម៉ោងបច្ចុប្បន្ន",
    "Khoảng tạm tắt không hợp lệ": "ចន្លោះពេលផ្អាក Alarm មិនត្រឹមត្រូវ",
    "Khoảng tạm tắt không trùng với lịch Alarm nào đang bật": "ចន្លោះពេលផ្អាកមិនត្រួតលើកាលវិភាគ Alarm ដែលកំពុងដំណើរការណាមួយទេ",
  };
  ...
  String allHomeReminderAppliedText(
    ...
    fil: "Naitakda ang Reminder para sa $updatedHomes bahay."
        "${skippedHomes > 0 ? "\n\nNilaktawan ang $skippedHomes bahay dahil wala kang pahintulot." : ""}",
    km: "បានកំណត់ Reminder សម្រាប់ផ្ទះចំនួន $updatedHomes។"
  ...
  String allHomeAlarmAppliedText({
    ...
    vi: "Đã cài Alarm cho $updatedDevices thiết bị trong $updatedHomes nhà.\n"
        ...
        "${skippedHomes > 0 ? "\n\n$skippedHomes nhà bị bỏ qua vì bạn không có quyền." : ""}",
    fil: "Naitakda ang Alarm para sa $updatedDevices aparato sa $updatedHomes bahay.\n"
        "Oras ng pag-uulit: $repeatLabel."
        "${skippedHomes > 0 ? "\n\nNilaktawan ang $skippedHomes bahay dahil wala kang pahintulot." : ""}",
    km: "បានកំណត់ Alarm សម្រាប់ឧបករណ៍ $updatedDevices នៅក្នុងផ្ទះចំនួន $updatedHomes។\n"
  ...
  String allHomeShareResultText(int skipped) {
    ...
    return choose(
      ...
      fil: "Naibahagi ang mga bahay na pinamamahalaan mo.\n\nNilaktawan ang $skipped bahay dahil wala kang pahintulot na ibahagi ang mga ito.",
  ...
  String ownershipInviteTitle(String homeName) => choose(
    ...
    fil: "Inimbitahan kang tanggapin ang pagmamay-ari ng bahay na \"$homeName\"",
  ...
  String fcmTokenReadyText({
    ...
    return ready
      ...
      fil: "Handa na ang FCM token, ngunit may kulang pang kinakailangan para sa Awtomatikong Proteksyon kapag wala sa bahay.",
  ...
  String emergencyDeviceRecommendationText(int emergencyTotal) => choose(
    ...
    fil: "May $emergencyTotal aparatong pang-emergency. Inirerekomendang minimum: sensor ng usok at SOS.",

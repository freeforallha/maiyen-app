...
class AppStrings {
  ...
  String? _translationFromMap(Map<String, String> translations, String text) {
    ...
    for (final entry in translations.entries) {
      ...
      for (final placeholder in placeholders) {
        pattern.write(RegExp.escape(template.substring(cursor, placeholder.start)));
        pattern.write('(.+?)');
  ...
  String? _frenchDynamic(String vi, String en) {
    ...
    if (en.startsWith("You disabled every Alarm for") && firstQuote != null) {
      return "Vous avez désactivé toutes les Alarm de « $firstQuote ».";
    }
  ...
  String alarmSettingChangedMessage({
    ...
    return enabled
      ...
      id: "Anda menonaktifkan semua Alarm untuk \"$homeName\".",
  ...
  String deviceSosClearedMessage(String name) => choose(
    ...
    id: "\"$name\" tidak lagi dalam status SOS.",
  ...
  static const Map<String, String> _english = {
    ...
    "Khoảng tạm tắt không trùng với lịch Alarm nào đang bật": "The pause range does not overlap any active Alarm schedule",
  };
  ...
  static const Map<String, String> _chinese = {
    ...
    "Chỉ Chủ nhà hoặc Quản trị viên mới có quyền thay đổi Mode Bảo vệ": "只有屋主或管理员可以更改布防模式",
    ...
    "Thao tác này sẽ thay đổi lịch Home Alarm của toàn bộ thiết bị an ninh trong các nhà đã chọn.\n\nNhững thành viên đang sử dụng Alarm 'Theo nhà' sẽ bị ảnh hưởng.\nAlarm cá nhân ở chế độ 'Riêng tôi' sẽ không bị thay đổi.": "此操作会更改所选家庭中所有安全设备的家庭 Alarm 计划。\n\n正在使用按家庭 Alarm 设置的成员会受到影响。\n处于仅自己模式的个人 Alarm 不会改变。",
    "Thao tác này sẽ thêm Home Reminder cho các nhà đã chọn.\n\nNhững thành viên đang sử dụng Reminder 'Theo nhà' sẽ bị ảnh hưởng.\nReminder cá nhân ở chế độ 'Riêng tôi' sẽ không bị thay đổi.": "此操作会为所选家庭添加家庭 Reminder。\n\n正在使用按家庭 Reminder 设置的成员会受到影响。\n处于仅自己模式的个人 Reminder 不会改变。",
    ...
    "\$actorName đã bật Mode Bảo vệ thủ công cho \"\$homeName\". Chế độ này chỉ tắt khi một thành viên có quyền chủ động chuyển về Bình thường. \$repeatMessage": "\$actorName 已为 \"\$homeName\" 开启手动布防模式。只有有权限的成员切回普通模式时，此模式才会关闭。\$repeatMessage",
    ...
    "Dùng vị trí để tự động bật Chế độ Bảo vệ khi mọi người rời nhà.": "使用位置在所有人离家时自动开启布防模式。",
    "CẢNH BÁO SOS": "SOS 警报",
    ...
    "Kiểm tra cửa hoặc khóa đang mở trước khi giữ nhà ở chế độ Bảo vệ.": "在让这个家保持布防模式前，请先检查打开的门或锁。",
    ...
    "FCM token đã sẵn sàng, nhưng Auto rời khỏi nhà còn thiếu điều kiện.": "FCM token 已准备好，但自动离家仍缺少条件。",
    ...
    "Khoảng tạm tắt không trùng với lịch Alarm nào đang bật": "暂停时间范围与任何已启用的 Alarm 计划均不重叠",
  };
  ...
  static const Map<String, String> _korean = {
    ...
    "Theo nhà": "집 기준",
    "Riêng tôi": "나만",
    "Dùng lịch chung do Chủ nhà hoặc Quản trị viên thiết lập": "집 소유자 또는 관리자가 설정한 공용 일정을 사용합니다",
    ...
    "30 phút": "30분",
    "15 phút": "15분",
    "Bạn đang xem lịch của chủ nhà. Chọn Riêng tôi để tự đặt lịch Alarm.": "집 소유자의 일정을 보고 있습니다. 나만을 선택해 내 Alarm 일정을 설정하세요.",
    ...
    "Thao tác này sẽ thay đổi lịch Home Alarm của toàn bộ thiết bị an ninh trong các nhà đã chọn.\n\nNhững thành viên đang sử dụng Alarm 'Theo nhà' sẽ bị ảnh hưởng.\nAlarm cá nhân ở chế độ 'Riêng tôi' sẽ không bị thay đổi.": "선택한 집의 모든 보안 기기 Alarm 일정을 변경합니다.\n\nAlarm을 집 기준으로 사용하는 구성원이 영향을 받습니다.\n나만 모드의 개인 Alarm은 변경되지 않습니다.",
    "Thao tác này sẽ thêm Home Reminder cho các nhà đã chọn.\n\nNhững thành viên đang sử dụng Reminder 'Theo nhà' sẽ bị ảnh hưởng.\nReminder cá nhân ở chế độ 'Riêng tôi' sẽ không bị thay đổi.": "선택한 집에 집 Reminder를 추가합니다.\n\nReminder를 집 기준으로 사용하는 구성원이 영향을 받습니다.\n나만 모드의 개인 Reminder는 변경되지 않습니다.",
    ...
    "\$actorName đã đổi vai trò của \$memberName từ \$oldRoleName thành \$newRoleName trong nhà \"\$homeName\".": "\$actorName님이 \"\$homeName\"에서 \$memberName님의 역할을 변경했습니다. 이전 역할: \$oldRoleName, 새 역할: \$newRoleName.",
    ...
    "\$actorName đã cập nhật tên nhà thành \"\$newName\" và thay đổi địa chỉ.": "\$actorName님이 집 이름을 \"\$newName\"로 업데이트하고 주소를 변경했습니다.",
    "\$actorName đã đổi tên nhà thành \"\$newName\".": "\$actorName님이 집 이름을 변경했습니다. 새 이름은 \"\$newName\"입니다.",
    "\$actorName đã cập nhật địa chỉ của nhà \"\$newName\".": "\$actorName님이 \"\$newName\"의 주소를 업데이트했습니다.",
    "\$actorName đã đổi tên thiết bị \"\$oldDeviceName\" thành \"\$newName\" trong nhà \"\$homeName\".": "\$actorName님이 \"\$homeName\"에서 기기 \"\$oldDeviceName\"의 이름을 변경했습니다. 새 이름은 \"\$newName\"입니다.",
    ...
    "FCM token đã sẵn sàng, nhưng Auto rời khỏi nhà còn thiếu điều kiện.": "FCM 토큰은 준비되었지만 자동 외출에 필요한 조건이 부족합니다.",
    ...
    "Khoảng tạm tắt không trùng với lịch Alarm nào đang bật": "일시 중지 범위가 활성화된 Alarm 일정과 겹치지 않습니다",
  };
  ...
  static const Map<String, String> _japanese = {
    ...
    "Thao tác này sẽ thay đổi lịch Home Alarm của toàn bộ thiết bị an ninh trong các nhà đã chọn.\n\nNhững thành viên đang sử dụng Alarm 'Theo nhà' sẽ bị ảnh hưởng.\nAlarm cá nhân ở chế độ 'Riêng tôi' sẽ không bị thay đổi.": "選択した家のすべてのセキュリティデバイスの Alarm スケジュールを変更します。\n\n家の Alarm 設定を使用しているメンバーに影響します。\n「自分のみ」モードの個人 Alarm は変更されません。",
    "Thao tác này sẽ thêm Home Reminder cho các nhà đã chọn.\n\nNhững thành viên đang sử dụng Reminder 'Theo nhà' sẽ bị ảnh hưởng.\nReminder cá nhân ở chế độ 'Riêng tôi' sẽ không bị thay đổi.": "選択した家に家の Reminder を追加します。\n\n家の Reminder 設定を使用しているメンバーに影響します。\n「自分のみ」モードの個人 Reminder は変更されません。",
    ...
    "Khoảng tạm tắt không trùng với lịch Alarm nào đang bật": "一時停止期間は有効な Alarm スケジュールと重なっていません",
  };
  ...
  static const Map<String, String> _german = {
    ...
    "\$actorName đã bật Mode Bảo vệ thủ công cho \"\$homeName\". Chế độ này chỉ tắt khi một thành viên có quyền chủ động chuyển về Bình thường. \$repeatMessage": "\$actorName hat den manuellen Schutzmodus für \"\$homeName\" aktiviert. Dieser Modus wird nur deaktiviert, wenn ein berechtigtes Mitglied in den Normalmodus zurückwechselt. \$repeatMessage",
    ...
    "FCM token đã sẵn sàng, nhưng Auto rời khỏi nhà còn thiếu điều kiện.": "Der FCM-Token ist bereit, aber für den automatischen Schutz beim Verlassen fehlt noch eine Voraussetzung.",
    ...
    "Hoặc": "Oder",
    "Giờ bắt đầu và kết thúc không được trùng nhau": "Start- und Endzeit dürfen nicht identisch sein",
    "Giờ kết thúc phải sau thời điểm hiện tại": "Die Endzeit muss nach der aktuellen Zeit liegen",
    "Khoảng tạm tắt không hợp lệ": "Ungültiger Zeitraum für die Alarm-Pause",
    "Khoảng tạm tắt không trùng với lịch Alarm nào đang bật": "Der Pausenzeitraum überschneidet sich mit keinem aktiven Alarm-Zeitplan",
  };
  ...
  static const Map<String, String> _russian = {
    ...
    "FCM token đã sẵn sàng, nhưng Auto rời khỏi nhà còn thiếu điều kiện.": "FCM-токен готов, но для автоматической охраны при уходе ещё не выполнено одно условие.",
    ...
    "Hoặc": "Или",
    "Giờ bắt đầu và kết thúc không được trùng nhau": "Время начала и окончания не должно совпадать",
    "Giờ kết thúc phải sau thời điểm hiện tại": "Время окончания должно быть позже текущего времени",
    "Khoảng tạm tắt không hợp lệ": "Недопустимый интервал приостановки Alarm",
    "Khoảng tạm tắt không trùng với lịch Alarm nào đang bật": "Интервал приостановки не совпадает ни с одним активным расписанием Alarm",
  };
  ...
  static const Map<String, String> _french = {
    ...
    "Auto rời khỏi nhà chưa ổn": "La protection automatique au départ n'est pas prête",
    "Auto rời khỏi nhà đã sẵn sàng": "La protection automatique au départ est prête",
    "Auto rời khỏi nhà chưa bật": "La protection automatique au départ n'est pas activée",
    ...
    "Đã tắt toàn bộ Alarm của nhà": "Alarm a été entièrement désactivé pour la maison",
    ...
    "Vous avez désactivé toutes les Alarm de « \$homeName ».",
    ...
    "Hoặc": "Ou",
    "Giờ bắt đầu và kết thúc không được trùng nhau": "Les heures de début et de fin ne peuvent pas être identiques",
    "Giờ kết thúc phải sau thời điểm hiện tại": "L'heure de fin doit être postérieure à l'heure actuelle",
    "Khoảng tạm tắt không hợp lệ": "Période de pause Alarm non valide",
    "Khoảng tạm tắt không trùng với lịch Alarm nào đang bật": "La période de pause ne chevauche aucun programme Alarm actif",
  };
  ...
  static const Map<String, String> _spanish = {
    ...
    "Auto rời khỏi nhà chưa ổn": "La protección automática al salir aún no está lista",
    "Auto rời khỏi nhà đã sẵn sàng": "La protección automática al salir está lista",
    "Auto rời khỏi nhà chưa bật": "La protección automática al salir no está activada",
    "Nên thêm báo khói, SOS hoặc thiết bị khẩn cấp phù hợp với nhà.":
    ...
    "Hoặc": "O",
    "Giờ bắt đầu và kết thúc không được trùng nhau": "Las horas de inicio y fin no pueden ser iguales",
    "Giờ kết thúc phải sau thời điểm hiện tại": "La hora de finalización debe ser posterior a la hora actual",
    "Khoảng tạm tắt không hợp lệ": "Intervalo de pausa de Alarm no válido",
    "Khoảng tạm tắt không trùng với lịch Alarm nào đang bật": "El intervalo de pausa no coincide con ninguna programación de Alarm activa",
  };
  ...
  static const Map<String, String> _indonesian = {
    ...
    "Bạn không có quyền sửa lịch chung của nhà": "Anda tidak memiliki izin untuk mengedit kalender umum rumah Anda",
    ...
    "Chưa có thiết bị, hãy nhấn nút + để thêm để bắt đầu duy trì an ninh": "Tidak ada perangkat, tekan tombol + untuk menambahkan untuk mulai menjaga keamanan",
    "CHƯA AN TOÀN": "TIDAK AMAN",
    "ĐÃ AN TOÀN": "SUDAH AMAN",
    "Nhà đang có dấu hiệu cần kiểm tra, bạn nên xem lại các trạng thái bên dưới.": "Rumah menunjukkan tanda-tanda perlu diperiksa, Anda harus meninjau status di bawah.",
    "Nhà đang hoạt động ổn định, bạn có thể yên tâm.": "Rumah beroperasi dengan stabil, Anda dapat yakin.",
    "Không có dấu hiệu khói hoặc SOS bất thường.": "Tidak ada tanda-tanda asap atau SOS yang tidak normal.",
    "Chưa có nhiều hoạt động mới để phân tích sâu hơn.": "Tidak banyak kegiatan baru untuk analisis lebih dalam.",
    ...
    "Nhắc kiểm tra nhà theo thời gian": "Ingatkan untuk memeriksa rumah dari waktu ke waktu",
    ...
    "Không có nhà nào đủ điều kiện để cài": "Tidak ada rumah yang memenuhi syarat",
    ...
    "Đặt vị trí nhà và bật bảo vệ tự động": "Tetapkan lokasi rumah dan aktifkan perlindungan otomatis",
    "Chuyển quyền chủ nhà hoặc xoá nhà": "Alihkan kepemilikan atau hapus rumah",
    "Đặt Reminder / Alarm nhà đã chọn": "Atur Reminder / Alarm untuk rumah yang dipilih",
    ...
    "Các nhà đã chọn sẽ bị xoá vĩnh viễn.": "Rumah yang dipilih akan dihapus secara permanen.",
    "Hoặc quét QR để xin gia nhập các nhà đã chọn": "Atau pindai QR untuk mengajukan permohonan bergabung dengan rumah yang dipilih",
    ...
    "Không có nhà nào bạn có quyền quản lý": "Tidak ada rumah Anda memiliki hak pengelolaan",
    ...
    "Chỉ chủ nhà mới được xoá nhà": "Hanya pemilik rumah yang dapat menghapus rumah",
    "Chỉ chủ nhà mới được chuyển quyền": "Hanya pemilik rumah yang dapat mengalihkan hak",
    ...
    "Bạn không có quyền thực hiện thao tác này.": "Anda tidak memiliki izin untuk melakukan operasi ini.",
    "Không thể hoàn tất thao tác. Vui lòng thử lại.": "Operasi tidak dapat diselesaikan. Silakan coba lagi.",
    "QR gia nhập nhiều nhà không hợp lệ": "QR tidak valid untuk bergabung dengan beberapa rumah",
    ...
    "Đã gửi yêu cầu gia nhập nhà": "Permintaan untuk bergabung dengan rumah terkirim",
    "QR gia nhập không hợp lệ": "QR tidak valid bergabung",
    "Bạn đang là chủ nhà này": "Anda adalah pemilik rumah ini",
    "QR này không phải mã xin gia nhập nhà": "QR ini bukan kode untuk bergabung dengan rumah",
    ...
    "Nhà này và toàn bộ thiết bị bên trong sẽ bị xoá vĩnh viễn.": "Rumah ini dan semua perangkat di dalamnya akan dihapus secara permanen.",
    "Đã xoá nhà": "Rumah dihapus",
    "QR của nhà này": "QR rumah ini",
    "Người khác quét mã này để gửi yêu cầu gia nhập nhà.": "Orang lain memindai kode ini untuk mengirim permintaan untuk bergabung dengan rumah tersebut.",
    "Chia sẻ nhà": "Bagikan rumah",
    "Quét QR để xin gia nhập nhà": "Pindai QR untuk mengajukan permohonan bergabung dengan rumah",
    "Quét QR xin gia nhập nhà": "Pindai QR untuk bergabung dengan rumah",
    "Đưa mã QR chia sẻ nhà vào khung hình": "Posisikan kode QR berbagi rumah di dalam bingkai",
    ...
    "Không thể chuyển quyền cho chính bạn": "Tidak dapat mentransfer hak ke diri Anda sendiri",
    ...
    "Đã gửi yêu cầu chuyển quyền chủ nhà": "Permintaan pengalihan kepemilikan telah dikirim",
    "Bạn không có quyền xoá thiết bị": "Anda tidak memiliki izin untuk menghapus perangkat",
    "Xóa Device?": "Hapus Perangkat?",
    "Đã gửi yêu cầu xoá thiết bị": "Mengajukan permintaan untuk menghapus perangkat",
    ...
    "Quét mã QR được chủ nhà chia sẻ": "Pindai kode QR yang dibagikan oleh pemilik rumah",
    "Tên nhà": "Nama rumah",
    ...
    "Thêm số điện thoại để dùng cho các trường hợp khẩn cấp": "Tambahkan nomor telepon untuk keadaan darurat",
    "Hoàn tất": "Selesai",
    "Đã tạo nhà mới": "Rumah baru dibuat",
    "Về muộn": "Pulang larut malam",
    "Ra ngoài": "Keluar",
    "Khác": "Lainnya",
    "⏸️ Tạm tắt Alarm hôm nay": "⏸️ Matikan Alarm hari ini",
    ...
    "Xem lời mời chia sẻ và xin gia nhập": "Lihat undangan untuk berbagi dan mengajukan permohonan untuk bergabung",
    ...
    "Hành động này sẽ xoá toàn bộ dữ liệu:": "Tindakan ini akan menghapus semua data:",
    ...
    "Bạn không có quyền quản lý phòng": "Anda tidak memiliki izin untuk mengelola ruangan",
    "Đổi tên phòng": "Ganti nama ruangan",
    "Tên phòng": "Nama ruangan",
    "Xoá phòng": "Hapus ruangan",
    "Thiết bị trong phòng này sẽ được chuyển về Chưa phân phòng.": "Perangkat di ruangan ini akan dipindahkan ke ruangan yang belum ditetapkan.",
    ...
    "Hãy đặt vị trí nhà trước khi bật tự động Bảo vệ": "Tetapkan lokasi rumah sebelum mengaktifkan Mode Perlindungan otomatis",
    "Bán kính bảo vệ mặc định: 150 m": "Radius perlindungan bawaan: 150 m",
    "Mỗi thành viên sẽ cần cấp quyền vị trí Luôn cho phép để trạng thái rời/đến nhà hoạt động khi app chạy nền.": "Setiap anggota harus memberikan izin lokasi Selalu Izinkan agar status berangkat/tiba aktif saat aplikasi berjalan di latar belakang.",
    ...
    "Tên này chỉ hiển thị riêng trên tài khoản của bạn.": "Nama ini hanya terlihat di akun Anda.",
    "Tên và địa chỉ sẽ được cập nhật cho toàn bộ thành viên trong nhà.": "Nama dan alamat akan diperbarui untuk semua anggota keluarga.",
    ...
    "Hãy thực hiện kiểm tra bằng tài khoản Owner": "Lakukan pengujian menggunakan akun Pemilik rumah",
    "Không đọc được dữ liệu nhà": "Tidak dapat membaca data rumah",
    "Nhà cần có ít nhất một thiết bị để test": "Rumah memerlukan setidaknya satu perangkat untuk menguji",
    "Đóng": "Tutup",
    ...
    "Bạn không có quyền sắp xếp phòng": "Anda tidak memiliki izin penyortiran ruangan",
    ...
    "Dùng lịch chung do Chủ nhà hoặc Quản trị viên thiết lập": "Gunakan jadwal bersama yang ditetapkan oleh Pemilik rumah atau Administrator",
    "Dùng lịch riêng chỉ áp dụng cho tài khoản của bạn": "Gunakan kalender pribadi yang hanya berlaku untuk akun Anda",
    ...
    "Không tìm thấy nhà của thông báo này": "Rumah tidak ditemukan untuk pesan ini",
    "Không tìm thấy thiết bị trong nhà này": "Tidak ada perangkat yang ditemukan di rumah ini",
    ...
    "Tạm tắt Alarm hôm nay": "Mati sementara Alarm hari ini",
    ...
    "Bạn sẽ rời khỏi các nhà được chia sẻ.": "Anda akan meninggalkan rumah bersama.",
    ...
    "Vẫn chuyển về Bình thường": "Tetap kembali ke Mode Normal",
    "Tự động Bảo vệ khi rời nhà vẫn đang bật. Nếu mọi thành viên vẫn ở ngoài, hệ thống có thể tự bật lại Bảo vệ sau vài phút.": "Mode Perlindungan otomatis saat keluar rumah masih aktif. Jika semua anggota masih berada di luar, sistem dapat mengaktifkan kembali Mode Perlindungan setelah beberapa menit.",
    ...
    "Hành động này sẽ thay đổi thời gian báo động của một số thiết bị ": "Tindakan ini akan mengubah waktu alarm beberapa perangkat",
    "Hành động này sẽ tắt toàn bộ báo động của nhà ": "Tindakan ini akan mematikan semua alarm rumah",
    "Tắt toàn bộ Alarm?": "Matikan semua Alarm?",
    "Không xoá được lịch tạm tắt Alarm": "Tidak dapat menghapus jadwal pematian Alarm",
    "Không lưu được tạm tắt Alarm": "Tidak dapat menyimpan pematian sementara Alarm",
    ...
    "Không thể xác nhận tài khoản hiện tại": "Tidak dapat mengonfirmasi akun saat ini",
    "Mật khẩu không đúng": "Kata sandi salah",
    "Không thể xác nhận mật khẩu": "Tidak dapat mengonfirmasi kata sandi",
    "Chỉ Chủ nhà hoặc Quản trị viên mới có quyền thay đổi lặp báo động": "Hanya Pemilik rumah atau Administrator yang berhak mengubah pengulangan alarm",
    "Không lưu được thời gian lặp báo động": "Tidak dapat menyimpan waktu pengulangan alarm",
    "Chỉ Chủ nhà hoặc Quản trị viên mới có quyền thay đổi Mode Bảo vệ": "Hanya Pemilik rumah atau Administrator yang berhak mengubah Mode Perlindungan",
    "Không thể thay đổi chế độ nhà": "Tidak dapat mengubah mode rumah",
    "Đã bật Bảo vệ nhưng chưa gửi được thông báo": "Mode Perlindungan aktif, tetapi notifikasi belum terkirim",
    "Đã bật Mode Bảo vệ thủ công": "Mode Perlindungan Manual diaktifkan",
    "Đã chuyển nhà về Bình thường": "Rumah telah dialihkan ke Mode Normal",
    "60 phút": "60 menit",
    "30 phút": "30 menit",
    "15 phút": "15 menit",
    "Bạn đang xem lịch của chủ nhà. Chọn Riêng tôi để tự đặt lịch Alarm.": "Anda sedang melihat jadwal Pemilik rumah. Pilih Hanya saya untuk mengatur jadwal Alarm sendiri.",
    "Chọn giờ kết thúc Alarm": "Pilih waktu berakhir Alarm",
    "Chọn giờ bắt đầu Alarm": "Pilih waktu mulai Alarm",
    "Bạn không có quyền sửa lịch Alarm của nhà": "Anda tidak memiliki izin untuk mengubah jadwal Alarm rumah",
    "Không thể áp dụng Alarm cho toàn bộ thiết bị": "Alarm tidak dapat diterapkan ke semua perangkat",
    "Nhà chưa có thiết bị an ninh để áp dụng": "Rumah belum memiliki perangkat keamanan untuk diterapkan",
    "Bạn không có quyền sửa lịch Theo nhà. Hãy chọn Riêng tôi.": "Anda tidak memiliki izin untuk mengubah jadwal rumah. Pilih Hanya saya.",
    "Không thể lưu chế độ Alarm": "Tidak dapat menyimpan mode Alarm",
    "Thêm Reminder": "Menambahkan Reminder",
    "Reminder sẽ nhắc bạn kiểm tra trạng thái an toàn của ngôi nhà vào giờ đã chọn.": "Reminder akan mengingatkan Anda untuk memeriksa status keamanan rumah pada jam yang dipilih.",
    ...
    "Đồng ý": "Setuju",
    "Bạn chắc chắn muốn rời khỏi nhà này?": "Apakah Anda yakin ingin meninggalkan rumah ini?",
    "Xoá thành viên?": "Hapus anggota?",
    "Rời khỏi nhà?": "Meninggalkan rumah?",
    "Chỉ chủ nhà mới được thay đổi vai trò": "Hanya Pemilik rumah yang dapat mengubah peran",
    "Bạn không có quyền xoá thành viên này": "Anda tidak memiliki izin untuk menghapus anggota ini",
    "Bạn": "Anda",
    ...
    "Thành viên chưa cập nhật số điện thoại": "Anggota belum memperbarui nomor telepon",
    "Bảo vệ thủ công đang bật - chỉ tắt khi chuyển về Bình thường": "Mode Perlindungan manual aktif - hanya dapat dimatikan dengan beralih ke Mode Normal",
    "Thời gian lặp": "Ulangi waktu",
    "Chọn 0 để chỉ báo một lần. Cài đặt này dùng cho cả Bảo vệ thủ công và Tự động Bảo vệ khi rời nhà.": "Pilih 0 agar Alarm hanya berbunyi sekali. Pengaturan ini berlaku untuk Mode Perlindungan manual dan otomatis saat keluar rumah.",
    ...
    "Cảm biến khói chưa ghi nhận bất thường.": "Sensor asap belum mencatat adanya kelainan.",
    "Bạn hoặc thành viên đã chủ động bật Bảo vệ.": "Anda atau anggota yang berwenang telah mengaktifkan Mode Perlindungan.",
    "SafeHome tự bật Bảo vệ vì bạn đã rời khỏi nhà.": "SafeHome mengaktifkan Mode Perlindungan secara otomatis karena Anda meninggalkan rumah.",
    "Nhà đang ở chế độ dùng bình thường.": "Rumah sedang berada dalam Mode Normal.",
    ...
    "Bạn đã mở app gần đây để kiểm tra trạng thái.": "Anda baru-baru ini membuka aplikasi untuk memeriksa status.",
    "Bạn nên mở app định kỳ để kiểm tra quyền, lịch và cảnh báo chưa đọc.": "Anda harus membuka aplikasi secara berkala untuk memeriksa izin, kalender, dan peringatan yang belum dibaca.",
    "Sau vài lần sử dụng, SafeHome sẽ đánh giá thói quen kiểm tra app tốt hơn.": "Setelah beberapa kali penggunaan, SafeHome akan mengevaluasi kebiasaan pemeriksaan aplikasi dengan lebih baik.",
    ...
    "Cần kiểm tra quyền vị trí luôn luôn và điều kiện chạy nền.": "Izin lokasi selalu aktif dan kondisi latar belakang perlu diperiksa.",
    "Thiết bị đủ điều kiện để Auto rời khỏi nhà hoạt động.": "Perangkat memenuhi syarat untuk pengoperasian keluar rumah secara otomatis.",
    "Bạn có thể bật khi muốn tự động chuyển Bảo vệ lúc rời nhà.": "Aktifkan fitur ini untuk beralih otomatis ke Mode Perlindungan saat meninggalkan rumah.",
    "Auto rời khỏi nhà chưa ổn": "Perlindungan otomatis saat keluar rumah belum siap",
    "Auto rời khỏi nhà đã sẵn sàng": "Perlindungan otomatis saat keluar rumah siap",
    "Auto rời khỏi nhà chưa bật": "Perlindungan otomatis saat keluar rumah belum aktif",
    "Nên thêm báo khói, SOS hoặc thiết bị khẩn cấp phù hợp với nhà.": "Sebaiknya menambahkan alarm asap, SOS atau perangkat darurat yang sesuai untuk rumah.",
    "Chưa có thiết bị khẩn cấp": "Peralatan darurat tidak tersedia",
    "Đã có thiết bị khẩn cấp": "Peralatan darurat tersedia",
    "Nên đặt lịch Alarm cho thời gian ngủ hoặc vắng nhà.": "Alarm harus dijadwalkan untuk waktu tidur atau pergi.",
    "Nhà đã có lịch Alarm hoặc lịch cảnh báo theo thiết bị.": "Rumah sudah mempunyai jadwal Alarm atau jadwal alarm sesuai perangkat.",
    "Chưa set lịch Alarm": "Belum dijadwalkan Alarm",
    "Đã set lịch Alarm": "Jadwal Alarm telah diatur",
    "Nên có ít nhất một Reminder để không quên kiểm tra nhà.": "Sebaiknya atur setidaknya satu Reminder agar Anda tidak lupa memeriksa rumah.",
    "App sẽ nhắc bạn kiểm tra nhà theo lịch đã đặt.": "Aplikasi akan mengingatkan Anda untuk memeriksa rumah sesuai jadwal yang ditetapkan.",
    "Chưa setup Reminder": "Belum diatur Reminder",
    "Đã setup Reminder": "Reminder telah diatur",
    "Hãy mở lại app hoặc đăng nhập lại nếu thiết bị không nhận cảnh báo.": "Silakan buka kembali aplikasi atau masuk lagi jika perangkat tidak menerima peringatan.",
    "Thiết bị chưa đăng ký nhận cảnh báo": "Perangkat tidak terdaftar untuk menerima peringatan",
    "Thiết bị nhận cảnh báo bình thường": "Perangkat menerima peringatan secara normal",
    "iOS quản lý chạy nền chặt hơn Android; hãy giữ thông báo và vị trí luôn luôn nếu dùng Auto rời khỏi nhà.": "iOS membatasi aktivitas latar belakang lebih ketat daripada Android; aktifkan notifikasi dan izin lokasi selalu saat menggunakan perlindungan otomatis ketika keluar rumah.",
    "Cơ chế iOS": "Mekanisme iOS",
    "Hãy kiểm tra quyền chạy nền và tự khởi động để cảnh báo không bị trễ.": "Periksa izin latar belakang dan mulai otomatis agar peringatan tidak tertunda.",
    "Thiết bị đã xác nhận các điều kiện chạy nền quan trọng.": "Perangkat telah memenuhi kondisi latar belakang penting.",
    "Cần kiểm tra chạy nền / tự khởi động": "Perlu memeriksa latar belakang berjalan / mulai otomatis",
    "Chạy nền ổn định": "Latar belakang stabil berjalan",
    "Một số máy Android có thể trì hoãn cảnh báo nếu tối ưu pin còn bật.": "Beberapa perangkat Android mungkin menunda peringatan jika pengoptimalan baterai diaktifkan.",
    "Điện thoại ít có khả năng trì hoãn cảnh báo SafeHome.": "Ponsel cenderung tidak menunda alarm SafeHome.",
    "Chưa tắt tối ưu pin": "Pengoptimalan baterai belum dimatikan.",
    "Tối ưu pin không chặn app": "Pengoptimalan baterai tidak memblokir aplikasi.",
    "Auto rời khỏi nhà cần quyền vị trí luôn luôn để chạy ổn định.": "Meninggalkan rumah secara otomatis memerlukan izin lokasi setiap saat agar dapat berjalan dengan stabil.",
    "Cần cấp quyền vị trí để Auto rời khỏi nhà hoạt động.": "Perlu memberikan izin lokasi agar Otomatis meninggalkan rumah untuk beroperasi.",
    "Dịch vụ vị trí đang tắt nên Auto rời khỏi nhà không ổn định.": "Layanan lokasi mati sehingga keluar rumah secara otomatis tidak stabil.",
    "Chỉ cần quyền này khi dùng Auto rời khỏi nhà.": "Izin ini hanya diperlukan saat menggunakan Otomatis untuk meninggalkan rumah.",
    "Chưa cấp vị trí luôn luôn": "Posisi belum diberikan",
    "Đã cấp vị trí luôn luôn": "Posisi selalu diberikan",
    "iOS không mở toàn màn hình như Android; app dùng notification và âm thanh hệ thống.": "iOS tidak membuka layar penuh seperti Android; Aplikasi ini menggunakan notifikasi dan suara sistem.",
    "Android dùng cảnh báo toàn màn hình; nếu máy chặn, hãy cấp quyền trong cài đặt.": "Android menggunakan peringatan layar penuh; Jika perangkat Anda memblokirnya, berikan izin di pengaturan.",
    "Cảnh báo trên iOS": "Peringatan iOS",
    "Cảnh báo toàn màn hình": "Peringatan Layar Penuh",
    "Cảnh báo có thể không hiển thị nếu thông báo bị tắt.": "Peringatan mungkin tidak ditampilkan jika pemberitahuan dinonaktifkan.",
    "Điện thoại có thể nhận thông báo SafeHome.": "Ponsel dapat menerima notifikasi SafeHome.",
    ...
    "Kiểm tra điện thoại và cách bạn đang dùng app.": "Periksa ponsel Anda dan cara Anda menggunakan aplikasi.",
    "Hệ thống SafeHome": "Sistem SafeHome",
    "Hệ thống: Đang kiểm tra...": "Sistem: Memeriksa...",
    "Tên": "Nama",
    "Bạn không có quyền thay đổi vị trí nhà": "Anda tidak memiliki izin untuk mengubah lokasi rumah",
    "Hãy bật GPS để đặt vị trí nhà": "Harap aktifkan GPS untuk menyetel lokasi rumah",
    "Bạn chưa cấp quyền vị trí": "Anda belum memberikan izin lokasi",
    "Hãy cấp quyền vị trí trong Cài đặt ứng dụng": "Harap berikan izin lokasi di Pengaturan Aplikasi",
    "Đã bật tự động Bảo vệ khi mọi người rời nhà": "Mode Perlindungan otomatis saat semua orang keluar telah diaktifkan",
    "Đã tắt tự động Bảo vệ khi mọi người rời nhà": "Mode Perlindungan otomatis saat semua orang keluar telah dinonaktifkan",
    "Không thể thay đổi trạng thái Alarm": "Status tidak dapat diubah Alarm",
    "Đã tắt toàn bộ Alarm của nhà": "Dinonaktifkan sepenuhnya Alarm dari rumah",
    "QR này không phải mã xin gia nhập Home": "QR ini bukan kode permintaan bergabung rumah",
    "Thêm Home": "Tambah rumah",
    "Mở cài đặt": "Buka pengaturan",
    "Để sau": "Nanti",
    "SafeHome cần quyền vị trí \"Luôn cho phép\" để nhận biết khi bạn rời hoặc trở về nhà, kể cả khi ứng dụng đang chạy nền.": "SafeHome memerlukan izin lokasi \"Selalu izinkan\" untuk mendeteksi saat Anda meninggalkan atau kembali ke rumah, termasuk ketika aplikasi berjalan di latar belakang.",
    "SafeHome hiện chỉ được truy cập vị trí khi bạn đang sử dụng ứng dụng.\n\nHãy chọn quyền Vị trí và chuyển sang \"Luôn cho phép\" để tính năng tự động Bảo vệ khi rời nhà hoạt động khi ứng dụng đang chạy nền.": "SafeHome saat ini hanya dapat mengakses lokasi saat Anda menggunakan aplikasi.\n\nBuka izin Lokasi lalu pilih \"Selalu izinkan\" agar Mode Perlindungan otomatis saat keluar rumah dapat berfungsi di latar belakang.",
    "Cho phép vị trí luôn luôn": "Selalu izinkan lokasi",
    "Các nhà của bạn sẽ bị xoá.\nCác nhà được chia sẻ sẽ được rời khỏi.": "Rumah Anda akan dihapus.\nRumah bersama akan ditinggalkan.",
    "Thao tác này sẽ thay đổi lịch Home Alarm của toàn bộ thiết bị an ninh trong các nhà đã chọn.\n\nNhững thành viên đang sử dụng Alarm 'Theo nhà' sẽ bị ảnh hưởng.\nAlarm cá nhân ở chế độ 'Riêng tôi' sẽ không bị thay đổi.": "Tindakan ini akan mengubah jadwal Alarm rumah semua perangkat keamanan di rumah yang dipilih.\n\nAnggota yang menggunakan Alarm 'Menurut rumah' akan terpengaruh.\nAlarm pribadi dalam mode 'Hanya saya' tidak akan diubah.",
    "Thao tác này sẽ thêm Home Reminder cho các nhà đã chọn.\n\nNhững thành viên đang sử dụng Reminder 'Theo nhà' sẽ bị ảnh hưởng.\nReminder cá nhân ở chế độ 'Riêng tôi' sẽ không bị thay đổi.": "Tindakan ini akan menambahkan Reminder rumah ke rumah yang dipilih.\n\nAnggota yang menggunakan Reminder 'Menurut rumah' akan terpengaruh.\nReminder pribadi dalam mode 'Hanya saya' tidak akan diubah.",
    "Khi bật, các thiết bị an ninh sẽ được giám sát ngay.\n\nTự động Bảo vệ khi rời nhà sẽ tạm dừng. Chế độ này không tự tắt khi có người về nhà và chỉ được tắt khi một thành viên có quyền chủ động chuyển về Bình thường.": "Saat diaktifkan, perangkat keamanan akan segera dipantau.\n\nMode Perlindungan otomatis saat keluar rumah akan dijeda. Mode ini tidak mati secara otomatis ketika seseorang pulang dan hanya dapat dimatikan saat anggota yang berwenang beralih ke Mode Normal.",
    "Hành động này sẽ thay đổi thời gian báo động của một số thiết bị trong hôm nay...": "Tindakan ini akan mengubah waktu alarm beberapa perangkat hari ini...",
    "Hành động này sẽ tắt toàn bộ báo động của nhà dưới mọi hình thức. Bạn sẽ không còn nhận được cảnh báo khi có nguy hiểm trên điện thoại nữa.": "Tindakan ini akan mematikan semua alarm rumah apa pun. Anda tidak akan lagi menerima peringatan ketika ada bahaya di ponsel Anda.",
    "Alarm đang sử dụng chế độ Theo nhà.\n\nBạn sẽ nhận cảnh báo theo lịch Alarm chung do Chủ nhà hoặc Quản trị viên thiết lập.": "Alarm menggunakan mode Mengikuti rumah.\n\nAnda akan menerima peringatan sesuai jadwal Alarm bersama yang ditetapkan oleh Pemilik rumah atau Administrator.",
    "Alarm đang sử dụng chế độ Riêng tôi.\n\nBạn sẽ nhận cảnh báo theo lịch Alarm riêng đã thiết lập cho tài khoản này.": "Alarm menggunakan mode Saya sendiri.\n\nAnda akan menerima peringatan sesuai dengan jadwal individu Alarm yang diatur untuk akun ini.",
    "Không thể đăng nhập bằng Google": "Tidak dapat masuk dengan Google",
    "Không đặt được mật khẩu": "Tidak dapat menyetel sandi",
    "Chấp nhận": "Terima",
    "Cho phép": "Izinkan",
    "Không thể chấp nhận lời mời. Vui lòng thử lại.": "Tidak dapat menerima undangan. Silakan coba lagi.",
    "Không thể chấp nhận lời xin vào nhà. Vui lòng thử lại.": "Permintaan masuk rumah tidak dapat diterima. Silakan coba lagi.",
    "Từ chối": "Tolak",
    ...
    "Mật khẩu nhập lại không khớp": "Kata sandi yang dimasukkan kembali tidak cocok",
    ...
    "Hãy chọn quyền vị trí Luôn cho phép trong Cài đặt ứng dụng": "Silakan pilih izin lokasi Selalu izinkan di Instal aplikasi",
    "Tài khoản Google cần tạo thêm mật khẩu để dùng các chức năng bảo mật.": "Akun Google perlu membuat kata sandi tambahan untuk menggunakan fungsi keamanan.",
    "Alarm": "Alarm",
    "Bạn không có quyền thực hiện thao tác này。": "Anda tidak memiliki izin untuk melakukan operasi ini.",
    "Cài đặt": "Pengaturan",
    "Cập nhật": "Perbarui",
    "Chọn ngôn ngữ": "Pilih bahasa",
    "Chưa có dữ liệu thiết bị để đánh giá": "Data perangkat tidak tersedia untuk ditinjau",
    "Chuyển quyền sở hữu cho thành viên khác": "Mentransfer kepemilikan ke anggota lain",
    "Có": "Ya",
    ...
    "Đang mở khi nhà ở chế độ Bảo vệ": "Terbuka saat rumah dalam Mode Perlindungan",
    "Đang mở trong giờ Alarm": "Buka pada jam kerja Alarm",
    "Đang tải...": "Memuat...",
    "Hồ sơ, yêu cầu và lời mời tham gia": "Profil, persyaratan, dan undangan untuk bergabung",
    ...
    "Khóa đang mở khi nhà ở chế độ Bảo vệ": "Kunci terbuka saat rumah dalam Mode Perlindungan",
    ...
    "Thêm, đổi tên và sắp xếp phòng": "Menambah, mengganti nama, dan mengatur ruangan",
    ...
    "Báo động lặp sau \$securityModeRepeatMinutes phút nếu sự cố vẫn còn.": "Alarm berulang setelah \$securityModeRepeatMinutes menit jika masalah terus berlanjut.",
    "\$actorName đã bật Mode Bảo vệ thủ công cho \"\$homeName\". Chế độ này chỉ tắt khi một thành viên có quyền chủ động chuyển về Bình thường. \$repeatMessage": "\$actorName telah mengaktifkan Mode Perlindungan Manual untuk \"\$homeName\". Mode ini hanya dimatikan ketika anggota yang berwenang beralih kembali ke Mode Normal. \$repeatMessage",
    "Bạn đã bật Alarm cho nhà \"\$homeName\".": "Anda telah mengaktifkan Alarm untuk rumah \"\$homeName\".",
    "Bạn đã tắt toàn bộ Alarm của nhà \"\$homeName\".": "Anda telah menonaktifkan semua Alarm untuk rumah \"\$homeName\".",
    ...
    "\$actorName đã đổi vai trò của \$memberName từ \$oldRoleName thành \$newRoleName trong nhà \"\$homeName\".": "\$actorName mengubah peran \$memberName dari \$oldRoleName menjadi \$newRoleName di rumah \"\$homeName\".",
    ...
    "Đang theo dõi để tự động bật Chế độ Bảo vệ.": "Memantau untuk mengaktifkan Mode Perlindungan secara otomatis.",
    "Dùng vị trí để tự động bật Chế độ Bảo vệ khi mọi người rời nhà.": "Gunakan lokasi untuk mengaktifkan Mode Perlindungan secara otomatis saat semua orang meninggalkan rumah.",
    ...
    "Không thể xác nhận với SafeHome. Hãy kiểm tra kết nối và thử lại.": "Tidak dapat mengonfirmasi dengan SafeHome. Silakan periksa koneksi Anda dan coba lagi.",
    "Chỉ tắt cảnh báo khi bạn đã kiểm tra tình trạng trong nhà.\n\nBạn chắc chắn muốn tắt cảnh báo?": "Matikan peringatan hanya setelah Anda memeriksa kondisi rumah.\n\nApakah Anda yakin ingin mematikan peringatan?",
    ...
    "Mode Bảo vệ sẽ chỉ báo động một lần": "Mode Perlindungan hanya akan membunyikan Alarm sekali",
    "Mode Bảo vệ sẽ lặp báo động sau \$minutes phút": "Mode Perlindungan akan mengulangi Alarm setelah \$minutes menit",
    "Đã gửi yêu cầu gia nhập \$count nhà": "Permintaan bergabung untuk \$count rumah telah dikirim",
    "\$requesterName đang xin gia nhập nhà \"\$homeName\".": "\$requesterName meminta bergabung dengan rumah \"\$homeName\".",
    "Bạn đã xoá nhà \"\$homeName\".": "Anda telah menghapus rumah \"\$homeName\".",
    "Bạn đã gửi yêu cầu chuyển quyền chủ nhà \"\$homeName\" cho \$email.": "Anda telah mengirimkan permintaan untuk mengalihkan kepemilikan \"\$homeName\" ke \$email.",
    "\$actorName muốn chuyển quyền chủ nhà \"\$homeName\" cho bạn.": "\$actorName ingin mentransfer kepemilikan \"\$homeName\" kepada Anda.",
    "\$actorName đã mời bạn tham gia nhà \"\$homeName\".": "\$actorName telah mengundang Anda untuk bergabung dengan rumah \"\$homeName\".",
    "SafeHome đang xoá thiết bị \"\$deviceName\" khỏi nhà \"\$homeName\".": "SafeHome menghapus perangkat \"\$deviceName\" dari rumah \"\$homeName\".",
    "Thiết bị \"\$deviceName\" đã xuất hiện trong \"\$homeName\".": "Perangkat \"\$deviceName\" telah muncul di \"\$homeName\".",
    "Bạn đã tạo nhà \"\$name\".": "Anda telah membuat rumah \"\$name\".",
    "\$actorName đã cập nhật tên nhà thành \"\$newName\" và thay đổi địa chỉ.": "\$actorName memperbarui nama rumah menjadi \"\$newName\" dan mengubah alamatnya.",
    "\$actorName đã đổi tên nhà thành \"\$newName\".": "\$actorName telah mengubah nama rumah menjadi \"\$newName\".",
    "\$actorName đã cập nhật địa chỉ của nhà \"\$newName\".": "\$actorName memperbarui alamatnya \"\$newName\".",
    "\$actorName đã đổi tên thiết bị \"\$oldDeviceName\" thành \"\$newName\" trong nhà \"\$homeName\".": "\$actorName mengganti nama perangkat \"\$oldDeviceName\" menjadi \"\$newName\" di rumah \"\$homeName\".",
    "Đang ghép nối: \$seconds giây": "Pemasangan: \$seconds detik",
    "Chế độ thêm thiết bị đã được mở trong nhà \"\$homeName\" trong \$seconds giây.": "Mode penambahan perangkat telah dibuka di rumah \"\$homeName\" selama \$seconds detik.",
    "Khoảng thời gian phải nằm trong khung Alarm (\$start → \$end)": "Interval waktu harus berada dalam frame Alarm (\$start → \$end)",
    "\$passCount/\$total bài test đạt\n\n": "\$passCount/\$total tes lulus\n\n",
    "\$name chưa cập nhật số điện thoại trong hồ sơ.": "\$name belum memperbarui nomor teleponnya di profil.",
    ...
    "\"\$name\" phát hiện khói trong \"\$homeName\".": "\"\$name\" mendeteksi asap di \"\$homeName\".",
    "\"\$name\" đã trở lại trạng thái bình thường.": "\"\$name\" telah kembali ke status normal.",
    "\"\$name\" vừa kích hoạt SOS trong \"\$homeName\".": "\"\$name\" baru saja mengaktifkan SOS di \"\$homeName\".",
    "\"\$name\" đã hết trạng thái SOS.": "\"\$name\" telah kedaluwarsa status SOS.",
    "\"\$name\" báo bị tháo/cạy trong \"\$homeName\".": "\"\$name\" terdeteksi dilepas atau dicongkel di \"\$homeName\".",
    "\"\$name\" đã hết cảnh báo tháo/cạy.": "Peringatan gangguan pada \"\$name\" telah berakhir.",
    "\"\$name\" đã đóng trong \"\$homeName\".": "\"\$name\" ditutup di \"\$homeName\".",
    "\"\$name\" đang mở trong \"\$homeName\".": "\"\$name\" terbuka di \"\$homeName\".",
    "\"\$name\" trong \"\$homeName\" đang yếu pin.": "\"\$name\" di \"\$homeName\" baterai lemah.",
    "\"\$name\" trong \"\$homeName\" đã mất kết nối.": "\"\$name\" di \"\$homeName\" telah kehilangan koneksi.",
    "\"\$name\" trong \"\$homeName\" đã kết nối trở lại.": "\"\$name\" di \"\$homeName\" terhubung lagi.",
    "\"\$name\" ghi nhận nhiệt độ cao trong \"\$homeName\".": "\"\$name\" mencatat suhu tinggi di \"\$homeName\".",
    "\"\$name\" ghi nhận độ ẩm cao trong \"\$homeName\".": "\"\$name\" mencatat kelembapan tinggi di \"\$homeName\".",
    ...
    "Có cửa đang mở hoặc thiết bị bị tháo": "Ada pintu terbuka atau perangkat dilepas",
    "Có thiết bị đang cảnh báo": "Ada peringatan perangkat",
    "Nếu chưa có ai xác nhận, SafeHome sẽ chuyển sang gọi điện khẩn cấp.": "Jika tidak ada yang mengonfirmasi, SafeHome akan beralih ke panggilan darurat.",
    "Báo lại lúc \$time nếu vấn đề chưa được xử lý.": "Laporkan kembali ke \$time jika masalah belum teratasi.",
    "Sẽ báo lại theo lịch Alarm đã cài nếu vấn đề chưa được xử lý.": "Akan melaporkan kembali sesuai jadwal Alarm yang terpasang jika masalah belum teratasi.",
    "\"\$deviceName\" đã đóng trong \"\$resolvedHomeName\".": "\"\$deviceName\" ditutup di \"\$resolvedHomeName\".",
    "\"\$deviceName\" đang mở trong \"\$resolvedHomeName\".": "\"\$deviceName\" dibuka di \"\$resolvedHomeName\".",
    "\$count nhà đã chọn": "\$count rumah terpilih",
    "🚨 \$count nhà không an toàn\$suffix": "🚨 \$count rumah tidak aman\$suffix",
    "⚠️ \$count nhà cần chú ý\$suffix": "⚠️ \$count rumah perlu perhatian\$suffix",
    "✅ \$count nhà an toàn": "✅ Rumah aman \$count",
    "\$count nhà đang được theo dõi": "\$count rumah dipantau",
    "\$minutes phút": "\$minutes menit",
    "Đã cài Reminder cho \$updatedHomes nhà.": "Terpasang Reminder untuk rumah \$updatedHomes.",
    "Đã cài Alarm cho \$updatedDevices thiết bị trong \$updatedHomes nhà.\n": "Alarm telah diatur untuk \$updatedDevices perangkat di \$updatedHomes rumah.\n",
    "Đã chia sẻ các nhà bạn có quyền.\n\n\$skipped nhà bị bỏ qua vì bạn không có quyền chia sẻ.": "Rumah yang boleh Anda bagikan telah dibagikan.\n\n\$skipped rumah dilewati karena Anda tidak memiliki izin untuk membagikannya.",
    "Đã áp dụng Alarm cho \$count thiết bị an ninh": "Alarm diterapkan ke \$count perangkat keamanan",
    "Áp dụng cùng một lịch cho \$count thiết bị an ninh": "Terapkan jadwal yang sama ke \$count perangkat keamanan",
    ...
    "Bạn chắc chắn muốn xoá \$name khỏi nhà này?": "Apakah Anda yakin ingin menghapus \$name dari rumah ini?",
    "\$targetEmail\nXin gia nhập \"\$homeName\"": "\$targetEmail\nSilakan bergabung dengan \"\$homeName\"",
    "Xin gia nhập \"\$homeName\"": "Silakan bergabung dengan \"\$homeName\"",
    "Bạn được mời nhận quyền nhà \"\$homeName\"": "Anda diundang untuk menerima hak atas \"\$homeName\"",
    ...
    "Hãy thêm thiết bị SafeHome đầu tiên để bắt đầu theo dõi nhà.": "Tambahkan perangkat SafeHome pertama untuk memulai pemantauan rumah.",
    "Kiểm tra cảnh báo khẩn cấp trước, sau đó liên hệ thành viên trong nhà nếu cần.": "Periksa peringatan darurat terlebih dahulu, lalu hubungi anggota rumah tangga jika perlu.",
    "Không có thành viên nào ở nhà nhưng cửa hoặc khóa đang mở, hãy kiểm tra ngay.": "Tidak ada anggota di rumah tetapi pintu atau kunci terbuka, harap segera dicek.",
    "Kiểm tra cửa hoặc khóa đang mở trước khi giữ nhà ở chế độ Bảo vệ.": "Periksa pintu atau kunci yang terbuka sebelum mempertahankan rumah dalam Mode Perlindungan.",
    "Có thể vẫn có người ở nhà; nếu đúng, nên chuyển về Bình thường.": "Mungkin masih ada orang di rumah; jika demikian, sebaiknya beralih ke Mode Normal.",
    "Có thành viên chưa xác định vị trí, hãy nhắc họ mở app hoặc kiểm tra quyền vị trí.": "Ada anggota yang belum ditentukan lokasinya, harap ingatkan untuk membuka aplikasi atau memeriksa izin lokasi.",
    "Có thiết bị mất kết nối, hãy kiểm tra pin, nguồn hoặc vị trí đặt thiết bị.": "Perangkat kehilangan koneksi, periksa baterai, daya, atau lokasi perangkat.",
    "Có thiết bị pin yếu, nên thay pin sớm để tránh mất cảnh báo.": "Ada baterai lemah di perangkat, baterai harus diganti lebih awal untuk menghindari kehilangan peringatan.",
    "Bạn chưa đặt Reminder, nên tạo lịch nhắc kiểm tra nhà định kỳ.": "Anda belum menyetel Reminder, sebaiknya buat jadwal untuk mengingatkan Anda agar memeriksa rumah secara berkala.",
    "Bạn chưa đặt lịch Alarm, nên bật bảo vệ theo khung giờ thường vắng nhà.": "Anda belum menetapkan jadwal untuk Alarm, jadi sebaiknya aktifkan keamanan pada jam-jam biasanya Anda jauh dari rumah.",
    "Không có việc cần xử lý ngay, bạn chỉ cần tiếp tục theo dõi trạng thái nhà.": "Tidak ada yang perlu segera dilakukan, Anda hanya perlu terus memantau status rumah.",
    ...
    "Phát hiện \$count vấn đề cần xử lý": "Terdeteksi masalah \$count yang harus diselesaikan",
    "Hôm nay các cửa đã được sử dụng \$count lần": "Pintu digunakan hari ini \$count kali",
    "Đã ghi nhận \$count hoạt động gần đây": "Tercatat \$count baru-baru ini aktif",
    "Hệ thống: Cần kiểm tra \$issueCount mục": "Sistem: Perlu pemeriksaan \$issueCount item",
    "FCM token đã sẵn sàng trên điện thoại này.": "Token FCM siap di ponsel ini.",
    "FCM token đã sẵn sàng, nhưng Auto rời khỏi nhà còn thiếu điều kiện.": "FCM sudah siap, tetapi syarat keluar rumah otomatis kurang.",
    "Hiện có \$emergencyTotal thiết bị khẩn cấp. Khuyến nghị tối thiểu: báo khói và SOS.": "Peralatan darurat \$emergencyTotal tersedia. Rekomendasi minimum: alarm asap dan SOS.",
    "Bạn chắc chắn muốn chuyển quyền chủ nhà cho:\n\$targetEmail?": "Anda pasti ingin mengalihkan kepemilikan rumah ke:\n\$targetEmail?",
    ...
    "Dữ liệu gần nhất cập nhật \$count phút trước": "Data terbaru diperbarui \$count menit yang lalu",
    "Dữ liệu gần nhất cập nhật \$count giờ trước": "Data terbaru diperbarui \$count jam yang lalu",
    ...
    "\$name: Đang mở khi nhà ở chế độ Bảo vệ": "\$name: Terbuka saat rumah dalam Mode Perlindungan",
    "An tâm hơn trong từng ngôi nhà": "Lebih tenang di setiap rumah",
    "Báo động SafeHome": "Alarm SafeHome",
    "Có cảnh báo an ninh cần kiểm tra ngay.": "Terdapat alarm keamanan yang perlu segera diperiksa.",
    ...
    "Hoặc": "Atau",
    "Giờ bắt đầu và kết thúc không được trùng nhau": "Waktu mulai dan selesai tidak boleh sama",
    "Giờ kết thúc phải sau thời điểm hiện tại": "Waktu selesai harus setelah waktu saat ini",
    "Khoảng tạm tắt không hợp lệ": "Rentang jeda Alarm tidak valid",
    "Khoảng tạm tắt không trùng với lịch Alarm nào đang bật": "Rentang jeda tidak bertepatan dengan jadwal Alarm aktif mana pun",
  };
  ...
  static const Map<String, String> _thai = {
    ...
    "Bạn không có quyền sửa lịch chung của nhà": "คุณไม่มีสิทธิ์แก้ไขกำหนดเวลาส่วนกลางของบ้าน",
    ...
    "Chưa có thiết bị, hãy nhấn nút + để thêm để bắt đầu duy trì an ninh": "ยังไม่มีอุปกรณ์ กดปุ่ม + เพื่อเพิ่มอุปกรณ์และเริ่มดูแลความปลอดภัย",
    "CHƯA AN TOÀN": "ไม่ปลอดภัย",
    "ĐÃ AN TOÀN": "ปลอดภัยแล้ว",
    "Nhà đang có dấu hiệu cần kiểm tra, bạn nên xem lại các trạng thái bên dưới.": "บ้านมีสถานะที่ต้องตรวจสอบ โปรดตรวจสอบรายละเอียดด้านล่าง",
    "Nhà đang hoạt động ổn định, bạn có thể yên tâm.": "บ้านทำงานเป็นปกติ คุณวางใจได้",
    "Không có dấu hiệu khói hoặc SOS bất thường.": "ไม่พบควันหรือเหตุการณ์ SOS ผิดปกติ",
    "Chưa có nhiều hoạt động mới để phân tích sâu hơn.": "ยังไม่มีกิจกรรมใหม่เพียงพอสำหรับการวิเคราะห์เพิ่มเติม",
    ...
    "Tìm home...": "ค้นหาบ้าน...",
    "Đặt vị trí nhà và bật bảo vệ tự động": "ตั้งค่าตำแหน่งบ้านและเปิดการป้องกันอัตโนมัติ",
    ...
    "Hoặc quét QR để xin gia nhập các nhà đã chọn": "หรือสแกน QR เพื่อขอเข้าร่วมบ้านที่เลือก",
    ...
    "Chỉ chủ nhà mới được chuyển quyền": "เฉพาะเจ้าของบ้านเท่านั้นที่โอนสิทธิ์เจ้าของบ้านได้",
    ...
    "Không thể hoàn tất thao tác. Vui lòng thử lại.": "ดำเนินการไม่สำเร็จ โปรดลองอีกครั้ง",
    ...
    "QR này không phải mã xin gia nhập nhà": "QR นี้ไม่ใช่รหัสสำหรับขอเข้าร่วมบ้าน",
    ...
    "Nhà này và toàn bộ thiết bị bên trong sẽ bị xoá vĩnh viễn.": "บ้านนี้และอุปกรณ์ทั้งหมดภายในจะถูกลบอย่างถาวร",
    "Đã xoá nhà": "ลบบ้านแล้ว",
    "QR của nhà này": "QR ของบ้านหลังนี้",
    "Người khác quét mã này để gửi yêu cầu gia nhập nhà.": "ผู้อื่นสามารถสแกนรหัสนี้เพื่อส่งคำขอเข้าร่วมบ้าน",
    ...
    "Thêm số điện thoại để dùng cho các trường hợp khẩn cấp": "เพิ่มหมายเลขโทรศัพท์สำหรับกรณีฉุกเฉิน",
    "Hoàn tất": "เสร็จสิ้น",
    ...
    "Tên phòng": "ชื่อห้อง",
    "Xoá phòng": "ลบห้อง",
    "Thiết bị trong phòng này sẽ được chuyển về Chưa phân phòng.": "อุปกรณ์ในห้องนี้จะถูกย้ายไปยังส่วนยังไม่ได้กำหนดห้อง",
    ...
    "Hãy đặt vị trí nhà trước khi bật tự động Bảo vệ": "โปรดตั้งค่าตำแหน่งบ้านก่อนเปิดการป้องกันอัตโนมัติ",
    "Bán kính bảo vệ mặc định: 150 m": "รัศมีป้องกันเริ่มต้น: 150 ม.",
    "Mỗi thành viên sẽ cần cấp quyền vị trí Luôn cho phép để trạng thái rời/đến nhà hoạt động khi app chạy nền.": "สมาชิกแต่ละคนต้องอนุญาตตำแหน่งเป็น \"อนุญาตเสมอ\" เพื่อให้ตรวจจับการออกจากและกลับถึงบ้านได้ขณะแอปทำงานเบื้องหลัง",
    ...
    "Tên này chỉ hiển thị riêng trên tài khoản của bạn.": "ชื่อนี้จะปรากฏเฉพาะในบัญชีของคุณเท่านั้น",
    "Tên và địa chỉ sẽ được cập nhật cho toàn bộ thành viên trong nhà.": "ชื่อและที่อยู่จะอัปเดตให้สมาชิกทุกคนในบ้าน",
    ...
    "Hãy thực hiện kiểm tra bằng tài khoản Owner": "โปรดทดสอบด้วยบัญชีเจ้าของบ้าน",
    "Không đọc được dữ liệu nhà": "ไม่สามารถอ่านข้อมูลบ้านได้",
    "Nhà cần có ít nhất một thiết bị để test": "บ้านต้องมีอุปกรณ์อย่างน้อยหนึ่งเครื่องเพื่อทดสอบ",
    "Đóng": "ปิด",
    ...
    "Theo nhà": "ตามบ้าน",
    "Riêng tôi": "เฉพาะฉัน",
    "Dùng lịch chung do Chủ nhà hoặc Quản trị viên thiết lập": "ใช้กำหนดเวลาส่วนกลางที่เจ้าของบ้านหรือผู้ดูแลระบบตั้งไว้",
    "Dùng lịch riêng chỉ áp dụng cho tài khoản của bạn": "ใช้กำหนดเวลาส่วนตัวสำหรับบัญชีของคุณเท่านั้น",
    ...
    "Không tìm thấy nhà của thông báo này": "ไม่พบบ้านที่เกี่ยวข้องกับการแจ้งเตือนนี้",
    ...
    "Tự động Bảo vệ khi rời nhà vẫn đang bật. Nếu mọi thành viên vẫn ở ngoài, hệ thống có thể tự bật lại Bảo vệ sau vài phút.": "การป้องกันอัตโนมัติเมื่อออกจากบ้านยังเปิดอยู่ หากสมาชิกทุกคนยังอยู่นอกบ้าน ระบบอาจเปิดโหมดป้องกันอีกครั้งโดยอัตโนมัติหลังจากไม่กี่นาที",
    ...
    "Hành động này sẽ thay đổi thời gian báo động của một số thiết bị ": "การดำเนินการนี้จะเปลี่ยนเวลา Alarm ของอุปกรณ์บางเครื่อง",
    "Hành động này sẽ tắt toàn bộ báo động của nhà ": "การดำเนินการนี้จะปิด Alarm ทั้งหมดของบ้าน",
    ...
    "Chỉ Chủ nhà hoặc Quản trị viên mới có quyền thay đổi lặp báo động": "เฉพาะเจ้าของบ้านหรือผู้ดูแลระบบเท่านั้นที่เปลี่ยนการทำซ้ำของ Alarm ได้",
    "Không lưu được thời gian lặp báo động": "ไม่สามารถบันทึกช่วงเวลาทำซ้ำของ Alarm ได้",
    "Chỉ Chủ nhà hoặc Quản trị viên mới có quyền thay đổi Mode Bảo vệ": "เฉพาะเจ้าของบ้านหรือผู้ดูแลระบบเท่านั้นที่เปลี่ยนโหมดป้องกันได้",
    "Không thể thay đổi chế độ nhà": "ไม่สามารถเปลี่ยนโหมดบ้านได้",
    "Đã bật Bảo vệ nhưng chưa gửi được thông báo": "เปิดโหมดป้องกันแล้ว แต่ยังส่งการแจ้งเตือนไม่สำเร็จ",
    "Đã bật Mode Bảo vệ thủ công": "เปิดโหมดป้องกันด้วยตนเองแล้ว",
    "Đã chuyển nhà về Bình thường": "เปลี่ยนบ้านเป็นโหมดปกติแล้ว",
    "60 phút": "60 นาที",
    "30 phút": "30 นาที",
    "15 phút": "15 นาที",
    "Bạn đang xem lịch của chủ nhà. Chọn Riêng tôi để tự đặt lịch Alarm.": "คุณกำลังดูกำหนดเวลาของเจ้าของบ้าน เลือก \"เฉพาะฉัน\" เพื่อตั้งกำหนดเวลา Alarm ของคุณเอง",
    "Chọn giờ kết thúc Alarm": "เลือกเวลาสิ้นสุด Alarm",
    "Chọn giờ bắt đầu Alarm": "เลือกเวลาเริ่มต้น Alarm",
    "Bạn không có quyền sửa lịch Alarm của nhà": "คุณไม่มีสิทธิ์แก้ไขกำหนดเวลา Alarm ของบ้าน",
    "Không thể áp dụng Alarm cho toàn bộ thiết bị": "ไม่สามารถใช้ Alarm กับอุปกรณ์ทั้งหมดได้",
    "Nhà chưa có thiết bị an ninh để áp dụng": "บ้านยังไม่มีอุปกรณ์รักษาความปลอดภัยที่ใช้ได้",
    "Bạn không có quyền sửa lịch Theo nhà. Hãy chọn Riêng tôi.": "คุณไม่มีสิทธิ์แก้ไขกำหนดเวลาแบบตามบ้าน โปรดเลือก \"เฉพาะฉัน\"",
    "Không thể lưu chế độ Alarm": "ไม่สามารถบันทึกโหมด Alarm ได้",
    "Thêm Reminder": "เพิ่ม Reminder",
    "Reminder sẽ nhắc bạn kiểm tra trạng thái an toàn của ngôi nhà vào giờ đã chọn.": "Reminder จะเตือนให้คุณตรวจสอบสถานะความปลอดภัยภายในบ้านตามเวลาที่เลือก",
    ...
    "Đồng ý": "ตกลง",
    "Bạn chắc chắn muốn rời khỏi nhà này?": "คุณแน่ใจหรือไม่ว่าต้องการออกจากบ้านนี้",
    "Xoá thành viên?": "ลบสมาชิกหรือไม่",
    "Rời khỏi nhà?": "ออกจากบ้านหรือไม่",
    "Chỉ chủ nhà mới được thay đổi vai trò": "เฉพาะเจ้าของบ้านเท่านั้นที่เปลี่ยนบทบาทได้",
    ...
    "Thành viên chưa cập nhật số điện thoại": "สมาชิกยังไม่ได้อัปเดตหมายเลขโทรศัพท์",
    "Bảo vệ thủ công đang bật - chỉ tắt khi chuyển về Bình thường": "เปิดโหมดป้องกันด้วยตนเองอยู่ ปิดได้โดยเปลี่ยนเป็นโหมดปกติเท่านั้น",
    "Thời gian lặp": "เวลาทำซ้ำ",
    "Chọn 0 để chỉ báo một lần. Cài đặt này dùng cho cả Bảo vệ thủ công và Tự động Bảo vệ khi rời nhà.": "เลือก 0 เพื่อแจ้งเตือนเพียงครั้งเดียว การตั้งค่านี้ใช้กับทั้งโหมดป้องกันด้วยตนเองและการป้องกันอัตโนมัติเมื่อออกจากบ้าน",
    ...
    "Bạn hoặc thành viên đã chủ động bật Bảo vệ.": "คุณหรือสมาชิกเปิดโหมดป้องกันด้วยตนเอง",
    "SafeHome tự bật Bảo vệ vì bạn đã rời khỏi nhà.": "SafeHome เปิดโหมดป้องกันอัตโนมัติเนื่องจากคุณออกจากบ้าน",
    ...
    "Bạn đã mở app gần đây để kiểm tra trạng thái.": "คุณเพิ่งเปิดแอปเพื่อตรวจสอบสถานะ",
    "Bạn nên mở app định kỳ để kiểm tra quyền, lịch và cảnh báo chưa đọc.": "คุณควรเปิดแอปเป็นระยะเพื่อตรวจสอบสิทธิ์ กำหนดเวลา และการแจ้งเตือนที่ยังไม่ได้อ่าน",
    "Sau vài lần sử dụng, SafeHome sẽ đánh giá thói quen kiểm tra app tốt hơn.": "หลังใช้งานไปสักระยะ SafeHome จะประเมินพฤติกรรมการตรวจสอบแอปได้แม่นยำขึ้น",
    ...
    "Cần kiểm tra quyền vị trí luôn luôn và điều kiện chạy nền.": "ต้องตรวจสอบสิทธิ์ตำแหน่งแบบอนุญาตเสมอและเงื่อนไขการทำงานเบื้องหลัง",
    "Thiết bị đủ điều kiện để Auto rời khỏi nhà hoạt động.": "อุปกรณ์พร้อมสำหรับการป้องกันอัตโนมัติเมื่อออกจากบ้าน",
    "Bạn có thể bật khi muốn tự động chuyển Bảo vệ lúc rời nhà.": "เปิดได้หากต้องการให้เปลี่ยนเป็นโหมดป้องกันอัตโนมัติเมื่อออกจากบ้าน",
    "Auto rời khỏi nhà chưa ổn": "การป้องกันอัตโนมัติเมื่อออกจากบ้านยังไม่พร้อม",
    "Auto rời khỏi nhà đã sẵn sàng": "การป้องกันอัตโนมัติเมื่อออกจากบ้านพร้อมใช้งาน",
    "Auto rời khỏi nhà chưa bật": "ยังไม่ได้เปิดการป้องกันอัตโนมัติเมื่อออกจากบ้าน",
    "Nên thêm báo khói, SOS hoặc thiết bị khẩn cấp phù hợp với nhà.": "ควรเพิ่มเครื่องตรวจจับควัน SOS หรืออุปกรณ์ฉุกเฉินที่เหมาะกับบ้าน",
    "Chưa có thiết bị khẩn cấp": "ไม่มีอุปกรณ์ฉุกเฉิน",
    "Đã có thiết bị khẩn cấp": "มีอุปกรณ์ฉุกเฉินแล้ว",
    "Nên đặt lịch Alarm cho thời gian ngủ hoặc vắng nhà.": "ควรกำหนดเวลา Alarm ในช่วงนอนหลับหรือไม่มีคนอยู่บ้าน",
    "Nhà đã có lịch Alarm hoặc lịch cảnh báo theo thiết bị.": "บ้านมีกำหนดเวลา Alarm หรือกำหนดการแจ้งเตือนตามอุปกรณ์แล้ว",
    "Chưa set lịch Alarm": "ยังไม่ได้ตั้งกำหนดเวลา Alarm",
    "Đã set lịch Alarm": "ตั้งกำหนดเวลา Alarm แล้ว",
    "Nên có ít nhất một Reminder để không quên kiểm tra nhà.": "ควรมี Reminder อย่างน้อยหนึ่งรายการเพื่อไม่ให้ลืมตรวจสอบบ้าน",
    "App sẽ nhắc bạn kiểm tra nhà theo lịch đã đặt.": "แอปจะเตือนให้คุณตรวจสอบบ้านตามกำหนดเวลาที่ตั้งไว้",
    "Chưa setup Reminder": "ยังไม่ได้ตั้งค่า Reminder",
    "Đã setup Reminder": "ตั้งค่า Reminder แล้ว",
    "Hãy mở lại app hoặc đăng nhập lại nếu thiết bị không nhận cảnh báo.": "โปรดเปิดแอปหรือเข้าสู่ระบบอีกครั้งหากอุปกรณ์ไม่ได้รับการแจ้งเตือน",
    "Thiết bị chưa đăng ký nhận cảnh báo": "อุปกรณ์ยังไม่ได้ลงทะเบียนรับการแจ้งเตือน",
    "Thiết bị nhận cảnh báo bình thường": "อุปกรณ์รับการแจ้งเตือนได้ตามปกติ",
    "iOS quản lý chạy nền chặt hơn Android; hãy giữ thông báo và vị trí luôn luôn nếu dùng Auto rời khỏi nhà.": "iOS จัดการการทำงานเบื้องหลังเข้มงวดกว่า Android โปรดเปิดการแจ้งเตือนและอนุญาตตำแหน่งเสมอเมื่อใช้การป้องกันอัตโนมัติเมื่อออกจากบ้าน",
    "Cơ chế iOS": "กลไก iOS",
    "Hãy kiểm tra quyền chạy nền và tự khởi động để cảnh báo không bị trễ.": "โปรดตรวจสอบสิทธิ์การทำงานเบื้องหลังและการเริ่มอัตโนมัติ เพื่อไม่ให้การแจ้งเตือนล่าช้า",
    "Thiết bị đã xác nhận các điều kiện chạy nền quan trọng.": "อุปกรณ์ผ่านเงื่อนไขสำคัญสำหรับการทำงานเบื้องหลังแล้ว",
    "Cần kiểm tra chạy nền / tự khởi động": "ต้องตรวจสอบการทำงานเบื้องหลัง / การเริ่มอัตโนมัติ",
    "Chạy nền ổn định": "ทำงานเบื้องหลังได้เสถียร",
    "Một số máy Android có thể trì hoãn cảnh báo nếu tối ưu pin còn bật.": "อุปกรณ์ Android บางตัวอาจชะลอการเตือนหากเปิดใช้งานการเพิ่มประสิทธิภาพแบตเตอรี่",
    "Điện thoại ít có khả năng trì hoãn cảnh báo SafeHome.": "โทรศัพท์มีโอกาสทำให้การแจ้งเตือน SafeHome ล่าช้าน้อยลง",
    ...
    "Auto rời khỏi nhà cần quyền vị trí luôn luôn để chạy ổn định.": "การป้องกันอัตโนมัติเมื่อออกจากบ้านต้องใช้สิทธิ์ตำแหน่งแบบ \"อนุญาตเสมอ\" เพื่อทำงานอย่างเสถียร",
    "Cần cấp quyền vị trí để Auto rời khỏi nhà hoạt động.": "ต้องอนุญาตตำแหน่งเพื่อให้การป้องกันอัตโนมัติเมื่อออกจากบ้านทำงาน",
    "Dịch vụ vị trí đang tắt nên Auto rời khỏi nhà không ổn định.": "บริการตำแหน่งปิดอยู่ การป้องกันอัตโนมัติเมื่อออกจากบ้านจึงอาจทำงานไม่เสถียร",
    "Chỉ cần quyền này khi dùng Auto rời khỏi nhà.": "ต้องใช้สิทธิ์นี้เมื่อใช้การป้องกันอัตโนมัติเมื่อออกจากบ้านเท่านั้น",
    "Chưa cấp vị trí luôn luôn": "ยังไม่ได้อนุญาตตำแหน่งเสมอ",
    "Đã cấp vị trí luôn luôn": "อนุญาตตำแหน่งเสมอแล้ว",
    "iOS không mở toàn màn hình như Android; app dùng notification và âm thanh hệ thống.": "iOS ไม่เปิดแบบเต็มหน้าจอเหมือน Android แอปจึงใช้การแจ้งเตือนและเสียงของระบบ",
    "Android dùng cảnh báo toàn màn hình; nếu máy chặn, hãy cấp quyền trong cài đặt.": "Android ใช้การแจ้งเตือนแบบเต็มหน้าจอ หากอุปกรณ์บล็อกไว้ โปรดให้สิทธิ์ในการตั้งค่า",
    "Cảnh báo trên iOS": "การแจ้งเตือนบน iOS",
    "Cảnh báo toàn màn hình": "การแจ้งเตือนแบบเต็มหน้าจอ",
    "Cảnh báo có thể không hiển thị nếu thông báo bị tắt.": "การแจ้งเตือนอาจไม่แสดงหากปิดใช้งานการแจ้งเตือน",
    "Điện thoại có thể nhận thông báo SafeHome.": "โทรศัพท์รับการแจ้งเตือน SafeHome ได้",
    ...
    "Kiểm tra điện thoại và cách bạn đang dùng app.": "ตรวจสอบโทรศัพท์และวิธีที่คุณใช้งานแอป",
    ...
    "Hãy cấp quyền vị trí trong Cài đặt ứng dụng": "โปรดให้สิทธิ์ตำแหน่งในการตั้งค่าแอป",
    "Đã bật tự động Bảo vệ khi mọi người rời nhà": "เปิดการป้องกันอัตโนมัติเมื่อทุกคนออกจากบ้านแล้ว",
    "Đã tắt tự động Bảo vệ khi mọi người rời nhà": "ปิดการป้องกันอัตโนมัติเมื่อทุกคนออกจากบ้านแล้ว",
    ...
    "QR này không phải mã xin gia nhập Home": "QR นี้ไม่ใช่รหัสสำหรับขอเข้าร่วมบ้าน",
    "Thêm Home": "เพิ่มบ้าน",
    "Mở cài đặt": "เปิดการตั้งค่า",
    "Để sau": "ไว้ภายหลัง",
    "SafeHome cần quyền vị trí \"Luôn cho phép\" để nhận biết khi bạn rời hoặc trở về nhà, kể cả khi ứng dụng đang chạy nền.": "SafeHome ต้องใช้สิทธิ์ตำแหน่ง \"อนุญาตเสมอ\" เพื่อระบุว่าคุณออกจากหรือกลับถึงบ้าน แม้แอปทำงานเบื้องหลัง",
    "SafeHome hiện chỉ được truy cập vị trí khi bạn đang sử dụng ứng dụng.\n\nHãy chọn quyền Vị trí và chuyển sang \"Luôn cho phép\" để tính năng tự động Bảo vệ khi rời nhà hoạt động khi ứng dụng đang chạy nền.": "ขณะนี้ SafeHome เข้าถึงตำแหน่งได้เฉพาะขณะใช้งานแอปเท่านั้น\n\nโปรดเลือกสิทธิ์ตำแหน่งและเปลี่ยนเป็น \"อนุญาตเสมอ\" เพื่อให้การป้องกันอัตโนมัติเมื่อออกจากบ้านทำงานขณะแอปอยู่เบื้องหลัง",
    "Cho phép vị trí luôn luôn": "อนุญาตตำแหน่งเสมอ",
    "Các nhà của bạn sẽ bị xoá.\nCác nhà được chia sẻ sẽ được rời khỏi.": "บ้านของคุณจะถูกลบ\nคุณจะออกจากบ้านที่แชร์กับคุณ",
    "Thao tác này sẽ thay đổi lịch Home Alarm của toàn bộ thiết bị an ninh trong các nhà đã chọn.\n\nNhững thành viên đang sử dụng Alarm 'Theo nhà' sẽ bị ảnh hưởng.\nAlarm cá nhân ở chế độ 'Riêng tôi' sẽ không bị thay đổi.": "การดำเนินการนี้จะเปลี่ยนกำหนดเวลา Alarm ของบ้านสำหรับอุปกรณ์รักษาความปลอดภัยทั้งหมดในบ้านที่เลือก\n\nสมาชิกที่ใช้ Alarm แบบ 'ตามบ้าน' จะได้รับผลกระทบ\nAlarm ส่วนตัวในโหมด 'เฉพาะฉัน' จะไม่เปลี่ยนแปลง",
    "Thao tác này sẽ thêm Home Reminder cho các nhà đã chọn.\n\nNhững thành viên đang sử dụng Reminder 'Theo nhà' sẽ bị ảnh hưởng.\nReminder cá nhân ở chế độ 'Riêng tôi' sẽ không bị thay đổi.": "การดำเนินการนี้จะเพิ่ม Reminder ของบ้านให้บ้านที่เลือก\n\nสมาชิกที่ใช้ Reminder แบบ 'ตามบ้าน' จะได้รับผลกระทบ\nReminder ส่วนตัวในโหมด 'เฉพาะฉัน' จะไม่เปลี่ยนแปลง",
    "Khi bật, các thiết bị an ninh sẽ được giám sát ngay.\n\nTự động Bảo vệ khi rời nhà sẽ tạm dừng. Chế độ này không tự tắt khi có người về nhà và chỉ được tắt khi một thành viên có quyền chủ động chuyển về Bình thường.": "เมื่อเปิด อุปกรณ์รักษาความปลอดภัยจะถูกตรวจสอบทันที\n\nการป้องกันอัตโนมัติเมื่อออกจากบ้านจะหยุดชั่วคราว โหมดนี้จะไม่ปิดเองเมื่อมีคนกลับบ้าน และจะปิดเมื่อสมาชิกที่ได้รับอนุญาตเปลี่ยนเป็นโหมดปกติเท่านั้น",
    "Hành động này sẽ thay đổi thời gian báo động của một số thiết bị trong hôm nay...": "การดำเนินการนี้จะเปลี่ยนเวลา Alarm ของอุปกรณ์บางเครื่องในวันนี้...",
    "Hành động này sẽ tắt toàn bộ báo động của nhà dưới mọi hình thức. Bạn sẽ không còn nhận được cảnh báo khi có nguy hiểm trên điện thoại nữa.": "การดำเนินการนี้จะปิด Alarm ทุกประเภทของบ้าน คุณจะไม่ได้รับการแจ้งเตือนบนโทรศัพท์เมื่อเกิดอันตรายอีกต่อไป",
    "Alarm đang sử dụng chế độ Theo nhà.\n\nBạn sẽ nhận cảnh báo theo lịch Alarm chung do Chủ nhà hoặc Quản trị viên thiết lập.": "Alarm กำลังใช้โหมดตามบ้าน\n\nคุณจะได้รับการแจ้งเตือนตามกำหนดเวลา Alarm ส่วนกลางที่เจ้าของบ้านหรือผู้ดูแลระบบตั้งไว้",
    "Alarm đang sử dụng chế độ Riêng tôi.\n\nBạn sẽ nhận cảnh báo theo lịch Alarm riêng đã thiết lập cho tài khoản này.": "Alarm กำลังใช้โหมดเฉพาะฉัน\n\nคุณจะได้รับการแจ้งเตือนตามกำหนดเวลา Alarm ส่วนตัวที่ตั้งไว้สำหรับบัญชีนี้",
    "Không thể đăng nhập bằng Google": "ไม่สามารถลงชื่อเข้าใช้ด้วย Google ได้",
    "Không đặt được mật khẩu": "ไม่สามารถตั้งรหัสผ่านได้",
    "Chấp nhận": "ยอมรับ",
    "Cho phép": "อนุญาต",
    "Không thể chấp nhận lời mời. Vui lòng thử lại.": "ไม่สามารถยอมรับคำเชิญได้ โปรดลองอีกครั้ง",
    "Không thể chấp nhận lời xin vào nhà. Vui lòng thử lại.": "ไม่สามารถยอมรับคำขอเข้าร่วมบ้านได้ โปรดลองอีกครั้ง",
    "Từ chối": "ปฏิเสธ",
    ...
    "Hãy chọn quyền vị trí Luôn cho phép trong Cài đặt ứng dụng": "โปรดเลือกสิทธิ์ตำแหน่ง \"อนุญาตเสมอ\" ในการตั้งค่าแอป",
    "Tài khoản Google cần tạo thêm mật khẩu để dùng các chức năng bảo mật.": "บัญชี Google จำเป็นต้องสร้างรหัสผ่านเพิ่มเติมเพื่อใช้ฟังก์ชันความปลอดภัย",
    "Alarm": "Alarm",
    "Bạn không có quyền thực hiện thao tác này。": "คุณไม่มีสิทธิ์ดำเนินการนี้",
    "Cài đặt": "การตั้งค่า",
    "Cập nhật": "อัปเดต",
    "Chọn ngôn ngữ": "เลือกภาษา",
    "Chưa có dữ liệu thiết bị để đánh giá": "ยังไม่มีข้อมูลอุปกรณ์สำหรับการประเมิน",
    "Chuyển quyền sở hữu cho thành viên khác": "โอนสิทธิ์เจ้าของบ้านให้สมาชิกคนอื่น",
    "Có": "ใช่",
    ...
    "Khóa đang mở khi nhà ở chế độ Bảo vệ": "ล็อกเปิดอยู่เมื่อบ้านอยู่ในโหมดป้องกัน",
    ...
    "Báo động lặp sau \$securityModeRepeatMinutes phút nếu sự cố vẫn còn.": "Alarm จะทำซ้ำหลัง \$securityModeRepeatMinutes นาที หากยังมีปัญหาอยู่",
    "\$actorName đã bật Mode Bảo vệ thủ công cho \"\$homeName\". Chế độ này chỉ tắt khi một thành viên có quyền chủ động chuyển về Bình thường. \$repeatMessage": "\$actorName เปิดโหมดป้องกันด้วยตนเองสำหรับ \"\$homeName\" โหมดนี้จะปิดเมื่อสมาชิกที่ได้รับอนุญาตเปลี่ยนกลับเป็นโหมดปกติเท่านั้น \$repeatMessage",
    "Bạn đã bật Alarm cho nhà \"\$homeName\".": "คุณเปิด Alarm สำหรับบ้าน \"\$homeName\" แล้ว",
    "Bạn đã tắt toàn bộ Alarm của nhà \"\$homeName\".": "คุณได้ปิด Alarm ทั้งหมดของบ้าน \"\$homeName\" แล้ว",
    "Thành viên mới": "สมาชิกใหม่",
    "Thành viên rời nhà": "สมาชิกออกจากบ้าน",
    "\$displayMemberName đã rời khỏi nhà \"\$homeName\".": "\$displayMemberName ออกจากบ้าน \"\$homeName\" แล้ว",
    "\$actorName đã đổi vai trò của \$memberName từ \$oldRoleName thành \$newRoleName trong nhà \"\$homeName\".": "\$actorName เปลี่ยนบทบาทของ \$memberName จาก \$oldRoleName เป็น \$newRoleName ในบ้าน \"\$homeName\"",
    ...
    "Đang theo dõi để tự động bật Chế độ Bảo vệ.": "กำลังตรวจสอบเพื่อเปิดโหมดป้องกันอัตโนมัติ",
    "Dùng vị trí để tự động bật Chế độ Bảo vệ khi mọi người rời nhà.": "ใช้ตำแหน่งเพื่อเปิดโหมดป้องกันอัตโนมัติเมื่อทุกคนออกจากบ้าน",
    ...
    "Không thể xác nhận với SafeHome. Hãy kiểm tra kết nối và thử lại.": "ไม่สามารถยืนยันกับ SafeHome ได้ โปรดตรวจสอบการเชื่อมต่อแล้วลองอีกครั้ง",
    "Chỉ tắt cảnh báo khi bạn đã kiểm tra tình trạng trong nhà.\n\nBạn chắc chắn muốn tắt cảnh báo?": "ปิดการแจ้งเตือนเมื่อคุณตรวจสอบสถานะในบ้านแล้วเท่านั้น\n\nคุณแน่ใจหรือไม่ว่าต้องการปิดการแจ้งเตือน",
    ...
    "Mode Bảo vệ sẽ chỉ báo động một lần": "โหมดป้องกันจะแจ้งเตือนเพียงครั้งเดียว",
    "Mode Bảo vệ sẽ lặp báo động sau \$minutes phút": "โหมดป้องกันจะแจ้งเตือนซ้ำหลัง \$minutes นาที",
    "Đã gửi yêu cầu gia nhập \$count nhà": "ส่งคำขอเข้าร่วมบ้าน \$count หลังแล้ว",
    "\$requesterName đang xin gia nhập nhà \"\$homeName\".": "\$requesterName กำลังขอเข้าร่วมบ้าน \"\$homeName\"",
    "Bạn đã xoá nhà \"\$homeName\".": "คุณได้ลบบ้าน \"\$homeName\" แล้ว",
    "Bạn đã gửi yêu cầu chuyển quyền chủ nhà \"\$homeName\" cho \$email.": "คุณได้ส่งคำขอโอนสิทธิ์เจ้าของบ้านของ \"\$homeName\" ให้ \$email แล้ว",
    "\$actorName muốn chuyển quyền chủ nhà \"\$homeName\" cho bạn.": "\$actorName ต้องการโอนสิทธิ์เจ้าของบ้านของ \"\$homeName\" ให้คุณ",
    "\$actorName đã mời bạn tham gia nhà \"\$homeName\".": "\$actorName ขอเชิญคุณเข้าร่วมบ้าน \"\$homeName\"",
    "SafeHome đang xoá thiết bị \"\$deviceName\" khỏi nhà \"\$homeName\".": "SafeHome กำลังลบอุปกรณ์ \"\$deviceName\" ออกจากบ้าน \"\$homeName\"",
    "Thiết bị \"\$deviceName\" đã xuất hiện trong \"\$homeName\".": "เพิ่มอุปกรณ์ \"\$deviceName\" ในบ้าน \"\$homeName\" แล้ว",
    "Bạn đã tạo nhà \"\$name\".": "คุณสร้างบ้าน \"\$name\" แล้ว",
    "\$actorName đã cập nhật tên nhà thành \"\$newName\" và thay đổi địa chỉ.": "\$actorName อัปเดตชื่อบ้านเป็น \"\$newName\" และเปลี่ยนที่อยู่แล้ว",
    "\$actorName đã đổi tên nhà thành \"\$newName\".": "\$actorName เปลี่ยนชื่อบ้านเป็น \"\$newName\" แล้ว",
    "\$actorName đã cập nhật địa chỉ của nhà \"\$newName\".": "\$actorName อัปเดตที่อยู่ของบ้าน \"\$newName\" แล้ว",
    "\$actorName đã đổi tên thiết bị \"\$oldDeviceName\" thành \"\$newName\" trong nhà \"\$homeName\".": "\$actorName เปลี่ยนชื่ออุปกรณ์ \"\$oldDeviceName\" เป็น \"\$newName\" ในบ้าน \"\$homeName\"",
    "Đang ghép nối: \$seconds giây": "กำลังจับคู่: \$seconds วินาที",
    "Chế độ thêm thiết bị đã được mở trong nhà \"\$homeName\" trong \$seconds giây.": "เปิดโหมดเพิ่มอุปกรณ์ในบ้าน \"\$homeName\" เป็นเวลา \$seconds วินาที",
    "Khoảng thời gian phải nằm trong khung Alarm (\$start → \$end)": "ช่วงเวลาหยุดชั่วคราวต้องอยู่ภายในกำหนดเวลา Alarm (\$start → \$end)",
    "\$passCount/\$total bài test đạt\n\n": "ผ่านการทดสอบ \$passCount/\$total รายการ\n\n",
    "\$name chưa cập nhật số điện thoại trong hồ sơ.": "\$name ยังไม่ได้อัปเดตหมายเลขโทรศัพท์ในโปรไฟล์",
    ...
    "\"\$name\" phát hiện khói trong \"\$homeName\".": "\"\$name\" ตรวจจับควันใน \"\$homeName\"",
    "\"\$name\" đã trở lại trạng thái bình thường.": "\"\$name\" กลับสู่สถานะปกติแล้ว",
    "\"\$name\" vừa kích hoạt SOS trong \"\$homeName\".": "\"\$name\" เปิดใช้งาน SOS ใน \"\$homeName\"",
    "\"\$name\" đã hết trạng thái SOS.": "\"\$name\" สิ้นสุดสถานะ SOS แล้ว",
    "\"\$name\" báo bị tháo/cạy trong \"\$homeName\".": "\"\$name\" ถูกงัดแงะใน \"\$homeName\"",
    "\"\$name\" đã hết cảnh báo tháo/cạy.": "การแจ้งเตือนการงัดแงะของ \"\$name\" สิ้นสุดแล้ว",
    "\"\$name\" đã đóng trong \"\$homeName\".": "\"\$name\" ปิดแล้วใน \"\$homeName\"",
    "\"\$name\" đang mở trong \"\$homeName\".": "\"\$name\" เปิดอยู่ใน \"\$homeName\"",
    "\"\$name\" trong \"\$homeName\" đang yếu pin.": "\"\$name\" ใน \"\$homeName\" มีแบตเตอรี่เหลือน้อย",
    "\"\$name\" trong \"\$homeName\" đã mất kết nối.": "\"\$name\" ใน \"\$homeName\" ออฟไลน์แล้ว",
    "\"\$name\" trong \"\$homeName\" đã kết nối trở lại.": "\"\$name\" ใน \"\$homeName\" กลับมาออนไลน์แล้ว",
    "\"\$name\" ghi nhận nhiệt độ cao trong \"\$homeName\".": "\"\$name\" ตรวจพบอุณหภูมิสูงใน \"\$homeName\"",
    "\"\$name\" ghi nhận độ ẩm cao trong \"\$homeName\".": "\"\$name\" ตรวจพบความชื้นสูงใน \"\$homeName\"",
    ...
    "Nếu chưa có ai xác nhận, SafeHome sẽ chuyển sang gọi điện khẩn cấp.": "หากไม่มีใครยืนยัน SafeHome จะเปลี่ยนไปใช้การโทรฉุกเฉิน",
    "Báo lại lúc \$time nếu vấn đề chưa được xử lý.": "จะแจ้งเตือนอีกครั้งเวลา \$time หากยังไม่ได้แก้ไขปัญหา",
    "Sẽ báo lại theo lịch Alarm đã cài nếu vấn đề chưa được xử lý.": "จะแจ้งเตือนซ้ำตามกำหนดเวลา Alarm ที่ตั้งไว้ หากยังไม่ได้แก้ไขปัญหา",
    "\"\$deviceName\" đã đóng trong \"\$resolvedHomeName\".": "\"\$deviceName\" ปิดแล้วใน \"\$resolvedHomeName\"",
    "\"\$deviceName\" đang mở trong \"\$resolvedHomeName\".": "\"\$deviceName\" เปิดอยู่ใน \"\$resolvedHomeName\"",
    "\$count nhà đã chọn": "เลือกบ้าน \$count หลัง",
    "🚨 \$count nhà không an toàn\$suffix": "🚨 บ้านที่ไม่ปลอดภัย \$count หลัง\$suffix",
    "⚠️ \$count nhà cần chú ý\$suffix": "⚠️ บ้านที่ต้องตรวจสอบ \$count หลัง\$suffix",
    ...
    "Đã cài Reminder cho \$updatedHomes nhà.": "ตั้ง Reminder ให้บ้าน \$updatedHomes หลังแล้ว",
    "Đã cài Alarm cho \$updatedDevices thiết bị trong \$updatedHomes nhà.\n": "ตั้งค่า Alarm ให้กับอุปกรณ์ \$updatedDevices เครื่องในบ้าน \$updatedHomes หลังแล้ว\n",
    "Đã chia sẻ các nhà bạn có quyền.\n\n\$skipped nhà bị bỏ qua vì bạn không có quyền chia sẻ.": "แชร์บ้านที่คุณมีสิทธิ์แล้ว\n\nข้ามบ้าน \$skipped หลังเนื่องจากคุณไม่มีสิทธิ์แชร์",
    "Đã áp dụng Alarm cho \$count thiết bị an ninh": "ใช้ Alarm กับอุปกรณ์รักษาความปลอดภัย \$count เครื่องแล้ว",
    "Áp dụng cùng một lịch cho \$count thiết bị an ninh": "ใช้กำหนดเวลาเดียวกันกับอุปกรณ์รักษาความปลอดภัย \$count เครื่อง",
    ...
    "Bạn chắc chắn muốn xoá \$name khỏi nhà này?": "คุณแน่ใจหรือไม่ว่าต้องการลบ \$name ออกจากบ้านหลังนี้",
    "\$targetEmail\nXin gia nhập \"\$homeName\"": "\$targetEmail\nขอเข้าร่วม \"\$homeName\"",
    "Xin gia nhập \"\$homeName\"": "ขอเข้าร่วม \"\$homeName\"",
    "Bạn được mời nhận quyền nhà \"\$homeName\"": "คุณได้รับเชิญให้รับสิทธิ์เจ้าของบ้านของ \"\$homeName\"",
    ...
    "Hãy thêm thiết bị SafeHome đầu tiên để bắt đầu theo dõi nhà.": "โปรดเพิ่มอุปกรณ์ SafeHome เครื่องแรกเพื่อเริ่มตรวจสอบบ้าน",
    "Kiểm tra cảnh báo khẩn cấp trước, sau đó liên hệ thành viên trong nhà nếu cần.": "ตรวจสอบการแจ้งเตือนฉุกเฉินก่อน แล้วติดต่อสมาชิกในบ้านหากจำเป็น",
    "Không có thành viên nào ở nhà nhưng cửa hoặc khóa đang mở, hãy kiểm tra ngay.": "ไม่มีสมาชิกอยู่บ้าน แต่ประตูหรือล็อกเปิดอยู่ โปรดตรวจสอบทันที",
    "Kiểm tra cửa hoặc khóa đang mở trước khi giữ nhà ở chế độ Bảo vệ.": "ตรวจสอบประตูหรือล็อกที่เปิดอยู่ก่อนเปิดโหมดป้องกันให้บ้าน",
    "Có thể vẫn có người ở nhà; nếu đúng, nên chuyển về Bình thường.": "อาจยังมีคนอยู่บ้าน หากใช่ ควรเปลี่ยนเป็นโหมดปกติ",
    "Có thành viên chưa xác định vị trí, hãy nhắc họ mở app hoặc kiểm tra quyền vị trí.": "มีสมาชิกที่ยังไม่ทราบตำแหน่ง โปรดแจ้งให้เปิดแอปหรือตรวจสอบสิทธิ์ตำแหน่ง",
    "Có thiết bị mất kết nối, hãy kiểm tra pin, nguồn hoặc vị trí đặt thiết bị.": "มีอุปกรณ์ขาดการเชื่อมต่อ โปรดตรวจสอบแบตเตอรี่ แหล่งจ่ายไฟ หรือตำแหน่งอุปกรณ์",
    "Có thiết bị pin yếu, nên thay pin sớm để tránh mất cảnh báo.": "มีอุปกรณ์แบตเตอรี่ใกล้หมด ควรเปลี่ยนแบตเตอรี่เร็ว ๆ นี้เพื่อไม่ให้พลาดการแจ้งเตือน",
    "Bạn chưa đặt Reminder, nên tạo lịch nhắc kiểm tra nhà định kỳ.": "คุณยังไม่ได้ตั้ง Reminder ควรสร้างกำหนดการ Reminder เพื่อตรวจสอบบ้านเป็นระยะ",
    "Bạn chưa đặt lịch Alarm, nên bật bảo vệ theo khung giờ thường vắng nhà.": "คุณยังไม่ได้ตั้งกำหนดเวลา Alarm ควรเปิดโหมดป้องกันตามช่วงเวลาที่มักไม่มีคนอยู่บ้าน",
    "Không có việc cần xử lý ngay, bạn chỉ cần tiếp tục theo dõi trạng thái nhà.": "ไม่มีสิ่งที่ต้องจัดการทันที โปรดติดตามสถานะบ้านต่อไป",
    ...
    "Hôm nay các cửa đã được sử dụng \$count lần": "วันนี้มีการใช้งานประตู \$count ครั้ง",
    "Đã ghi nhận \$count hoạt động gần đây": "บันทึกกิจกรรมล่าสุด \$count รายการแล้ว",
    "Hệ thống: Cần kiểm tra \$issueCount mục": "ระบบ: ต้องตรวจสอบ \$issueCount รายการ",
    "FCM token đã sẵn sàng trên điện thoại này.": "โทเค็น FCM พร้อมใช้งานบนโทรศัพท์เครื่องนี้แล้ว",
    "FCM token đã sẵn sàng, nhưng Auto rời khỏi nhà còn thiếu điều kiện.": "โทเค็น FCM พร้อมใช้งานแล้ว แต่การป้องกันอัตโนมัติเมื่อออกจากบ้านยังขาดเงื่อนไขบางอย่าง",
    "Hiện có \$emergencyTotal thiết bị khẩn cấp. Khuyến nghị tối thiểu: báo khói và SOS.": "ขณะนี้มีอุปกรณ์ฉุกเฉิน \$emergencyTotal เครื่อง คำแนะนำขั้นต่ำ: เครื่องตรวจจับควันและ SOS",
    "Bạn chắc chắn muốn chuyển quyền chủ nhà cho:\n\$targetEmail?": "คุณแน่ใจหรือไม่ว่าต้องการโอนสิทธิ์เจ้าของบ้านให้บุคคลต่อไปนี้:\n\$targetEmail?",
    ...
    "Dữ liệu gần nhất cập nhật \$count phút trước": "อัปเดตข้อมูลล่าสุดเมื่อ \$count นาทีที่แล้ว",
    "Dữ liệu gần nhất cập nhật \$count giờ trước": "อัปเดตข้อมูลล่าสุดเมื่อ \$count ชั่วโมงที่แล้ว",
    ...
    "\$name: Đang mở khi nhà ở chế độ Bảo vệ": "\$name: เปิดอยู่เมื่อบ้านอยู่ในโหมดป้องกัน",
    "An tâm hơn trong từng ngôi nhà": "อุ่นใจมากขึ้นในทุกบ้าน",
    "Báo động SafeHome": "Alarm ของ SafeHome",
    "Có cảnh báo an ninh cần kiểm tra ngay.": "มีการแจ้งเตือนด้านความปลอดภัยที่ต้องตรวจสอบทันที",
    "Có cảnh báo cần kiểm tra": "มีสัญญาณเตือนที่ต้องตรวจสอบ",
    "Tự đóng sau \$time": "ปิดอัตโนมัติหลัง \$time",
    "Ngày trong tuần": "วันในสัปดาห์",
    "Hoặc": "หรือ",
    "Giờ bắt đầu và kết thúc không được trùng nhau": "เวลาเริ่มต้นและเวลาสิ้นสุดต้องไม่ตรงกัน",
    "Giờ kết thúc phải sau thời điểm hiện tại": "เวลาสิ้นสุดต้องอยู่หลังเวลาปัจจุบัน",
    "Khoảng tạm tắt không hợp lệ": "ช่วงเวลาหยุด Alarm ชั่วคราวไม่ถูกต้อง",
    "Khoảng tạm tắt không trùng với lịch Alarm nào đang bật": "ช่วงหยุด Alarm ชั่วคราวไม่ทับซ้อนกับกำหนดเวลา Alarm ที่เปิดใช้งานอยู่",
  };
  ...
  static const Map<String, String> _malay = {
    ...
    "Đặt Reminder / Alarm nhà đã chọn": "Tetapkan Reminder / Alarm ke rumah terpilih",
    ...
    "Mỗi thành viên sẽ cần cấp quyền vị trí Luôn cho phép để trạng thái rời/đến nhà hoạt động khi app chạy nền.": "Setiap ahli perlu memberikan kebenaran lokasi Sentiasa Benarkan supaya status keluar/masuk rumah berfungsi apabila aplikasi berjalan di latar belakang.",
    ...
    "Hành động này sẽ thay đổi thời gian báo động của một số thiết bị ": "Tindakan ini akan mengubah masa Alarm bagi sesetengah peranti ",
    "Hành động này sẽ tắt toàn bộ báo động của nhà ": "Tindakan ini akan mematikan semua Alarm rumah ",
    "Tắt toàn bộ Alarm?": "Matikan semua Alarm?",
    "Không xoá được lịch tạm tắt Alarm": "Tidak dapat memadam jadual henti sementara Alarm",
    ...
    "Chỉ Chủ nhà hoặc Quản trị viên mới có quyền thay đổi lặp báo động": "Hanya Pemilik rumah atau Pentadbir yang dibenarkan mengubah ulangan Alarm",
    "Không lưu được thời gian lặp báo động": "Tidak dapat menyimpan masa ulangan Alarm",
    "Chỉ Chủ nhà hoặc Quản trị viên mới có quyền thay đổi Mode Bảo vệ": "Hanya Pemilik rumah atau Pentadbir yang berhak menukar Mod Perlindungan",
    ...
    "30 phút": "30 minit",
    "15 phút": "15 minit",
    "Bạn đang xem lịch của chủ nhà. Chọn Riêng tôi để tự đặt lịch Alarm.": "Anda sedang melihat jadual pemilik rumah. Pilih Untuk saya sahaja untuk menetapkan jadual Alarm anda sendiri.",
    "Chọn giờ kết thúc Alarm": "Pilih masa tamat Alarm",
    "Chọn giờ bắt đầu Alarm": "Pilih masa mula Alarm",
    "Bạn không có quyền sửa lịch Alarm của nhà": "Anda tidak mempunyai kebenaran untuk mengubah Jadual Alarm rumah",
    "Không thể áp dụng Alarm cho toàn bộ thiết bị": "Tidak dapat menggunakan Alarm pada semua peranti",
    ...
    "Reminder sẽ nhắc bạn kiểm tra trạng thái an toàn của ngôi nhà vào giờ đã chọn.": "Reminder akan mengingatkan anda untuk menyemak status keselamatan rumah anda pada masa yang dipilih.",
    ...
    "Bạn đã mở app gần đây để kiểm tra trạng thái.": "Anda membuka apl baru-baru ini untuk menyemak status.",
    "Bạn nên mở app định kỳ để kiểm tra quyền, lịch và cảnh báo chưa đọc.": "Anda sebaiknya membuka aplikasi secara berkala untuk menyemak kebenaran, jadual dan amaran yang belum dibaca.",
    "Sau vài lần sử dụng, SafeHome sẽ đánh giá thói quen kiểm tra app tốt hơn.": "Selepas beberapa penggunaan, SafeHome akan menilai tabiat menyemak apl dengan lebih baik.",
    ...
    "Nên đặt lịch Alarm cho thời gian ngủ hoặc vắng nhà.": "Sebaiknya tetapkan Jadual Alarm untuk waktu tidur atau ketika tiada orang di rumah.",
    "Nhà đã có lịch Alarm hoặc lịch cảnh báo theo thiết bị.": "Rumah sudah mempunyai Jadual Alarm atau jadual amaran mengikut peranti.",
    "Chưa set lịch Alarm": "Jadual Alarm belum ditetapkan",
    "Đã set lịch Alarm": "Jadual Alarm telah ditetapkan",
    "Nên có ít nhất một Reminder để không quên kiểm tra nhà.": "Sebaiknya tetapkan sekurang-kurangnya satu Reminder supaya anda tidak terlupa memeriksa rumah.",
    "App sẽ nhắc bạn kiểm tra nhà theo lịch đã đặt.": "Aplikasi akan mengingatkan anda untuk memeriksa rumah mengikut jadual yang ditetapkan.",
    "Chưa setup Reminder": "Reminder belum disediakan lagi",
    "Đã setup Reminder": "Reminder telah disediakan",
    "Hãy mở lại app hoặc đăng nhập lại nếu thiết bị không nhận cảnh báo.": "Sila buka semula apl atau log masuk semula jika peranti tidak menerima amaran.",
    ...
    "iOS không mở toàn màn hình như Android; app dùng notification và âm thanh hệ thống.": "iOS tidak membuka skrin penuh seperti Android; Aplikasi ini menggunakan pemberitahuan dan bunyi sistem.",
    ...
    "Kiểm tra điện thoại và cách bạn đang dùng app.": "Semak telefon anda dan cara anda menggunakan apl itu.",
    "Hệ thống SafeHome": "Sistem SafeHome",
    ...
    "Thao tác này sẽ thay đổi lịch Home Alarm của toàn bộ thiết bị an ninh trong các nhà đã chọn.\n\nNhững thành viên đang sử dụng Alarm 'Theo nhà' sẽ bị ảnh hưởng.\nAlarm cá nhân ở chế độ 'Riêng tôi' sẽ không bị thay đổi.": "Tindakan ini akan mengubah jadual Alarm rumah bagi semua peranti keselamatan di rumah yang dipilih.\n\nAhli yang menggunakan Alarm 'Mengikut rumah' akan terjejas.\nAlarm peribadi dalam mod 'Untuk saya sahaja' tidak akan berubah.",
    "Thao tác này sẽ thêm Home Reminder cho các nhà đã chọn.\n\nNhững thành viên đang sử dụng Reminder 'Theo nhà' sẽ bị ảnh hưởng.\nReminder cá nhân ở chế độ 'Riêng tôi' sẽ không bị thay đổi.": "Tindakan ini akan menambahkan Reminder rumah pada rumah yang dipilih.\n\nAhli yang menggunakan Reminder 'Mengikut rumah' akan terjejas.\nReminder peribadi dalam mod 'Untuk saya sahaja' tidak akan berubah.",
    ...
    "Hành động này sẽ thay đổi thời gian báo động của một số thiết bị trong hôm nay...": "Tindakan ini akan mengubah masa Alarm bagi sesetengah peranti pada hari ini...",
    "Hành động này sẽ tắt toàn bộ báo động của nhà dưới mọi hình thức. Bạn sẽ không còn nhận được cảnh báo khi có nguy hiểm trên điện thoại nữa.": "Tindakan ini akan mematikan semua Alarm rumah. Anda tidak lagi menerima amaran bahaya pada telefon.",
    "Alarm đang sử dụng chế độ Theo nhà.\n\nBạn sẽ nhận cảnh báo theo lịch Alarm chung do Chủ nhà hoặc Quản trị viên thiết lập.": "Alarm menggunakan mod Mengikut rumah.\n\nAnda akan menerima amaran mengikut Jadual Alarm bersama yang ditetapkan oleh Pemilik rumah atau Pentadbir.",
    "Alarm đang sử dụng chế độ Riêng tôi.\n\nBạn sẽ nhận cảnh báo theo lịch Alarm riêng đã thiết lập cho tài khoản này.": "Alarm menggunakan mod Untuk saya sahaja.\n\nAnda akan menerima amaran mengikut Jadual Alarm peribadi yang ditetapkan untuk akaun ini.",
    ...
    "Báo động lặp sau \$securityModeRepeatMinutes phút nếu sự cố vẫn còn.": "Alarm akan berulang selepas \$securityModeRepeatMinutes minit jika masalah berterusan.",
    "\$actorName đã bật Mode Bảo vệ thủ công cho \"\$homeName\". Chế độ này chỉ tắt khi một thành viên có quyền chủ động chuyển về Bình thường. \$repeatMessage": "\$actorName telah menghidupkan Mod Perlindungan manual untuk \"\$homeName\". Mod ini hanya dimatikan apabila ahli yang dibenarkan menukarnya kepada Mod Normal. \$repeatMessage",
    "Bạn đã bật Alarm cho nhà \"\$homeName\".": "Anda telah mendayakan Alarm untuk rumah \"\$homeName\".",
    "Bạn đã tắt toàn bộ Alarm của nhà \"\$homeName\".": "Anda telah melumpuhkan semua Alarm rumah \"\$homeName\".",
    ...
    "Mode Bảo vệ sẽ chỉ báo động một lần": "Mod Perlindungan hanya akan membunyikan Alarm sekali",
    "Mode Bảo vệ sẽ lặp báo động sau \$minutes phút": "Mod Perlindungan akan mengulangi Alarm selepas \$minutes minit",
    ...
    "Khoảng thời gian phải nằm trong khung Alarm (\$start → \$end)": "Tempoh Jeda Alarm mesti berada dalam Jadual Alarm (\$start → \$end)",
    ...
    "Sẽ báo lại theo lịch Alarm đã cài nếu vấn đề chưa được xử lý.": "Amaran akan diulang mengikut Jadual Alarm jika masalah belum diselesaikan.",
    ...
    "Đã cài Reminder cho \$updatedHomes nhà.": "Reminder telah ditetapkan untuk \$updatedHomes rumah.",
    ...
    "Đã áp dụng Alarm cho \$count thiết bị an ninh": "Alarm telah digunakan pada \$count peranti keselamatan",
    ...
    "Có thành viên chưa xác định vị trí, hãy nhắc họ mở app hoặc kiểm tra quyền vị trí.": "Terdapat ahli yang lokasinya belum ditentukan, sila ingatkan mereka untuk membuka aplikasi atau menyemak kebenaran lokasi.",
    ...
    "Bạn chưa đặt Reminder, nên tạo lịch nhắc kiểm tra nhà định kỳ.": "Anda belum menetapkan Reminder, anda harus membuat jadual untuk mengingatkan anda supaya memeriksa rumah anda secara berkala.",
    "Bạn chưa đặt lịch Alarm, nên bật bảo vệ theo khung giờ thường vắng nhà.": "Anda belum menetapkan Jadual Alarm. Sebaiknya hidupkan Mod Perlindungan pada waktu rumah biasanya kosong.",
    ...
    "Khoảng tạm tắt không trùng với lịch Alarm nào đang bật": "Tempoh Jeda Alarm tidak bertindih dengan mana-mana Jadual Alarm yang aktif",
  };
  ...
  String allHomeReminderAppliedText(
    ...
    id: "Reminder telah diatur untuk $updatedHomes rumah."
        "${skippedHomes > 0 ? "\n\n$skippedHomes rumah dilewati karena Anda tidak memiliki izin." : ""}",
    th: "ตั้งค่า Reminder ให้บ้าน $updatedHomes หลังแล้ว"
        "${skippedHomes > 0 ? "\n\nข้ามบ้าน $skippedHomes หลังเนื่องจากคุณไม่มีสิทธิ์" : ""}",
    ms: "Reminder telah ditetapkan untuk $updatedHomes rumah."
  ...
  String allHomeAlarmAppliedText({
    ...
    fr: "Alarm configuré pour $updatedDevices appareils dans $updatedHomes maisons.\n"
        ...
        "${skippedHomes > 0 ? "\n\n$skippedHomes maisons ont été ignorées car vous n'avez pas l'autorisation." : ""}",
    id: "Alarm telah diatur untuk $updatedDevices perangkat di $updatedHomes rumah.\n"
        "Waktu ulang: $repeatLabel."
        "${skippedHomes > 0 ? "\n\n$skippedHomes rumah dilewati karena Anda tidak memiliki izin." : ""}",
    th: "ตั้งค่า Alarm ให้กับอุปกรณ์ $updatedDevices เครื่องในบ้าน $updatedHomes หลังแล้ว\n"
        "เวลาทำซ้ำ: $repeatLabel"
        "${skippedHomes > 0 ? "\n\nข้ามบ้าน $skippedHomes หลังเนื่องจากคุณไม่มีสิทธิ์" : ""}",
    ms: "Alarm telah ditetapkan untuk $updatedDevices peranti di $updatedHomes rumah.\n"

...
class AppStrings {
  ...
  String noPhysicalSirenMessage() => choose(
    vi: "Chưa có còi vật lý",
    en: "No physical siren is installed",
    zh: "尚未安装实体警报器",
    ko: "물리 사이렌이 없습니다",
    ja: "物理サイレンがありません",
    de: "Keine physische Sirene vorhanden",
    ru: "Физическая сирена не установлена",
    fr: "Aucune sirène physique installée",
    es: "No hay ninguna sirena física instalada",
    id: "Belum ada sirene fisik",
    th: "ยังไม่มีไซเรนจริง",
    ms: "Belum ada siren fizikal",
    fil: "Wala pang pisikal na sirena",
    km: "មិនទាន់មានស៊ីរ៉ែនផ្ទាល់",
    my: "ရုပ်ပိုင်းဆိုင်ရာ ဥဩ မရှိသေးပါ",
    lo: "ຍັງບໍ່ມີໄຊເຣນຈິງ",
    ta: "உடல் சைரன் இல்லை",
    pt: "Nenhuma sirene física instalada",
    tet: "Seidauk iha sirene físiku",
    it: "Nessuna sirena fisica installata",
    pl: "Brak fizycznej syreny",
    nl: "Geen fysieke sirene geïnstalleerd",
    cs: "Není nainstalována fyzická siréna",
    sk: "Nie je nainštalovaná fyzická siréna",
    uk: "Фізичну сирену не встановлено",
    ro: "Nu este instalată nicio sirenă fizică",
    hu: "Nincs fizikai sziréna telepítve",
    bg: "Няма инсталирана физическа сирена",
    hr: "Nema instalirane fizičke sirene",
    sr: "Нема инсталиране физичке сирене",
    bs: "Nema instalirane fizičke sirene",
    sl: "Fizična sirena ni nameščena",
    mk: "Нема инсталирана физичка сирена",
    sq: "Nuk ka sirenë fizike të instaluar",
    el: "Δεν έχει εγκατασταθεί φυσική σειρήνα",
    tr: "Fiziksel siren kurulu değil",
    sv: "Ingen fysisk siren installerad",
    da: "Ingen fysisk sirene installeret",
    nb: "Ingen fysisk sirene er installert",
    fi: "Fyysistä sireeniä ei ole asennettu",
    isLang: "Engin líkamleg sírena uppsett",
    et: "Füüsilist sireeni pole paigaldatud",
    lv: "Nav uzstādīta fiziska sirēna",
    lt: "Neįrengta fizinė sirena",
    ga: "Níl aon bhonnán fisiciúil suiteáilte",
    mt: "L-ebda sirena fiżika mhija installata",
    be: "Фізічная сірэна не ўсталявана",
    lb: "Keng physesch Sirène installéiert",
    ca: "No hi ha cap sirena física instal·lada",
    cnr: "Nema instalirane fizičke sirene",
    hy: "Ֆիզիկական շչակ տեղադրված չէ",
    ka: "ფიზიკური სირენა არ არის დაყენებული",
    az: "Fiziki siren quraşdırılmayıb",
  );

  String sirenReadyMessage() => choose(
    vi: "Còi đang sẵn sàng",
    en: "The siren is ready",
    zh: "警报器已准备就绪",
    ko: "사이렌이 준비되었습니다",
    ja: "サイレンは使用可能です",
    de: "Die Sirene ist bereit",
    ru: "Сирена готова",
    fr: "La sirène est prête",
    es: "La sirena está lista",
    id: "Sirene siap digunakan",
    th: "ไซเรนพร้อมใช้งาน",
    ms: "Siren sedia digunakan",
    fil: "Handa na ang sirena",
    km: "ស៊ីរ៉ែនរួចរាល់",
    my: "ဥဩ အသင့်ဖြစ်နေပါပြီ",
    lo: "ໄຊເຣນພ້ອມໃຊ້ງານ",
    ta: "சைரன் தயாராக உள்ளது",
    pt: "A sirene está pronta",
    tet: "Sirene prontu ona",
    it: "La sirena è pronta",
    pl: "Syrena jest gotowa",
    nl: "De sirene is gereed",
    cs: "Siréna je připravena",
    sk: "Siréna je pripravená",
    uk: "Сирена готова",
    ro: "Sirena este pregătită",
    hu: "A sziréna készen áll",
    bg: "Сирената е готова",
    hr: "Sirena je spremna",
    sr: "Сирена је спремна",
    bs: "Sirena je spremna",
    sl: "Sirena je pripravljena",
    mk: "Сирената е подготвена",
    sq: "Sirena është gati",
    el: "Η σειρήνα είναι έτοιμη",
    tr: "Siren hazır",
    sv: "Sirenen är redo",
    da: "Sirenen er klar",
    nb: "Sirenen er klar",
    fi: "Sireeni on valmiina",
    isLang: "Sírenan er tilbúin",
    et: "Sireen on valmis",
    lv: "Sirēna ir gatava",
    lt: "Sirena paruošta",
    ga: "Tá an bonnán réidh",
    mt: "Is-sirena lesta",
    be: "Сірэна гатова",
    lb: "D'Sirène ass prett",
    ca: "La sirena està preparada",
    cnr: "Sirena je spremna",
    hy: "Շչակը պատրաստ է",
    ka: "სირენა მზად არის",
    az: "Siren hazırdır",
  );

  String sirenConnectionIssueMessage() => choose(
    vi: "Kết nối tới còi đang gặp sự cố",
    en: "The connection to the siren is having problems",
    zh: "与警报器的连接出现问题",
    ko: "사이렌 연결에 문제가 있습니다",
    ja: "サイレンへの接続に問題があります",
    de: "Die Verbindung zur Sirene ist gestört",
    ru: "Возникла проблема с подключением к сирене",
    fr: "La connexion à la sirène rencontre un problème",
    es: "La conexión con la sirena tiene problemas",
    id: "Koneksi ke sirene sedang bermasalah",
    th: "การเชื่อมต่อกับไซเรนมีปัญหา",
    ms: "Sambungan ke siren sedang bermasalah",
    fil: "May problema sa koneksyon sa sirena",
    km: "ការតភ្ជាប់ទៅស៊ីរ៉ែនកំពុងមានបញ្ហា",
    my: "ဥဩနှင့် ချိတ်ဆက်မှုတွင် ပြဿနာရှိနေသည်",
    lo: "ການເຊື່ອມຕໍ່ຫາໄຊເຣນກຳລັງມີບັນຫາ",
    ta: "சைரனுடன் இணைப்பில் சிக்கல் உள்ளது",
    pt: "A ligação à sirene está com problemas",
    tet: "Ligasaun ba sirene iha problema",
    it: "La connessione alla sirena presenta un problema",
    pl: "Wystąpił problem z połączeniem z syreną",
    nl: "Er is een probleem met de verbinding met de sirene",
    cs: "Připojení k siréně má problém",
    sk: "Pripojenie k siréne má problém",
    uk: "Виникла проблема з підключенням до сирени",
    ro: "Conexiunea la sirenă are o problemă",
    hu: "Probléma van a szirénához való kapcsolódással",
    bg: "Има проблем с връзката към сирената",
    hr: "Postoji problem s vezom sa sirenom",
    sr: "Постоји проблем са везом са сиреном",
    bs: "Postoji problem s vezom sa sirenom",
    sl: "Pri povezavi s sireno je prišlo do težave",
    mk: "Има проблем со поврзувањето со сирената",
    sq: "Ka problem me lidhjen me sirenën",
    el: "Υπάρχει πρόβλημα σύνδεσης με τη σειρήνα",
    tr: "Siren bağlantısında sorun var",
    sv: "Det är problem med anslutningen till sirenen",
    da: "Der er problemer med forbindelsen til sirenen",
    nb: "Det er problemer med tilkoblingen til sirenen",
    fi: "Sireenin yhteydessä on ongelma",
    isLang: "Vandamál kom upp við tengingu við sírenuna",
    et: "Sireeni ühendusega on probleem",
    lv: "Radusies problēma ar savienojumu ar sirēnu",
    lt: "Kilo problema jungiantis prie sirenos",
    ga: "Tá fadhb leis an nasc leis an mbonnán",
    mt: "Hemm problema fil-konnessjoni mas-sirena",
    be: "Узнікла праблема з падключэннем да сірэны",
    lb: "Et gëtt e Problem mat der Verbindung zur Sirène",
    ca: "Hi ha un problema amb la connexió a la sirena",
    cnr: "Postoji problem s vezom sa sirenom",
    hy: "Շչակի հետ կապի խնդիր կա",
    ka: "სირენასთან კავშირის პრობლემა წარმოიშვა",
    az: "Sirenlə bağlantıda problem var",
  );

  String sirenMutedShortMessage() => choose(
    vi: "Đã tắt còi",
    en: "Siren turned off",
    zh: "警报器已关闭",
    ko: "사이렌을 껐습니다",
    ja: "サイレンを停止しました",
    de: "Sirene ausgeschaltet",
    ru: "Сирена выключена",
    fr: "Sirène désactivée",
    es: "Sirena apagada",
    id: "Sirene dimatikan",
    th: "ปิดไซเรนแล้ว",
    ms: "Siren telah dimatikan",
    fil: "Napatay na ang sirena",
    km: "បានបិទស៊ីរ៉ែន",
    my: "ဥဩကို ပိတ်ပြီးပါပြီ",
    lo: "ປິດໄຊເຣນແລ້ວ",
    ta: "சைரன் அணைக்கப்பட்டது",
    pt: "Sirene desligada",
    tet: "Sirene mate ona",
    it: "Sirena disattivata",
    pl: "Syrena wyłączona",
    nl: "Sirene uitgeschakeld",
    cs: "Siréna vypnuta",
    sk: "Siréna vypnutá",
    uk: "Сирену вимкнено",
    ro: "Sirena a fost oprită",
    hu: "Sziréna kikapcsolva",
    bg: "Сирената е изключена",
    hr: "Sirena je isključena",
    sr: "Сирена је искључена",
    bs: "Sirena je isključena",
    sl: "Sirena je izklopljena",
    mk: "Сирената е исклучена",
    sq: "Sirena u fik",
    el: "Η σειρήνα απενεργοποιήθηκε",
    tr: "Siren kapatıldı",
    sv: "Sirenen har stängts av",
    da: "Sirenen er slukket",
    nb: "Sirenen er slått av",
    fi: "Sireeni sammutettu",
    isLang: "Slökkt á sírenu",
    et: "Sireen välja lülitatud",
    lv: "Sirēna izslēgta",
    lt: "Sirena išjungta",
    ga: "Múchadh an bonnán",
    mt: "Is-sirena ġiet mitfija",
    be: "Сірэна выключана",
    lb: "Sirène ausgeschalt",
    ca: "Sirena apagada",
    cnr: "Sirena je isključena",
    hy: "Շչակն անջատված է",
    ka: "სირენა გამორთულია",
    az: "Siren söndürüldü",
  );
  ...
  String get followHomeAlarmSyncNote => choose(
    vi: "Khi bật, lịch cá nhân và thông báo báo động sẽ tự động đồng bộ theo lịch chung của nhà.",
    en: "When enabled, your personal schedule and alarm notifications automatically follow the home's shared schedule.",
    zh: "启用后，个人计划和警报通知将自动与家庭公共计划同步。",
    ko: "켜면 개인 일정과 경보 알림이 집의 공용 일정에 자동으로 동기화됩니다.",
    ja: "オンにすると、個人スケジュールとアラーム通知が家の共通スケジュールに自動で同期されます。",
    de: "Wenn aktiviert, werden Ihr persönlicher Zeitplan und die Alarmbenachrichtigungen automatisch mit dem gemeinsamen Hauszeitplan synchronisiert.",
    ru: "После включения личное расписание и уведомления тревоги автоматически синхронизируются с общим расписанием дома.",
    fr: "Lorsque cette option est activée, votre planning personnel et les notifications d’alarme suivent automatiquement le planning commun du domicile.",
    es: "Al activarlo, tu horario personal y las notificaciones de alarma se sincronizan automáticamente con el horario común del hogar.",
    ...
    cs: "Po zapnutí se osobní plán a oznámení alarmu automaticky synchronizují se společným plánem domácnosti.",
    sk: "Po zapnutí sa osobný rozvrh a upozornenia alarmu automaticky zosynchronizujú so spoločným rozvrhom domácnosti.",
    uk: "Після ввімкнення особистий розклад і сповіщення тривоги автоматично синхронізуються зі спільним розкладом дому.",
    ro: "Când este activată, programarea personală și notificările de alarmă se sincronizează automat cu programarea comună a locuinței.",
    hu: "Bekapcsoláskor a személyes ütemezés és a riasztási értesítések automatikusan követik az otthon közös ütemezését.",
    bg: "Когато е включено, личният график и известията за аларма автоматично се синхронизират с общия график на дома.",
    hr: "Kada je uključeno, osobni raspored i obavijesti alarma automatski se usklađuju sa zajedničkim rasporedom doma.",
    sr: "Када је укључено, лични распоред и обавештења аларма аутоматски се усклађују са заједничким распоредом дома.",
    bs: "Kada je uključeno, lični raspored i obavijesti alarma automatski se usklađuju sa zajedničkim rasporedom doma.",
    sl: "Ko je omogočeno, se osebni urnik in obvestila alarma samodejno uskladijo s skupnim urnikom doma.",
    mk: "Кога е вклучено, личниот распоред и известувањата за аларм автоматски се усогласуваат со заедничкиот распоред на домот.",
    sq: "Kur aktivizohet, orari personal dhe njoftimet e alarmit sinkronizohen automatikisht me orarin e përbashkët të shtëpisë.",
    el: "Όταν ενεργοποιείται, το προσωπικό πρόγραμμα και οι ειδοποιήσεις συναγερμού συγχρονίζονται αυτόματα με το κοινό πρόγραμμα του σπιτιού.",
    tr: "Açıldığında kişisel programınız ve alarm bildirimleri evin ortak programıyla otomatik olarak eşitlenir.",
    sv: "När detta är aktiverat synkroniseras ditt personliga schema och dina larmaviseringar automatiskt med hemmets gemensamma schema.",
    ...
    ga: "Nuair a bhíonn sé cumasaithe, sioncrónaítear do sceideal pearsanta agus fógraí aláraim go huathoibríoch le sceideal comhroinnte an tí.",
    mt: "Meta jkun mixgħul, l-iskeda personali u n-notifiki tal-allarm jissinkronizzaw awtomatikament mal-iskeda komuni tad-dar.",
  ...
  String get deleteAllAlarmSchedules => choose(
    vi: "Xóa nhanh toàn bộ lịch báo động",
    en: "Quickly delete all alarm schedules",
    zh: "快速删除所有警报计划",
    ko: "모든 경보 일정 빠르게 삭제",
    ja: "すべてのアラーム予定を一括削除",
    de: "Alle Alarmzeitpläne schnell löschen",
    ru: "Быстро удалить все расписания тревоги",
    fr: "Supprimer rapidement tous les plannings d’alarme",
    es: "Eliminar rápidamente todos los horarios de alarma",
    id: "Hapus cepat semua jadwal alarm",
    th: "ลบตารางสัญญาณเตือนทั้งหมดอย่างรวดเร็ว",
    ms: "Padam cepat semua jadual penggera",
    fil: "Mabilis na tanggalin ang lahat ng iskedyul ng alarm",
    km: "លុបកាលវិភាគសំឡេងរោទិ៍ទាំងអស់រហ័ស",
    my: "အချက်ပေးအချိန်ဇယားအားလုံးကို အမြန်ဖျက်ရန်",
    lo: "ລຶບຕາຕະລາງແຈ້ງເຕືອນທັງໝົດຢ່າງວ່ອງໄວ",
    ta: "அனைத்து அலாரம் அட்டவணைகளையும் விரைவாக நீக்கு",
    pt: "Excluir rapidamente todos os horários de alarme",
    tet: "Apaga lalais oráriu alarme hotu",
    it: "Elimina rapidamente tutti i programmi di allarme",
    pl: "Szybko usuń wszystkie harmonogramy alarmu",
    nl: "Alle alarmschema’s snel verwijderen",
    cs: "Rychle odstranit všechny plány alarmu",
    sk: "Rýchlo odstrániť všetky plány alarmu",
    uk: "Швидко видалити всі розклади тривоги",
    ro: "Șterge rapid toate programările alarmei",
    hu: "Az összes riasztási ütemezés gyors törlése",
    bg: "Бързо изтриване на всички графици за аларма",
    hr: "Brzo izbriši sve rasporede alarma",
    sr: "Брзо избриши све распореде аларма",
    bs: "Brzo izbriši sve rasporede alarma",
    sl: "Hitro izbriši vse urnike alarma",
    mk: "Брзо избриши ги сите распореди за аларм",
    sq: "Fshi shpejt të gjitha oraret e alarmit",
    el: "Γρήγορη διαγραφή όλων των προγραμμάτων συναγερμού",
    tr: "Tüm alarm programlarını hızlıca sil",
    sv: "Ta snabbt bort alla larmscheman",
    da: "Slet hurtigt alle alarmplaner",
    nb: "Slett raskt alle alarmplaner",
    fi: "Poista nopeasti kaikki hälytysaikataulut",
    isLang: "Eyða öllum viðvörunaráætlunum fljótt",
    et: "Kustuta kiiresti kõik häireajakavad",
    lv: "Ātri dzēst visus trauksmes grafikus",
    lt: "Greitai ištrinti visus pavojaus tvarkaraščius",
    ga: "Scrios gach sceideal aláraim go tapa",
    mt: "Ħassar malajr l-iskedi kollha tal-allarm",
    be: "Хутка выдаліць усе расклады трывогі",
    lb: "All Alarmpläng séier läschen",
    ca: "Suprimeix ràpidament tots els horaris d’alarma",
    cnr: "Brzo izbriši sve rasporede alarma",
    hy: "Արագ ջնջել ահազանգի բոլոր ժամանակացույցերը",
    ka: "ყველა განგაშის განრიგის სწრაფად წაშლა",
    az: "Bütün həyəcan cədvəllərini tez sil",
  );

  String get deleteAllAlarmSchedulesConfirm => choose(
    vi: "Xóa toàn bộ lịch báo động mà bạn có quyền quản lý? Cấu hình thông báo, còi vật lý và toàn màn hình vẫn được giữ.",
    en: "Delete every alarm schedule you can manage? Notification, physical siren, and fullscreen settings will be kept.",
    zh: "删除您有权管理的所有警报计划？通知、实体警笛和全屏设置将保留。",
    ko: "관리할 수 있는 모든 경보 일정을 삭제할까요? 알림, 물리적 사이렌 및 전체 화면 설정은 유지됩니다.",
    ja: "管理できるすべてのアラーム予定を削除しますか？通知、物理サイレン、全画面設定は保持されます。",
    de: "Alle von Ihnen verwaltbaren Alarmzeitpläne löschen? Benachrichtigungs-, Sirenen- und Vollbildeinstellungen bleiben erhalten.",
    ru: "Удалить все доступные вам расписания тревоги? Настройки уведомлений, физической сирены и полноэкранного режима сохранятся.",
    fr: "Supprimer tous les plannings d’alarme que vous pouvez gérer ? Les réglages de notification, de sirène physique et de plein écran seront conservés.",
    es: "¿Eliminar todos los horarios de alarma que puedes administrar? Se conservarán los ajustes de notificación, sirena física y pantalla completa.",
    ...
    cs: "Odstranit všechny plány alarmu, které můžete spravovat? Nastavení oznámení, fyzické sirény a celé obrazovky zůstanou zachována.",
    sk: "Odstrániť všetky plány alarmu, ktoré môžete spravovať? Nastavenia upozornení, fyzickej sirény a celej obrazovky zostanú zachované.",
    uk: "Видалити всі розклади тривоги, якими ви можете керувати? Налаштування сповіщень, фізичної сирени та повноекранного режиму буде збережено.",
    ro: "Ștergi toate programările alarmei pe care le poți gestiona? Setările de notificare, sirenă fizică și ecran complet vor fi păstrate.",
    hu: "Törli az összes kezelhető riasztási ütemezést? Az értesítési, fizikai sziréna- és teljes képernyős beállítások megmaradnak.",
    bg: "Да се изтрият ли всички графици за аларма, които можете да управлявате? Настройките за известия, физическа сирена и цял екран ще се запазят.",
    hr: "Izbrisati sve rasporede alarma kojima možete upravljati? Postavke obavijesti, fizičke sirene i cijelog zaslona ostat će sačuvane.",
    sr: "Избрисати све распореде аларма којима можете управљати? Подешавања обавештења, физичке сирене и целог екрана остаће сачувана.",
    bs: "Izbrisati sve rasporede alarma kojima možete upravljati? Postavke obavijesti, fizičke sirene i cijelog ekrana ostat će sačuvane.",
    sl: "Izbrišem vse urnike alarma, ki jih lahko upravljate? Nastavitve obvestil, fizične sirene in celozaslonskega prikaza bodo ohranjene.",
    mk: "Да се избришат сите распореди за аларм со кои можете да управувате? Поставките за известувања, физичка сирена и цел екран ќе се зачуваат.",
    sq: "Të fshihen të gjitha oraret e alarmit që mund të menaxhoni? Cilësimet e njoftimit, sirenës fizike dhe ekranit të plotë do të ruhen.",
    el: "Να διαγραφούν όλα τα προγράμματα συναγερμού που μπορείτε να διαχειριστείτε; Οι ρυθμίσεις ειδοποιήσεων, φυσικής σειρήνας και πλήρους οθόνης θα διατηρηθούν.",
    tr: "Yönetebildiğiniz tüm alarm programları silinsin mi? Bildirim, fiziksel siren ve tam ekran ayarları korunacaktır.",
    sv: "Ta bort alla larmscheman som du kan hantera? Inställningar för aviseringar, fysisk siren och helskärm behålls.",
    ...
    ga: "Scrios gach sceideal aláraim is féidir leat a bhainistiú? Coinneofar socruithe fógraí, bonnáin fhisiciúil agus lánscáileáin.",
    mt: "Tħassar l-iskedi kollha tal-allarm li tista’ timmaniġġja? Is-settings tan-notifiki, tas-sirena fiżika u tal-iskrin sħiħ se jinżammu.",
  ...
  String get allAlarmSchedulesDeleted => choose(
    vi: "Đã xóa toàn bộ lịch báo động",
    en: "All alarm schedules were deleted",
    zh: "已删除所有警报计划",
    ko: "모든 경보 일정이 삭제되었습니다",
    ja: "すべてのアラーム予定を削除しました",
    de: "Alle Alarmzeitpläne wurden gelöscht",
    ru: "Все расписания тревоги удалены",
    fr: "Tous les plannings d’alarme ont été supprimés",
    es: "Se eliminaron todos los horarios de alarma",
    id: "Semua jadwal alarm telah dihapus",
    th: "ลบตารางสัญญาณเตือนทั้งหมดแล้ว",
    ms: "Semua jadual penggera telah dipadam",
    fil: "Natanggal na ang lahat ng iskedyul ng alarm",
    km: "បានលុបកាលវិភាគសំឡេងរោទិ៍ទាំងអស់",
    my: "အချက်ပေးအချိန်ဇယားအားလုံးကို ဖျက်ပြီးပါပြီ",
    lo: "ລຶບຕາຕະລາງແຈ້ງເຕືອນທັງໝົດແລ້ວ",
    ta: "அனைத்து அலாரம் அட்டவணைகளும் நீக்கப்பட்டன",
    pt: "Todos os horários de alarme foram excluídos",
    tet: "Oráriu alarme hotu apaga ona",
    it: "Tutti i programmi di allarme sono stati eliminati",
    pl: "Wszystkie harmonogramy alarmu zostały usunięte",
    nl: "Alle alarmschema’s zijn verwijderd",
    cs: "Všechny plány alarmu byly odstraněny",
    sk: "Všetky plány alarmu boli odstránené",
    uk: "Усі розклади тривоги видалено",
    ro: "Toate programările alarmei au fost șterse",
    hu: "Az összes riasztási ütemezés törölve",
    bg: "Всички графици за аларма са изтрити",
    hr: "Svi rasporedi alarma su izbrisani",
    sr: "Сви распореди аларма су избрисани",
    bs: "Svi rasporedi alarma su izbrisani",
    sl: "Vsi urniki alarma so izbrisani",
    mk: "Сите распореди за аларм се избришани",
    sq: "Të gjitha oraret e alarmit u fshinë",
    el: "Διαγράφηκαν όλα τα προγράμματα συναγερμού",
    tr: "Tüm alarm programları silindi",
    sv: "Alla larmscheman har tagits bort",
    da: "Alle alarmplaner er slettet",
    nb: "Alle alarmplaner er slettet",
    fi: "Kaikki hälytysaikataulut poistettiin",
    isLang: "Öllum viðvörunaráætlunum var eytt",
    et: "Kõik häireajakavad kustutati",
    lv: "Visi trauksmes grafiki ir dzēsti",
    lt: "Visi pavojaus tvarkaraščiai ištrinti",
    ga: "Scriosadh gach sceideal aláraim",
    mt: "L-iskedi kollha tal-allarm tħassru",
    be: "Усе расклады трывогі выдалены",
    lb: "All Alarmpläng goufe geläscht",
    ca: "S’han suprimit tots els horaris d’alarma",
    cnr: "Svi rasporedi alarma su izbrisani",
    hy: "Ահազանգի բոլոր ժամանակացույցերը ջնջված են",
    ka: "ყველა განგაშის განრიგი წაიშალა",
    az: "Bütün həyəcan cədvəlləri silindi",
  );

  String get duplicateAlarmSchedule => choose(
    vi: "Đã có lịch báo động trùng hoàn toàn khung giờ này",
    en: "An alarm schedule with exactly this time range already exists",
    zh: "已存在时间范围完全相同的警报计划",
    ko: "정확히 같은 시간대의 경보 일정이 이미 있습니다",
    ja: "まったく同じ時間帯のアラーム予定がすでにあります",
    de: "Ein Alarmzeitplan mit genau diesem Zeitraum ist bereits vorhanden",
    ru: "Расписание тревоги с точно таким временем уже существует",
    fr: "Un planning d’alarme avec exactement cette plage horaire existe déjà",
    es: "Ya existe un horario de alarma con exactamente este intervalo",
    id: "Jadwal alarm dengan rentang waktu yang sama persis sudah ada",
    th: "มีตารางสัญญาณเตือนที่มีช่วงเวลาเดียวกันทุกประการอยู่แล้ว",
    ms: "Jadual penggera dengan julat masa yang sama tepat sudah wujud",
    fil: "May alarm schedule nang may eksaktong parehong oras na",
    km: "មានកាលវិភាគសំឡេងរោទិ៍ដែលមានចន្លោះពេលដូចគ្នាពិតប្រាកដរួចហើយ",
    my: "အချိန်အပိုင်းအခြား အတိအကျတူသော အချက်ပေးအချိန်ဇယား ရှိပြီးသားဖြစ်သည်",
    lo: "ມີຕາຕະລາງແຈ້ງເຕືອນທີ່ມີຊ່ວງເວລາດຽວກັນແລ້ວ",
    ta: "இதே நேர வரம்புடன் ஒரு அலாரம் அட்டவணை ஏற்கனவே உள்ளது",
    pt: "Já existe um horário de alarme com exatamente este intervalo",
    tet: "Oráriu alarme ho tempu hanesan loos eziste ona",
    it: "Esiste già un programma di allarme con esattamente questo intervallo",
    pl: "Harmonogram alarmu z dokładnie tym zakresem czasu już istnieje",
    nl: "Er bestaat al een alarmschema met precies dit tijdsbereik",
    cs: "Plán alarmu s přesně tímto časovým rozsahem již existuje",
    sk: "Plán alarmu s presne týmto časovým rozsahom už existuje",
    uk: "Розклад тривоги з точно таким діапазоном часу вже існує",
    ro: "Există deja o programare a alarmei cu exact acest interval",
    hu: "Már létezik pontosan ilyen időtartományú riasztási ütemezés",
    bg: "Вече съществува график за аларма с точно този часови диапазон",
    hr: "Raspored alarma s potpuno istim vremenom već postoji",
    sr: "Распоред аларма са потпуно истим временом већ постоји",
    bs: "Raspored alarma s potpuno istim vremenom već postoji",
    sl: "Urnik alarma s povsem enakim časovnim razponom že obstaja",
    mk: "Веќе постои распоред за аларм со точно истиот временски период",
    sq: "Ekziston tashmë një orar alarmi me pikërisht këtë interval",
    el: "Υπάρχει ήδη πρόγραμμα συναγερμού με ακριβώς αυτό το χρονικό διάστημα",
    tr: "Tam olarak bu zaman aralığına sahip bir alarm programı zaten var",
    sv: "Det finns redan ett larmschema med exakt detta tidsintervall",
    da: "Der findes allerede en alarmplan med præcis dette tidsrum",
    nb: "Det finnes allerede en alarmplan med nøyaktig dette tidsrommet",
    fi: "Täsmälleen samalla aikavälillä oleva hälytysaikataulu on jo olemassa",
    isLang: "Viðvörunaráætlun með nákvæmlega þessu tímabili er þegar til",
    et: "Täpselt sama ajavahemikuga häireajakava on juba olemas",
    lv: "Trauksmes grafiks ar tieši tādu pašu laika diapazonu jau pastāv",
    lt: "Pavojaus tvarkaraštis su lygiai tokiu pačiu laiko intervalu jau yra",
    ga: "Tá sceideal aláraim leis an raon ama céanna ann cheana",
    mt: "Diġà teżisti skeda tal-allarm bl-istess medda ta’ ħin eżatta",
    be: "Расклад трывогі з дакладна такім жа часам ужо існуе",
    lb: "En Alarmplang mat genee dësem Zäitraum existéiert schonn",
    ca: "Ja existeix un horari d’alarma amb exactament aquest interval",
    cnr: "Raspored alarma sa potpuno istim vremenom već postoji",
    hy: "Այս նույն ժամային միջակայքով ահազանգի ժամանակացույց արդեն կա",
    ka: "ზუსტად ამ დროის დიაპაზონის განგაშის განრიგი უკვე არსებობს",
    az: "Məhz bu vaxt aralığına malik həyəcan cədvəli artıq mövcuddur",
  );
